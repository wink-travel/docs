...
"developer/applications.mdx": {
	id: "developer/applications.mdx";
  slug: "developer/applications";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"developer/build-on-wink.mdx": {
	id: "developer/build-on-wink.mdx";
  slug: "developer/build-on-wink";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"getting-started/customers.md": {
	id: "getting-started/customers.md";
  slug: "getting-started/customers";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"getting-started/how-to-use.mdx": {
	id: "getting-started/how-to-use.mdx";
  slug: "getting-started/how-to-use";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"getting-started/key-features.mdx": {
	id: "getting-started/key-features.mdx";
  slug: "getting-started/key-features";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"studio/accounts.mdx": {
	id: "studio/accounts.mdx";
  slug: "studio/accounts";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
...
"travel-agent/payment-terms.md": {
	id: "travel-agent/payment-terms.md";
  slug: "travel-agent/payment-terms";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
"travel-agent/terms-of-service.md": {
	id: "travel-agent/terms-of-service.md";
  slug: "travel-agent/terms-of-service";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
...
"winklinks/what-is-a-link-manager.md": {
	id: "winklinks/what-is-a-link-manager.md";
  slug: "winklinks/what-is-a-link-manager";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
