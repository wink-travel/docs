...
async function translateWholeFile(
  ...
  const userPrompt = [
    ...
    "- Preserve Starlight-specific formatting: keep admonitions like ':::tip', ':::note', ':::caution' intact; keep single '*' bullet lists as-is.",
    ...
    "- Product names: DO NOT translate brand/product names (e.g., 'Wink', 'WinkLinks', 'Wink Studio', 'Wink Extranet', 'Wink Agency', 'TripPay', 'Winkfluence', 'Winkfluence Inc.'), even when they appear in headings, emphasized text, or link anchor text.",
    "- Legal defined terms: in legal documents (terms of service, payment terms), DO NOT translate the entity names 'TripPay Corporation' and 'Winkfluence Inc.'; translate surrounding defined terms such as 'Payment Collection Agent' consistently throughout the file.",
