...
등록된 여행사를 위한 당사의 솔루션은 [Wink Agent](https://agent.wink.travel)입니다. 에이전트가 고객을 대신해 검색하고 예약할 수 있는 셀프 서비스 포털이며, 각 예약마다 수수료를 받을 수 있습니다.
...
`Travel Agent`를 관리하려는 개발자는 [Developers > API > Travel Agent](/ko/api/overview/)로 이동하세요.
