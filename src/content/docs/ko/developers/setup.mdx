...
<Steps>
1. Wink에서 사용자 계정을 [등록](/ko/account/register)하세요.
2. [제휴사 계정 생성](/ko/portal/create-account). 애플리케이션을 연결하려면 필요합니다. 자세한 내용은 [Studio란 무엇인가](/ko/portal/studio/what-is-studio)를 참조하세요.
3. [애플리케이션 생성](/ko/portal/settings/applications) 후 2단계에서 생성한 제휴사 계정과 연결하세요. 서버 간 API 통합의 경우 클라이언트 유형으로 **MACHINE_2_MACHINE**을 선택하세요.
...
[APIs](/ko/api) 섹션으로 이동하여 작업할 API를 선택하세요.
