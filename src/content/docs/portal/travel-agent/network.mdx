...
When you first get started as an travel agent on Wink, you find some stuff you want to sell on the platform and share it on social media, your travel blog, app etc.
...
:::note
You can interact with your active and pending relationships by clicking on `Account > Network` from the main nav bar.
:::
...
Keep in mind, for most travel agents, it doesn't make any sense to connect directly with a supplier. Most suppliers already offer up their best deals and upsells to everyone on the platform.
...
When you've found a supplier you'd like to work with (see [Search](/portal/studio/search/) ) and you want to initiate a relationship request, here's what happens:
...
Developers who want to manage their network can head over to [Developers > API > Sales Channel](/api).
