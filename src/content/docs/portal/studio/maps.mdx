...
- Click on a map marker to see inventory details in the form of a [Card](/portal/studio/cards).
...
- **Single marker map**: Create a map from something you found while [searching](/portal/studio/search).
- **Multi marker map**: Create a map from a [curated list](/portal/studio/curated-lists) or [saved search](/portal/studio/saved-searches).
...
Above is an image taken from [Search](/portal/studio/search) and shows you some of the things you can do with your search results. One of those actions is `Make a map`.
Click on that button and it will redirect you to our map form page where you can start customizing your map.

### Multi marker map

Both [curated lists](/portal/studio/curated-lists#list-actions) and [saved searches](/portal/studio/saved-searches#list-actions) come with an action that lets you create a map. This map will contain map markers for all inventory within those lists.
...
- **Embed** Shows you how to embed this map as a [Map](/integrations/web-components/#content-loader) into your website.
- **Use with WordPress** Shows you how to use our [WordPress plugin](/integrations/wordpress) to embed this map into your website.
...
Developers who want to manage maps can head over to [Developers > API > Inventory](/api/overview/).
