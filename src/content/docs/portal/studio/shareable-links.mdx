...
Above is an image taken from [Search](/portal/studio/search) and shows you some of the things you can do with your search results. One of those actions is `Make a link`.
...
<Steps>
 ...
 2. Select the [Customization](/portal/settings/branding) you want to apply to this link.
