...
1. Choose the affiliate account you want to work with from your [list of accounts](https://app.wink.travel)
2. Navigate to the search page in one of two ways:
    ...
    2. From the main nav bar, click `Browse > Hotels` or `Browse > Inventory`
...
- **Make a link** [Create a link](/portal/studio/shareable-links) you can easily share in emails, on social media or messaging apps.
- **Make a map** [Create a map](/portal/studio/maps) you can use with WinkLinks, WordPress, embed it and more.
- **Make a card** [Create a card](/portal/studio/cards) you can use with WinkLinks, WordPress, embed it and more.
...
When you click on `Add to...`, a menu opens up that displays your existing [curated lists](/portal/studio/curated-lists) and a way to create a new list. You can:
...
If you are looking for, but cannot find, a certain supplier, you'll be shown a field to complete which lets you find what you are looking for on Google Places. If it exists on Google Places, you can generate a `lead` on Wink.
This tells us that someone wants us to contact this supplier and thell them to join Wink. We will reach out to the supplier and request that they join. You will be notified when they do.

## API

Developers who want to `Browse Inventory` can head over to [Developers > API > Browse](/api/overview/).

## Further reading

- Managing your [Curated Lists](/portal/studio/curated-lists).
- Turning search results into [Shareable Links](/portal/studio/shareable-links).
- Turning search results into [Cards](/portal/studio/cards).
- Turning search results into [Maps](/portal/studio/maps).
