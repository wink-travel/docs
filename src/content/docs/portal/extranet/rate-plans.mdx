...
- **Enabled** Toggle this rate plan on or off. When disabled, the rate plan will not be available for booking on any sales channel.
- **Prepaid** Set whether this rate plan requires pre-payment at the time of booking.
- **Loyalty points** Whether the guest accrues your loyalty points on this rate plan. *e.g. No*
- **Single occupancy rate modifier** Set a price modifier for a single occupant in a multi-occupancy room. *e.g. 5% OFF regular price*
- **Extra adult rate modifier** Set a price modifier for an extra adult in the room. *e.g. +10 / adult*
- **Extra child rate modifier** Set a price modifier for an extra child in the room. *e.g. +5 / child*

### Cancellation policy

- **Cancellation policy** Set the cancellation policy for this rate plan. *e.g. Refundable*
- **Exceptions** Set additional cancellation policies that come into effect for specific date ranges. *e.g. For the month of December, use the `Refundable with extra conditions` policy.*

### Meals

Select the meal plans that come with this rate plan. The following options are available:
...
- **Pricing type** Choose how this charge is calculated. Available types:
  - *Per stay* — Charged once per booking.
  - *Per day* — Charged once per night of stay.
  - *Per person / Per stay* — Charged per guest per booking.
  - *Per person / Per day* — Charged per guest per night.
...
- Occupancy
- Age
- Sell / Stay / Available days / Arrival / Departure / Required dates
...
By enabling this restriction, you are ONLY allowing this rate to be searched for on the specified days of the week.
...
Developers who want to manage `Rate Plans` can head over to [Developers > APIs > Monetize](/api/overview/).
