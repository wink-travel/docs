...
To manage content on WinkLinks, select the affiliate account you want to work with in [Portal](/portal/overview), then navigate to `WinkLinks` in the main nav bar.
...
<Steps>
1. Enter the link you want to share. *e.g. https://trvl.as/3xWCH*
