...
<Steps>
1. **Anda membuat konten** dalam bahasa utama Anda — baik secara manual atau menggunakan [pendaftaran berbantuan AI](/id/guides/hoteliers/ai-assisted-registration).
...
3. **Konten terjemahan disimpan** bersama dengan konten asli Anda. Setiap terjemahan terhubung ke sumber aslinya, sehingga pembaruan pada konten sumber dapat memicu penerjemahan ulang.
...
Terjemahan mencakup semua teks yang berhadapan dengan pengguna di seluruh inventaris Anda:
...
- **Tulis konten sumber yang jelas.** Terjemahan mesin bekerja terbaik dengan kalimat yang jelas dan sederhana. Hindari idiom dan bahasa sehari-hari yang mungkin sulit diterjemahkan.
...
- [Pendaftaran Berbantuan AI](/id/guides/hoteliers/ai-assisted-registration) — Daftarkan properti dengan AI dan terjemahan otomatis.
