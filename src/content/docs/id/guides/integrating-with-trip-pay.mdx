...
description: Artikel ini berisi contoh lengkap tentang cara mengintegrasikan dan membiarkan TripPay menangani pembayaran untuk Anda.
sidebar:
  order: 4
---
...
- [Payment Web Component](/id/integrations/web-components/#payment).
...
Saat TripPay merespons dengan payable contract, Anda akan melihat bahwa mereka menyisipkan penerima manfaat mereka sendiri sebesar 4,0%.
:::

### Respon

Saat TripPay merespons permintaan Anda, tampilannya akan seperti ini:
...
:::note
Pastikan Anda sudah memuat gaya dan Javascript kami sebelumnya.
:::
