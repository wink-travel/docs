...
Ini hanya untuk pengembang web. Jika Anda secara tidak sengaja menghapus [Aplikasi](/id/my-account/applications) ; sehingga client ID tidak lagi tersedia, silakan buat aplikasi baru dan gunakan client ID baru untuk menyematkan Komponen Web kami.
