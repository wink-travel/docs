...
| **Manajer saluran** | `channel-manager.update.rate`, `channel-manager.update.availability` |
...
- [Webhooks](/id/portal/settings/webhooks) — Referensi lengkap untuk pengelolaan webhook.
- [Applications](/id/portal/settings/applications) — Kelola kredensial API Anda.
