...
Langsung saja ke bagian [API](/id/api/overview/) kami dan pilih API yang ingin Anda gunakan.
...
13. Atur bidang `Scope` ke ruang lingkup yang dipisahkan spasi yang dibutuhkan integrasi Anda (misalnya `inventory.read inventory.write inventory.remove`). Lihat [referensi scope](/id/developers/authentication#scopes) untuk daftar lengkap.
