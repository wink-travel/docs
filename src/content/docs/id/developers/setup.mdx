...
<Steps>
  1. Gunakan [Pencarian API](https://developer.wink.travel/lookup) untuk mengambil tujuan atau hotel.
...
<Steps>
  ...
  2. Klik di sini `Download OpenAPI spec` dari atas [Pencarian API](https://developer.wink.travel/lookup) halaman.
  3. Impor ke Postman.
