...
<Steps>
1. [Daftar](/id/my-account/register) akun pengguna Anda di Wink.
2. [Buat akun afiliasi](/id/my-account/create-account). Anda memerlukan ini untuk mengikat Aplikasi Anda. Lihat [apa itu Studio](/id/studio/what-is-studio) untuk konteks lebih lanjut.
3. [Buat Aplikasi](/id/my-account/applications) dan kaitkan dengan akun afiliasi yang Anda buat di Langkah 2. Untuk integrasi API server-ke-server, pilih **MACHINE_2_MACHINE** sebagai tipe klien.
...
Langsung saja ke bagian [API](/id/developers/apis) kami dan pilih API yang ingin Anda gunakan.
