...
[Komponen Web](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) adalah standar yang memungkinkan Anda mengintegrasikan seluruh fitur Javascript ke dalam situs web Anda tanpa perlu mengetahui cara coding.
...
Inventaris mungkin sudah tidak tersedia lagi. Pergi ke [Studio](/id/portal/studio/cards) dan periksa apakah status "kartu" tersedia.
...
Inventaris mungkin telah dihapus. Pergi ke [Studio](/id/portal/studio/cards) dan periksa apakah status "kartu" tersedia.
Jika tidak, akan muncul berwarna merah. Jika demikian, Anda dapat menunggu dan mungkin pemasok membuatnya tersedia lagi atau menghapusnya dari daftar Anda.
