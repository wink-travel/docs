...
[Komponen Web](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) adalah standar yang memungkinkan Anda mengintegrasikan fitur Javascript secara utuh ke dalam situs web Anda tanpa perlu mengetahui cara pemrograman.
