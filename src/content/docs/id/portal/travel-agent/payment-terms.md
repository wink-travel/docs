...
description: Dokumen ini membahas ketersediaan dana dan bagaimana Wink mendukung model agen untuk agen perjalanan.
sidebar:
  order: 5
---
...
:::caution[Perhatian]
Ketentuan pembayaran di bawah ini berlaku untuk agen perjalanan yang ingin mengakuisisi dan menyalurkan dana secara mandiri.  
...
Ketentuan tersebut tersedia di bawah [Affiliate Portal > Payment Terms](/id/portal/studio/payment-terms).
:::

**KETENTUAN PEMBAYARAN WINK**  
**UNTUK AGEN PERJALANAN (Merchant of Record)**

Ketentuan Layanan Pembayaran ini (“Ketentuan Pembayaran”) adalah perjanjian hukum yang mengikat dan merupakan bagian dari hubungan kontraktual yang dibentuk berdasarkan "SYARAT & KETENTUAN AGEN PERJALANAN" (“Perjanjian Utama”)
...
Definisi dan istilah yang ditetapkan dalam Perjanjian Utama berlaku untuk Ketentuan Pembayaran ini kecuali didefinisikan lain di sini.

**1\. Definisi**

Seperti yang didefinisikan dalam perjanjian utama "SYARAT & KETENTUAN AGEN PERJALANAN" ("Perjanjian Utama"), istilah berikut memiliki arti yang sama dalam Ketentuan Pembayaran ini:
...
* Komisi Agen Perjalanan seperti yang ditentukan dalam Perjanjian Terpisah (kami menggunakan 10% untuk contoh ini)
...
Jika diperlukan konversi mata uang, akan diproses dengan kurs yang diberikan oleh layanan pemrosesan pembayaran. Agen Perjalanan bertanggung jawab atas biaya yang terkait dengan konversi mata uang.
...
Ketentuan Pembayaran ini merupakan bagian integral dan memperluas ketentuan pembayaran yang tercantum dalam Perjanjian Utama, "SYARAT & KETENTUAN AGEN PERJALANAN_220924," antara Wink dan Agen Perjalanan.
