...
Kebijakan pembatalan menentukan bagaimana dana pemesan ditangani jika tamu tidak dapat datang. Kebijakan pembatalan hadir dalam dua jenis yang berbeda:

1. Dapat dikembalikan
2. Tidak dapat dikembalikan

Sebagian besar waktu, kedua opsi ini sudah cukup. Namun, keduanya memberi Anda banyak ruang untuk menyesuaikan kebijakan pembatalan Anda lebih lanjut.

:::tip[Fun fact]
Wink mendukung total 8500 variasi kebijakan pembatalan.
:::

Untuk membuat kebijakan pembatalan, klik tombol `Create a new cancellation policy`.

## Tidak dapat dikembalikan

Untuk membuat kebijakan pembatalan yang tidak dapat dikembalikan, atur sakelar ke 🛑 mati saat ditanya apakah kebijakan dapat dikembalikan.
...
Untuk membuat kebijakan pembatalan yang dapat dikembalikan, atur sakelar ke ✅ hidup saat ditanya apakah kebijakan dapat dikembalikan.
