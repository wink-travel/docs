...
<Steps>
1. [Регистрирайте се](/bg/my-account/register) с вашия потребителски акаунт в Wink.
2. [Създайте афилиейт акаунт](/bg/my-account/create-account). Ще ви трябва, за да свържете вашето приложение. Вижте [какво е Studio](/bg/studio/what-is-studio) за повече контекст.
3. [Създайте приложение](/bg/my-account/applications) и го свържете с афилиейт акаунта, който създадохте в Стъпка 2. За интеграции API сървър-сървър изберете **MACHINE_2_MACHINE** като тип клиент.
...
Отидете в нашия раздел [APIs](/bg/developers/apis) и изберете API-то, с което искате да работите.
