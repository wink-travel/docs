...
<Steps>
  1. Използвайте [API за търсене](https://developer.wink.travel/lookup) за извличане на дестинации или хотели.
...
<Steps>
  ...
  2. Кликнете върху `Download OpenAPI spec` от върха на [API за търсене](https://developer.wink.travel/lookup) страница.
