...
* Други услуги, свързани с плащания, във връзка с услугите на доставчика на настаняване.
...
2.7 **Ограничения на плащанията навън**. Платежният посредник може да ограничи сумата на плащане навън поради съображения за съответствие или оперативни причини. Ако сумата, която ви се дължи, надвишава този лимит, Платежният посредник може да извърши серия от плащания (възможно през няколко дни), за да ви предостави пълната сума.

2.8 **Валутна конверсия**. Платежният посредник ще превежда плащанията ви в избраната от вас валута чрез Платежния посредник. Наличните валути могат да бъдат ограничени поради регулаторни или оперативни причини, базирани на страната ви на пребиваване и/или договорната единица на Платежния посредник. Всякакви такива ограничения ще бъдат съобщени чрез Платежния посредник и ще бъдете подканени да изберете друга валута. Платежният посредник използва USD, EUR и GBP като стандартни валути за получаване и изплащане на средства. Транзакции с други валути ще носят разходи за валутна конверсия.
...
2.13 **Известия**. Платежният посредник ще изпрати уведомление за всякакъв неизплатен баланс към доставчика на настаняване при поискване. Тези уведомления ще бъдат изпращани на контактните данни, които са в архива или са предоставени. Отговорността за актуалността на тези данни е на партньора.

2.14 **Трети страни интегратори**. Моля, имайте предвид, че определени партньори, наричани „Трети страни интегратори“, ще отговарят за обработката на платежни транзакции. В резултат на това тези Трети страни интегратори ще поемат ролята на търговец по сметката. Следователно условията за плащане на Wink няма да се прилагат за тези транзакции. Вместо това хотелът трябва да приеме нови условия за плащане, специфични за Третите страни интегратори.
...
Доставчикът на настаняване заявява, гарантира и поема ангажимент, че спазва във всички отношения всички международни търговски норми, приложимите ограничения върху търговията, потока на средства, финансирането на тероризма и законодателството за предотвратяване на подкупи и корупция, включително, но не само, американския Закон за борба с корупцията, британския Закон за подкупите от 2010 г. и закона на Сингапур за предотвратяване на корупцията.

Доставчикът гарантира, че по негово най-добро знание нито той, нито свързаните с него страни не са били осъдени за престъпление, свързано с подкуп или корупция, и не са обект на разследване от държавни, административни или регулаторни органи.
...
7.2 Независимо от назначаването на Платежния посредник като ограничен агент за събиране на плащания съгласно раздел 6, Платежният посредник изрично отказва всякаква отговорност за действия или пропуски на доставчик на настаняване или трети страни. Платежният посредник няма задължения като агент на доставчика, освен в степента, изрично посочена в тези Условия за плащане, а всякакви допълнителни задължения, които могат да се подразбират по закон, са изключени в максимална степен, разрешена от приложимия закон.

7.3 Ако решим да извършим проверка на самоличността на доставчик на настаняване, в максимална степен, разрешена от закона, отказваме гаранции, че такива проверки ще идентифицират предишни нарушения или ще гарантират, че доставчикът няма да извърши нарушения в бъдеще.
...
8.1 В максимална степен, разрешена от закона, никоя от страните не носи отговорност за косвени, случайни, последващи, специални или наказателни щети, произтичащи от този договор или нарушение на него, дори ако е била уведомена за възможността от такива щети. Това ограничение не се прилага за нарушения, свързани с поверителност и/или права върху интелектуална собственост.

8.2 Никоя от страните не може да изключи отговорност по отношение на (i) смърт или телесна повреда, причинени от небрежност на нея или на нейните служители, агенти или подизпълнители, (ii) измама, извършена от нея или нейните служители, или (iii) всяко нарушение, действие, пропуск или отговорност, която не може да бъде ограничена по приложим закон.
...
В максимална степен, разрешена от приложимия закон, вие се съгласявате да освободите, защитите (по избор на Платежния посредник), обезщетите и държите Платежния посредник и всички негови свързани лица и дъщерни дружества, както и техните служители, директори, служители и агенти, безвредни от всякакви претенции, отговорности, щети, загуби и разходи, включително разумни правни и счетоводни такси, произтичащи от или свързани с (i) нарушението на тези Условия за плащане; (ii) неправилното използване на Платежните услуги; (iii) вашето или нашето по ваше указание неизпълнение на правилно отчитане, събиране или превеждане на данъци; или (iv) нарушението на закони, разпоредби или права на трети страни.
...
10.3 **Прекратяване**. Можете да прекратите този договор по всяко време, като ни изпратите имейл или изтриете акаунта си в Wink. Прекратяването на договора ще служи и като уведомление за анулиране на акаунта ви в Wink съгласно Общите условия. Без да ограничаваме правата си по-долу, Платежният посредник може да прекрати договора по свое усмотрение с 30-дневно предизвестие по имейл до регистрирания ви адрес. Платежният посредник може да прекрати договора незабавно без предизвестие, ако (i) сте нарушили съществено задълженията си по договора; (ii) сте предоставили неточна, измамна, остаряла или непълна информация; (iii) сте нарушили приложими закони, разпоредби или права на трети страни; или (iv) Платежният посредник смята, че е необходимо за защита на други доставчици, Wink, Платежния посредник или трети страни.

10.4 **Спиране и други мерки**. Платежният посредник може да ограничи или временно/постоянно да спре използването или достъпа ви до Платежните услуги (i) за да спазва приложим закон или заповед на съд, правоохранителен орган или друг административен орган; (ii) ако сте нарушили тези Условия, Общите условия, приложими закони, разпоредби или права на трети страни; (iii) ако сте предоставили неточна, измамна, остаряла или непълна информация за необходимите данни за плащане; (iv) за суми, които дължите и са просрочени или неизпълнени; или (v) ако Платежният посредник смята, че е необходимо за защита на личната безопасност или имуществото на Wink, доставчиците, Платежния посредник или трети страни, или за предотвратяване на измами или други незаконни дейности.
...
10.6 **Ефект от прекратяване**. Ако анулирате акаунта си в Wink като доставчик или Платежният посредник предприеме мерки по-горе, Платежният посредник може да възстанови пълната сума на гостите с потвърдени резервации, а вие няма да имате право на компенсация за чакащи или анулирани резервации.
...
11.2 Ако сключвате договор с Платежния посредник в Обединеното кралство, тези Условия за плащане се тълкуват съгласно английското право. Ако действате като потребител и ако задължителните потребителски защити в страната ви на пребиваване са по-благоприятни за вас, те ще се прилагат независимо от избора на английско право. Като потребител можете да заведете дело по тези Условия пред компетентния съд по местоживеене или съд в Англия. Ако Платежният посредник иска да упражни права срещу вас като потребител, може да го направи само в съдилищата на юрисдикцията, в която пребивавате. Ако действате като бизнес, се съгласявате да се подчините на изключителната юрисдикция на английските съдилища.

11.3 Ако сключвате договор с Платежния посредник в Словакия, тези Условия за плащане се тълкуват съгласно законите на ЕС. Ако действате като потребител, съдебни дела, които можете да заведете срещу нас във връзка с тези Условия, могат да се водят само в съд в град Братислава или съд с юрисдикция в мястото ви на пребиваване. Ако действате като бизнес, се съгласявате да се подчините на изключителната юрисдикция на съд в град Братислава, Словакия.
