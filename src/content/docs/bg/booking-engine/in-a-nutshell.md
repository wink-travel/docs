...
* Предлагане на резервируеми инвентарни продукти в желания формат, език и валута, като например:
  ...
  * А [карта](/studio/maps) на твоя [карта](/studio/maps) сметка.
...
Интеграторите, които искат още повече свобода, имат достъп до всички същите функции чрез нашия [Плъгин за WordPress](/developers/wordpress/), [Плъгин за WordPress](/developers/wordpress/) и[API](/developers/apis).
