...
Тази конфигурация работи за всеки персонализиран GTM Container ID. Използвахме Sojern като пример, тъй като това е много често срещана интеграция.
</Aside>
...
|----------|-----|----------|
| `property_id` | string | Идентификатор на имот в Wink |
...
| `rate_plan_id` | string | Идентификатор на тарифен план |
| `room_rate_id` | string | Идентификатор на конкретна стая/тарифна ставка |
...
GA4 игнорира персонализираните параметри с обхват артикул в отчетите, докато не ги регистрирате изрично като такива. Трябва да регистрирате само параметрите, които възнамерявате да използвате в отчетите — не е нужно да регистрирате всички 18.
...
GA4 позволява до 50 персонализирани дименсии с обхват артикул на стандартен имот (имотите 360 позволяват повече).
</Aside>
