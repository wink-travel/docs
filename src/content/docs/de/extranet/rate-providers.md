...
Um Ihren Tarifanbieter festzulegen, klicken Sie in der Hauptnavigationsleiste auf `Distribution > Channel manager`.

Wählen Sie Ihren Tarifanbieter aus der Dropdown-Liste aus und klicken Sie auf die Schaltfläche `Speichern`. Dadurch kann der Tarifanbieter uns Tarife senden und wir benachrichtigen ihn, wenn eine Buchung auf Wink für eine Ihrer Unterkünfte erfolgt ist.
