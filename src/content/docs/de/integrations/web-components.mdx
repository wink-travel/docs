...
Eine Änderung der Reiseroute in einer unserer Itinerary-Komponenten löst das Ereignis zur Aktualisierung der Reiseroute für jedes Inventar aus, das Sie derzeit auf der Seite anzeigen.
...
Die Zahlungs-Komponente ermöglicht es Ihnen, TripPay mitzuteilen, dass ein Reisender etwas kaufen möchte, sowie die Regeln und Preise für diese Artikel.
