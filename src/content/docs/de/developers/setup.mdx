---
title: Einrichtung
description: Dieser Artikel zeigt Ihnen, wie Sie sich schnell als Entwickler einrichten und mit dem Testen unserer APIs auf Wink beginnen.
sidebar:
  order: 1
---
...
:::note
Tests sollten immer in unserer [Staging-Umgebung](/getting-started/environments) durchgeführt werden. Dort gibt es deutlich weniger Daten, aber Sie können so viel testen, wie Sie möchten, ohne die Produktionsumgebung zu belasten.
...
<Steps>
1. [Registrieren](/user/register) Sie Ihr Benutzerkonto auf Wink
2. Erstellen Sie ein [Reisebürokonto](/travel-agent/what-is-agent) oder ein [Affiliate-Konto](/studio/what-is-studio).
3. [Erstellen Sie eine Anwendung](/developer/applications), die Sie mit dem in Schritt 2 erstellten Konto verknüpfen.
...
Gehen Sie zu unserem [APIs](/developer/apis) Bereich und wählen Sie die API aus, mit der Sie arbeiten möchten.
