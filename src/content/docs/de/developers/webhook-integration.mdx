...
- **Schnell antworten** — Geben Sie ein `200 OK` zurück, sobald Sie die Nutzlast erhalten. Führen Sie aufwändige Verarbeitung asynchron durch.
...
- [Applications](/de/portal/settings/applications) — Verwalten Sie Ihre API-Zugangsdaten.
