...
Scopes sind benannt als `section.action`, wobei die Aktion eine der folgenden ist:
...
| **Booking** | `booking.read` `booking.write` `booking.remove` | Suchen, Anzeigen, Erstellen, Stornieren und Erstatten von Buchungen; Checkout; Stornierungsbedingungen | Niedrig–Mittel |
...
Holen Sie sich eine 'Client ID' und einen 'Secret Key' von einer Ihrer Apps und navigieren Sie zu einer unserer [APIs](/de/api/overview/).
:::
