...
- Durchführung leichter semantischer / Stichwortsuchen über Dokumentationen und Live-APIs
...
Tipps:
- Verwenden Sie die Befehlspalette: „MCP: List Servers“, um die Verbindung zu bestätigen und Tools zu durchsuchen.
...
| `wink://api/{apiName}/operations` | Vollständige Auflistung der Operationen, gruppiert nach Tags |
...
| `wink://api/{apiName}/operation/{key}/request` | Anfragetypische Ansicht mit erforderlichen Eingaben und minimalem Beispielpayload |
| `wink://api/{apiName}/operation/{key}/response/{status}` | Antworttypische Ansicht für einen bestimmten Statuscode |
| `wink://api/{apiName}/operation/{key}/recipe` | Aufgabenorientierter Ablauf zur korrekten Ausführung dieser Operation |
...
| `docs_search` | Finden von konzeptuellen Dokumentationen / Anleitungen | `authentication`, `webhooks`, `wordPress` |
...
## Hinweise
- Jede zurückgegebene URI kann vom Agenten geöffnet werden, um den vollständigen Inhalt anzuzeigen.
