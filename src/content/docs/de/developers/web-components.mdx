...
Inventar könnte nicht mehr verfügbar sein. Gehen Sie zu [Wink Studio](/de/studio/cards) und prüfen Sie, ob der Status der "Karte" verfügbar ist.
...
Inventar könnte entfernt worden sein. Gehen Sie zu [Wink Studio](/de/studio/cards) und prüfen Sie, ob der Status der "Karte" verfügbar ist.
Wenn nicht, wird sie rot angezeigt. In diesem Fall können Sie warten, ob der Anbieter sie wieder verfügbar macht, oder sie aus Ihrer Liste entfernen.
...
Dies ist nur für Webentwickler relevant. Wenn Sie versehentlich die [Application](/de/my-account/applications) entfernt haben und die Client-ID nicht mehr verfügbar ist, erstellen Sie bitte eine neue Anwendung und verwenden Sie die neue Client-ID, um unsere Webkomponenten einzubetten.
