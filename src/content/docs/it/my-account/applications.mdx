...
- **MACHINE_2_MACHINE** — Per integrazioni server-to-server che si autenticano direttamente usando le credenziali client. Usalo quando il tuo servizio backend deve chiamare le API Wink senza la presenza di un utente.
...
3. **Tipo di client** Scegli `SPA` per app web o `MACHINE_2_MACHINE` per integrazioni server.
