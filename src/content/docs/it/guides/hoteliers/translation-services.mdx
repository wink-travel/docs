...
<Steps>
1. **Crei contenuti** nella tua lingua principale — manualmente o utilizzando la [registrazione assistita da AI](/it/guides/hoteliers/ai-assisted-registration).
...
4. **I viaggiatori vedono i contenuti nella loro lingua** in base alle impostazioni del browser, alla lingua selezionata o al rilevamento GeoIP.
</Steps>

## Cosa viene tradotto

La traduzione copre tutto il testo rivolto agli utenti nel tuo inventario:
...
Per il percorso più rapido verso contenuti multilingue:

1. **Registra la tua struttura** utilizzando la [registrazione assistita da AI](/it/guides/hoteliers/ai-assisted-registration) — l’AI genera contenuti nella tua lingua principale.
2. **La traduzione parte automaticamente** — Wink crea attività di traduzione per tutte le lingue abilitate.
3. **Revisiona le traduzioni chiave** — mentre la traduzione automatica gestisce la maggior parte, revisiona le traduzioni importanti (come il testo di benvenuto) per garantirne l’accuratezza.
...
- [Localizzazione](/it/getting-started/localization) — Supporto a livello di piattaforma per lingue e località.
- [Registrazione assistita da AI](/it/guides/hoteliers/ai-assisted-registration) — Registra una struttura con AI e traduzione automatica.
