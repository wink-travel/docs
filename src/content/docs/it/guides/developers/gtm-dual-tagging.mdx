...
2. **Inseriscilo nel portale Wink**
   ...
   Accedi a [app.wink.travel](https://app.wink.travel), seleziona il tuo account e vai alla scheda **Personalizzazioni**. Incolla il tuo Sojern GTM Container ID nel campo Sojern e salva. La tua integrazione è ora attiva.
...
- **Il tracciamento di Wink e il pixel Sojern funzionano in parallelo**, leggendo dallo stesso set condiviso di dati evento. Ogni evento di prenotazione tracciato da Wink è simultaneamente disponibile per il tuo contenitore Sojern.
...
<Aside type="note">
Le dimensioni personalizzate possono impiegare fino a 24 ore per comparire nei report GA4 dopo la registrazione. I dati storici raccolti prima della registrazione non vengono retroattivamente inseriti.
