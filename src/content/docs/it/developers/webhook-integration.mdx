...
- **Rispondi rapidamente** — Restituisci un `200 OK` non appena ricevi il payload. Eventuali elaborazioni pesanti eseguirle in modo asincrono.
...
Cancellare un webhook lo rimuove definitivamente. Qualsiasi integrazione che dipende da quel webhook smetterà di ricevere notifiche.
...
- [Applications](/it/portal/settings/applications) — Gestisci le tue credenziali API.
