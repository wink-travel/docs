...
Cliccando sul pulsante, quando l'utente non è autenticato, verrà reindirizzato per autenticarsi.
...
Questo è solo per sviluppatori web. Se hai accidentalmente rimosso l'[Applicazione](/it/developer/applications) ; rendendo il client ID non più disponibile, crea una nuova applicazione e usa il nuovo client ID per incorporare i nostri Componenti Web.
