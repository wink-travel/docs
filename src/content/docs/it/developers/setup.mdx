...
<Steps>
  1. Utilizzare il [API di ricerca](https://developer.wink.travel/lookup) per recuperare destinazioni o hotel.
...
<Steps>
  ...
  2. Fare clic su `Download OpenAPI spec` dalla cima del [API di ricerca](https://developer.wink.travel/lookup) pagina.
