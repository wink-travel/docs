...
3. [Crea un’Applicazione](/it/portal/settings/applications) e associa l’account affiliato creato al Passo 2. Per integrazioni API server-to-server, scegli **MACHINE_2_MACHINE** come tipo di client.
