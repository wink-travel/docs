...
[Webové komponenty](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) jsou standard, který vám umožňuje integrovat celé JavaScriptové funkce do vašeho webu, aniž byste museli umět programovat.
...
Platební komponenta umožňuje informovat TripPay, že cestovatel chce něco zakoupit, a předat pravidla a ceny těchto položek.
...
Toto je určeno pouze pro webové vývojáře. Pokud jste omylem odstranili [Aplikaci](/cs/portal/settings/applications), čímž se klientské ID stalo nedostupným, vytvořte prosím novou aplikaci a použijte nové klientské ID pro vložení našich webových komponent.
