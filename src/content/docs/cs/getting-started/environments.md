...
:::note
Staging prostředí je dostupné na vyžádání. To znamená, že přejde do režimu spánku, pokud není používáno, a znovu se zapne, když je potřeba. Buďte prosím trpěliví, pokud ho probouzíte. Spuštění všech serverů po prvním připojení k jednomu z našich serverů nebo aplikací trvá asi minutu.
:::
