...
Cestovní agenti získávají přístup k cestovnímu inventáři po celém světě za skvělé ceny prostřednictvím našeho dedikovaného [portálu pro cestovní agenty](https://agent.wink.travel). Mohou provádět rezervace přes náš portál, přes naše API nebo nechat své uživatele rezervovat sami na webu cestovního agenta, který používá naše technologie.
