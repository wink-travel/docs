...
<Steps>
1. [Zaregistrujte se](/cs/account/register) jako uživatel na Wink.
2. [Vytvořte partnerský účet](/cs/portal/create-account). Budete ho potřebovat k navázání vaší aplikace. Více informací najdete v [co je Studio](/cs/portal/studio/what-is-studio).
3. [Vytvořte aplikaci](/cs/portal/settings/applications) a přiřaďte ji k partnerskému účtu, který jste vytvořili v kroku 2. Pro server-to-server API integrace vyberte jako typ klienta **MACHINE_2_MACHINE**.
...
Přejděte do naší sekce [API](/cs/api) a vyberte API, se kterým chcete pracovat.
