...
<Steps>
  1. Použijte [Vyhledávací API](https://developer.wink.travel/lookup) pro vyhledání destinací nebo hotelů.
...
<Steps>
  ...
  2. Klikněte na `Download OpenAPI spec` z vrcholu [Vyhledávací API](https://developer.wink.travel/lookup) strana.
