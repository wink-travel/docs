...
Jakmile budete připraveni spustit produkci, ověříme váš účet a vaši aplikaci a můžete spustit v našem produkčním prostředí.
:::

Postupujte podle těchto kroků:

<Steps>
1. [Zaregistrujte](/cs/account/register) si uživatelský účet na Wink.
...
3. [Vytvořte aplikaci](/cs/portal/settings/applications) a přiřaďte ji k affiliate účtu, který jste vytvořili v kroku 2. Pro server-to-server API integrace vyberte jako typ klienta **MACHINE_2_MACHINE**.
