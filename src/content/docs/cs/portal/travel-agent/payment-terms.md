...
description: Tento dokument pokrývá dostupnost finančních prostředků a jak Wink podporuje model agentury pro cestovní kanceláře.
sidebar:
  order: 5
---
...
:::caution[Upozornění]
Níže uvedené platební podmínky platí pro cestovní kanceláře, které chtějí samy získávat a rozdělovat finanční prostředky.  
...
Všechny cestovní kanceláře stále mohou rezervovat přes náš portál pro cestovní kanceláře pomocí platební brány Wink s vlastní nebo cestovatelovou kreditní kartou. Proto všechny cestovní kanceláře musí také souhlasit s platebními podmínkami, kde je platební brána Wink obchodníkem záznamu.

Tyto podmínky jsou k dispozici v [Affiliate Portal > Payment Terms](/cs/portal/studio/payment-terms).
:::
...
2. **CESTOVNÍ KANCELÁŘÍ**, jejíž údaje jsou uvedeny v registračním formuláři cestovní kanceláře nebo byly odeslány online („Cestovní kancelář“).
...
2.2 **Odečtení poplatků:** Cestovní kancelář nejprve odečte poplatek poskytovatele služby a poté odečte svou provizi podle příkladu níže:

* 1,5 % rezervační poplatek pro Wink.  
* Provize cestovní kanceláře dle Samostatné smlouvy (v tomto příkladu použijeme 10 %)

Hodnota rezervace USD 1 000  
Poplatek Wink (1,5 %) = USD 15  
Mezisoučet = 1 000 - 15 = 985

2.3 **Čistá platba poskytovatelům ubytování:** Cestovní kancelář je odpovědná za vyplacení Čisté platby poskytovateli ubytování podle podmínek Samostatné smlouvy mezi cestovní kanceláří a poskytovatelem ubytování. Wink není odpovědný za provádění jakýchkoli plateb poskytovateli ubytování.
