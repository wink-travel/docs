...
Pro správu nastavení WinkLinks přejděte v hlavním navigačním panelu na `WinkLinks` a klikněte na záložku `Design`.
...
- **Počáteční zobrazení** Ovládejte, jak vaše publikum poprvé interaguje s vaší stránkou a vidí váš obsah. Máte k dispozici tři možnosti:
    ...
    - `Seznamový` design. Většina ostatních správců odkazů zobrazuje jednoduchý seznam s URL a minimálním obsahem. Zvolte tento způsob zobrazení, pokud máte hodně obsahu a chcete ho zobrazit co nejrychleji.
...
- Přečtěte si více o [Přizpůsobení](/cs/portal/settings/branding).
