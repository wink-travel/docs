...
Webhooky jsou způsob, jak od vás Wink může přijímat a reagovat na události v reálném čase pro váš účet.

<Steps>
 1. Vyberte účet, se kterým chcete pracovat, z [Účty](https://app.wink.travel).
...
1. Odešle se událost Wink `booking.created`.
2. Váš systém aktivně poslouchá tuto událost.
...
3. ***Povolit*** Nechte zapnuté, aby byl aktivní.
...
- Změnit URL webhooku, na které posloucháte.
