...
Pro nastavení poskytovatele sazeb klikněte v hlavním navigačním panelu na `Distribution > Channel manager`.

Vyberte svého poskytovatele sazeb ze seznamu a klikněte na tlačítko `Save`. Tím umožníte poskytovateli sazeb zasílat nám sazby a my je budeme informovat, když dojde k rezervaci na Wink pro jednu z vašich nemovitostí.
...
Níže je seznam dodavatelů, které podporujeme:
...
*Pokud má dodavatel proxy, znamená to, že sazby od dodavatele přijímáme nepřímo přes proxy.*

| Dodavatel | Typ | Proxy | Od | Poslední úprava | Komentář
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Nyní d-edge |
