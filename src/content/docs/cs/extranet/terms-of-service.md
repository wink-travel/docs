...
description: Snadno dostupné a aktuální podmínky pro všechny naše uživatele přidružených subjektů.
sidebar:
  order: 32
---
...
Registrací a přihlášením do programu Wink jako poskytovatel ubytování poskytovatel ubytování tímto potvrzuje, že si přečetl, rozumí, uznává a přijímá podmínky této smlouvy o poskytovateli ubytování (dále jen „Smlouva“).
...
1. Poskytování služeb distribuce ubytování prostřednictvím Wink nebo jakýmkoli jiným způsobem, který Poskytovatel ubytování používá k distribuci svých produktů (dále jen „Poskytovatel ubytování“), jejichž podrobnosti jsou uvedeny v Platebních podmínkách a cena, podmínky a dostupnost byly dohodnuty; a  
2. Poskytování ubytovacích služeb Poskytovatelem ubytování konečnému spotřebiteli/hostu, které bylo rezervováno prostřednictvím Wink.
...
**„Nejlepší dostupná cena“ nebo „BAR“** znamená nejnižší před-slevovou, provizní cenu za pokoje včetně DPH, kterou nabízí široké veřejnosti Participující hotel, Poskytovatel ubytování nebo jím pověřený třetí distributor. Pro vyloučení pochybností jsou do Nejlepší dostupné ceny zahrnuty i propagační ceny, sváteční ceny a jakékoli jiné veřejně dostupné neomezené ceny.
...
**„Platební podmínky“** znamenají sazby, dostupnost, nabídky, propagace, platební podmínky a jakákoli další pravidla nebo podmínky týkající se distribuce pokojů, na kterých se Strany dohodly.
...
**„Sazba(y)“** znamená sazbu za hotelový pokoj(y) zpřístupněnou Wink Poskytovatelem ubytování pro jakýkoli příslušný typ pokoje nebo typ sazby podle Smlouvy k distribuci na všech kanálech Wink.

**„Pokoj(e)“** znamená ubytování umístěné v jakémkoli Participujícím hotelu nebo ubytovacím zařízení.

**„Daně“** znamenají všechny místní, státní, federální a národní daně a/nebo poplatky za služby, včetně, pro vyloučení pochybností, jakékoli daně z přidané hodnoty (DPH), prodejní, užívací, spotřební, ubytovací, přechodné, nájemní, městské, rekreační a jiné podobné daně, vládní poplatky nebo poplatky.
...
1.1.1 Tato Smlouva není zamýšlena, ani by nic zde uvedené nebo v jakýchkoli dohodách s ní souvisejících nemělo být vykládáno tak, aby vytvářelo společný podnik nebo vztah partnerů, partnerství či vztah hlavního a zástupce mezi Stranami. Pokud se Strany písemně nedohodnou jinak, žádná z nich nesmí (i) uzavírat smlouvy nebo závazky s třetími stranami jako zástupce druhé Strany, (ii) označovat se nebo prezentovat jako takový zástupce nebo se jím jakkoli vydávat, ani (iii) jednat nebo zastupovat druhou Stranu jakýmkoli způsobem nebo za jakýmkoli účelem.

1.1.2 Pokud Wink písemně nesouhlasí jinak nebo není v této Smlouvě uvedeno jinak, Poskytovatel ubytování nesmí nikde na svých webových stránkách uvádět žádné prohlášení, výslovné či implicitní, že webová stránka je součástí, je schválena nebo je oficiální webovou stránkou Wink.

**2. Uzavírání smluv s hosty**

Když obdržíte potvrzení rezervace prostřednictvím platformy Wink, vstupujete do smlouvy přímo s hostem a jste odpovědní za poskytování svých služeb za podmínek a za cenu uvedenou v potvrzení rezervace. Také souhlasíte s placením souvisejících poplatků, pokud a kdy jsou relevantní, jak je definováno v Platebních podmínkách.
...
Jako Poskytovatel ubytování vám Wink nabízí nástroje potřebné k prodeji vašeho inventáře online prostřednictvím našich proprietárních prodejních kanálů.

Poskytovatelé ubytování jsou odpovědní za to, aby informace a obsah jejich profilu byly vždy aktuální a přesné. Poskytovatelé ubytování musí respektovat dostupnost, ceny a jakékoli další závazky dohodnuté v této smlouvě. Jsou výhradně odpovědní za aktualizaci a udržování aktuálních údajů o dostupnosti, sazbách a případných místních daních prostřednictvím Wink extranet. Poskytovatelé ubytování tímto umožňují Wink propagovat pokoje na všech trzích. Wink důrazně doporučuje poskytovatelům ubytování nabízet vždy nejkonkurenceschopnější sazby, propagace a nabídky.
...
Wink poskytuje Poskytovatelům ubytování digitální nástroje potřebné k distribuci a prodeji jejich inventáře online prostřednictvím 5 proprietárních kanálů. Aktivací vaší nemovitosti pomocí funkce samoaktivace na vašem dashboardu se vaše nemovitost automaticky zpřístupní k rezervaci na Traveliko.com a prostřednictvím sítě. Tyto kanály můžete ručně deaktivovat v extranet v sekci \- Distribuce \- Prodejní kanály.

* Traveliko.com – 0% provize OTA  
...
* Wink Network – affiliate síť propojující hotely přímo s našimi partnerskými subjekty

Rezervační poplatky, provize a platební poplatky se vztahují následovně na jakoukoli potvrzenou rezervaci:
...
**Vezměte prosím na vědomí, že někteří partneři, dále označovaní jako „třetí integrátoři“, budou odpovědní za zpracování platebních transakcí. Tito třetí integrátoři tak převezmou roli obchodníka zapsaného v evidenci. V důsledku toho se na tyto transakce již nebudou vztahovat platební podmínky Wink. Místo toho musí hotel přijmout nové platební podmínky specifické pro třetí integrátory.**
...
7.3 Poskytovatel ubytování bude odpovědný a souhlasí s tím, že Wink odškodní za jakékoli ztráty, náklady, pokuty a/nebo škody vzniklé v důsledku neúplného nebo neaktuálního zahrnutí daní do svých sazeb a/nebo v důsledku neinformování nebo nesprávného informování Wink o příslušných daních.

7.4 Wink při nabízení pokojů svým partnerům zahrne všechny příslušné daně (s výhradou pododdílu (a) tohoto oddílu). Veškeré částky splatné podle této Smlouvy, pokud není uvedeno jinak, zahrnují DPH nebo jiné příslušné daně či poplatky (kromě daně z příjmu právnických osob nebo jiných daní zisku). Pokud jakákoli částka DPH bude vyměřena a uvalena příslušným úřadem odpovědným za DPH v zemi, kde jsou služby poskytovány, Wink po obdržení platného daňového dokladu od Poskytovatele ubytování zaplatí Poskytovateli ubytování částku DPH zahrnutou v částkách zahrnujících DPH splatných podle této Smlouvy.

7.5 Jakýkoli nárok příslušného úřadu na pokuty nebo úroky vzniklé z opožděné platby nebo jakékoli fakturované DPH bude na účet Poskytovatele ubytování. Dále, pokud jakákoli částka DPH bude vyměřena a uvalena příslušným úřadem odpovědným za DPH v zemi, kde jsou služby přijímány v rámci mechanismu samovyměření, Wink tuto DPH zohlední ve svém daňovém přiznání k DPH v souladu s legislativou dané země. Jakýkoli nárok příslušného úřadu na pokuty nebo úroky vzniklé z opožděné platby samovyměřené DPH bude na účet Wink.
...
Pouze osoba podepisující tuto smlouvu bude jediným určeným zástupcem Poskytovatele ubytování, který bude mít pravomoc požadovat změny bankovních údajů a/nebo údajů o příjemci platby Poskytovatele ubytování. Žádná jiná osoba nebude mít takovou pravomoc jménem Poskytovatele ubytování. Jakákoli změna takové určené osoby musí být písemně oznámena Wink a bude provedena pouze písemnou dodatkem k této Smlouvě podepsaným oběma Stranami.
...
9.2 Pokud dojde k chybě Poskytovatele ubytování, která způsobí nesprávné nahrání sazby, a rezervace je následně provedena za nesprávnou sazbu, musí Poskytovatel ubytování tuto rezervaci dodržet za nesprávnou sazbu.
...
10.2 Každý Participující poskytovatel ubytování musí vynaložit přiměřené úsilí, aby při check-inu ověřil, že předložená identifikace hosta odpovídá údajům o rezervaci. Pokud je rezervace potenciálně podvodná nebo některá data poskytnutá hostem nemohou být Winkem ověřena, Poskytovatel ubytování a Wink spolupracují na řešení této situace, včetně možnosti zrušení rezervace kdykoli. Poskytovatel ubytování souhlasí s plnou spoluprací s Winkem a poskytne mu veškeré požadované informace v souvislosti s potenciálně podvodnou rezervací.

10.3 Strany souhlasí, že pokud Poskytovatel ubytování nesplní tuto povinnost a rezervace se následně ukáže jako potenciálně podvodná, Wink nenese odpovědnost.
...
* Přesunout hosta do alternativní nemovitosti stejné nebo vyšší kategorie/standardu ve stejné oblasti za stejných podmínek jako původní rezervace, přičemž tento přesun bude hrazen Poskytovatelem ubytování bez dalších nákladů pro postiženého hosta, včetně, mimo jiné:  
* Veškerých nákladů na dopravu a dalších nákladů spojených s přesunem hosta.  
* Umožnit Wink odečíst veškeré přímé náklady vzniklé z nedostupnosti a/nebo přesunu z pohledávek Poskytovatele ubytování, pokud Wink utrpí finanční sankce, náhrady nebo náklady spojené s takovou nedostupností a/nebo přesunem.

11.2 V případě nesplnění podmínek této Smlouvy Poskytovatelem ubytování, včetně nepřijatelných podmínek prostor a/nebo nedostatků zařízení a služeb, má Wink právo zastavit platby a požadovat řádné splnění dohodnutých podmínek rezervace. Poskytovatel ubytování nese plné náklady na jakékoli odškodnění postiženému hostu a udrží Wink bez odpovědnosti za škody vzniklé vadným plněním svých povinností.

**12. Podmínky nemovitosti Participujícího hotelu**

Poskytovatel ubytování co nejdříve oznámí prostřednictvím sekce „Oznámení“ ve Wink Extranetu jakékoli stavební práce, renovace, rekonstrukce, aktualizace nebo jiné práce, které mohou ovlivnit schopnost poskytovat pokoje, zařízení a služby a/nebo mohou negativně ovlivnit pobyt hosta. Pro vyloučení pochybností platí, že v případě nedostupnosti nebo nesplnění z těchto důvodů se uplatní ustanovení článku 11 („Nedostupnost / Nesplnění“) a Poskytovatel ubytování nese plné náklady na odškodnění postiženého hosta, přičemž Wink je zproštěn odpovědnosti.

**13. Změny, doba trvání a ukončení**

13.1 Změny. S výjimkou případů vyžadovaných platným právem může Wink kdykoli změnit tyto Podmínky. Pokud provedeme zásadní změny, zveřejníme upravené Podmínky na platformě Wink a aktualizujeme datum „Naposledy aktualizováno“ v horní části těchto Podmínek. Pokud se vás změny týkají, oznámíme vám je nejméně třicet (30) dní před jejich účinností. Pokud smlouvu před účinností změn neukončíte, vaše další používání služeb bude považováno za souhlas s upravenými Podmínkami.

13.2 Doba trvání. Pokud není dohodnuto jinak, tato Smlouva začíná platit dnem podpisu na dobu neurčitou.

13.3 Tato Smlouva trvá do jejího ukončení Stranami následovně:

* Wink může kdykoli a bez udání důvodu ukončit smlouvu s třicetidenní písemnou výpovědí druhé Straně;  
* Poskytovatel ubytování může kdykoli bez udání důvodu smlouvu ukončit deaktivací nemovitosti v extranet Wink;  
* Jiným způsobem výslovně uvedeným v této Smlouvě.

13.4 Wink si vyhrazuje právo okamžitě písemně ukončit tuto Smlouvu, pokud:

* Poskytovatel ubytování zahájí insolvenční řízení, bankrot, správu, likvidaci, soudní správu nebo jiné obdobné řízení, které nebude do 60 dnů zrušeno nebo vyřešeno ve prospěch Poskytovatele ubytování;  
* Věřitel provede nebo se pokusí provést zástavní právo na Participující hotel;  
...
* Uhradí příslušné závazky.

**14. Prohlášení a záruky**

Poskytovatel ubytování zaručuje a prohlašuje, že bude plně dodržovat následující:

14.1 Poskytování všech pokojů a zařízení a služeb bude vždy v souladu s dobrými průmyslovými standardy a bude poskytováno s veškerou péčí, pozorností a odborností;
...
14.7 Poskytovatel ubytování není založen ani rezidentem země podléhající ekonomickým nebo obchodním sankcím;

14.8 Na vlastní náklady dokončí jakékoli práce nezbytné k odstranění nedostatků a/nebo vad oznámených příslušnými orgány bezodkladně. Poskytovatel ubytování o tom bez prodlení informuje Wink a zváží jakékoli rozumné doporučení Wink.

**15. Incidenty a stížnosti hostů**

15.1 Pokud se hostovi stane jakýkoli incident, Poskytovatel ubytování musí o tom Wink co nejdříve informovat a plně s ním spolupracovat při řešení takové situace.
...
15.3 Pokud Wink musí hostovi poskytnout odškodnění v důsledku incidentu, nároku nebo stížnosti způsobené jednáním nebo opomenutím Poskytovatele ubytování, Poskytovatel ubytování souhlasí s tím, že Wink takové náklady neprodleně uhradí v plné výši v souladu s článkem 33 Obecných podmínek („Odstupnění“).
...
16.1 Během platnosti Smlouvy může Wink provést audit relevantních záznamů Poskytovatele ubytování a/nebo Participujících hotelů, které jsou nezbytné k ověření (i) plnění rezervací; (ii) všech plateb přijatých Winkem a/nebo hosty; a (iii) všech plateb zaplacených nebo splatných Winkem a/nebo hosty.

16.2 Každá Strana hradí své náklady na audit, kromě situace, kdy audit prokáže, že Poskytovatel ubytování nesplňuje své povinnosti podle této Smlouvy. V takovém případě Poskytovatel ubytování uhradí náklady na audit a přijme opatření k nápravě.

**17. Pojištění**

Poskytovatel ubytování zajistí adekvátní pojištění u renomovaných pojišťoven oprávněných působit v příslušném státě/zemi, které kryje veškerá rizika třetích stran vzniklá v souvislosti s poskytováním ubytování (nebo jakýchkoli zařízení a služeb) a/nebo touto Smlouvou, včetně odpovědnosti Wink za škody na majetku, úrazy, škody třetím stranám apod.

**18. Protikorupční opatření, obchodní omezení a etika**
...
Poskytovatel ubytování zaručuje, že dodržuje a bude dodržovat Kodex chování dodavatelů Wink.

Poskytovatel ubytování prohlašuje, že dodržuje všechny mezinárodní obchodní normy, platná omezení obchodu, toku finančních prostředků, financování terorismu a zákony o prevenci úplatkářství a korupce, včetně, ale nikoli výlučně, UK Bribery Act 2010 a Singapore Prevention of Corruption Act.

Poskytovatel ubytování zaručuje, že podle jeho nejlepšího vědomí ani on, ani jeho přidružené subjekty nebyli odsouzeni za trestný čin související s úplatkářstvím nebo korupcí a nejsou předmětem žádného vyšetřování ze strany vládních, správních nebo regulačních orgánů.

**19. Důvěrnost**

19.1 Důvěrné informace. Strany rozumí a souhlasí, že při plnění této Smlouvy může každá Strana získat přístup k důvěrným a citlivým informacím druhé Strany (dále jen „Důvěrné informace“). Důvěrné informace zahrnují údaje o zákaznících, objem transakcí, marketingové a obchodní plány, obchodní, finanční, technické a provozní informace, statistiky využití, údaje o sazbách, produktech a dostupnosti, cenové politiky, konverzní data, osobní údaje hostů, software a informace o softwaru používaném Winkem, podmínky této Smlouvy a další neveřejné informace označené jako důvěrné.

19.2 Ochrana důvěrných informací. Každá Strana souhlasí, že: (a) všechny důvěrné informace zůstanou výhradním majetkem poskytující Strany a přijímající Strana je nebude používat jinak než k plnění této Smlouvy, (b) bude udržovat důvěrnost a zajistí, aby její zaměstnanci, zástupci a agenti (dále jen „oprávněné osoby“) zachovávali důvěrnost, (c) důvěrné informace zpřístupní pouze oprávněným osobám, které je potřebují znát, (d) nebude kopírovat, zveřejňovat, přenášet, reprodukovat, sdělovat nebo zpřístupňovat důvěrné informace třetím stranám, ani je uchovávat v nechráněných systémech, a (e) na písemnou žádost druhé Strany vrátí nebo zničí všechny kopie důvěrných informací. Pokud některá Strana zpracovává osobní údaje druhé Strany, upraví se toto zpracování prostřednictvím smlouvy o zpracování údajů (DPA), která bude součástí této Smlouvy.

19.3 Povolené zveřejnění. Důvěrné informace nezahrnují informace, které (i) se stanou veřejně dostupnými bez porušení této Smlouvy, (ii) byly přijímající Stranou známy před uzavřením této Smlouvy, (iii) jsou zveřejněny třetí stranou bez povinnosti mlčenlivosti, nebo (iv) jsou vyžadovány k zveřejnění zákonem, soudním příkazem nebo vládním orgánem. Wink může tuto Smlouvu důvěrně zpřístupnit svým společnostem poskytovatelů ubytování.

19.4 Údaje o zákaznících. Strany vynaloží přiměřené úsilí k ochraně důvěrnosti a soukromí údajů o zákaznících a zabrání neoprávněnému použití nebo zveřejnění. Dodržují platné zákony o ochraně osobních údajů a soukromí. Používají přiměřená bezpečnostní opatření, včetně šifrování dat a kanálů. Poskytovatel ubytování musí Wink neprodleně informovat o bezpečnostním incidentu (nejpozději do 1 dne od zjištění). Každá Strana má zásady ochrany osobních údajů přístupné zákazníkům. Strany mohou uplatnit práva na přístup, opravu, výmaz, námitku, přenositelnost a omezení zpracování osobních údajů písemnou žádostí na adresy uvedené v záhlaví této Smlouvy, včetně podání stížnosti u místního úřadu pro ochranu údajů.
...
19.6 Každá Strana může kontaktovat pověřence pro ochranu osobních údajů druhé Strany na e-mailu dataprotectionofficer@Wink.

**20. Práva duševního vlastnictví**

20.1 Poskytovatel ubytování uznává, že Wink a/nebo jeho poskytovatelé licencí si ponechávají vlastnictví všech práv, titulů a zájmů k veškerým právům duševního vlastnictví Wink nebo obsaženým na webu Wink, včetně loga Wink, obsahu a dat Wink. Nic v této Smlouvě nepřenáší žádná taková práva na Poskytovatele ubytování.

20.2 Poskytovatel ubytování nesmí zveřejňovat, integrovat, používat, kombinovat, využívat, začleňovat nebo jinak zpřístupňovat obsah a data Wink (nebo jejich části) (a) se svým vlastním obsahem nebo obsahem konkurentů Wink (včetně hotelů), (b) pro svůj prospěch (kromě umožnění služby a systému podle této Smlouvy), (c) pro konkurenty Wink (včetně hotelů), nebo (d) pro jiné účely či na třetích platformách, pokud to není výslovně povoleno. Affiliate nesmí upravovat, měnit, zkreslovat, vytvářet odvozená díla na základě obsahu a nesmí obsahovat odkazy na konkurenty Wink.

20.3 Poskytovatel ubytování nesmí registrovat, získávat, používat, kupovat nebo získávat internetové domény obsahující slovo „Wink“ nebo jeho varianty, překlady či překlepy jako součást adresy.
...
22.3 Poskytovatel ubytování prohlašuje, že má všechna potřebná práva, licence, souhlasy a oprávnění k: (i) poskytnutí obsahu Wink; (ii) uděluje Wink nevýhradní, bezplatné, neodvolatelné, celosvětové a sublicencovatelné právo používat, upravovat, zobrazovat, publikovat a upravovat obsah, jména, loga, ochranné známky a další duševní vlastnictví Poskytovatele ubytování („IPR“) pro účely plnění této Smlouvy; (iii) zaručuje Wink a jeho klientům, že tato práva neporušují práva třetích stran; a (iv) bude odpovědný za jakékoli pomlouvačné nebo nemorální informace a pravdivost a přesnost poskytnutých IPR.

22.4 Poskytovatel ubytování bude po celou dobu platnosti a po ukončení této Smlouvy odškodňovat Wink, jeho poskytovatele ubytování a partnery a udržovat je bez újmy na požádání za veškeré ztráty vzniklé z nároků na IPR.

22.5 Poskytovatel ubytování bude (i) poskytovat Wink aktualizace o průběhu nároků na IPR v požadované formě včetně důkazů o vyřešení nebo zamítnutí nároku co nejdříve; (ii) pokud nesplní tuto povinnost nebo Wink nebude spokojen s průběhem nároku, Wink převezme okamžitou kontrolu nad nárokem na náklady Poskytovatele ubytování. Wink má právo odečíst náklady a odškodnění z jakýchkoli současných, podmíněných nebo budoucích pohledávek vůči Poskytovateli ubytování.

**23. Publicita / Vnější komunikace**

23.1 Poskytovatel ubytování nesmí zveřejňovat žádné materiály týkající se Wink nebo této Smlouvy, ať už médiím nebo jiným třetím stranám, bez předchozího písemného souhlasu Wink. Poskytovatel ubytování nese plnou odpovědnost za škody způsobené Wink v důsledku porušení tohoto ustanovení.

23.2 Poskytovatel ubytování se bude konzultovat s Wink ohledně obsahu jakékoli komunikace, kterou hodlá zveřejnit, a poskytne Wink kopii finální verze.
...
**25. Oprávnění k podpisu – Zástupce poskytovatele ubytování**

25.1 Poskytovatel ubytování zaručuje, že osoba podepisující tuto Smlouvu a/nebo poskytující informace Wink má oprávnění a pravomoc tuto Smlouvu podepsat za všechny Participující hotely a zavazuje se, že během platnosti Smlouvy bude dodržovat její povinnosti.
...
Žádné zřeknutí se porušení nebo podmínky této Smlouvy nebude považováno za zřeknutí se jiných nebo budoucích porušení.

**28. Oddělitelnost**

Pokud je jakékoli ustanovení této Smlouvy shledáno neplatným nebo nevymahatelným, bude upraveno nebo odstraněno tak, aby byla Smlouva platná a vymahatelná, přičemž ostatní ustanovení zůstanou v platnosti.

**29. Vztah Stran**

Strany jsou nezávislými dodavateli a žádná ze stran není agentem nebo partnerem druhé.

**30. Postoupení**

30.1 Žádná Strana nesmí postoupit svá práva nebo povinnosti bez písemného souhlasu druhé Strany, kromě Wink, který může postoupit práva spřízněné společnosti bez souhlasu Poskytovatele ubytování.

30.2 Tato Smlouva je prospěšná Stranám a jejich nástupcům a nepřevádí žádná práva třetím stranám, pokud není výslovně uvedeno jinak.

**31. Vyšší moc**

Wink nenese odpovědnost za zpoždění nebo nesplnění povinností z důvodů mimo jeho kontrolu, včetně přírodních katastrof, válek, terorismu, stávky apod.

**32. Omezení odpovědnosti**

32.1 V maximálním rozsahu povoleném zákonem nenese žádná Strana odpovědnost za nepřímé, náhodné, následné, zvláštní nebo trestní škody.

32.2 Výjimky platí pro smrt nebo úraz způsobený nedbalostí, podvod nebo jiné zákonem nezakázané odpovědnosti.

32.3 Strany uznávají, že omezení odpovědnosti jsou spravedlivá a rozumná.

**33. Odškodnění**

V maximálním rozsahu povoleném zákonem souhlasíte s tím, že Wink a jeho poskytovatelé ubytování budou odškodněni za nároky vzniklé z vašeho porušení těchto Podmínek, nesprávného používání služeb, nesprávného hlášení nebo placení daní či porušení zákonů.

**34. Rozhodné právo a jurisdikce**

34.1 Tato Smlouva se řídí zákony Singapuru. Zákon o právech třetích stran 2001 (Cap 53B) se na tuto Smlouvu nevztahuje. Strany se pokusí spory řešit smírně.

34.2 Veškeré spory budou řešeny výhradně příslušným soudem v Singapuru.

**35. Počet vyhotovení**

Tato Smlouva může být podepsána ve více vyhotoveních, která společně tvoří jeden dokument. Elektronický podpis Wink má stejnou platnost jako originál.
...
36.2 Pokud je jakékoli ustanovení neplatné, Strany nahradí toto ustanovení platným s podobným účinkem.

**37. Uzavření smlouvy**

Smlouva nabývá platnosti písemným potvrzením přijetí Poskytovatelem ubytování ze strany Wink. Registrací a přihlášením do programu Wink jako Poskytovatel ubytování souhlasíte s podmínkami této Smlouvy včetně změn.

Poskytovatel ubytování potvrdil, že si Smlouvu přečetl a souhlasí s ní. Elektronické přijetí je platné a závazné.

**38. Oznámení**

Veškerá oznámení musí být v angličtině, písemná, doručená osobně, doporučenou poštou nebo mezinárodním expresním kurýrem na sídlo nebo e-mailem kontaktní osobě.

Oznámení se považuje za doručené (i) při osobním předání s potvrzením, (ii) při doporučené poště při doložení doručení, (iii) při expresním kurýru ke dni doručení, (iv) při e-mailu po potvrzení přijetí.
