---
title: 简要介绍
description: 本文将带您了解有关预订引擎的所有信息。
sidebar:
  order: 0
---
...
- 以所需格式、语言和货币提供可预订库存，例如：
    - Facebook 上的[可分享链接](/zh-CN/portal/studio/shareable-links)。
    - https://book.wink.travel 上的酒店落地页，展示该酒店的库存。
...
预订引擎是一组可重用功能，我们通过 https://book.wink.travel 提供；这是一个高度可定制的网站，供酒店和加盟商向旅客销售产品。

希望获得更多自由度的集成商，可以通过我们的 [WordPress 插件](/zh-CN/integrations/wordpress/)、[Web 组件](/zh-CN/integrations/web-components) 和 [API](/zh-CN/api) 访问所有相同功能。
