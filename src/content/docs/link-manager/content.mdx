...
To manage content on WinkLinks, make sure you've already selected the affiliate account to work with on Wink Studio, navigate to `WinkLinks` in the top navigation bar.
