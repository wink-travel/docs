...
:::note
Tu primera app ya está creada cuando [creas una nueva cuenta](/es-AR/portal/create-account). Usamos esa app para algunos escenarios de reserva.
...
Si no tienes más uso para una app, puedes eliminarla.
