...
- Las líneas 6 a 9 te muestran cómo usar el [wink-content-loader](/es-AR/integrations/web-components/#content-loader) Web Component y decirle que obtenga una tarjeta de habitación para tu código.
- La línea 11 te muestra cómo incrustar nuestro Javascript en tu sitio.
- La línea 13 te muestra cómo incrustar el [wink-app-loader](/es-AR/integrations/web-components/#application-loader) Web Component y decirle que obtenga tus preferencias de configuración a nivel de página.

## API

Los desarrolladores que quieran gestionar tarjetas pueden dirigirse a [Desarrolladores > API > Inventario](/es-AR/api/overview/).
