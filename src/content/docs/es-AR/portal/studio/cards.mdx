...
Arriba hay una imagen tomada de [Búsqueda](/es-AR/portal/studio/search) que te muestra algunas de las cosas que puedes hacer con tus resultados de búsqueda. Una de esas acciones es `Crear una tarjeta`.
...
<Steps>
 ...
 2. Selecciona la [Personalización](/es-AR/portal/settings/branding) que quieres aplicar a esta tarjeta.
...
Los desarrolladores que quieran gestionar tarjetas pueden dirigirse a [Desarrolladores > API > Inventario](/es-AR/api).
