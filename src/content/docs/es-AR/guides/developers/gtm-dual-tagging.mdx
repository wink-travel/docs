...
description: Cómo conectar tu cuenta de Sojern con Wink para que Sojern pueda rastrear el recorrido de reserva de tus huéspedes y potenciar tus campañas de retargeting y publicidad.
sidebar:
...
<Aside type="tip">
Esto asume que ya tienes una cuenta activa de Sojern y que has recibido tu ID de Contenedor GTM de tu gerente de cuenta de Sojern. Si aún no tienes una cuenta de Sojern, visita [sojern.com/contact](https://www.sojern.com/contact) para comenzar.
</Aside>
...
Se activa cuando se renderiza una cuadrícula o lista de inventario hotelero.
...
Estos parámetros llevan contexto específico de reserva de Wink. GA4 no los muestra automáticamente en reportes — debes registrarlos como **dimensiones personalizadas a nivel ítem** en tu propiedad GA4 antes de que aparezcan en exploraciones o reportes estándar. Consulta [Dimensiones Personalizadas en GA4](#custom-dimensions-in-ga4) más abajo para instrucciones.
...
| `room_rate_name` | string | Nombre visible de la tarifa de la habitación |
