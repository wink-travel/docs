...
| Nombre de la dimensión | Parámetro del evento | Tipo |
|------------------------|---------------------|------|
...
| Ubicación de la habitación | `room_location` | Texto |
| Vista de la habitación | `room_view` | Texto |
| Clasificación de la habitación | `room_classification` | Texto |
