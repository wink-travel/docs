...
:::note
Tu primera aplicación ya está creada cuando [creas una nueva cuenta](/es-AR/my-account/create-account). Usamos esa aplicación para algunos escenarios de reserva.
...
6. **URIs de redirección post-cierre de sesión** *(Opcional)* URLs a las que se puede redirigir a los usuarios después de cerrar sesión. Esto asegura que los usuarios aterricen en una página conocida tras finalizar su sesión.
