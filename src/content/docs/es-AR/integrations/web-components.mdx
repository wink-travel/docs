...
El inventario podría no estar disponible. Ve a [Studio](/es-AR/portal/studio/cards) y verifica si el estado de la "tarjeta" está disponible.
...
El inventario podría haber sido eliminado. Ve a [Studio](/es-AR/portal/studio/cards) y verifica si el estado de la "tarjeta" está disponible.
Si no lo está, aparecerá en rojo. En ese caso, puedes esperar y tal vez el proveedor lo vuelva a poner disponible o eliminarlo de tu lista.
...
Esto es solo para desarrolladores web. Si eliminaste accidentalmente la [Aplicación](/es-AR/account/applications) ; haciendo que el client ID ya no esté disponible, por favor crea una nueva aplicación y usa el nuevo client ID para incrustar nuestros Componentes Web.
