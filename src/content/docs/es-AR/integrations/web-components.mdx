...
[Componentes Web](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) es un estándar que te permite integrar funciones completas en Javascript dentro de tu sitio web sin necesidad de saber programar.
...
El inventario podría ya no estar disponible. Ve a [Wink Studio](/es-AR/portal/studio/cards) y verifica si el estado de la "tarjeta" está disponible.
