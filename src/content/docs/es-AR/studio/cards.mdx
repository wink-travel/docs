...
Una tarjeta representa un único proveedor (por ejemplo, hotel o proveedor de experiencias) o inventario (es decir, tipo de habitación, sala de reuniones, spa, etc.) y muestra los detalles a través de una interfaz interactiva y reservable en formato tarjeta.
...
Una tarjeta soporta múltiples caras para minimizar el tamaño de la tarjeta y categorizar los datos; facilitando su consumo por parte del usuario y dándote una mayor oportunidad de convertir al usuario en una reserva.
...
<Steps>
 ...
 4. Selecciona el <Badge text="distintivo" variant="tip" size="small" /> que quieres usar en la tarjeta. Un distintivo permite a los usuarios comparar inventarios según una métrica agregada como `eco-amigable`.
...
- **Incrustar** Te muestra cómo incrustar esta tarjeta como un [Card](/es-AR/integrations/web-components/#content-loader) en tu sitio web.
...
- Las líneas 6 a 9 te muestran cómo usar el Componente Web [wink-content-loader](/es-AR/integrations/web-components/#content-loader) y decirle que cargue una tarjeta de habitación para tu código.
- La línea 11 te muestra cómo incrustar nuestro Javascript en tu sitio.
- La línea 13 te muestra cómo incrustar el Componente Web [wink-app-loader](/es-AR/integrations/web-components/#application-loader) y decirle que cargue tus preferencias de configuración a nivel de página.
...
- Aprende más sobre nuestra colección de [Componentes Web](/es-AR/integrations/web-components).
