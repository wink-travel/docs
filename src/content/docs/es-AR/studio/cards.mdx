...
- **Incrustar** Te muestra cómo incrustar esta tarjeta como un [Card](/es-AR/developers/integrations/web-components/#content-loader) en tu sitio web.
...
- Las líneas 6 a 9 te muestran cómo usar el [wink-content-loader](/es-AR/developers/integrations/web-components/#content-loader) Web Component y decirle que obtenga una tarjeta de habitación para tu código.
- La línea 11 te muestra cómo incrustar nuestro Javascript en tu sitio.
- La línea 13 te muestra cómo incrustar el [wink-app-loader](/es-AR/developers/integrations/web-components/#application-loader) Web Component y decirle que obtenga tus preferencias de configuración a nivel de página.
