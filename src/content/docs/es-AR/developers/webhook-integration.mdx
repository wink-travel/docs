...
Wink soporta **más de 64 tipos de eventos de webhook** en categorías que incluyen gestión de cuentas, contratos de reserva, pagos, actualizaciones de gestores de canales y administración de entidades. Eventos comunes incluyen:
...
Para una lista completa de todos los tipos de eventos con descripciones, consultá el **Catálogo de Eventos de Webhook**.

<LinkButton href="/es-AR/developers/webhook-events">
  Ver los más de 64 tipos de eventos
</LinkButton>

:::tip
Comenzá suscribiéndote a todos los eventos durante el desarrollo. Una vez que entiendas las cargas útiles, reducí la suscripción solo a los eventos que tu sistema necesita.
:::
...
- [Catálogo de Eventos de Webhook](/es-AR/developers/webhook-events) — Lista completa de todos los más de 64 tipos de eventos.
- [Webhooks](/es-AR/portal/settings/webhooks) — Referencia completa para la gestión de webhooks.
- [Applications](/es-AR/portal/settings/applications) — Gestioná tus credenciales API.
