...
Puedes encontrar ejemplos para [tarjetas](/es-AR/studio/cards), [grillas](/es-AR/studio/grids) y [mapas](/es-AR/studio/maps).
...
:::note
Para aprender cómo generar el `id` del contrato de reserva, lee la guía: [Integrando con TripPay](/es-AR/guides/integrating-with-trip-pay).
:::
...
El inventario podría ya no estar disponible. Ve a [Wink Studio](/es-AR/studio/cards) y verifica si el estado de la "tarjeta" está disponible.
...
El inventario podría haber sido eliminado. Ve a [Wink Studio](/es-AR/studio/cards) y verifica si el estado de la "tarjeta" está disponible.
Si no lo está, aparecerá en rojo. En ese caso, puedes esperar y tal vez el proveedor lo vuelva a poner disponible o eliminarlo de tu lista.
...
Esto es solo para desarrolladores web. Si eliminaste accidentalmente la [Aplicación](/es-AR/my-account/applications) ; haciendo que el client ID ya no esté disponible, por favor crea una nueva aplicación y usa el nuevo client ID para insertar nuestros Componentes Web.
