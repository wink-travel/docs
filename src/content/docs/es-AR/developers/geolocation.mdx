...
| Ubicación de propiedad | Punto | Ubicación exacta de un listado de propiedad |
...
Consulta la [documentación de APIs](/es-AR/api/overview/) para detalles específicos de cada endpoint.
...
- [APIs](/es-AR/api/overview/) — Referencia completa de API.
