...
description: Política de privacidad fácilmente accesible y actualizada para todos nuestros usuarios viajeros.
sidebar:
  order: 5
---

TRAVELIKO SINGAPORE PTE. LTD., operando bajo el nombre Wink (la “Compañía”), desea informar a quien contacte a la Compañía que es necesario recopilar, compilar y usar sus datos personales para el servicio de la Compañía de acuerdo con esta Política de Privacidad. Al contactar y revelar sus datos personales a la Compañía con fines de comunicación, coordinación y/o provisión de los servicios de la Compañía para usted, se considera que usted acepta y está de acuerdo en cumplir con esta Política de Privacidad.
...
(2) Indirectamente, a través de una referencia de un tercero a quien usted pueda otorgar consentimiento para revelar sus datos personales a la Compañía; o
...
(1) Su nombre completo, incluyendo su información relacionada o la información de su representante (en caso de que usted nos contacte en nombre de una persona jurídica) que puede incluir su documento de identidad.

(2) Información de contacto como número de teléfono, correo electrónico o información de cuenta en redes sociales.

(3) Otros datos personales que usted pueda proporcionar a la Compañía durante las comunicaciones, como información sobre consultas, información de interés o cualquier otra información personalmente identificable que usted proporcione directamente a la Compañía a través de diversos canales de comunicación.

(4) En caso de comunicación vía el sitio web, puede incluir su información técnica como dirección IP, cookies, incluyendo información sobre su comportamiento de navegación.

Propósito del procesamiento y uso de los datos personales, la Compañía necesita recopilar, compilar y usar los datos personales del solicitante de empleo para los siguientes fines:

(1) Para la gestión de las comunicaciones con las que usted ha interactuado con la Compañía, como responder preguntas, proporcionar información relevante según lo solicitado y requerido, gestionar quejas o responder a comentarios que usted haga directamente a la Compañía a través de diversos canales de comunicación, incluyendo coordinación continua, ejecución de acuerdos de servicio y/o cumplimiento de derechos y obligaciones que la Compañía y usted puedan acordar;

(2) Para el cumplimiento de obligaciones legales a las que la Compañía pueda estar sujeta bajo ciertas condiciones. Esto puede incluir, pero no se limita a, cumplir con deberes asociados con la preparación de documentos contables y fiscales en relación con cualquier servicio proporcionado por la Compañía para usted;

(3) Para el propósito de construir y mejorar las relaciones comerciales, incluyendo mejorar el servicio que la Compañía brinda para su beneficio, para lo cual la Compañía puede recopilar y/o usar sus datos personales con fines de control, aseguramiento del servicio, análisis de gestión y resolución de problemas relacionados con el negocio, incluyendo, pero no limitado a, capacitación de empleados y planificación de mejoras futuras del servicio;
...
Período de retención de los datos personales, para cumplir con los fines descritos anteriormente, la Compañía necesita recopilar, compilar y procesar sus datos personales según el siguiente período:

(1) Para el procesamiento de datos personales con el fin de proporcionar servicios, ejecutar un acuerdo y/o cumplir con derechos y deberes bajo el acuerdo, la Compañía necesita procesar sus datos personales mientras la Compañía tenga la obligación de brindarle servicios;
...
(1) Proveedores de servicios externos de la Compañía contratados para brindar servicios de apoyo a la Compañía en la prestación de servicios para usted, incluidos consultores de la Compañía. Dicha divulgación de datos personales a estos terceros se realizará de acuerdo con los fines y solo en base a la necesidad de saber; o
...
Dirección: #03-01 Wilkie Edge, 8 Wilkie Road, Singapore 228095

Correo electrónico: dataprotectionofficer@wink.travel  
Número de teléfono: +66 (0) 854891301
