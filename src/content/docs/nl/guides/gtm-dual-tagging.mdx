...
Alle events die een `items` array bevatten, gebruiken hetzelfde itemschema. Elke eigenschap is optioneel tenzij als verplicht gemarkeerd.
...
GA4 negeert aangepaste itemparameters in rapporten totdat u ze expliciet registreert als item-gescopeerde aangepaste dimensies. U hoeft alleen de parameters te registreren die u in rapporten wilt gebruiken — niet alle 18.
