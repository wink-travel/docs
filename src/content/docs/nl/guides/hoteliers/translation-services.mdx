...
<Steps>
1. **Je maakt inhoud aan** in je primaire taal — handmatig of met behulp van [AI-ondersteunde registratie](/nl/guides/hoteliers/ai-assisted-registration).
...
1. **Registreer je accommodatie** met behulp van [AI-ondersteunde registratie](/nl/guides/hoteliers/ai-assisted-registration) — AI genereert inhoud in je primaire taal.
...
- **Werk de bron bij, niet de vertaling.** Als je vertaalde inhoud moet aanpassen, werk dan de originele brontekst bij en laat de vertaling opnieuw lopen. Zo blijven alle talen consistent.

## Verdere lectuur

- [Lokalisatie](/nl/getting-started/localization) — Platformniveau taal- en locale-ondersteuning.
- [AI-ondersteunde registratie](/nl/guides/hoteliers/ai-assisted-registration) — Registreer een accommodatie met AI en automatische vertaling.
