...
2. **Voer Het In in het Wink-portaal**
   ...
   Log in op [app.wink.travel](https://app.wink.travel), selecteer uw account en open uw aanpassingsinstellingen. Plak in de sectie **Analytics & integraties** uw GTM Container ID in het veld **GTM Container ID** en sla op. Uw integratie is nu actief.
...
<Aside type="note">
Aangepaste dimensies kunnen tot 24 uur nodig hebben voordat ze in GA4-rapporten verschijnen na registratie. Historische data die vóór registratie is verzameld, wordt niet achteraf toegevoegd.

GA4 staat maximaal 50 item-scoped custom dimensions toe per standaard property (360-properties hebben een hoger limiet).
</Aside>
