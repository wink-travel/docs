...
<Steps>
1. [Registreer](/nl/account/register) je gebruikersaccount op Wink.
2. [Maak een affiliate account aan](/nl/portal/create-account). Dit heb je nodig om je Applicatie aan te koppelen. Zie [wat is Studio](/nl/portal/studio/what-is-studio) voor meer context.
3. [Maak een Applicatie aan](/nl/portal/settings/applications) en koppel deze aan het affiliate account dat je in Stap 2 hebt aangemaakt. Kies voor server-naar-server API-integraties **MACHINE_2_MACHINE** als clienttype.
4. Zodra je je `Applicatie` hebt aangemaakt, kopieer en bewaar je direct de client-id en geheime sleutel — de geheime sleutel wordt slechts één keer getoond en kan niet opnieuw worden opgevraagd.
</Steps>
...
Ga naar onze [API's](/nl/api) sectie en kies de API waarmee je wilt werken.
