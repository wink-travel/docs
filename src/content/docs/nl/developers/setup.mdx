...
3. [Maak een Applicatie aan](/nl/account/applications) en koppel deze aan het affiliate account dat je in Stap 2 hebt aangemaakt. Kies voor server-naar-server API-integraties **MACHINE_2_MACHINE** als clienttype.
