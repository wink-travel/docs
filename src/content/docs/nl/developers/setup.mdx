...
<Steps>
  1. Gebruik de [Opzoek-API](https://developer.wink.travel/lookup) om bestemmingen of hotels op te halen.
...
<Steps>
  ...
  2. Klik op `Download OpenAPI spec` vanaf de top van de [Opzoek-API](https://developer.wink.travel/lookup) pagina.
