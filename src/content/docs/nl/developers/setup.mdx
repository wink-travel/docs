...
:::note
Testen moet altijd plaatsvinden in onze [stagingomgeving](/getting-started/environments). Daar is veel minder data, maar je kunt zo veel testen als je wilt zonder de productieomgeving te belasten.
...
<Steps>
1. [Registreer](/user/register) je gebruikersaccount op Wink
2. Maak een [reisagentaccount](/travel-agent/what-is-agent) of een [affiliate-account](/studio/what-is-studio) aan.
3. [Maak een Applicatie aan](/developer/applications) en koppel deze aan het account dat je in stap 2 hebt aangemaakt.
...
Ga naar onze [API's](/developer/apis) sectie en kies de API waarmee je wilt werken.
