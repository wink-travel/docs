...
<Steps>
1. [Registreer](/nl/my-account/register) je gebruikersaccount op Wink.
2. [Maak een affiliate account aan](/nl/my-account/create-account). Dit heb je nodig om je Applicatie aan te koppelen. Zie [wat is Studio](/nl/studio/what-is-studio) voor meer context.
3. [Maak een Applicatie aan](/nl/my-account/applications) en koppel deze aan het affiliate account dat je in Stap 2 hebt aangemaakt. Kies voor server-naar-server API-integraties **MACHINE_2_MACHINE** als clienttype.
...
Ga naar onze [API's](/nl/developers/apis) sectie en kies de API waarmee je wilt werken.
...
13. Stel het veld `Scope` in op `inventory.read inventory.write inventory.remove`. Dit zijn alle scopes die je nodig hebt voor Wink.
