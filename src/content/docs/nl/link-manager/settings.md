---
title: Instellingen
description: In dit artikel leggen we uit hoe je je WinkLinks-pagina kunt aanpassen met de functies die beschikbaar zijn onder instellingen.
sidebar:
  order: 4
---

Om je WinkLinks-instellingen te beheren, ga je naar `WinkLinks` in de hoofd navigatiebalk en klik je op het tabblad `Instellingen`.

Hier zijn de manieren waarop je het gedrag van je WinkLinks kunt configureren met `Instellingen`:
...
- **Initiële weergave** Bepaal hoe je publiek eerst met je site omgaat en je content ziet. Er zijn drie opties beschikbaar:
    ...
    - `Rij-gebaseerd` ontwerp. Dit is een manier om je content iets minder zwaar te maken voor browsers, maar we raden aan dat je content een vergelijkbare hoeveelheid tekst bevat om de kaarten beter uit te lijnen.
    - `Lijst-gebaseerd` ontwerp. De meeste andere linkmanagers tonen een eenvoudige lijst met een url en minimale content. Kies deze manier van weergeven als je veel content hebt en het zo snel mogelijk wilt tonen.
...
- Gedrag bij weergave van posts (Banner Modus, Slimme Banner/Interactief, Layout-Aware automatische aanpassing)  
- Aangepaste QR-codes met merkstijl (vorm, kleuren, stippen, hoeken)  
- Organisatie van content met tags (categoriseer links zoals "Hotels", "Reizen", "Aanbiedingen")  
- Volledige controle over linkindeling, bestandsuploads en contentblokken
...
- Lees meer over [Personalisaties](/nl/studio/customization).
