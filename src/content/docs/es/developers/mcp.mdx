...
3. Abre Cursor. Ve a **Configuración → Configuración de Cursor → MCP** y confirma que ambos servidores aparecen con indicador de estado verde. Si están en rojo, haz clic en **Actualizar**.
...
:::note
El soporte MCP en Windsurf requiere la versión **1.4** o superior. Compruébalo en **Ayuda → Acerca de Windsurf** y actualiza desde la web de Windsurf si es necesario.
:::
...
Has iniciado sesión con una cuenta Wink que no tiene entidad gestora. Ve a [Wink Portal](https://app.wink.travel) y asegúrate de que tu cuenta está configurada antes de usar el servidor MCP.
