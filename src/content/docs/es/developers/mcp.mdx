...
Configuración: Añade servidor remoto vía ajustes MCP.
```json
{
  "mcpServers": {
    "wink-docs": {
...
Consulta [AI Skills](/es/developers/ai-skills) para habilidades disponibles e instrucciones de instalación.
