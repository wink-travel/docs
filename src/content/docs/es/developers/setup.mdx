...
<Steps>
1. [Registra](/es/my-account/register) tu cuenta de usuario en Wink.
2. [Crea una cuenta afiliada](/es/my-account/create-account). La necesitarás para vincular tu Aplicación. Consulta [qué es Studio](/es/studio/what-is-studio) para más contexto.
3. [Crea una Aplicación](/es/my-account/applications) y asóciala con la cuenta afiliada que creaste en el Paso 2. Para integraciones API servidor a servidor, elige **MACHINE_2_MACHINE** como tipo de cliente.
...
Dirígete a nuestra sección de [APIs](/es/developers/apis) y elige la API con la que quieres trabajar.
...
:::tip[Consejo Profesional]
Se recomienda convertir el dominio del servidor, el client ID y el client secret en variables de entorno. De esa manera puedes cambiar fácilmente entre los entornos de staging y producción y reutilizar todas las operaciones que hayas creado.
:::
