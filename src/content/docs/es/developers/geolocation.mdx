...
Consulta la [documentación de APIs](/es/developers/apis) para detalles específicos de cada endpoint.

## Lecturas adicionales

- [Búsqueda (Booking Engine)](/es/booking-engine/search) — Cómo los viajeros buscan inventario.
- [Mapas (Studio)](/es/studio/maps) — Descubrimiento de inventario basado en mapas.
- [APIs](/es/developers/apis) — Referencia completa de la API.
