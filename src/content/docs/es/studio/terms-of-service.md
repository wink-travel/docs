...
**"Alojamiento"** significa cualquier forma de alojamiento, incluyendo pero no limitado a Proveedores de Alojamiento, moteles, casas de huéspedes, bed & breakfasts, hostales, villas, apartamentos (con servicio o no), lodges, posadas, alojamientos para huéspedes, resorts, condominios, campamentos y cualquier otro tipo de alojamiento o proveedor de hospedaje (ya sea o no disponible en los Sitios Web de Wink).  
...
**"Control"** significa la posesión del poder o la capacidad para (directa o indirectamente, solo o en concierto con otros, ya sea mediante la propiedad de valores con derecho a voto u otros intereses de propiedad, una sociedad u otro medio) (i) ejercer o causar el ejercicio de más de la mitad de los derechos de voto en la junta de accionistas de una empresa, (ii) nombrar a más de la mitad de los directores ((no) ejecutivos) o directores supervisores de una empresa, o (iii) dirigir o causar la dirección de la gestión relacionada con una empresa.  
...
**“Facilitador de Pagos”** es una subsidiaria de propiedad total de Winkfluence, que gestiona los Servicios de Pago, cobrando pagos de los huéspedes (“Pay-in”), mediante el cobro del método de pago asociado con su compra, como tarjeta de crédito, tarjeta de débito, transferencia bancaria, criptomonedas o PayPal, etc., y desembolsa los fondos adeudados (“Comisión Neta”) a la cuenta bancaria local del Afiliado.  
...
**"SEO"** significa optimización para motores de búsqueda e incluye el proceso de (i) mejorar el volumen o calidad del tráfico a un sitio web o página web desde motores de búsqueda a través de resultados de búsqueda "naturales" o no pagados ("orgánicos" o "algorítmicos"), o (ii) lograr o crear una mejor clasificación en los resultados de motores de búsqueda para una palabra clave o palabras clave específicas.  
**“Nombre de Dominio Similar”** tiene el significado establecido en la Cláusula 4.7.1.  
**"Regulaciones Anti-Spam"** significa cualquier política, regulación, restricción u obligación prescrita, declarada aplicable o anunciada periódicamente por Plataformas de Terceros que (i) prohíben o previenen el Doble Servicio, Cloaking o cualquier técnica o método similar, o (ii) contienen tales restricciones o regulaciones adicionales respecto al spam o para preservar una experiencia de usuario única.  
...
1) mostrar tales elementos de los Datos de Wink y tal información adicional de los Proveedores de Alojamiento en el/los Sitio(s) Web del Afiliado, todo según lo proporcionado o puesto a disposición por Wink al Afiliado;  
...
4.4.4 Durante la vigencia de este Acuerdo (y continuando posteriormente respecto a las Marcas de Wink y los Datos de Wink) el Afiliado cumplirá inmediatamente con cualquier solicitud hecha por Wink para adherirse y cumplir con esta Cláusula 4.4, en caso contrario Wink podrá terminar con efecto inmediato y sin perjuicio de sus recursos legales y contractuales.
...
4.8.1 En caso de que el Afiliado ofrezca Comparación de Precios en un Sitio Web del Afiliado relevante según lo establecido en el Formulario de Registro de Socio Afiliado, al Afiliado se le concederá acceso únicamente a las tarifas y datos de disponibilidad de los Proveedores de Alojamiento relevantes tal como se ponen a disposición en el Sitio Web de Wink (colectivamente, los "Datos de Tarifas y Disponibilidad") mediante una conexión directa a los servidores web de Wink (es decir, vía conexión JSON). Los Datos de Tarifas y Disponibilidad se pondrán a disposición conforme a los términos y condiciones adicionales que Wink establezca.
...
4.8.3 En caso de que el Afiliado ofrezca Comparación de Precios, el Afiliado asegurará que las tarifas de habitación puestas a disposición por todos los Competidores de Wink (incluyendo todos los Proveedores de Alojamiento o centro de reserva o intermediario o agente (colectivamente los "Proveedores de Terceros")) en el Sitio Web del Afiliado sean precisas, correctas y no engañosas o confusas en comparación con las tarifas reales puestas a disposición en el/los sitio(s) web de los Proveedores de Terceros.

4.8.4 Wink será tratado al menos tan favorablemente en el sitio web de Comparación de Precios del Afiliado (respecto a clasificación, visualización y oportunidades de conversión) como los mejores Competidores de Wink (x), Proveedores de Alojamiento (y) o cualquier centro de reserva o agente o intermediario de o gestionado, propiedad o controlado por un Competidor de Wink o Proveedores de Alojamiento (z), disponibles en el sitio web de Comparación de Precios del Afiliado.

**4.9 Carga de la prueba, cumplimiento, medidas cautelares y otros recursos**

4.9.1 Las Partes acuerdan y reconocen que en caso de una infracción (presunta o amenazante) o incumplimiento por parte del Afiliado de sus obligaciones bajo esta Cláusula 4, la carga de la prueba recae en el Afiliado. En otras palabras, Wink tiene el beneficio de la presunción y el Afiliado debe proporcionar y entregar pruebas suficientes y satisfactorias (es decir, concluyentes e irrefutables) para defender o rechazar una reclamación.
...
(b) Las Partes proporcionarán al Auditor toda la información, datos, cooperación, asistencia y acceso a libros y registros contables, documentos, archivos y papeles e información almacenada electrónicamente que el Auditor pueda solicitar razonablemente para completar su asignación de manera oportuna.  
...
Ninguna Parte creará, publicará, distribuirá ni permitirá materiales escritos que hagan referencia a la otra Parte sin antes someter dicho material a la otra Parte y recibir el consentimiento previo por escrito de la Parte no sometida. Este consentimiento no será retenido ni demorado de manera irrazonable.
...
Las Partes son y actuarán como contratistas independientes en la ejecución de este Acuerdo. Ninguna Parte actuará ni será considerada agente o socio de la otra Parte para ningún propósito ni tendrá autoridad para vincular a la otra en ningún aspecto.
...
Cualquier notificación bajo este Acuerdo se considerará recibida (i) si se entrega en mano, al firmar un recibo de entrega o, (ii) si es por correo registrado prepagado, al probar la entrega; o (iii) si es por mensajería exprés, en la fecha registrada de entrega de dicha mensajería (iv) si es por correo electrónico siempre que se confirme la recepción.
