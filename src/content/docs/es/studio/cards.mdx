...
- Las líneas 6 a 9 te muestran cómo usar el Componente Web [wink-content-loader](/es/integrations/web-components/#content-loader) y decirle que obtenga una tarjeta de habitación para invitados para tu código.
