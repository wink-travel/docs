...
- **Incrustar** Te muestra cómo incrustar esta tarjeta como un [Card](/es/developers/integrations/web-components/#content-loader) en tu sitio web.
...
- Las líneas 6 a 9 te muestran cómo usar el Componente Web [wink-content-loader](/es/developers/integrations/web-components/#content-loader) y decirle que obtenga una tarjeta de habitación para invitados para tu código.
