...
<Steps>
 ...
 4. Selecciona la <Badge text="insignia" variant="tip" size="small" /> que quieres usar en la tarjeta. Una insignia permite a los usuarios comparar inventarios en una métrica agregada como `eco-friendly`.
...
- Las líneas 6 a 9 te muestran cómo usar el [wink-content-loader](/es/integrations/web-components/#content-loader) Web Component y decirle que obtenga una tarjeta de habitación para tu código.
