...
- **Transferencia bancaria** El costo depende del país donde te encuentres y de dónde se envían los fondos. Incluimos una calculadora de cotización que puedes usar cuando tengas fondos disponibles en tu cuenta.
...
Para superar la asignación, el **propietario** de una cuenta habilita el pago según consumo y elige cuáles de sus cuentas se miden. El uso de todas tus cuentas habilitadas se agrupa en una **única factura mensual**, que puedes pagar automáticamente con tarjeta o recibir como factura para pagar tú mismo.

Una vez habilitado, tu uso se mide pero **nunca se limita** — no alcanzarás un límite de gasto con nosotros.
...
:::tip[Precios en vivo]
Los precios unitarios y las asignaciones gratuitas siempre se muestran en el Portal, directamente desde nuestro sistema de facturación, para que puedas consultarlos antes de comprometerte. Consulta [Facturación](/es/portal/plan) para habilitar el pago según consumo, elegir tus cuentas y seguir el uso y las facturas del mes. Consulta [Social](/es/portal/social/what-is-social) para ver cómo el volumen de publicaciones afecta tu gasto.
:::
