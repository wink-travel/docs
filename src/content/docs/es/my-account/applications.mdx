...
6. **URIs de redirección post-cierre de sesión** *(Opcional)* URLs a las que los usuarios pueden ser redirigidos después de cerrar sesión. Esto asegura que los usuarios lleguen a una página conocida tras finalizar su sesión.
