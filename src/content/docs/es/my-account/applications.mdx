...
Al crear una aplicación, eliges un tipo de cliente que determina cómo se autentica la aplicación:
...
6. **URIs de redirección post-cierre de sesión** *(Opcional)* URLs a las que se puede redirigir a los usuarios después de cerrar sesión. Esto asegura que los usuarios lleguen a una página conocida tras finalizar su sesión.
7. Haz clic en el botón `Guardar` para continuar.
</Steps>

Serás redirigido de nuevo a tu lista de aplicaciones. Verás tu nueva aplicación en la lista y tendrás acceso a la clave secreta de la aplicación solo esta vez. Asegúrate de copiarla y guardarla en un lugar seguro.
...
Serás redirigido de nuevo a tu lista de aplicaciones.
