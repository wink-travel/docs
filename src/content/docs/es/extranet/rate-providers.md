...
Seleccione su proveedor de tarifas en la lista desplegable y haga clic en el botón `Save`. Esto permitirá que el proveedor de tarifas nos envíe tarifas y les notificaremos cuando haya una reserva realizada en Wink para una de sus propiedades.
...
- Le harán completar el formulario ***PRS***.
  ...
  - ...y su moneda deseada.
- Complete el formulario y envíelo de vuelta a SynXis.

## Proveedores

A continuación, una lista de proveedores que soportamos:
...
| Fastbooking | CM |  | 2016 | 2016 | Ahora d-edge |
