---
title: Headless CMS
description: Inserta el inventario de viajes de Wink en cualquier headless CMS (Contentful, Strapi, Sanity, etc.) o sitio personalizado.
sidebar:
  order: 7
---
...
### 3. Añadir el cargador de la aplicación
