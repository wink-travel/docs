...
2. **Ingresa el ID en el Portal de Wink**
   ...
   Inicia sesión en [app.wink.travel](https://app.wink.travel), selecciona tu cuenta y ve a la pestaña **Personalizaciones**. Pega tu ID de Contenedor GTM de Sojern en el campo de Sojern y guarda. Tu integración ya está activa.
