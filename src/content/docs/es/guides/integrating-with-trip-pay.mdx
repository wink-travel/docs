...
description: Este artículo contiene un ejemplo completo de cómo integrarse y dejar que TripPay gestione el pago por ti.
sidebar:
  order: 4
---
...
- [Payment Web Component](/es/integrations/web-components/#payment).
...
- `redirectUrl` indica a TripPay a qué página redirigir tras completar el pago.
...
- El inventario que quieres reservar de ese proveedor. Todo está especificado en el arreglo anidado `contractItemList`.
