...
:::tip
You can use your Wink user account to log into TripPay.
:::
...
- Manage accounts.
- Manage mappings [link your internal payees with TripPay accounts](/payment/mapping).

## Dashboard

When you log into TripPay, the dashboard gives you an at-a-glance overview of your payment activity with aggregate metrics including:

- Total bookings processed
- Total revenue
- Available balance

The booking grid shows all your transactions with filtering, sorting, and export capabilities. You can filter by date range, booking code, status, and more.
