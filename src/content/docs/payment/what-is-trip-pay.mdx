...
:::note
Wink acquired TripPay in 2019 after using TripPay's features for a short time.
:::
...
:::tip
To learn how to prepare and finalize a payment, continue on to the next section.
:::
