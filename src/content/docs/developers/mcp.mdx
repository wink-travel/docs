...
The Booking Engine toolset supports MPP hotel payments with `agentic_booking_quote` and `agentic_booking_pay`. Payment-aware MCP clients can also use `agentic_booking_book`.

See [Agentic Payments](/developers/agentic-payments/) for the booking endpoint, payment methods and retry rules.
