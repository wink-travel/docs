...
Booking Engine includes destination lookup, hotel and room search, `agentic_booking_quote`, `agentic_booking_pay`, booking retrieval and receipts. See [Agentic Payments](/developers/agentic-payments/) for connection setup, the permissions to select and the steps from search to confirmation.
