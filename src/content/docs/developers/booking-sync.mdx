...
- [Channel Manager Integrations](/guides/hoteliers/channel-managers) — How Wink connects with PMS and channel managers.
- [Webhook Events Catalog](/developers/webhook-events) — Subscribe to booking events.
- [Bookings (Extranet)](/portal/extranet/bookings) — Managing bookings from the property portal.
