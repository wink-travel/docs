...
<Steps>
1. [Register](/my-account/register) your user account on Wink.
2. [Create an affiliate account](/my-account/create-account). You'll need this to bind your Application to. See [what is Studio](/studio/what-is-studio) for more context.
3. [Create an Application](/my-account/applications) and associate it with the affiliate account you created in Step 2. For server-to-server API integrations, choose **MACHINE_2_MACHINE** as the client type.
...
Head on over to our [APIs](/developers/apis) section and choose the API you want to work with.
