...
<Steps>
1. [Register](/account/register) your user account on Wink.
...
3. [Create an Application](/portal/settings/applications) and associate it with the affiliate account you created in Step 2. For server-to-server API integrations, choose **MACHINE_2_MACHINE** as the client type.
...
Head on over to our [APIs](/api) section and choose the API you want to work with.
