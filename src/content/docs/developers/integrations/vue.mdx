...
<Aside type="tip">
For Nuxt 3, see the dedicated [Nuxt integration page](/developers/integrations/nuxt) which covers SSR-safe loading.
</Aside>
...
- [Nuxt 3 integration](/developers/integrations/nuxt)
