...
Add the JSX intrinsic declaration file from the [React integration page](/integrations/react#typescript--declare-jsx-intrinsics) — Remix uses React under the hood.
