...
This is for web developers only. If you accidentally removed the [Application](/account/applications) ; making the client ID no longer available, please create a new application and use the new client ID to embed our Web Components.
