...
Samples can be found for [cards](/portal/studio/cards), [grids](/portal/studio/grids) and [maps](/portal/studio/maps).
...
:::note
To learn how to generate the booking contract `id`, read the guide: [Integrating with TripPay](/guides/developers/integrating-with-trip-pay).
:::
...
Inventory might no longer be available. Go to [Wink Studio](/portal/studio/cards) and check to see if the status of the "card" is available.
...
Inventory might have been removed. Go to [Wink Studio](/portal/studio/cards) and check to see if the status of the "card" is available.
If it is not, it will show up as red. If that's the case, you can wait and maybe the supplier makes it available again or remove it from your list.
...
This is for web developers only. If you accidentally removed the [Application](/portal/settings/applications) ; making the client ID no longer available, please create a new application and use the new client ID to embed our Web Components.
