...
* 物件に管理者を割り当てる
* 使用 [ウィンクリンクス](/link-manager/wink-links) 、 [ワードプレス](/developers/wordpress) そして私たちの [ワードプレス](/developers/wordpress) 複数の不動産を一箇所で販売、宣伝します。
...
法人旅行者は当社のアカウントを自分で管理できます [企業ポータル](/corporate/what-is-group) または公式にサポートされている [企業ポータル](/corporate/what-is-group) プラグインと[コンカー](https://www.concur.com/) 統合。
