---
title: 認証
description: WinkのOAuth2認証サーバーを使った認証方法を学びましょう。
sidebar:
  order: 2
---
...
- `Authorization` = `Bearer ${access_token}` *取得したアクセストークンを挿入してください。*

:::tip
コードを一行も書くことなく、すべてのAPIをテストできます。

お手持ちのアプリから「Client ID」と「Secret Key」を取得し、任意の[API](/ja/api)にアクセスしてください。
:::
