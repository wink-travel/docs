...
<Steps>
1. Winkでユーザーアカウントを[登録](/ja/account/register)します。
...
3. [アプリケーションを作成](/ja/portal/settings/applications)し、ステップ2で作成したアフィリエイトアカウントに関連付けます。サーバー間API連携の場合は、クライアントタイプに**MACHINE_2_MACHINE**を選択してください。
...
[APIs](/ja/api)セクションにアクセスし、使用したいAPIを選択してください。
