...
Visi kelionių agentai vis tiek gali rezervuoti per mūsų kelionių agentų portalą, naudodamiesi Wink mokėjimų vartais su savo arba keliautojo kreditine kortele. Todėl visi kelionių agentai taip pat turi sutikti su paslaugų teikimo sąlygomis, kuriose Wink mokėjimų vartai yra įrašytas kaip prekybininkas.

Šios sąlygos yra prieinamos [Affiliate Portal > Terms of Service](/lt/studio/terms-of-service).
:::
...
1. Be kitų šioje Sutartyje apibrėžtų terminų, šie apibrėžimai taikomi visoje Sutartyje, jei nėra aiškiai nurodyta kitaip:
