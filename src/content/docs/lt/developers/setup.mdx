...
Kai būsite pasiruošę paleisti gyvai, mes patvirtinsime jūsų paskyrą ir programą, ir galėsite paleisti gamybinėje aplinkoje.
:::

Sekite šiuos žingsnius:

<Steps>
1. [Užsiregistruokite](/lt/account/register) vartotojo paskyrą Wink platformoje.
2. [Sukurkite filialo paskyrą](/lt/portal/create-account). Ją reikės susieti su jūsų programa. Daugiau informacijos rasite skyriuje [kas yra Studio](/lt/portal/studio/what-is-studio).
3. [Sukurkite programą](/lt/portal/settings/applications) ir susiekite ją su filialo paskyra, sukurtą 2 žingsnyje. Serverio-serverio API integracijoms pasirinkite **MACHINE_2_MACHINE** kaip kliento tipą.
...
:::tip[Pro patarimas]
Patogumui rekomenduojame integratoriams naudoti galinius taškus, pažymėtus kaip `OAuth2`. Šie galiniai taškai žino, kad kviečiama API, ir jau žino, kurioje paskyroje esate, todėl jums nereikia nurodyti `companyIdentifier` URL.
:::
...
:::tip[Pro patarimas]
Rekomenduojama serverio domeną, klientų ID ir slaptą raktą laikyti aplinkos kintamaisiais. Taip lengvai galėsite keisti tarp staging ir gamybinės aplinkos bei pakartotinai naudoti visas sukurtas operacijas.
:::
