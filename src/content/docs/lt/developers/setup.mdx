...
<Steps>
1. [Užsiregistruokite](/lt/getting-started/sign-up) vartotojo paskyrą Wink platformoje.
...
3. [Sukurkite programą](/lt/account/applications) ir susiekite ją su filialo paskyra, sukurtą 2 žingsnyje. Serverio-serverio API integracijoms pasirinkite **MACHINE_2_MACHINE** kaip kliento tipą.
