...
description: Šiame straipsnyje pateikiamos mūsų paslaugų teikimo sąlygos kelionių agentams Wink platformoje.
sidebar:
  order: 4
---
...
:::caution[Pranešimas]
Žemiau pateiktos paslaugų teikimo sąlygos taikomos kelionių agentams, kurie nori patys įsigyti ir paskirstyti lėšas.  
Tai galima atlikti tik per mūsų API ir tik tiems kelionių agentams, kurie registracijos metu nurodė, kad nori tai daryti.

Visi kelionių agentai vis tiek gali rezervuoti per mūsų kelionių agentų portalą, naudodamiesi Wink mokėjimų vartais su savo arba keliautojo kreditine kortele. Todėl visi kelionių agentai taip pat turi sutikti su paslaugų teikimo sąlygomis, kuriose Wink mokėjimų vartai yra įrašyti kaip prekybininkas.

Šios sąlygos yra prieinamos [Affiliate Portal > Terms of Service](/lt/portal/studio/terms-of-service).
:::
...
1. Be kitų šioje Sutartyje apibrėžtų terminų, taikomi šie apibrėžimai, jei nėra priešingos nuostatos:
