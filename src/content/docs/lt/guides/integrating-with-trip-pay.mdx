...
description: Šiame straipsnyje pateikiamas pilnas pavyzdys, kaip integruotis ir leisti TripPay tvarkyti mokėjimą už jus.
sidebar:
  order: 4
---
...
- [Mokėjimas > Susiejimas](/lt/payment/mapping).
- [Mokėjimas > Integracija](/lt/payment/integration).
- [Mokėjimo internetinis komponentas](/lt/integrations/web-components/#payment).
- [Mokėjimo API](/lt/developers/apis/#payment-api). *Perskaitykite skyrių apie `Sukurti apmokėtinus kontraktus`*
...
:::note
Daugiau apie apmokėtino kontrakto kūrimo reikalavimus sužinokite Mokėjimo API.
:::
...
:::note
Aukščiau pateiktame JSON pavyzdyje yra 3 gavėjai:
...
Kai TripPay atsako su apmokėtinu kontraktu, pastebėsite, kad jis įtraukė savo gavėją su 4,0% dalimi.
:::
