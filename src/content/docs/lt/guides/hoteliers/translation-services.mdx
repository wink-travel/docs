...
1. **Užregistruokite savo objektą** naudodami [dirbtinio intelekto pagalbą registruojantis](/lt/guides/hoteliers/ai-assisted-registration) — DI sukuria turinį jūsų pagrindine kalba.
...
- [Dirbtinio intelekto pagalba registruojantis](/lt/guides/hoteliers/ai-assisted-registration) — Užregistruokite objektą su DI ir automatinio vertimo pagalba.
