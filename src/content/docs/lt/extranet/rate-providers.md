...
Norėdami nustatyti savo kainų tiekėją, pagrindinėje navigacijos juostoje spustelėkite `Distribution > Channel manager`.

Iš išskleidžiamojo sąrašo pasirinkite savo kainų tiekėją ir spustelėkite mygtuką `Save`. Tai leis kainų tiekėjui siųsti mums kainas, o mes juos informuosime, kai Wink bus užregistruota rezervacija vienam iš jūsų objektų.
...
Žemiau pateikiamas palaikomų tiekėjų sąrašas:
...
| Fastbooking | CM |  | 2016 | 2016 | Dabar d-edge |
