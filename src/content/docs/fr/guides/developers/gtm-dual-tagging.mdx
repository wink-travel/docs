...
3. **Remplissez les détails de la dimension**
   ...
   - **Nom de la dimension** — le libellé lisible qui apparaît dans les rapports GA4 (voir tableau ci-dessous)
...
| `userId` | Identifiant utilisateur authentifié (omis si non connecté) |
