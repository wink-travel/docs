...
description: Cet article contient nos conditions générales d'utilisation pour les agents de voyage sur la plateforme Wink.
sidebar:
  order: 4
---
...
:::caution[Avis]
Les conditions générales d'utilisation ci-dessous s'appliquent aux agents de voyage qui souhaitent acquérir et distribuer des fonds de manière autonome.  
Cela ne peut se faire que via notre API et uniquement par les agents de voyage ayant indiqué vouloir procéder ainsi lors de leur inscription.

Tous les agents de voyage peuvent toujours réserver via notre portail agent de voyage en utilisant la passerelle de paiement de Wink avec leur propre carte de crédit ou celle du voyageur. Par conséquent, tous les agents de voyage doivent également accepter les conditions générales d'utilisation où la passerelle de paiement de Wink est le commerçant enregistré.

Ces conditions sont disponibles sous [Affiliate Portal > Terms of Service](/fr/portal/studio/terms-of-service).
:::
...
1. **Winkfluence**, une société constituée selon les lois de Singapour et ayant son siège social au \#03-01 Wilkie Edge 8 Wilkie Road Singapore 228095 avec le numéro d'enregistrement TVA 201437335D (ci-après dénommée "Wink") et  
...
(i) Wink exploite un système en ligne (le "Système") par lequel les hébergements participants (collectivement les "Fournisseurs d’Hébergement") peuvent rendre leur inventaire disponible pour réservation et par lequel l’Agent de Voyage peut effectuer des réservations auprès de ces Fournisseurs d’Hébergement pour le compte de leurs clients (le "Service") ;
...
1. En plus des termes définis ailleurs dans cet Accord, les définitions suivantes s’appliquent dans tout l’Accord sauf indication contraire :

* **"Hébergement"** désigne toute forme d’hébergement incluant, sans s’y limiter, hôtels, motels, maisons d’hôtes, bed & breakfasts, auberges, villas, appartements, lodges, auberges, stations balnéaires, et tout autre type de fournisseur d’hébergement (qu’il soit disponible ou non sur les Sites Wink).  
...
* **“Force Majeure”** désigne tout événement hors du contrôle raisonnable d’une partie, incluant mais sans s’y limiter les catastrophes naturelles, actes de guerre, terrorisme, troubles civils, pandémies et actions gouvernementales, empêchant une partie de remplir ses obligations en vertu du présent Accord.  
...
* **“Paiements”** désigne les obligations financières découlant du présent Accord, incluant commissions, frais ou autres charges, payables par une partie à l’autre.

* **"Facilitateur de Paiement"** est une filiale en propriété exclusive de Winkfluence qui gère les Services de Paiement, collectant les paiements des clients en débitant le moyen de paiement associé à leur achat tel que carte de crédit, carte de débit, virement bancaire, cryptomonnaies, ou PayPal, etc.  
...
* **"Contrat Séparé"** désigne le contrat indépendant entre l’Agent de Voyage et le Fournisseur d’Hébergement détaillant les conditions spécifiques de paiement, incluant la Commission et le calendrier des paiements.  
...
3.1 **Collecte des paiements :** L’Agent de Voyage doit collecter le paiement du client au moment de la réservation.
...
3.5 **Facturation de Wink :** Wink émettra une facture mensuelle à l’Agent de Voyage pour les Frais de Réservation de 1,5 % accumulés sur le mois. L’Agent de Voyage est responsable du règlement de cette facture dans les délais spécifiés.
...
* Wink fournira l’accès au Système et garantira la disponibilité du Service à l’Agent de Voyage.
...
* Si un paiement dû en vertu du présent Accord n’est pas reçu à la date d’échéance, Wink se réserve le droit de facturer des intérêts au taux de 5 % par mois ou au taux maximal autorisé par la loi, selon le moindre des deux, sur le montant impayé, calculés à partir de la date d’échéance jusqu’à la date de paiement. De plus, Wink peut suspendre les services jusqu’à réception du paiement. Toutefois, en cas d’erreurs dans la facture soumise par Wink, l’Agent de Voyage ne sera tenu de payer que la partie correcte et précise de la facture et ne sera pas soumis à des intérêts ou pénalités pour non-paiement de la partie incorrecte.
...
* Les paiements doivent être effectués en USD. L’Agent de Voyage est responsable de tous les impôts, droits ou autres charges applicables aux transactions en vertu du présent Accord, y compris les frais de conversion de devise si les paiements sont effectués dans une autre devise que l’USD.
...
* En cas de litige sur une facture, l’Agent de Voyage doit notifier Wink dans les 10 jours suivant la date de la facture, en fournissant les raisons détaillées du litige. Les deux parties négocieront de bonne foi pour résoudre rapidement le différend. La partie non contestée de la facture doit être payée à la date d’échéance.

**7\. Responsabilités de l’Agent de Voyage**

7.1 **Conformité aux lois et réglementations :**

* L’Agent de Voyage doit se conformer à toutes les lois, réglementations et normes applicables locales, nationales et internationales dans l’exercice de ses activités, y compris mais sans s’y limiter celles relatives à la protection des consommateurs, à la protection des données et à la lutte contre le blanchiment d’argent.  
...
* L’Agent de Voyage doit fournir au Service Provider des rapports réguliers détaillant la performance de ses obligations en vertu du présent Accord, incluant mais sans s’y limiter les données de ventes, statistiques de Réservation et retours clients. Il est responsable de l’exactitude de ces rapports et doit coopérer avec le Service Provider lors de tout audit ou revue de ses opérations.
...
* L’Agent de Voyage doit respecter toutes les conditions d’utilisation associées à la Plateforme du Service Provider, y compris toute mise à jour ou modification de ces conditions. Il est responsable de s’assurer que ses employés et agents en ont connaissance et s’y conforment.

7.10 **Indemnisation :**

* L’Agent de Voyage doit indemniser et tenir le Service Provider à couvert de toute réclamation, dommage, responsabilité et dépense découlant d’une violation du présent Accord par l’Agent de Voyage, y compris mais sans s’y limiter tout manquement à respecter les lois applicables, fausse représentation des services ou manquement à ses obligations envers les clients ou Fournisseurs d’Hébergement.
...
9.2 **Indemnisation :** Chaque Partie s’engage à indemniser et à tenir l’autre indemne de toute réclamation découlant d’une violation du présent Accord ou de la négligence de la Partie indemnisante.

9.3 **Force Majeure :** Aucune des Parties ne sera responsable des retards ou manquements dus à des causes hors de leur contrôle raisonnable, incluant actes de Dieu, catastrophes naturelles, guerre, terrorisme, grèves, etc.

**10\. Durée et résiliation**

10.1 **Durée :** Le présent Accord prend effet à la date de signature et reste en vigueur jusqu’à résiliation par l’une ou l’autre des Parties.
...
11.2.2 **Arbitrage :** Si le différend ne peut être résolu par négociation dans les trente (30) jours, il sera soumis et définitivement résolu par arbitrage selon les règles du Singapore International Arbitration Centre (SIAC), lesquelles sont réputées incorporées par référence dans cette clause. Le nombre d’arbitres sera d’un, le siège ou lieu légal de l’arbitrage sera Singapour. La langue de la procédure d’arbitrage sera l’anglais.
...
12.1 **Définition** : Aucune des parties ne sera responsable d’un manquement ou retard dans l’exécution de ses obligations en vertu du présent Accord si ce manquement ou retard est dû à un événement de Force Majeure. Un "Événement de Force Majeure" désigne tout événement hors du contrôle raisonnable d’une partie, incluant mais sans s’y limiter catastrophes naturelles (telles que tremblements de terre, inondations ou ouragans), guerre, terrorisme, troubles civils, pandémies, actions gouvernementales ou tout autre événement imprévisible ou inévitable.
