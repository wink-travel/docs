...
5. **URI de redirection** Au moins une URI de redirection est requise. Elle sert à valider le domaine de redirection après une authentification réussie. *ex. https://www.cool-site.com*
6. **URI de redirection après déconnexion** *(Optionnel)* URL vers lesquelles les utilisateurs peuvent être redirigés après la déconnexion. Cela garantit que les utilisateurs arrivent sur une page connue après la fin de leur session.
