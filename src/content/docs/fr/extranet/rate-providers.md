...
Pour définir votre fournisseur de tarifs, cliquez sur `Distribution > Channel manager` dans la barre de navigation principale.

Sélectionnez votre fournisseur de tarifs dans la liste déroulante et cliquez sur le bouton `Enregistrer`. Cela permettra au fournisseur de tarifs de nous envoyer les tarifs et nous les informerons lorsqu'une réservation aura été effectuée sur Wink pour l'une de vos propriétés.
...
Voici une liste des fournisseurs que nous supportons :
...
*Si le fournisseur a un proxy, cela signifie que nous recevons indirectement les tarifs du fournisseur via le proxy.*

| Fournisseur | Type | Proxy | Depuis | Dernière modification | Commentaire
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Maintenant d-edge |
