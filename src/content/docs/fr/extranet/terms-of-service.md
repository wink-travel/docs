...
En s’inscrivant et en adhérant au programme Wink en tant que fournisseur d’hébergement, le fournisseur d’hébergement déclare avoir pris connaissance, compris, reconnu et accepté les termes et conditions du présent contrat de fournisseur d’hébergement (le « Contrat »).
...
Wink et le Fournisseur d’Hébergement sont chacun une « Partie » au présent Contrat et sont collectivement désignés comme les « Parties ».
...
En plus des termes définis ailleurs dans ce Contrat, les définitions suivantes s’appliquent tout au long du présent Contrat, sauf indication contraire :
...
**« Commission »** désigne le montant dû à un Affilié pour chaque Transaction Matérialisée conformément au présent Contrat.

**« Équipements & Services »** désigne tous les équipements, repas, commodités et/ou autres services fournis par un Hôtel Participant.

**« Client(s) »** désigne l’utilisateur final qui a utilisé, utilise ou est réservé pour utiliser la Chambre (et autres Équipements et Services le cas échéant) suite à une réservation directe ou indirecte via Wink.

**« Hôtel(s) »** désigne tout hébergement disponible sur ou via les sites Wink.

**« Plateforme Wink »** désigne le réseau privé ou la solution technique utilisée par les Parties pour partager des informations en toute sécurité conformément au Contrat.

**« Propriété Intellectuelle »** désigne tous les droits de propriété intellectuelle de toute nature (qu’ils soient ou non enregistrés, enregistrables ou autres), y compris brevets, modèles d’utilité, marques, dessins enregistrés, noms de domaine, applications, noms commerciaux, goodwill, droits d’auteur, droits sur bases de données, droits moraux, savoir-faire, et tout autre droit de propriété intellectuelle liés aux logiciels, sites web, documents, informations, techniques, méthodes commerciales, dessins, logos, manuels, listes et procédures, méthodes marketing et littérature publicitaire, y compris le « look and feel » de tout site web.
...
**« Tarif Net »** désigne le tarif particulier que Wink doit payer à chaque Hôtel Participant pour les Chambres, convenu par écrit entre les Parties.
...
**« Conditions de Paiement »** désigne les tarifs, disponibilités, offres, promotions, conditions de paiement et toute autre règle ou condition relative à la distribution des Chambres convenues entre les Parties.
...
**« Tarif(s) »** désigne le(s) tarif(s) de chambre d’hôtel mis à disposition de Wink par le Fournisseur d’Hébergement pour tout type de chambre ou type de tarif applicable dans le cadre du Contrat à distribuer sur tous les Canaux Wink.

**« Chambre(s) »** désigne l’hébergement situé dans tout Hôtel Participant ou logement.

**« Taxes »** désigne toutes taxes locales, étatiques, fédérales et nationales et/ou frais de service, y compris, sans limitation, la TVA, taxes de vente, d’utilisation, d’accise, de séjour, de transit, de location, municipales, de station, et autres taxes similaires, frais ou charges gouvernementales.
...
1.1.1 Le présent Contrat n’a pas pour objet, ni ne doit être interprété comme créant une coentreprise ou une relation de partenaires, de société en participation, ou de mandant et mandataire entre les Parties. Sauf accord écrit contraire, aucune Partie ne doit (i) conclure un contrat ou engagement avec des tiers en tant qu’agent de l’autre Partie, (ii) se présenter comme tel agent, ou (iii) agir ou représenter l’autre Partie de quelque manière que ce soit.

1.1.2 Sauf accord écrit contraire de Wink ou disposition contraire dans ce Contrat, le Fournisseur d’Hébergement ne doit pas publier sur ses sites web une déclaration, expresse ou implicite, indiquant que le site fait partie de Wink, est approuvé par Wink ou est un site officiel de Wink.
...
5.2 Les Fournisseurs d’Hébergement sont responsables de la gestion et de l’utilisation des données personnelles des clients et autres conformément aux lois sur la protection de la vie privée applicables et aux présentes Conditions.
...
9.2 En cas d’erreur du Fournisseur d’Hébergement ayant entraîné la mise en ligne d’un Tarif incorrect, et qu’une Réservation est effectuée à ce Tarif erroné, la réservation doit être honorée au Tarif erroné.
...
10.1 Le Fournisseur d’Hébergement doit s’assurer que les coordonnées complètes et correctes des clients Wink sont correctement enregistrées dans ses systèmes afin que chaque Réservation soit clairement identifiable comme une Réservation faite conformément au présent Contrat.
...
13.2 Durée. Sauf accord contraire, ce Contrat débute à la date des présentes pour une durée indéterminée.

13.3 Ce Contrat est en vigueur jusqu’à résiliation par les Parties comme suit :

* Par Wink, à tout moment et sans motif, avec un préavis écrit de trente (30) jours calendaires ;  
* Par le Fournisseur d’Hébergement, sans motif, à tout moment, sans préavis, en désactivant l’établissement sur le tableau de bord extranet Wink.  
* Par tout autre moyen expressément prévu dans ce Contrat.

13.4 Wink se réserve le droit de résilier immédiatement ce Contrat par écrit si :
...
* Un créancier exerce ou tente d’exercer une hypothèque sur l’Hôtel Participant ;  
...
* Honorer toutes les Réservations faites avant la date d’effet, aux tarifs initialement réservés, y compris celles avec date d’arrivée postérieure à la résiliation, ou fournir des services alternatifs adaptés ;  
...
14.1 La fourniture de toutes les Chambres et Équipements & Services conformément aux bonnes pratiques du secteur, avec compétence, soin et diligence ;

14.2 Que tout le personnel de l’Hôtel Participant est qualifié et formé pour remplir ses obligations ;

14.3 Le respect de toutes les lois, normes et exigences des autorités compétentes concernant les Chambres, services, équipements et obligations ;

14.4 Que chaque Hôtel Participant a lu et accepté les termes du Contrat ;

14.5 Que toutes les Chambres et Équipements & Services sont sûrs et conformes aux lois locales, étatiques, fédérales et nationales. Le Fournisseur d’Hébergement garantit qu’aucune Chambre ni partie de l’Hôtel Participant ne dispose de chauffe-eau à gaz individuels ;
...
14.8 De réaliser à ses frais tous travaux nécessaires pour éliminer toute déficience ou défaut signalé par les autorités immédiatement, en informant Wink sans délai et en tenant compte des recommandations raisonnables de Wink.

**15. Incidents et réclamations clients**

15.1 En cas d’incident affectant un Client, le Fournisseur d’Hébergement doit en informer Wink dès que possible et coopérer pleinement pour la gestion appropriée.

15.2 Le Fournisseur d’Hébergement s’engage à coopérer avec Wink pour traiter toutes réclamations ou plaintes clients et à répondre dans un délai de sept (7) jours calendaires ou selon l’accord de niveau de service.

15.3 Si Wink doit indemniser un Client suite à un incident lié à un acte ou omission du Fournisseur d’Hébergement, ce dernier s’engage à rembourser Wink rapidement, conformément à la Section 33 (« Indemnisation »).

15.4 Le Fournisseur d’Hébergement autorise Wink à déduire tous coûts, dépenses et compensations liés aux incidents et plaintes clients de son solde.

**16. Droits d’audit**

16.1 Pendant la durée du Contrat, Wink peut auditer les registres pertinents du Fournisseur d’Hébergement et/ou des Hôtels Participants pour vérifier (i) l’exécution des Réservations ; (ii) tous paiements reçus par Wink et/ou Clients ; (iii) tous paiements versés ou à verser par Wink et/ou Clients.

16.2 Chaque Partie supporte ses propres frais d’audit, sauf si l’audit révèle un manquement du Fournisseur d’Hébergement à ses obligations, auquel cas il en supportera l’intégralité et prendra les mesures nécessaires pour se conformer.

**17. Assurance**

Le Fournisseur d’Hébergement doit maintenir une assurance adéquate auprès d’assureurs réputés et agréés, couvrant tous risques tiers liés à la fourniture d’hébergement (ou services/équipements) et/ou au présent Contrat, y compris la responsabilité de Wink pour (i) perte ou dommage matériel ; (ii) blessures ou décès ; (iii) perte ou dommage de biens tiers ; (iv) responsabilité envers des tiers.
...
Il déclare et garantit qu’il respecte toutes les normes commerciales internationales, restrictions commerciales, flux de fonds, financement du terrorisme, législations anti-corruption, notamment la UK Bribery Act 2010 et la Singapore Prevention of Corruption Act.

Le Fournisseur d’Hébergement garantit qu’à sa connaissance, ni lui ni ses parties associées n’ont été condamnés pour corruption ou font l’objet d’enquête par des autorités gouvernementales ou réglementaires.

**19. Confidentialité**

19.1 Informations confidentielles. Les Parties reconnaissent que dans l’exécution du Contrat, elles peuvent avoir accès à des informations confidentielles de l’autre Partie (« Informations Confidentielles »), incluant données clients, volume de transactions, plans marketing, informations financières, techniques, opérationnelles, statistiques d’usage, données tarifaires, politiques de prix, données personnelles des Clients, logiciels, termes du Contrat, et autres informations non publiques désignées comme confidentielles.

19.2 Protection des Informations Confidentielles. Chaque Partie s’engage à : (a) considérer les Informations Confidentielles comme propriété exclusive de la Partie divulgatrice et ne les utiliser que pour l’exécution du Contrat ; (b) maintenir la confidentialité par des méthodes prudentes ; (c) ne divulguer qu’aux personnes autorisées ayant besoin de connaître ; (d) ne pas copier, publier, transmettre ou rendre accessibles à des tiers ; (e) retourner ou détruire les copies sur demande écrite. En cas de traitement de données personnelles, un accord de traitement des données (DPA) sera conclu.

19.3 Divulgation permise. Les Informations Confidentielles n’incluent pas celles qui (i) deviennent publiques sans faute de la Partie réceptrice, (ii) étaient en possession avant le Contrat, (iii) sont divulguées par un tiers sans obligation de confidentialité, (iv) doivent être divulguées par loi ou autorité. Wink peut divulguer ce Contrat en toute confidentialité à ses sociétés fournisseurs.

19.4 Données clients. Les Parties s’efforceront de protéger la confidentialité et la vie privée des données clients, en conformité avec les lois applicables, en utilisant des mesures de sécurité appropriées, incluant chiffrement. Le Fournisseur d’Hébergement doit notifier Wink de toute violation de sécurité dans un délai d’un jour. Chaque Partie doit avoir une politique de confidentialité accessible aux clients. Les droits d’accès, rectification, effacement, opposition, portabilité et restriction peuvent être exercés par demande écrite.
...
20.1 Le Fournisseur d’Hébergement reconnaît que Wink et/ou ses concédants conservent la propriété de tous droits de propriété intellectuelle liés à Wink, y compris logo, contenu et données Wink. Rien dans ce Contrat ne transfère ces droits au Fournisseur d’Hébergement.

20.2 Le Fournisseur d’Hébergement ne doit pas divulguer, intégrer, utiliser ou rendre disponible le contenu et les données Wink avec son propre contenu ou celui d’un concurrent Wink, ni pour son propre bénéfice (sauf pour permettre le service), ni pour un concurrent, ni à d’autres fins, sauf disposition expresse. Le contenu ne doit pas inclure de lien ou référence à un concurrent Wink.

20.3 Le Fournisseur d’Hébergement ne doit pas enregistrer ou utiliser de noms de domaine incorporant « Wink » ou variantes similaires.

20.4 En concluant ce Contrat, Wink ne renonce pas à ses droits relatifs à la propriété intellectuelle vis-à-vis du Fournisseur d’Hébergement ou tiers.

**21. Changement de propriété**

21.1 Le Fournisseur d’Hébergement (et chaque Hôtel Participant) ne doit pas vendre, louer ou céder son intérêt dans un établissement sans préavis écrit de trois (3) mois. En cas de cession, le contrat doit prévoir que ce Contrat (y compris les Réservations) sera transféré ou novation au nouvel entité, sous réserve des dispositions.

21.2 Si Wink ne souhaite pas poursuivre avec la nouvelle entité, les Parties peuvent convenir de résilier immédiatement ce Contrat sans préjudice des Réservations existantes ou droits acquis.

**22. Contenu de l’annonce**

22.1 Wink fournira l’accès à l’extranet. Le Fournisseur d’Hébergement s’engage à télécharger toutes les informations et contenus relatifs au produit (photos, images, textes, vidéos, descriptions, équipements) pour assurer une distribution optimale et à maintenir ces contenus à jour. En cas de non-fourniture, Wink est autorisé à les télécharger depuis le site du Fournisseur, qui assume toute responsabilité. Le Fournisseur autorise Wink à modifier la taille et résolution pour marketing.
...
22.4 Le Fournisseur indemnisera Wink, ses fournisseurs et partenaires contre toute réclamation liée aux droits de propriété intellectuelle.

22.5 Le Fournisseur doit fournir des mises à jour sur l’état des réclamations IPR et, en cas de non-conformité ou insatisfaction, Wink pourra prendre le contrôle de la réclamation aux frais du Fournisseur, avec compensation sur les montants dus.

**23. Publicité / Communications externes**

23.1 Le Fournisseur ne doit pas publier de communication relative à Wink ou ce Contrat sans consentement écrit préalable, sous peine de responsabilité directe envers Wink.

23.2 Le Fournisseur doit consulter Wink sur le contenu de toute communication envisagée et fournir une copie de toute communication publiée.

**24. Primauté**

24.1 Ce Contrat permet la conclusion d’accords commerciaux individuels entre Wink et chaque Fournisseur. En cas de conflit, les termes du présent Contrat s’appliquent sous réserve de ce qui suit :

24.2 Pour les Conditions de Paiement concernant annulations, non-présentations, politiques de paiement, libérations et disponibilité des chambres (type standard), les termes du présent Contrat prévalent ;
...
25.1 Le Fournisseur garantit que lui-même, la personne signant ce Contrat et toute autre personne fournissant des informations (y compris Conditions de Paiement) à Wink ont l’autorité de signer ce Contrat pour chaque Hôtel Participant et de les engager. Il s’engage à respecter et faire respecter les obligations du Contrat.

25.2 Le Fournisseur accepte explicitement que l’acceptation électronique du Contrat et de ses Conditions, y compris modifications, soit valide, contraignante et exécutoire.

**26. Langue**

La version anglaise du Contrat prévaut en cas de divergence avec toute traduction.

**27. Renonciations**

Aucune renonciation à une violation ou condition ne sera considérée comme une renonciation à d’autres violations ou conditions, similaires ou différentes.

**28. Divisibilité**

Si une disposition est jugée illégale, invalide ou inapplicable, elle sera modifiée ou supprimée pour rendre le Contrat valide, les autres dispositions restant en vigueur.

**29. Relation entre les Parties**

Les Parties sont des contractants indépendants. Aucune Partie ne peut agir comme agent ou partenaire de l’autre ni engager l’autre.
...
30.2 Ce Contrat bénéficie aux Parties et leurs successeurs, sans conférer de droits à des tiers sauf disposition expresse.

**31. Force Majeure**

Wink n’est pas responsable des retards ou manquements dus à des causes hors de son contrôle raisonnable, incluant catastrophes naturelles, guerre, terrorisme, grèves, pandémies, pénuries, etc.

**32. Limitation de responsabilité**

32.1 Dans la limite permise par la loi, aucune Partie ne sera responsable des dommages indirects, accessoires, consécutifs, spéciaux ou punitifs, sauf en cas de violation des droits de confidentialité ou propriété intellectuelle.

32.2 Aucune exclusion de responsabilité pour décès ou blessure causés par négligence, fraude ou autres obligations non limitables par la loi.

32.3 Les Parties reconnaissent que ces limitations sont justes et raisonnables.

**33. Indemnisation**

Dans la limite permise par la loi, vous acceptez de dégager, défendre (au choix de Wink), indemniser Wink, ses fournisseurs, filiales, dirigeants, employés et agents contre toute réclamation, responsabilité, dommage, perte et dépense liés à (i) votre violation des Conditions ; (ii) votre mauvaise utilisation des Services ; (iii) votre manquement à déclarer, collecter ou reverser les taxes ; (iv) votre violation de lois ou droits tiers.

**34. Droit applicable et juridiction**

34.1 Ce Contrat est régi exclusivement par le droit de Singapour. La loi sur les contrats (droits des tiers) 2001 (Cap 53B) ne s’applique pas. Les Parties tenteront de régler amiablement tout litige.

34.2 Tout litige sera soumis exclusivement aux tribunaux compétents de Singapour, sans application des règles de conflit de lois.

**35. Exemplaires**

Ce Contrat peut être signé en plusieurs exemplaires, chacun étant un original. Une copie scannée ou électronique de la signature de Wink a la même valeur qu’une signature manuscrite originale.

**36. Intégralité de l’accord**

36.1 Ce Contrat (y compris formulaire d’inscription, annexes) constitue l’intégralité de l’accord entre les Parties et remplace tout accord antérieur.
...
Le Contrat prend effet après confirmation écrite d’acceptation par Wink. En s’inscrivant au programme partenaire Wink, le Fournisseur accepte les termes, y compris modifications.

Le Contrat a été lu et accepté par le fournisseur. L’acceptation électronique est valide, contraignante et exécutoire.

**38. Notifications**

Toutes notifications doivent être en anglais, écrites, remises en main propre, par courrier recommandé prépayé, ou par coursier international reconnu (ex. FedEx, UPS, DHL) à l’adresse du siège ou par e-mail à la personne de contact.
