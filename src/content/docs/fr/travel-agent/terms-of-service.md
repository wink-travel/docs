...
description: Cet article contient nos conditions d'utilisation pour les agents de voyage sur la plateforme Wink.
sidebar:
  order: 4
---
...
:::caution[Avis]
Les conditions d'utilisation ci-dessous s'appliquent aux agents de voyage qui souhaitent acquérir et distribuer des fonds de manière autonome.  
...
Tous les agents de voyage peuvent toujours réserver via notre portail agent de voyage en utilisant la passerelle de paiement de Wink avec leur propre carte de crédit ou celle du voyageur. Par conséquent, tous les agents de voyage doivent également accepter les conditions d'utilisation où la passerelle de paiement de Wink est le commerçant enregistré.
...
1. En plus des termes définis ailleurs dans le présent Accord, les définitions suivantes s’appliquent tout au long du présent Accord sauf indication contraire :
...
* **"Facilitateur de Paiement"** est une filiale à 100 % de Winkfluence qui gère les Services de Paiement, collectant les paiements des clients en débitant le moyen de paiement associé à leur achat, tel que carte de crédit, carte de débit, virement bancaire, cryptomonnaies, ou PayPal, etc.  
