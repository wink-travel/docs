...
:::note
L'environnement staging est disponible sur demande. Cela signifie qu'il se mettra en veille s'il n'y a pas d'utilisation et se rallumera lorsqu'il y en aura. Merci de faire preuve de patience si vous le réveillez. Il faut environ une minute pour démarrer tous les serveurs après votre première connexion à l'un de nos serveurs ou applications.
:::
