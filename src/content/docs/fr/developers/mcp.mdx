...
### Claude Code
Documentation officielle : [Connecter Claude Code aux outils via MCP](https://code.claude.com/docs/en/mcp)
...
### Codex
Documentation officielle : [Démarrage rapide Docs MCP pour Codex](https://developers.openai.com/resources/docs-mcp)
...
### Cursor
Documentation MCP Cursor : https://cursor.com/docs/context/mcp
...
### VS Code
Documentation officielle : https://code.visualstudio.com/docs/copilot/customization/mcp-servers
...
| `docs_search` | Trouver des documents conceptuels / guides | `authentication`, `webhooks`, `wordPress` |
...
- L’arborescence `wink://api` est dynamique et suit le catalogue OpenAPI en amont actuel au lieu d’un index généré du dépôt.
