...
<Steps>
  1. Utilisez le [API de recherche](https://developer.wink.travel/lookup) pour récupérer des destinations ou des hôtels.
...
<Steps>
  ...
  2. Cliquez sur `Download OpenAPI spec` du haut de la [API de recherche](https://developer.wink.travel/lookup) page.
