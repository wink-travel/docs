...
Wink prend en charge **plus de 64 types d’événements webhook** dans des catégories telles que la gestion de compte, les contrats de réservation, les paiements, les mises à jour des gestionnaires de canaux, et l’administration des entités. Les événements courants incluent :
...
| **Gestionnaire de canal** | `channel-manager.update.rate`, `channel-manager.update.availability` |
