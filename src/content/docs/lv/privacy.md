...
(3) Automātiski, izmantojot sistēmu, kad jūs piekļūstat Uzņēmuma vietnei un/vai izmantojat pakalpojumus.
...
(1) Jūsu pilns vārds, tostarp saistītā informācija vai jūsu pārstāvja informācija (ja jūs sazināties ar mums juridiskas personas vārdā), kas var ietvert jūsu identitātes dokumentu;
...
(4) Saziņas gadījumā caur vietni var ietvert jūsu tehnisko informāciju, piemēram, IP adresi, sīkdatnes, tostarp informāciju par jūsu pārlūkošanas uzvedību.
...
(2) Lai izpildītu juridiskās saistības, kurām Uzņēmums var būt pakļauts noteiktos apstākļos. Tas var ietvert, bet neaprobežojas ar, pienākumu izpildi, kas saistīti ar grāmatvedības dokumentu un nodokļu sagatavošanu saistībā ar jebkādiem Uzņēmuma sniegtajiem pakalpojumiem jums;

(3) Lai veidotu un uzlabotu biznesa attiecības, tostarp uzlabotu pakalpojumu, ko Uzņēmums sniedz jūsu labā, un Uzņēmums var vākt un/vai izmantot jūsu personas datus kontroles, pakalpojuma nodrošināšanas, pārvaldības analīzes un biznesa jautājumu risināšanas nolūkos, tostarp, bet ne tikai, darbinieku apmācībai un nākotnes pakalpojumu uzlabošanas plānošanai;

(4) Lai aizsargātu un aizstāvētu Uzņēmuma likumīgās tiesības gadījumā, ja jums un Uzņēmumam rodas strīds; un

(5) Pamatojoties uz skaidru piekrišanu, kas piešķirta Uzņēmumam, piemēram, mārketinga un informatīvo izdevumu saziņai, Uzņēmums var apstrādāt personas datus mērķos, kas definēti piekrišanā.
...
(1) Personas datu apstrādei pakalpojumu sniegšanas, līguma izpildes un/vai tiesību un pienākumu izpildes nolūkā, Uzņēmumam ir nepieciešams apstrādāt jūsu personas datus tik ilgi, kamēr Uzņēmumam ir pienākums sniegt jums pakalpojumus;

(2) Personas datu apstrādei likumdošanas prasību izpildes nolūkā, Uzņēmumam ir nepieciešams apstrādāt jūsu personas datus likumā noteiktajā termiņā;

(3) Personas datu apstrādei biznesa attiecību veidošanas un uzlabošanas un/vai pakalpojuma uzlabošanas nolūkā, Uzņēmums patur tiesības glabāt šos personas datus tik ilgi, cik tas ir nepieciešams biznesa vajadzībām. Uzņēmums garantē, ka personas datu glabāšana nepārkāps datu subjekta tiesības nepamatoti;

(4) Personas datu apstrādei Uzņēmuma likumīgo tiesību aizsardzības nolūkā, Uzņēmumam ir nepieciešams glabāt šos personas datus likumā noteiktajā termiņā; un

(5) Gadījumā, ja jūs piešķirat piekrišanu Uzņēmumam apstrādāt jūsu personas datus konkrētiem mērķiem, Uzņēmums apstrādās jūsu personas datus līdz brīdim, kad jūs atsauksiet šo piekrišanu.
...
(1) Uzņēmuma ārējiem pakalpojumu sniedzējiem, kas iesaistīti atbalsta pakalpojumu sniegšanā Uzņēmumam, lai nodrošinātu pakalpojumus jums, tostarp Uzņēmuma konsultantiem. Šāda personas datu atklāšana šīm trešajām pusēm notiks saskaņā ar mērķiem un tikai nepieciešamības gadījumā; vai
