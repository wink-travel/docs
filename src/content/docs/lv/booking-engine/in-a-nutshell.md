...
* Rezervējamā inventāra apkalpošana vēlamajā formātā, valodā un valūtā, piemēram:
  ...
  * A [karte](/studio/maps) uz jūsu [karte](/studio/maps) konts.
...
Integratoriem, kuri vēlas vēl lielāku brīvību, ir piekļuve visām tām pašām funkcijām, izmantojot mūsu [WordPress spraudnis](/developers/wordpress/), [WordPress spraudnis](/developers/wordpress/) un[API](/developers/apis).
