...
description: Šajā rakstā ir mūsu pakalpojumu noteikumi ceļojumu aģentiem Wink platformā.
sidebar:
  order: 4
---
...
:::caution[Paziņojums]
Zemāk minētie pakalpojumu noteikumi attiecas uz ceļojumu aģentiem, kas vēlas pašiem iegūt un izdalīt līdzekļus.  
To var veikt tikai caur mūsu API un tikai tie ceļojumu aģenti, kas reģistrācijas procesā ir norādījuši, ka vēlas to darīt.

Visi ceļojumu aģenti joprojām var veikt rezervācijas caur mūsu ceļojumu aģentu portālu, izmantojot Wink maksājumu vārteju ar savu vai ceļotāja kredītkarti. Tāpēc visiem ceļojumu aģentiem arī jāpiekrīt pakalpojumu noteikumiem, kuros Wink maksājumu vārteja ir reģistrētais tirgotājs.

Šie noteikumi ir pieejami sadaļā [Affiliate Portal > Terms of Service](/lv/studio/terms-of-service).
:::
...
2. **CEĻOJUMU AĢENTS**, kura dati ir norādīti Ceļojumu aģenta reģistrācijas veidlapā vai ir iesniegti tiešsaistē (turpmāk tekstā "Ceļojumu aģents").
...
1. Papildus citur šajā līgumā definētajiem terminiem, šādas definīcijas attiecas uz visu līgumu, ja nav norādīts citādi:
...
* **"Maksājumu facilitātors"** ir Winkfluence pilnībā piederoša meitasuzņēmums, kas pārvalda maksājumu pakalpojumus, iekasējot maksājumus no viesiem, iekasējot maksājuma veidu, kas saistīts ar viņu pirkumu, piemēram, kredītkarti, debetkarti, bankas pārskaitījumu, kriptovalūtas vai PayPal utt.  
