...
Lietošanas ērtībai integratoriem iesakām izmantot galapunktus, ko mēs apzīmējam kā`OAuth2`Šie galapunkti zina, ka jāgaida API izsaucēji, un jau zina, kurā kontā jūs atrodaties, tāpēc jums tas nav jānorāda.`companyIdentifier`jūsu URL vietrāžos.
:::
