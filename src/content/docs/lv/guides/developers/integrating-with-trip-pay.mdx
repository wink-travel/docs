...
- [Maksājuma tīmekļa komponents](/lv/integrations/web-components/#payment).
- [Maksājuma API](/lv/api). *Izlasiet sadaļu par `Maksājamo līgumu izveidi`*

Šeit ir soļi, kā veiksmīgi izmantot TripPay, lai samaksātu par rezervāciju:

<Steps>
1. Pārliecinieties, ka rezervācijas līgumā minētie labuma guvēji ir kartēti.
2. Ļaujiet ceļotājam izvēlēties inventāru, ko viņš vēlas rezervēt, un sagatavoties maksājumam.
3. Izveidojiet ar TripPay `maksājamu līgumu`, kas satur rezervējamās preces.
...
## Maksājama līguma izveide

:::note
Dodieties uz Maksājuma API, lai uzzinātu vairāk par prasībām maksājama līguma izveidei.
:::

### Pieprasījums
Šeit ir JSON parauga pieprasījums, kas ietver visu nepieciešamo jūsu pirmajam maksāmajam līgumam.
...
- Katrs ieraksts `contractItemList` satur:
    ...
    - **Maksājams** Kad ceļotājam jāveic maksājums. *Pašlaik atbalstām tikai tūlītējā maksājuma iespējas.*
    - **Politika** Iekļaujiet atcelšanas politikas noteikumus.
    - **Dienas likmju saraksts** Ja rezervējamā prece ir numurs, varat norādīt, cik maksā katra nakts, ko viesis uzturas.
    - **Labuma guvēji** Norādiet, kuriem TripPay kontiem jāpiešķir kāda daļa no preces cenas. *Atbalstītas fiksētas un procentuālās summas.*

:::note
Iepriekšējā JSON piemērā ir 3 labuma guvēji:
...
- 88,65% tika piešķirti piegādātājam par numura rezervāciju. *piemēram, Hilton*

Kad TripPay atbild ar maksājamu līgumu, jūs pamanīsiet, ka tas ir pievienojis savu labuma guvēju ar 4,0%.
:::
...
Šobrīd esat gatavs iegult `Maksājuma tīmekļa komponentu` savā vietnē un parādīt to lietotājam.
