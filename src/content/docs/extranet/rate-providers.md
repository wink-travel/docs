...
To set your rate provider, click on `Distribution > Channel manager` from the main nav bar.
...
*If the vendor has a proxy, it means we indirectly receives rate from the vendor through the proxy.*
