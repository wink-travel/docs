...
:::note
Our list of cities come directly from [geonames.org](https://geonames.org). If your city or island does not show up in the city dropdown, please let us know at [support@wink.travel](mailto:support@wink.travel).
:::
...
<Steps>
1. Click on `Account > Managers` in the top navigation bar.
...
Developers who want manage `Property information` can head over to [API > Property](https://docs.wink.travel/extranet/property).