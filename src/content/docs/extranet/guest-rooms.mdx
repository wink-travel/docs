...
:::note
Creating your first guest room is covered during the onboarding wizard.
:::

To manage your Guest Rooms, click on `Facilities > Guest Rooms` from the top navigation bar.
...
- ***Room type name*** The name of the room, as you refer to it internally.
...
Not all inventory is located on the premises. If you have inventory that is located off the premises of your property, let the traveler know here and you will be given the chance to set a separate map location along with optional contact information if a separate person or group manages this entity.
