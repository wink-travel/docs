...
To manage your Rate Plans, click on `Monetize > Rate Plans` from the top navigation bar.
...
By enabling this restiction, guests MUST depart on that day in order to see this rate.
...
Developers who want to manage `Rate Plans` can head over to [Developers > APIs > Monetize](/developer/apis/#monetize-api).