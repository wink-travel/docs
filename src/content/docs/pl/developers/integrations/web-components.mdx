...
Przykłady znajdziesz dla [kart](/pl/studio/cards), [siatek](/pl/studio/grids) i [map](/pl/studio/maps).
...
To dotyczy tylko programistów webowych. Jeśli przypadkowo usunąłeś [Aplikację](/pl/my-account/applications), przez co client ID nie jest już dostępny, utwórz nową aplikację i użyj nowego client ID do osadzenia naszych Komponentów Webowych.
