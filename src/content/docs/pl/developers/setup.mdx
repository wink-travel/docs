...
<Steps>
1. [Zarejestruj się](/pl/user/register) jako użytkownik na Wink
2. Utwórz [konto agenta turystycznego](/pl/travel-agent/what-is-agent) lub [konto afilianta](/pl/studio/what-is-studio).
3. [Utwórz aplikację](/pl/developer/applications), przypisując ją do konta utworzonego w kroku 2.
...
Przejdź do sekcji naszych [API](/pl/developer/apis) i wybierz API, z którym chcesz pracować.
