...
<Steps>
  1. Użyj [API wyszukiwania](https://developer.wink.travel/lookup) aby pobrać miejsca docelowe lub hotele.
...
<Steps>
  ...
  2. Kliknij na `Download OpenAPI spec` ze szczytu [API wyszukiwania](https://developer.wink.travel/lookup) strona.
