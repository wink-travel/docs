...
2. Przejdź do `Applications`, a następnie `Webhooks`. Zobacz [Webhooks](/pl/portal/settings/webhooks).
...
- [Webhooks](/pl/portal/settings/webhooks) — Pełna dokumentacja zarządzania webhookami.
