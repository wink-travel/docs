...
description: Dokument obejmuje dostępność środków oraz sposób, w jaki Wink wspiera model agenta dla agentów turystycznych.
sidebar:
  order: 5
---
...
Te warunki są dostępne w [Affiliate Portal > Payment Terms](/pl/portal/studio/payment-terms).
:::

**WARUNKI PŁATNOŚCI WINK**  
**DLA AGENTÓW TURYSTYCZNYCH (Sprzedawca zarejestrowany)**

Niniejsze Warunki Świadczenia Usług Płatniczych („Warunki Płatności”) stanowią wiążącą umowę prawną, która jest częścią relacji umownej ustanowionej na podstawie "WARUNKÓW I ZASAD DLA AGENTÓW TURYSTYCZNYCH" („Umowa Główna”).
...
* Prowizja Agenta Turystycznego określona w Umowie Oddzielnej (w tym przykładzie przyjmujemy 10%)

Wartość Rezerwacji USD 1,000  
Opłata Wink (1,5%) = USD 15  
Suma częściowa = 1,000 - 15 = 985

2.3 **Płatność Netto dla Dostawców Zakwaterowania:** Agent Turystyczny jest odpowiedzialny za przekazanie Płatności Netto Dostawcy Zakwaterowania zgodnie z warunkami Umowy Oddzielnej między Agentem Turystycznym a Dostawcą Zakwaterowania. Wink nie ponosi odpowiedzialności za dokonywanie jakichkolwiek płatności na rzecz Dostawcy Zakwaterania.
...
* Zapewnienie terminowego pobierania płatności od Gości, zgodnie z warunkami określonymi w punkcie 2.1.  
* Potrącenie odpowiedniej Opłaty za Rezerwację i Prowizji przed przekazaniem Płatności Netto Dostawcom Zakwaterowania zgodnie z Umową Oddzielną.  
* Terminowe regulowanie faktur Wink za Opłaty za Rezerwacje zgodnie z warunkami określonymi w punkcie 3.1.  
* Aktywne zarządzanie i rozwiązywanie wszelkich sporów związanych z rezerwacjami lub płatnościami, zapewniając komunikację z Wink w celu efektywnego rozwiązania problemów.

4.2 **Obowiązki Wink:**

* Wystawianie dokładnych i terminowych faktur miesięcznych za Opłaty za Rezerwacje, zgodnie z punktem 3.1.  
* Zapewnienie Agentowi Turystycznemu ciągłego dostępu do platformy Wink do przetwarzania rezerwacji i zarządzania płatnościami.  
* Wspieranie Agenta Turystycznego w rozwiązywaniu sporów dotyczących płatności poprzez udostępnianie niezbędnych danych transakcyjnych i wsparcia w razie potrzeby.
...
Wszelkie spory wynikające z lub związane z niniejszymi Warunkami Płatności będą rozstrzygane zgodnie z procedurami rozstrzygania sporów określonymi w Umowie Głównej, zapewniając spójne i jednolite podejście do rozwiązywania konfliktów między Wink a Agentem Turystycznym.

**7\. Zmiana Warunków**  
Wink zastrzega sobie prawo do zmiany niniejszych Warunków Płatności w dowolnym czasie. Wszelkie zmiany zostaną przekazane Agentowi Turystycznemu co najmniej 30 dni przed ich wejściem w życie. Kontynuowanie korzystania z platformy Wink po dacie wejścia zmian w życie oznacza akceptację zmodyfikowanych warunków.
