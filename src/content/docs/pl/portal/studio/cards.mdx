...
Powyższy obraz pochodzi z [Search](/pl/portal/studio/search) i pokazuje niektóre z rzeczy, które możesz zrobić z wynikami wyszukiwania. Jedną z tych akcji jest `Make a card`.
...
<Steps>
 ...
 2. Wybierz [Customization](/pl/portal/settings/branding), którą chcesz zastosować do tej karty.
...
Deweloperzy, którzy chcą zarządzać kartami, mogą przejść do [Developers > API > Inventory](/pl/api).
