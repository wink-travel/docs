...
Dzięki tej świetnej technologii możesz łatwo osadzić ofertę Wink z minimalnym wysiłkiem. Ten artykuł przeprowadzi Cię przez naszą kolekcję komponentów webowych i pokaże, jak ich używać.
...
Przykłady znajdziesz dla [kart](/pl/portal/studio/cards), [siatek](/pl/portal/studio/grids) i [map](/pl/portal/studio/maps).
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Wybierak planu podróży jako modal*</figcaption>
</figure>
...
Oferta może być już niedostępna. Przejdź do [Wink Studio](/pl/portal/studio/cards) i sprawdź, czy status "karty" jest dostępny.
...
Oferta mogła zostać usunięta. Przejdź do [Wink Studio](/pl/portal/studio/cards) i sprawdź, czy status "karty" jest dostępny.
Jeśli nie, będzie oznaczona na czerwono. W takim przypadku możesz poczekać, aż dostawca ponownie ją udostępni lub usunąć ją ze swojej listy.
