...
2. **Wprowadź go w portalu Wink**
   ...
   Zaloguj się na [app.wink.travel](https://app.wink.travel), wybierz swoje konto i przejdź do zakładki **Dostosowania**. Wklej swój identyfikator kontenera GTM Sojern w pole Sojern i zapisz. Twoja integracja jest teraz aktywna.
