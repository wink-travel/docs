...
- [Payment Web Component](/pl/integrations/web-components/#payment).
- [Payment API](/pl/api). *Przeczytaj sekcję o `Create payable contracts`*
...
2. Pozwól podróżnemu wybrać inwentarz, który chce zarezerwować i przygotować się do płatności.
...
Nie będziemy wyjaśniać każdego punktu danych, ponieważ są one już omówione w dokumentacji API.
...
- Każdy wpis w `contractItemList` zawiera:
    ...
    - **Cena** Cena elementu.
    - **Plan podróży** Kiedy ten element ma być zarezerwowany.
    ...
    - **Beneficjenci** Określ, które konto(y) TripPay powinny otrzymać jaką część ceny elementu. *Obsługiwane są kwoty stałe / procentowe.*
