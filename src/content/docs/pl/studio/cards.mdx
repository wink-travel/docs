...
- **Embed** Pokazuje, jak osadzić tę kartę jako [Card](/pl/developers/integrations/web-components/#content-loader) na Twojej stronie internetowej.
- **Use with WordPress** Pokazuje, jak używać naszego [WordPress plugin](/pl/developers/integrations/wordpress) do osadzenia tej karty na Twojej stronie.
...
- Linie od 6 do 9 pokazują, jak użyć [wink-content-loader](/pl/developers/integrations/web-components/#content-loader) Web Component i polecić mu pobranie karty pokoju gościnnego dla Twojego kodu.
