...
Użytkownik może wchodzić w interakcje z kartą na następujące sposoby:
...
<Steps>
 ...
 4. Wybierz <Badge text="badge" variant="tip" size="small" /> którą chcesz użyć na karcie. Badge pozwala użytkownikom porównywać zasoby według zbiorczego wskaźnika, takiego jak `eco-friendly`.
...
- **Use with WordPress** Pokazuje, jak użyć naszego [WordPress plugin](/pl/integrations/wordpress), aby osadzić tę kartę na Twojej stronie.
