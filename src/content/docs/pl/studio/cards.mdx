...
- **Embed** Pokazuje, jak osadzić tę kartę jako [Card](/pl/integrations/web-components/#content-loader) na Twojej stronie internetowej.
- **Use with WordPress** Pokazuje, jak używać naszego [WordPress plugin](/pl/integrations/wordpress) do osadzenia tej karty na Twojej stronie.
