...
- På Partner API’et er en **hotel-dag** et hotel prissat for én overnatning — *ikke* et API-kald. Et søg, der returnerer 20 hoteller for et 3-nætters ophold, er 60 hotel-dage fra én enkelt forespørgsel. Opslags- og autocomplete-endpoints er gratis og måles aldrig.
