...
Takket være denne smarte teknologi kan du nemt integrere Wink rejseinventar. Denne artikel guider dig gennem vores samling af webkomponenter og viser dig, hvordan du bruger dem.
...
Ved at klikke på komponenten ovenfor åbnes en modal, hvor du kan skrive den destination eller det hotel, du søger efter.
...
Ved at ændre rejseplanen i en af vores rejseplankomponenter udløses en opdateringsbegivenhed til alt inventar, du aktuelt har vist på siden.
...
Inventar kan være blevet fjernet. Gå til [Wink Studio](/da/portal/studio/cards) og tjek, om status for "kortet" er tilgængeligt.
Hvis det ikke er, vises det som rødt. I så fald kan du vente, og måske gør leverandøren det tilgængeligt igen, eller du kan fjerne det fra din liste.
