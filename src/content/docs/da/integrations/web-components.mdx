...
[Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) er en standard, der lader dig integrere hele Javascript-funktioner på dit website uden at skulle kunne kode.
...
Ved at ændre rejseplanen i en hvilken som helst af vores rejseplanskomponenter udløses en opdateringsbegivenhed til det inventar, du aktuelt har vist på siden.
...
Inventar kan være udsolgt. Gå til [Studio](/da/portal/studio/cards) og tjek, om status for "kortet" er tilgængeligt.
...
Inventar kan være fjernet. Gå til [Studio](/da/portal/studio/cards) og tjek, om status for "kortet" er tilgængeligt.
Hvis det ikke er, vises det som rødt. I så fald kan du vente, og måske gør leverandøren det tilgængeligt igen, eller fjerne det fra din liste.
...
Dette er kun for webudviklere. Hvis du ved et uheld har fjernet [Applikationen](/da/account/applications), så client ID ikke længere er tilgængelig, skal du oprette en ny applikation og bruge den nye client ID til at integrere vores Webkomponenter.
