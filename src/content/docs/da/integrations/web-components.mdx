...
Inventar kan være udgået. Gå til [Wink Studio](/da/studio/cards) og tjek, om status for "kortet" er tilgængeligt.
...
Dette er kun for webudviklere. Hvis du ved et uheld har fjernet [Applikationen](/da/my-account/applications), så klient-ID’et ikke længere er tilgængeligt, skal du oprette en ny applikation og bruge det nye klient-ID til at integrere vores Webkomponenter.
