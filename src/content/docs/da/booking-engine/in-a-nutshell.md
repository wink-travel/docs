---
title: Kort fortalt
description: Denne artikel guider dig igennem alt, hvad du ønskede at vide om bookingmotoren.
sidebar:
  order: 0
---
...
- At levere bookbart lager i det ønskede format, sprog og valuta, såsom:
    ...
    - En hotel-landingsside på https://book.wink.travel med lager for det pågældende hotel.
...
Bookingmotoren er en samling af genanvendelig funktionalitet, som vi eksponerer gennem https://book.wink.travel; et højt tilpasseligt website for hoteller og affiliates til at sælge deres ydelser til rejsende.

Integratører, der ønsker endnu mere frihed, har adgang til alle de samme funktioner via vores [WordPress-plugin](/da/integrations/wordpress/), [Web Components](/da/integrations/web-components) og [API’er](/da/api).
