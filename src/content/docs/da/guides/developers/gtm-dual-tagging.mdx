...
description: Sådan forbinder du din Sojern-konto til Wink, så Sojern kan spore dine gæsters bookingrejse og styrke dine retargeting- og reklamekampagner.
sidebar:
...
<Aside type="tip">
Dette forudsætter, at du allerede har en aktiv Sojern-konto og har modtaget din GTM Container ID fra din Sojern-kontoadministrator. Hvis du endnu ikke har en Sojern-konto, kan du besøge [sojern.com/contact](https://www.sojern.com/contact) for at komme i gang.
</Aside>
...
2. **Indtast den i Wink-portalen**
   ...
   Log ind på [app.wink.travel](https://app.wink.travel), vælg din konto, og gå til fanen **Customizations**. Indsæt din Sojern GTM Container ID i Sojern-feltet og gem. Din integration er nu aktiv.
...
Denne konfiguration fungerer for enhver brugerdefineret GTM Container ID. Vi brugte blot Sojern som eksempel, da det er en meget almindelig integration.
</Aside>
