...
<Steps>
1. [Registrer](/da/account/register) din brugerkonto på Wink.
...
3. [Opret en applikation](/da/portal/settings/applications) og tilknyt den til den affiliate-konto, du oprettede i trin 2. For server-til-server API-integrationer skal du vælge **MACHINE_2_MACHINE** som klienttype.
...
Gå til vores [API'er](/da/api) sektion og vælg den API, du vil arbejde med.
