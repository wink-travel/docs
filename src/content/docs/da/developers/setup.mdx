...
<Steps>
  1. Brug [Opslags-API](https://developer.wink.travel/lookup) for at hente destinationer eller hoteller.
...
<Steps>
  ...
  2. Klik på `Download OpenAPI spec` fra toppen af [Opslags-API](https://developer.wink.travel/lookup) side.
