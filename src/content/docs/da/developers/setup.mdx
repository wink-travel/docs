...
:::note
Testning bør altid foregå i vores [staging-miljø](/getting-started/environments). Der er langt færre data der, men du er fri til at teste så meget, du vil, uden at påvirke produktionsmiljøet.
...
<Steps>
1. [Registrer](/user/register) din brugerkonto på Wink
2. Opret en [rejsebureaukonto](/travel-agent/what-is-agent) eller en [affiliate-konto](/studio/what-is-studio).
3. [Opret en applikation](/developer/applications), hvor du tilknytter den til den konto, du oprettede i trin 2.
...
Gå til vores [API'er](/developer/apis) sektion og vælg den API, du vil arbejde med.
