...
3. [Opret en applikation](/da/account/applications) og tilknyt den til den affiliate-konto, du oprettede i trin 2. For server-til-server API-integrationer skal du vælge **MACHINE_2_MACHINE** som klienttype.
