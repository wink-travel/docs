---
title: Pe scurt
description: Acest articol te ghidează prin tot ce ai vrut să știi despre motorul de rezervări.
sidebar:
  order: 0
---
...
Motorul de rezervări este în centrul platformei noastre.

Responsabilitățile sale includ:

- Gestionarea valutelor și menținerea cursurilor de schimb actualizate.
- Oferirea furnizorilor de tarife a unei modalități de a ne trimite date despre tarife.
- Gestionarea datelor de referință. *de ex. regiuni, țări, destinații, proprietăți etc.*
...
- Furnizarea inventarului rezervabil în formatul, limba și valuta dorită, cum ar fi:
    ...
    - O [hartă](/ro/studio/maps) pe contul tău de [WinkLinks](/ro/link-manager/wink-links).
...
- Oferirea călătorilor a unei modalități de a:
    ...
    - Gestiona [rezervările și recenziile](/ro/booking-engine/bookings).
    - Gestiona [lista de dorințe](/ro/booking-engine/bucket-list) cu lucruri de rezervat în viitor.
    - Gestiona [profilul de călătorie](/ro/booking-engine/travel-preferences). *de ex. alergii, contact de urgență etc.*
