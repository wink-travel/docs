...
- [Payment Web Component](/ro/integrations/web-components/#payment).
- [Payment API](/ro/api). *Citește secțiunea despre `Create payable contracts`*
...
2. Lasă călătorul să aleagă inventarul pe care dorește să-l rezerve și pregătește-l pentru plată.
...
- Inventarul pe care dorești să-l rezervi de la acel furnizor. Toate acestea sunt specificate în array-ul imbricat `contractItemList`.
- Fiecare intrare din `contractItemList` conține:
    ...
    - **Descriere în engleză** O descriere mai detaliată a inventarului în limba engleză.
    - **Preț** Prețul articolului.
    - **Itinerariu** Perioada pentru care trebuie făcută rezervarea.
    - **Tipul de tarifare** Cum a fost calculat prețul.
    ...
    - **Politică** Include regulile politicii de anulare.
    - **Lista tarifelor zilnice** Dacă articolul rezervat este o cameră, poți include cât costă acea cameră pentru fiecare noapte de cazare.
...
Când TripPay răspunde la cererea ta, va arăta ceva de genul acesta:
...
În acest moment, ești gata să încorporezi `Payment Web Component` în site-ul tău și să-l afișezi utilizatorului.
