...
description: Cum să conectați contul Sojern la Wink pentru ca Sojern să poată urmări parcursul de rezervare al oaspeților dvs. și să alimenteze campaniile dvs. de retargeting și publicitate.
sidebar:
...
2. **Introduceți-l în portalul Wink**
   ...
   Conectați-vă la [app.wink.travel](https://app.wink.travel), selectați contul dvs. și accesați fila **Customizations**. Lipiți ID-ul containerului GTM Sojern în câmpul Sojern și salvați. Integrarea dvs. este acum activă.
...
Această configurare funcționează pentru orice ID container GTM personalizat. Am folosit Sojern doar ca exemplu, deoarece este o integrare foarte comună.
</Aside>
...
| `country_code` | string | Codul țării ISO 3166-1 alfa-2 |
...
| `room_rate_id` | string | Identificatorul tarifului camerei specifice |
...
| `bed_type` | string | Configurația patului pentru cameră (ex. `King`, `Twin`) |
...
| `deviceAgent` | Stringul brut al agentului utilizator |
