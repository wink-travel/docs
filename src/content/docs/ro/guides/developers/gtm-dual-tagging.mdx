...
<Aside type="tip">
Se presupune că aveți deja un cont activ Sojern și ați primit ID-ul containerului GTM de la managerul dvs. de cont Sojern. Dacă nu aveți încă un cont Sojern, vizitați [sojern.com/contact](https://www.sojern.com/contact) pentru a începe.
</Aside>
...
2. **Introduceți-l în portalul Wink**
   ...
   Conectați-vă la [app.wink.travel](https://app.wink.travel), selectați contul dvs. și accesați fila **Customizations**. Lipiți ID-ul containerului GTM Sojern în câmpul Sojern și salvați. Integrarea este acum activă.
...
Wink împinge evenimente compatibile GA4 către `dataLayer` pe tot parcursul experienței oaspetelui. Containerul dvs. GTM citește din același `dataLayer` partajat, astfel orice declanșator sau variabilă configurată are acces la toate proprietățile descrise mai jos.
...
Aceste evenimente se declanșează automat pe măsură ce un oaspete parcurge funnel-ul de rezervare. Configurați declanșatoarele GTM ca **Custom Event** care să corespundă numelor de eveniment de mai jos.
...
GA4 permite până la 50 de dimensiuni personalizate la nivel de articol per proprietate pe proprietățile standard (proprietățile 360 permit mai multe).
</Aside>
...
| `deviceAgent` | Stringul raw al user agent-ului |
