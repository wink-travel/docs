---
title: Integrarea Analiticelor GTM
description: Cum să conectați orice container Google Tag Manager (cum ar fi un container Sojern) la Wink pentru a urmări parcursul de rezervare al oaspeților și pentru a alimenta campaniile dvs. de retargeting și publicitate.
sidebar:
  label: Integrarea Analiticelor GTM
---
...
<Aside type="tip">
Se presupune că aveți deja un ID de Container GTM (format `GTM-XXXXXXX`). Dacă containerul provine de la un partener precum Sojern, cereți managerului dvs. de cont **ID-ul Containerului GTM** — acesta este diferit de un pixel sau ID de tag. Sunteți nou la Sojern? Vizitați [sojern.com/contact](https://www.sojern.com/contact) pentru a începe.
</Aside>
...
2. **Introduceți-l în Portalul Wink**
   ...
   Conectați-vă la [app.wink.travel](https://app.wink.travel), selectați contul dvs. și deschideți setările de personalizare. În secțiunea **Analytics & integrations**, lipiți ID-ul Containerului GTM în câmpul **GTM Container ID** și salvați. Integrarea dvs. este acum activă.
...
<Aside type="note">
Nu trebuie să plasați niciun cod pixel pe propriul site pentru această integrare. Wink încarcă containerul GTM automat pe toate paginile unde proprietatea dvs. este activă.

Aceasta funcționează pentru **orice** ID de Container GTM — Sojern este doar un exemplu comun.
</Aside>
...
| `coupon` | string | — | Codul de cupon aplicat articolului |
...
| `discount` | number | — | Valoarea discountului aplicat |
