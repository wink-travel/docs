...
2. **Introduceți-l în portalul Wink**
   ...
   Conectați-vă la [my.wink.travel](https://my.wink.travel), selectați contul dvs. și accesați fila **Customizations**. Lipiți ID-ul containerului GTM Sojern în câmpul Sojern și salvați. Integrarea dvs. este acum activă.
