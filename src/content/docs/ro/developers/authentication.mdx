...
- **`mcp.*` este doar pentru clienți agenți AI.** Aveți nevoie de el pentru a deschide transportul MCP; nu este necesar pentru apelurile obișnuite REST API. Vezi [Model Context Protocol](/ro/developers/mcp).

:::tip
Puteți testa toate API-urile noastre fără să scrieți o singură linie de cod înainte de a începe.

Luați un 'Client ID' și o 'Secret Key' de la una dintre aplicațiile dvs. și navigați la oricare dintre [API-urile noastre](/ro/api/overview/).
:::
