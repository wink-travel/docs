...
2. [Creează un cont afiliat](/ro/portal/create-account). Vei avea nevoie de acesta pentru a lega Aplicația ta. Vezi [ce este Studio](/ro/portal/studio/what-is-studio) pentru mai mult context.
3. [Creează o Aplicație](/ro/portal/settings/applications) și asociaz-o cu contul afiliat creat la Pasul 2. Pentru integrări API server-to-server, alege **MACHINE_2_MACHINE** ca tip client.
