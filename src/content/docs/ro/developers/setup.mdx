...
<Steps>
1. [Înregistrează-te](/ro/account/register) cu un cont de utilizator pe Wink.
2. [Creează un cont afiliat](/ro/portal/create-account). Vei avea nevoie de acesta pentru a asocia Aplicația ta. Vezi [ce este Studio](/ro/portal/studio/what-is-studio) pentru mai mult context.
3. [Creează o Aplicație](/ro/portal/settings/applications) și asociază-o cu contul afiliat creat la Pasul 2. Pentru integrări API server-to-server, alege **MACHINE_2_MACHINE** ca tip client.
...
Accesează secțiunea noastră de [API-uri](/ro/api) și alege API-ul cu care vrei să lucrezi.
