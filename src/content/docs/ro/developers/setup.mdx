...
<Steps>
  1. Folosește [API-ul de căutare](https://developer.wink.travel/lookup) pentru a recupera destinații sau hoteluri.
...
<Steps>
  ...
  2. Faceți clic pe `Download OpenAPI spec` din vârful [API-ul de căutare](https://developer.wink.travel/lookup) pagină.
