...
:::note
Testarea trebuie să aibă loc întotdeauna în [mediul nostru de testare](/getting-started/environments). Acolo există mult mai puține date, dar ești liber să testezi cât dorești fără să afectezi mediul de producție.
...
<Steps>
1. [Înregistrează-te](/user/register) cu contul tău de utilizator pe Wink
2. Creează un [cont de agent de turism](/travel-agent/what-is-agent) sau un [cont de afiliat](/studio/what-is-studio).
3. [Creează o Aplicație](/developer/applications) unde o asociezi cu contul creat la Pasul 2.
...
Accesează secțiunea noastră de [API-uri](/developer/apis) și alege API-ul cu care vrei să lucrezi.
