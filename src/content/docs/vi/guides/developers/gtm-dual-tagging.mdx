...
2. **Nhập vào cổng thông tin Wink**
   ...
   Đăng nhập vào [app.wink.travel](https://app.wink.travel), chọn tài khoản của bạn, và vào tab **Tùy chỉnh**. Dán ID Container GTM Sojern vào trường Sojern và lưu lại. Tích hợp của bạn giờ đã hoạt động.
...
- **Trên mọi trang mà cơ sở lưu trú của bạn hoạt động** trên Wink, ID Container GTM Sojern của bạn được chèn vào trang và hệ thống quản lý thẻ của Wink sẽ tải container Sojern cùng với container của mình. Việc này diễn ra tự động — không cần bước thủ công nào từ đội Wink cho từng cơ sở lưu trú.
...
Kích hoạt khi khách thêm một phòng vào giỏ hàng.
...
<Aside type="note">
Thuộc tính tùy chỉnh có thể mất đến 24 giờ để bắt đầu xuất hiện trong báo cáo GA4 sau khi đăng ký. Dữ liệu lịch sử thu thập trước khi đăng ký sẽ không được bổ sung lại.
...
| Tên thuộc tính | Tham số sự kiện | Loại |
|----------------|-----------------|------|
