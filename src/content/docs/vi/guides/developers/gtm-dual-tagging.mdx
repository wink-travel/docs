...
2. **Nhập vào cổng thông tin Wink**
   ...
   Đăng nhập vào [app.wink.travel](https://app.wink.travel), chọn tài khoản của bạn, và vào tab **Tùy chỉnh**. Dán ID Container GTM Sojern vào trường Sojern và lưu lại. Việc tích hợp của bạn giờ đã hoạt động.
...
| `num_perks` | số | Số ưu đãi đi kèm với mức giá |
...
| `guests` | Số lượng khách từ phiên tìm kiếm hiện tại |
| `rooms` | Số lượng phòng từ phiên tìm kiếm hiện tại |
