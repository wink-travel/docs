...
Khi người dùng đã xác thực, nó sẽ hiển thị biểu tượng hồ sơ của người dùng.
...
Kho có thể không còn sẵn có nữa. Hãy vào [Wink Studio](/vi/studio/cards) và kiểm tra xem trạng thái của "thẻ" có còn sẵn không.
...
:::note
`Tình trạng sẵn có` không có nghĩa là tình trạng sẵn có hàng ngày của kho để đặt. Nó có nghĩa là kho hoàn toàn không có sẵn cho bạn và/hoặc bất kỳ ai khác.
:::

### Đã bị xóa

Kho có thể đã bị xóa. Hãy vào [Wink Studio](/vi/studio/cards) và kiểm tra xem trạng thái của "thẻ" có còn sẵn không.
Nếu không, nó sẽ hiển thị màu đỏ. Trong trường hợp đó, bạn có thể chờ đợi và có thể nhà cung cấp sẽ làm cho nó sẵn có trở lại hoặc loại bỏ nó khỏi danh sách của bạn.
...
Phần này dành cho các nhà phát triển web. Nếu bạn vô tình xóa [Ứng dụng](/vi/developer/applications); khiến client ID không còn sẵn, vui lòng tạo một ứng dụng mới và sử dụng client ID mới để nhúng các Thành phần Web của chúng tôi.
