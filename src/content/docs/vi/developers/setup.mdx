...
<Steps>
  1. Sử dụng [API tra cứu](https://developer.wink.travel/lookup) để lấy thông tin về điểm đến hoặc khách sạn.
...
<Steps>
  ...
  2. Nhấp vào `Download OpenAPI spec` từ đỉnh của [API tra cứu](https://developer.wink.travel/lookup) trang.
