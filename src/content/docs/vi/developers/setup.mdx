...
<Steps>
1. [Đăng ký](/vi/user/register) tài khoản người dùng trên Wink
2. Tạo một [tài khoản đại lý du lịch](/vi/travel-agent/what-is-agent) hoặc một [tài khoản affiliate](/vi/studio/what-is-studio).
3. [Tạo một Ứng dụng](/vi/developer/applications) và liên kết nó với tài khoản bạn đã tạo ở Bước 2.
4. Sau khi tạo `Application`, hãy lưu client-id và client secret ở nơi an toàn.
</Steps>

## CDN

Tại Wink, chúng tôi sử dụng Cloudinary cho tất cả các tài sản hình ảnh và video. Khi bạn truy cập kho du lịch của chúng tôi, bạn sẽ có quyền truy cập đầy đủ vào tất cả các tính năng nâng cao của Cloudinary.
...
Hãy truy cập vào phần [APIs](/vi/developer/apis) của chúng tôi và chọn API bạn muốn làm việc.
...
### Postman
Bạn cũng có thể làm điều tương tự với Postman.
