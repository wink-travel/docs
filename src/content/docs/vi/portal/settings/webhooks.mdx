---
title: Webhooks
description: Đăng ký sự kiện từ Wink và TripPay.
sidebar:
  order: 11
---
...
<CloudinaryImage
    ...
    />
    <figcaption>*Mục webhook mẫu*</figcaption>
</figure>

## Tạo webhook

:::caution
Bạn cần tạo tài khoản affiliate trên Wink hoặc tài khoản trên TripPay trước khi tạo webhook vì bạn sẽ liên kết webhook với một tài khoản cụ thể.
:::
...
- Vô hiệu hóa webhook.
- Lắng nghe nhiều hoặc ít sự kiện hơn.
