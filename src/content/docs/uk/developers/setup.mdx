...
<Steps>
  1. Використовуйте [API пошуку](https://developer.wink.travel/lookup) щоб отримати напрямки або готелі.
...
<Steps>
  ...
  2. Натисніть на `Download OpenAPI spec` з вершини [API пошуку](https://developer.wink.travel/lookup) сторінка.
