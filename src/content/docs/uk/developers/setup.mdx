...
<Steps>
1. [Зареєструйтеся](/uk/user/register) як користувач на Wink
2. Створіть [обліковий запис турагента](/uk/travel-agent/what-is-agent) або [партнерський обліковий запис](/uk/studio/what-is-studio).
3. [Створіть додаток](/uk/developer/applications), пов’язавши його з обліковим записом, створеним на кроці 2.
...
Перейдіть до нашого розділу [API](/uk/developer/apis) і виберіть API, з яким хочете працювати.
...
:::tip[Порада]
Рекомендується зробити домен сервера, client ID та client secret змінними середовища. Так ви зможете легко перемикатися між тестовим і продуктивним середовищами та повторно використовувати всі створені операції.
:::
