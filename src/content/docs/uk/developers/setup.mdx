...
<Steps>
1. [Зареєструйтеся](/uk/my-account/register) як користувач на Wink.
2. [Створіть афілійований обліковий запис](/uk/my-account/create-account). Він потрібен для прив’язки вашого додатку. Детальніше дивіться у розділі [що таке Studio](/uk/studio/what-is-studio).
3. [Створіть додаток](/uk/my-account/applications) і зв’яжіть його з афілійованим обліковим записом, створеним на кроці 2. Для інтеграцій API сервер-сервер оберіть тип клієнта **MACHINE_2_MACHINE**.
...
Перейдіть до нашого розділу [APIs](/uk/developers/apis) і виберіть API, з яким хочете працювати.
