---
title: Інтеграція GTM Analytics
description: Як підключити будь-який контейнер Google Tag Manager (наприклад, контейнер Sojern) до Wink, щоб відстежувати шлях бронювання гостей і підтримувати ваші кампанії ретаргетингу та реклами.
sidebar:
  label: Інтеграція GTM Analytics
---
...
<Aside type="tip">
Це припускає, що у вас вже є GTM Container ID (формат `GTM-XXXXXXX`). Якщо ваш контейнер надається партнером, таким як Sojern, попросіть у вашого менеджера акаунту саме **GTM Container ID** — він відрізняється від pixel або tag ID. Новачок у Sojern? Відвідайте [sojern.com/contact](https://www.sojern.com/contact), щоб почати.
</Aside>
...
<Aside type="note">
Вам не потрібно розміщувати жоден код pixel на вашому власному сайті для цієї інтеграції. Wink автоматично завантажує ваш GTM контейнер на всіх сторінках, де активна ваша власність.

Це працює для **будь-якого** GTM Container ID — Sojern лише поширений приклад.
</Aside>
...
Ці параметри несуть контекст бронювання Wink. GA4 не відображає їх у звітах автоматично — потрібно зареєструвати кожен як **користувацький вимір на рівні елемента** у вашій GA4 властивості, щоб він з’явився у звітах або дослідженнях. Інструкції див. у розділі [Користувацькі виміри в GA4](#custom-dimensions-in-ga4) нижче.
...
<Aside type="note">
Користувацькі виміри можуть з’являтися у звітах GA4 з затримкою до 24 годин після реєстрації. Історичні дані, зібрані до реєстрації, не заповнюються заднім числом.
