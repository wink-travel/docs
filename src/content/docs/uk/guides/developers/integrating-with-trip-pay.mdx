...
- [Payment Web Component](/uk/integrations/web-components/#payment).
- [Payment API](/uk/api). *Прочитайте розділ про `Create payable contracts`*
...
- Рядки: **8 - 9** — це обліковий запис TripPay, який забезпечує бронювання. Це може бути:
    - Ваш інтеграторський обліковий запис TripPay.
...
- `identifier` — це дійсний UUID, який ви генеруєте.
- Постачальник, у якого ви хочете забронювати інвентар.
...
- Кожен запис у `contractItemList` містить:
    - **Користувач-гость** Це користувач, який прибуде на місце.
    ...
    - **Бенефіціари** Вкажіть, які облікові записи TripPay мають отримати яку частку від ціни елемента. *Підтримуються фіксовані та відсоткові суми.*

:::note
У наведеному вище прикладі JSON у нас є 3 бенефіціари:

- 1,5% було виділено платформі, що забезпечила бронювання. *наприклад, Wink*
...
На цьому етапі ви готові вбудувати `Payment Web Component` на свій вебсайт і показати його користувачу.
