...
description: Як підключити ваш обліковий запис Sojern до Wink, щоб Sojern міг відстежувати шлях бронювання ваших гостей і підтримувати ваші кампанії ретаргетингу та реклами.
sidebar:
...
Якщо ви запускаєте рекламні кампанії через Sojern, ви можете підключити свій обліковий запис Sojern до Wink, ввівши ваш Sojern GTM Container ID у порталі Wink. Після підключення піксель відстеження Sojern автоматично активується для вашої власності — охоплюючи повний шлях гостя від пошуку до завершеного бронювання.
...
1. **Отримайте свій GTM Container ID від Sojern**
   ...
   Зв’яжіться з менеджером вашого облікового запису Sojern і запросіть ваш **GTM Container ID**. Він має формат `GTM-XXXXXXX`. Це відрізняється від вашого Sojern Pixel ID — переконайтеся, що ви просите саме GTM Container ID.

2. **Введіть його в порталі Wink**

   Увійдіть у [app.wink.travel](https://app.wink.travel), виберіть свій обліковий запис і перейдіть на вкладку **Customizations**. Вставте ваш Sojern GTM Container ID у поле Sojern і збережіть. Ваша інтеграція тепер активна.

3. **Підтвердіть з менеджером вашого облікового запису Sojern**

   Повідомте менеджера вашого облікового запису Sojern, що інтеграція активна. Вони можуть перевірити зі свого боку, що піксель коректно спрацьовує на `wink.travel` для вашої власності і що дані надходять у ваш обліковий запис Sojern.

</Steps>

<Aside type="note">
Для цієї інтеграції вам не потрібно розміщувати жоден код пікселя на вашому власному сайті. Wink автоматично завантажує ваш Sojern контейнер на всіх сторінках, де активна ваша власність.
...
- **Поле Sojern GTM Container ID** доступне на вкладці Customizations у вашому порталі Wink. Коли ви вводите Container ID, Wink перевіряє формат і безпечно зберігає його для вашої власності.
- **На кожній сторінці, де активна ваша власність** у Wink, ваш Sojern GTM Container ID вставляється у сторінку, і система керування тегами Wink динамічно завантажує ваш Sojern контейнер разом зі своїм. Це відбувається автоматично — без ручних дій з боку команди Wink для кожної власності.
- **Ваш Sojern контейнер завантажується асинхронно**, тобто не впливає на швидкість завантаження сторінки для ваших гостей.
- **Власне відстеження Wink і ваш Sojern піксель працюють паралельно**, читаючи з одних і тих же спільних даних подій. Кожна подія бронювання, яку відстежує Wink, одночасно доступна вашому Sojern контейнеру.
- **Коли ваша власність не переглядається** — наприклад, коли гість переглядає інший готель у Wink — ваш Sojern контейнер не завантажується. Це гарантує, що Sojern отримує лише релевантні дані про вашу власність.
...
Кожна подія відповідає стандартній структурі GA4 Enhanced Ecommerce: рядок верхнього рівня `event` і об’єкт `ecommerce`. Перед кожним пушем Wink очищує попередній ecommerce-пейлоад, щоб уникнути проникнення застарілих даних у нові тригери.
...
Ці поля нативно розпізнаються GA4 і відображаються у стандартних звітах ecommerce без додаткових налаштувань.
...
Ці параметри несуть контекст бронювання, специфічний для Wink. GA4 не відображає їх у звітах автоматично — потрібно зареєструвати кожен як **користувацький вимір на рівні елемента** у вашій властивості GA4, щоб вони з’явилися у звітах або дослідженнях. Інструкції з налаштування див. у розділі [Custom Dimensions in GA4](#custom-dimensions-in-ga4) нижче.
...
1. **Відкрийте Custom Definitions**
   ...
   У GA4 перейдіть у **Admin** (піктограма шестерні внизу зліва) → виберіть вашу властивість → **Data display** → **Custom definitions**.
