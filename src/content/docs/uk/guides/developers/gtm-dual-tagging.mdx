...
Якщо ви проводите рекламні кампанії через Sojern, ви можете підключити свій обліковий запис Sojern до Wink, ввівши свій Sojern GTM Container ID у порталі Wink. Після підключення піксель відстеження Sojern автоматично активується для вашої власності — охоплюючи повний шлях гостя від пошуку до завершеного бронювання.

<Aside type="tip">
Це передбачає, що у вас вже є активний обліковий запис Sojern і ви отримали свій GTM Container ID від менеджера вашого облікового запису Sojern. Якщо у вас ще немає облікового запису Sojern, відвідайте [sojern.com/contact](https://www.sojern.com/contact), щоб почати.
</Aside>
...
2. **Введіть його в порталі Wink**
   ...
   Увійдіть на [app.wink.travel](https://app.wink.travel), виберіть свій обліковий запис і перейдіть на вкладку **Customizations**. Вставте свій Sojern GTM Container ID у поле Sojern і збережіть. Ваша інтеграція тепер активна.
...
<Aside type="note">
Для цієї інтеграції вам не потрібно розміщувати жоден код пікселя на вашому власному сайті. Wink автоматично завантажує ваш контейнер Sojern на всіх сторінках, де активна ваша власність.
...
- **На кожній сторінці, де активна ваша власність** у Wink, ваш Sojern GTM Container ID вставляється у сторінку, і система керування тегами Wink динамічно завантажує ваш контейнер Sojern разом зі своїм. Це відбувається автоматично — без ручних дій з боку команди Wink для кожної власності.
- **Ваш контейнер Sojern завантажується асинхронно**, тобто не впливає на швидкість завантаження сторінки для ваших гостей.
- **Власне відстеження Wink і ваш піксель Sojern працюють паралельно**, читаючи з одних і тих же спільних даних подій. Кожна подія бронювання, яку відстежує Wink, одночасно доступна вашому контейнеру Sojern.
...
Усі події, що містять масив `items`, використовують однакову схему елемента. Кожна властивість є необов’язковою, якщо не позначена як обов’язкова.
...
Ці параметри несуть контекст бронювання, специфічний для Wink. GA4 не відображає їх у звітах автоматично — потрібно зареєструвати кожен як **користувацький вимір на рівні елемента** у вашій властивості GA4, щоб вони з’явилися у звітах або дослідженнях. Інструкції див. у розділі [Користувацькі виміри в GA4](#custom-dimensions-in-ga4) нижче.
...
GA4 ігнорує користувацькі параметри елементів у звітах, доки ви явно не зареєструєте їх як користувацькі виміри на рівні елемента. Реєструвати потрібно лише ті параметри, які ви плануєте використовувати у звітах — не обов’язково всі 20.
