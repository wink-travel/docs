...
Виберіть свого постачальника тарифів зі списку та натисніть кнопку `Save`. Це дозволить постачальнику тарифів надсилати нам тарифи, і ми повідомимо їх, коли на Wink буде здійснено бронювання для одного з ваших об’єктів.


### SynXis

Якщо ваш об’єкт використовує channel manager SynXis, перед підключенням до Wink потрібно виконати ще один крок.

- Будь ласка, зв’яжіться зі своїм представником SynXis або службою підтримки (SHSCustomerCare@sabre.com).
- Повідомте їм, що хочете підключитися до Wink через Channel Connect Express (***CCX***).
- Вони запропонують вам заповнити форму ***PRS***.
  - Вас попросять ввести облікові дані користувача Wink.
  - ...та бажану валюту.
