...
description: Ось актуальний список постачальників тарифів, які ми підтримуємо безпосередньо на Wink.
sidebar:
  order: 18
---

## Встановлення постачальника тарифів

Щоб встановити свого постачальника тарифів, натисніть у головному меню `Distribution > Channel manager`.

Виберіть свого постачальника тарифів зі спадного списку та натисніть кнопку `Save`. Це дозволить постачальнику тарифів надсилати нам тарифи, і ми повідомимо їх, коли на Wink буде здійснено бронювання для однієї з ваших власностей.


### SynXis

Якщо ваша власність використовує channel manager SynXis, перед підключенням до Wink потрібно виконати ще один крок.

- Будь ласка, зв’яжіться зі своїм представником SynXis або службою підтримки клієнтів (SHSCustomerCare@sabre.com).
- Повідомте їм, що хочете підключитися до Wink через Channel Connect Express (***CCX***).
- Вони попросять вас заповнити форму ***PRS***.
  - Вас попросять ввести свої облікові дані Wink.
  - ...та бажану валюту.
...
*Якщо у постачальника є проксі, це означає, що ми отримуємо тарифи від постачальника опосередковано через проксі.*
