...
2. **أدخله في بوابة Wink**
   ...
   سجّل الدخول إلى [app.wink.travel](https://app.wink.travel)، اختر حسابك، واذهب إلى تبويب **التخصيصات**. الصق معرف حاوية GTM الخاص بـ Sojern في حقل Sojern واحفظ. أصبح التكامل الآن نشطًا.
...
يسمح GA4 بما يصل إلى 50 بُعدًا مخصصًا على مستوى العنصر لكل خاصية في الخصائص القياسية (خصائص 360 تسمح بالمزيد).
</Aside>
...
لا يتم تضمين حمولة `ecommerce` مع هذا الحدث.
