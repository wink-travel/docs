...
تشكل شروط خدمة الدفع هذه ("**شروط الدفع**") اتفاقًا قانونيًا ملزمًا بينك وبين TripPay (المشار إليها فيما بعد باسم **"مُيسر الدفع"**)، وهي شركة تابعة مملوكة بالكامل لشركة Winkfluence، تحكم خدمات الدفع (المعرفة أدناه) التي تتم من خلال أو بالارتباط مع منصة Wink (المشار إليها فيما بعد باسم **"Wink"**). عندما تذكر شروط الدفع هذه "**مُيسر الدفع**"، "**نحن**"، "**لنا**"، أو "**خاصتنا**"، فإنها تشير إلى شركة TripPay التي تتعاقد معها لخدمات الدفع.
