...
Contoh boleh didapati untuk [kad](/ms/studio/cards), [grid](/ms/studio/grids) dan [peta](/ms/studio/maps).
...
:::note
Untuk belajar cara menjana `id` kontrak tempahan, baca panduan: [Integrasi dengan TripPay](/ms/guides/integrating-with-trip-pay).
:::
...
Inventori mungkin tidak lagi tersedia. Pergi ke [Wink Studio](/ms/studio/cards) dan periksa sama ada status "kad" tersedia.
...
Inventori mungkin telah dikeluarkan. Pergi ke [Wink Studio](/ms/studio/cards) dan periksa sama ada status "kad" tersedia.
Jika tidak, ia akan dipaparkan berwarna merah. Jika itu berlaku, anda boleh menunggu dan mungkin pembekal akan membuatnya tersedia semula atau keluarkan dari senarai anda.
...
Ini untuk pembangun web sahaja. Jika anda secara tidak sengaja telah mengeluarkan [Aplikasi](/ms/my-account/applications) ; menyebabkan ID klien tidak lagi tersedia, sila buat aplikasi baru dan gunakan ID klien baru untuk menyematkan Komponen Web kami.
