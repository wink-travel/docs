...
:::note
Ujian harus sentiasa dilakukan di [persekitaran staging](/getting-started/environments) kami. Data di sana jauh lebih sedikit tetapi anda bebas untuk menguji sebanyak mana yang anda mahu tanpa mengganggu persekitaran produksi.

Apabila anda sudah bersedia untuk siaran langsung, kami akan mengesahkan akaun dan aplikasi anda dan anda boleh melancarkan di persekitaran produksi kami.
:::
...
2. Cipta [akaun ejen pelancongan](/travel-agent/what-is-agent) atau [akaun afiliasi](/studio/what-is-studio).
3. [Cipta Aplikasi](/developer/applications) di mana anda mengaitkannya dengan akaun yang anda cipta di Langkah 2.
...
Teruskan ke bahagian [API](/developer/apis) kami dan pilih API yang anda ingin gunakan.
