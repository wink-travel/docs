...
<Steps>
  1. Gunakan [API Carian](https://developer.wink.travel/lookup) untuk mendapatkan semula destinasi atau hotel.
...
<Steps>
  ...
  2. klik pada `Download OpenAPI spec` dari atas [API Carian](https://developer.wink.travel/lookup) muka surat.
