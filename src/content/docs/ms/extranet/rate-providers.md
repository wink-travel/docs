...
Untuk menetapkan penyedia kadar anda, klik pada `Distribution > Channel manager` dari bar navigasi utama.

Pilih penyedia kadar anda dari senarai dropdown dan klik butang `Save`. Ini akan membolehkan penyedia kadar menghantar kadar kepada kami dan kami akan memberitahu mereka apabila terdapat tempahan yang berlaku di Wink untuk salah satu hartanah anda.
...
- Mereka akan meminta anda melengkapkan borang ***PRS***.
  - Anda akan diminta mengisi kelayakan pengguna Wink anda.
  - ...dan mata wang yang anda inginkan.
- Lengkapkan borang dan hantar kembali kepada SynXis.

## Vendor

Berikut adalah senarai vendor yang kami sokong:
...
*Jika vendor mempunyai proksi, ini bermakna kami menerima kadar secara tidak langsung dari vendor melalui proksi tersebut.*

| Vendor | Jenis | Proksi | Sejak | Terakhir diubah | Komen
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Kini d-edge |
