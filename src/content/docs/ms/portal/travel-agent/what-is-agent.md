---
title: Apakah itu Ejen?
description: Ketahui bagaimana Wink menyokong ejen pelancongan berdaftar.
sidebar:
  order: 0
---
...
Pembangun yang ingin mengurus `Travel Agent` boleh pergi ke [Developers > API > Travel Agent](/ms/api).
