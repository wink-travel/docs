...
:::note
Tetapkan `Intelligent` kepada 🟢 dalam [Tetapan](/ms/portal/link-manager/settings) anda untuk menggunakan ciri ini.
:::
...
- [Pautan boleh dikongsi](/ms/portal/studio/shareable-links) - Pilih untuk dipaparkan sebagai:
    - [Sepanduk iklan](/ms/integrations/web-components/#content-loader).
    - Pautan biasa dengan kemas kini harga masa nyata.
- [Kad](/ms/portal/studio/cards) - Kad boleh ditempah dengan harga & ketersediaan masa nyata.
- [Grid](/ms/portal/studio/grids) - Grid dengan kad boleh ditempah.
- [Peta](/ms/portal/studio/maps) - Peta dengan penanda yang membuka kad boleh ditempah.
