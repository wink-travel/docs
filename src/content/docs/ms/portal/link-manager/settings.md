...
Untuk mengurus tetapan WinkLinks anda, navigasi ke `WinkLinks` di bar navigasi utama dan klik pada tab `Design`.

Berikut adalah cara anda boleh mengkonfigurasi tingkah laku WinkLinks anda dengan `Design`:
...
- **Initial display** Kawal bagaimana audiens anda pertama kali berinteraksi dengan laman anda dan melihat kandungan anda. Terdapat tiga pilihan yang tersedia untuk anda:
...
- Tingkah laku paparan pos (Mod Banner, Smart Banner/Interaktif, Penyesuaian auto Layout-Aware)  
