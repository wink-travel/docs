...
description: Ketahui bagaimana Wink secara automatik menterjemah kandungan hartanah anda ke dalam lebih 40 bahasa menggunakan perkhidmatan terjemahan yang diintegrasikan.
sidebar:
  order: 19
---
...
<Steps>
1. **Anda mencipta kandungan** dalam bahasa utama anda — sama ada secara manual atau menggunakan [pendaftaran dibantu AI](/ms/guides/hoteliers/ai-assisted-registration).
...
4. **Pelancong melihat kandungan dalam bahasa mereka** berdasarkan tetapan pelayar, lokal terpilih, atau pengesanan GeoIP.
</Steps>
...
1. **Daftarkan hartanah anda** menggunakan [pendaftaran dibantu AI](/ms/guides/hoteliers/ai-assisted-registration) — AI menjana kandungan dalam bahasa utama anda.
...
- **Tulis kandungan sumber yang jelas.** Terjemahan mesin berfungsi terbaik dengan ayat yang jelas dan ringkas. Elakkan idiom dan bahasa pasar yang mungkin sukar diterjemah.
...
- [Pendaftaran Dibantu AI](/ms/guides/hoteliers/ai-assisted-registration) — Daftarkan hartanah dengan AI dan terjemahan automatik.
