...
description: Cara menghubungkan akaun Sojern anda ke Wink supaya Sojern dapat menjejak perjalanan tempahan tetamu anda dan menggerakkan kempen penargetan semula dan pengiklanan anda.
sidebar:
...
Jika anda menjalankan kempen pengiklanan melalui Sojern, anda boleh menghubungkan akaun Sojern anda ke Wink dengan memasukkan ID Kontena GTM Sojern anda di portal Wink. Setelah disambungkan, pixel penjejakan Sojern akan diaktifkan secara automatik untuk hartanah anda — merangkumi keseluruhan perjalanan tetamu dari carian hingga tempahan selesai.
...
2. **Masukkan Ia di Portal Wink**
   ...
   Log masuk ke [app.wink.travel](https://app.wink.travel), pilih akaun anda, dan pergi ke tab **Customizations**. Tampal ID Kontena GTM Sojern anda ke dalam medan Sojern dan simpan. Integrasi anda kini aktif.
...
- **Medan ID Kontena GTM Sojern** tersedia di tab Customizations portal Wink anda. Apabila anda memasukkan ID Kontena anda, Wink mengesahkan format dan menyimpannya dengan selamat untuk hartanah anda.
- **Pada setiap halaman di mana hartanah anda aktif** di Wink, ID Kontena GTM Sojern anda dimasukkan ke dalam halaman dan sistem pengurusan tag Wink memuatkan kontena Sojern anda secara dinamik bersama-sama dengan kontena sendiri. Ini berlaku secara automatik — tiada langkah manual diperlukan daripada pasukan Wink untuk setiap hartanah.
...
- **Apabila hartanah anda tidak sedang dilihat** — contohnya, apabila tetamu melayari hotel lain di Wink — kontena Sojern anda tidak dimuatkan. Ini memastikan Sojern hanya menerima data yang relevan dengan hartanah anda.
...
Acara ini diaktifkan secara automatik apabila tetamu bergerak melalui corong tempahan. Konfigurasikan pencetus GTM anda sebagai pencetus **Custom Event** yang sepadan dengan nama acara di bawah.

| Langkah | Acara | Bila Ia Diaktifkan |
|------|-------|---------------|
...
Diaktifkan apabila grid atau senarai inventori hotel dipaparkan.
...
Diaktifkan apabila tetamu melihat hartanah tertentu.
...
Diaktifkan apabila tetamu menambah bilik ke troli mereka.
...
Diaktifkan apabila halaman checkout / pembayaran dimuatkan.
...
Diaktifkan apabila tetamu memilih atau mengesahkan kaedah pembayaran.
...
Diaktifkan apabila tetamu mengesahkan identiti melalui single sign-on.
...
Diaktifkan apabila tempahan disahkan.
...
Diaktifkan apabila tempahan dibatalkan.
...
Gunakan jadual berikut sebagai rujukan anda semasa mencipta dimensi tersuai. Nilai **Event parameter** mesti sepadan tepat — GA4 sensitif huruf besar kecil.
...
Acara berikut tersedia dalam dataLayer Wink tetapi bukan sebahagian daripada corong tempahan standard. Ia mungkin diaktifkan oleh interaksi lain di platform.
