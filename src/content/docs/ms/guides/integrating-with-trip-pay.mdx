...
- [Payment Web Component](/ms/integrations/web-components/#payment).
...
Pada tahap ini, anda sudah bersedia untuk menyematkan `Payment Web Component` ke dalam laman web anda dan memaparkannya kepada pengguna.
