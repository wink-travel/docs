...
2. **Enter It in the Wink Portal**
   ...
   Log into [app.wink.travel](https://app.wink.travel), select your account, and go to the **Customizations** tab. Paste your Sojern GTM Container ID into the Sojern field and save. Your integration is now live.
