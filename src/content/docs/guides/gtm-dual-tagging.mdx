...
GA4 ignores custom item parameters in reports until you explicitly register them as item-scoped custom dimensions. You only need to register the parameters you intend to use in reports — you do not need to register all 18.
