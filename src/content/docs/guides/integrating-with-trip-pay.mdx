...
At this point, you are ready to embed the `Payment Web Component` into your site and show it to the user.

```html
<trip-pay id="contract-1"></trip-pay>
```

As far as integration goes, that's all you need to do. All the heavy work is done by TripPay.