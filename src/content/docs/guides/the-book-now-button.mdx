...
This article is mainly for hotels who want to install a free, high-conversion, booking engine on their website. 
...
5. This will redirect you to your property's affiliate account on [Wink Studio](https://studio.wink.travel).
...
8. This will create a `Shareable Link` using your default [Customization](/studio/customization).
