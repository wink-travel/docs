...
For the simplest integration, we recommend using a [Shareable Link](/portal/studio/shareable-links).

Here are the steps to do this:

<Steps>
1. Go to https://app.wink.travel
...
Some hotels want a bit more functionality, and a deeper integration, for their website. This example will cover embedding a [Card](/portal/studio/cards) into their website.
...
13. To retrieve your `Client-ID`, go to [Applications](/account/applications).
14. To retrieve your `Configuration-ID`, go to [Customization](/portal/settings/branding)
14. You are ✅.
</Steps>
