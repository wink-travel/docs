...
It shows up when affiliates search for inventory to sell in [Studio](/portal/studio/what-is-studio).
...
Once you've create a new, direct, sales channel for them, your inventory will show up in [Studio](/portal/studio/what-is-studio) with a `Direct ribbon` overlaid your inventory.