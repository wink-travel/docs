...
Here's what connecting with influencers looked like before the Wink Travel Platform came along:
...
The Wink Travel Platform simplifies and adds value to the process above:
...
This is inventory that you make available through the [Wink Network](/portal/extranet/network) sales channel. 
It shows up when affiliates search for inventory to sell in [Wink Studio](/portal/studio/what-is-studio).
You can also track any affiliate that sells inventory from [Wink Network](/portal/extranet/network).
...
3. Configure your [Wink Network](/portal/extranet/network) sales channel to be appealing to affiliates looking for inventory to sell. *By default, we think it's already pretty compelling*.
</Steps>
...
This section is covered in [Extranet > Network](/portal/extranet/network/#explore-network).
...
Once you've create a new, direct, sales channel for them, your inventory will show up in [Wink Studio](/portal/studio/what-is-studio) with a `Direct ribbon` overlaid your inventory.