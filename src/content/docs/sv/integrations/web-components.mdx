...
Betalningskomponenten låter dig informera TripPay att en resenär vill köpa något samt regler och priser för dessa artiklar.
...
Inventariet kan ha blivit otillgängligt. Gå till [Wink Studio](/sv/portal/studio/cards) och kontrollera om statusen för "kortet" är tillgängligt.
...
Inventariet kan ha tagits bort. Gå till [Wink Studio](/sv/portal/studio/cards) och kontrollera om statusen för "kortet" är tillgängligt.
Om det inte är det visas det som rött. I så fall kan du vänta och kanske gör leverantören det tillgängligt igen eller ta bort det från din lista.
...
Detta gäller endast webbutvecklare. Om du av misstag tagit bort [Application](/sv/portal/settings/applications) så att client ID inte längre är tillgängligt, skapa en ny applikation och använd det nya client ID:t för att bädda in våra Web Components.
