...
Inventariet kan vara slut eller inte längre tillgängligt. Gå till [Wink Studio](/sv/portal/studio/cards) och kontrollera om statusen för "kortet" är tillgängligt.
...
Detta gäller endast webbutvecklare. Om du av misstag tagit bort [Application](/sv/portal/settings/applications) så att client ID inte längre är tillgängligt, skapa en ny applikation och använd det nya client ID för att bädda in våra Web Components.
