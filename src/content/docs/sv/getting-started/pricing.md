...
Wink tar ut en behandlingsavgift på 1,5 % per bokning. Detta täcker plattformsunderhåll och är vad som gör att vi kan erbjuda allt som listas ovan gratis.
:::
...
Denna modell är endast tillgänglig för resebyråer som innehar resebyrålicens i sin region och som önskar vara registrerad handlare. Några av våra registrerade resebyråer vill själva hantera betalningen och utbetalning av medel till hotell. Under denna modell ansvarar de för medlen och innehar nödvändiga licenser för att verka i sitt land.
...
- **Den fria gränsen täcker endast standardbildsinlägg.** Du får ett sådant per konto och månad. Videoinlägg och AI-genererat media debiteras från första inlägget — det finns ingen gratisgräns på dessa nivåer, så en fastighet som postar video bör räkna med en avgift redan första månaden.
...
- Endast ett **genererat** inlägg publicerat till ett tredjepartsnätverk (Facebook, Instagram) är debiterbart. Ett inlägg du skrivit själv är gratis, oavsett var det publiceras.
- **Publicering till WinkLinks är alltid gratis**, genererat eller inte.
- Du debiteras **vid publicering**, inte per försök. Att regenerera ett utkast tills du är nöjd ökar inte din faktura — du betalar en gång för det inlägg du faktiskt skickar. Försök är dock inte obegränsade: varje inlägg tillåter cirka 10 regenereringar för bilder och 3 för video, vilket speglar vad det kostar oss att producera dem. Du ser hur många du har kvar medan du arbetar.
...
När det är aktiverat mäts din användning men **begränsas aldrig** — du kommer inte att träffa någon hastighetsbegränsning för att spendera pengar hos oss.
