...
<Steps>
  1. Använd [Sök-API](https://developer.wink.travel/lookup) för att hämta destinationer eller hotell.
...
<Steps>
  ...
  2. Klicka på `Download OpenAPI spec` från toppen av [Sök-API](https://developer.wink.travel/lookup) sida.
