...
:::note
Testning bör alltid ske i vår [stagingmiljö](/getting-started/environments). Det finns mycket mindre data där men du kan testa så mycket du vill utan att påverka produktionsmiljön.
...
<Steps>
1. [Registrera](/user/register) ditt användarkonto på Wink
2. Skapa ett [resebyråkonto](/travel-agent/what-is-agent) eller ett [affiliate-konto](/studio/what-is-studio).
...
Gå till vår [API-sektion](/developer/apis) och välj det API du vill arbeta med.
