...
| `wink://api/{apiName}/operation/{key}/request` | Request-fokuserad vy med obligatoriska indata och minimal exempelpayload |
...
Se [AI Skills](/sv/developers/ai-skills) för tillgängliga färdigheter och installationsinstruktioner.
