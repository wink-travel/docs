...
* Visa bokningsbart lager i önskat format, språk och valuta, till exempel:
  ...
  * En [karta](/studio/maps) på din [karta](/studio/maps) konto.
...
Integratörer som vill ha ännu mer frihet har tillgång till alla samma funktioner via vår [WordPress-plugin](/developers/wordpress/), [WordPress-plugin](/developers/wordpress/) och[API:er](/developers/apis).
