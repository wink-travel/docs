...
| `property_brand` | string | Varumärket som anläggningen tillhör |
| `property_chain` | string | Kedjan som anläggningen tillhör |
...
GA4 ignorerar anpassade objektparametrar i rapporter tills du explicit registrerar dem som anpassade dimensioner med objektomfång. Du behöver bara registrera de parametrar du tänker använda i rapporter — du behöver inte registrera alla 18.
