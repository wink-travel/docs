...
För att ställa in din pristillhandahållare, klicka på `Distribution > Channel manager` i huvudnavigeringsfältet.

Välj din pristillhandahållare från rullgardinsmenyn och klicka på knappen `Spara`. Detta gör det möjligt för pristillhandahållaren att skicka priser till oss och vi kommer att meddela dem när en bokning har gjorts på Wink för någon av dina fastigheter.
...
Nedan är en lista över leverantörer vi stöder:
