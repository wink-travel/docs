...
<Steps>
  1. Használd a [Keresési API](https://developer.wink.travel/lookup) úti célok vagy szállodák lekéréséhez.
...
<Steps>
  ...
  2. Kattintson ide `Download OpenAPI spec` a tetejéről [Keresési API](https://developer.wink.travel/lookup) oldal.
