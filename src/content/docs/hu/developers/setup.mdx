---
title: Beállítás
description: Ez a cikk megmutatja, hogyan állíthatod be gyorsan fejlesztőként magad, és kezdheted el tesztelni az API-jainkat a Wink-en.
sidebar:
  order: 1
---
...
:::note
A tesztelést mindig a [staging környezetünkben](/getting-started/environments) kell végezni. Ott sokkal kevesebb adat van, de korlátlanul tesztelhetsz anélkül, hogy a termelési környezetet terhelnéd.
...
<Steps>
1. [Regisztrálj](/user/register) egy felhasználói fiókot a Wink-en
2. Hozz létre egy [utazási ügynöki fiókot](/travel-agent/what-is-agent) vagy egy [partneri fiókot](/studio/what-is-studio).
3. [Hozz létre egy alkalmazást](/developer/applications), amelyet összekapcsolsz a 2. lépésben létrehozott fiókkal.
...
Látogass el az [API-k](/developer/apis) szekciónkba, és válaszd ki a használni kívánt API-t.
