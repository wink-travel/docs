...
A Wink **64+ webhook eseménytípust** támogat különböző kategóriákban, beleértve a fiókkezelést, foglalási szerződéseket, fizetéseket, csatornakezelő frissítéseket és entitáskezelést. Gyakori események:
...
:::tip
Fejlesztés alatt érdemes az összes eseményre feliratkozni. Miután megértetted a payloadokat, szűkítsd le csak azokra az eseményekre, amelyekre a rendszerednek ténylegesen szüksége van.
:::
...
- **Idempotencia** — a kezelőd legyen idempotens. A Wink újrapróbálkozhat a kézbesítéssel, ha nem kap `200` választ.
- **Forrás ellenőrzése** — ellenőrizd, hogy a bejövő kérések valóban a Wink-től érkeznek, mielőtt feldolgozod őket.
