...
Ha a gombra kattint, amikor a felhasználó nincs hitelesítve, átirányítja a hitelesítéshez.
...
<CloudinaryImage
      ...
      resize="scale"
      quality="best"
      alt="Fiók gomb nyitott állapotban"
...
:::note
A foglalási szerződés `id` generálásának módját megtudhatja a következő útmutatóban: [Integrating with TripPay](/hu/guides/developers/integrating-with-trip-pay).
:::
