...
Ez csak webfejlesztőknek szól. Ha véletlenül eltávolította az [Alkalmazást](/hu/my-account/applications), így az ügyfélazonosító már nem elérhető, kérjük, hozzon létre egy új alkalmazást, és az új ügyfélazonosítót használja webkomponenseink beágyazásához.
