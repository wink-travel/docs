...
Az ár szolgáltató beállításához kattintson a fő navigációs sávban a `Distribution > Channel manager` menüpontra.

Válassza ki az ár szolgáltatót a legördülő listából, majd kattintson a `Mentés` gombra. Ez lehetővé teszi az ár szolgáltató számára, hogy árakat küldjön nekünk, és értesítjük őket, ha a Wink-en foglalás történik az egyik ingatlanára.
...
Az alábbiakban a támogatott szállítók listája található:
...
*Ha a szállítónak van proxy-ja, az azt jelenti, hogy közvetetten kapunk árat a szállítótól a proxy-n keresztül.*

| Szállító | Típus | Proxy | Mióta | Utolsó módosítás | Megjegyzés
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Most d-edge |
