...
- **Beágyazás** Megmutatja, hogyan ágyazhatod be ezt a kártyát [Kártyaként](/hu/developers/integrations/web-components/#content-loader) a weboldaladba.
...
- A 6-9. sorok megmutatják, hogyan használd a [wink-content-loader](/hu/developers/integrations/web-components/#content-loader) Web Komponenst, és hogyan kérj le egy vendégszoba kártyát a kódodhoz.
- A 11. sor megmutatja, hogyan ágyazd be a Javascriptünket az oldaladba.
- A 13. sor megmutatja, hogyan ágyazd be a [wink-app-loader](/hu/developers/integrations/web-components/#application-loader) Web Komponenst, és hogyan kérd le az oldal szintű konfigurációs beállításaidat.
