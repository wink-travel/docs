...
2. **Add meg a Wink portálon**
   ...
   Jelentkezz be a [app.wink.travel](https://app.wink.travel) oldalra, válaszd ki a fiókodat, és lépj a **Testreszabások** fülre. Illeszd be a Sojern GTM Container ID-dat a Sojern mezőbe, majd mentsd el. Az integrációd most aktív.
...
Ez a beállítás bármilyen egyedi GTM Container ID-val működik. A Sojern csak példaként szolgál, mivel ez egy nagyon gyakori integráció.
</Aside>
