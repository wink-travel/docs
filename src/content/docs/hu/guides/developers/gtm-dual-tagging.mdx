...
Ha Sojern-en keresztül futtatsz hirdetési kampányokat, csatlakoztathatod Sojern fiókodat a Winkhez úgy, hogy megadod a Sojern GTM Container ID-dat a Wink portálon. A csatlakozás után a Sojern nyomkövető pixele automatikusan aktiválódik az ingatlanodnál — lefedve a teljes vendégútvonalat a kereséstől a foglalás befejezéséig.
...
1. **Szerezd be a GTM Container ID-dat a Sojern-től**
   ...
   Vedd fel a kapcsolatot a Sojern fiókkezelőddel, és kérd el a **GTM Container ID**-dat. Ez a `GTM-XXXXXXX` formátumot követi. Ez eltér a Sojern Pixel ID-tól — győződj meg róla, hogy kifejezetten a GTM Container ID-t kéred.

2. **Add meg a Wink portálon**

   Jelentkezz be a [app.wink.travel](https://app.wink.travel) oldalra, válaszd ki a fiókodat, és menj a **Testreszabások** fülre. Illeszd be a Sojern GTM Container ID-dat a Sojern mezőbe, majd mentsd el. Az integrációd most élő.

3. **Erősítsd meg a Sojern fiókkezelőddel**

   Tájékoztasd a Sojern fiókkezelődet, hogy az integráció aktív. Ők ellenőrizhetik a saját oldalukon, hogy a pixel helyesen működik-e a `wink.travel` oldalon az ingatlanodnál, és hogy az adatok beérkeznek a Sojern fiókodba.

</Steps>

<Aside type="note">
Ehhez az integrációhoz nem kell pixel kódot elhelyezned a saját weboldaladon. A Wink automatikusan betölti a Sojern konténeredet minden olyan oldalon, ahol az ingatlanod aktív.

Ez a beállítás bármilyen egyedi GTM Container ID-val működik. Csak példaként használtuk a Sojern-t, mivel ez egy nagyon gyakori integráció.
</Aside>

---

## Mit Csinál a Wink a Saját Oldalán

Átláthatóság kedvéért, itt van, mit konfigurál a Wink az integráció működéséhez:

- **Egy Sojern GTM Container ID mező** elérhető a Wink portál Testreszabások fülén. Amikor megadod a Container ID-t, a Wink ellenőrzi a formátumot, és biztonságosan tárolja az ingatlanodhoz.
- **Minden olyan oldalon, ahol az ingatlanod aktív** a Wink-en, a Sojern GTM Container ID-d beillesztésre kerül az oldalba, és a Wink címke kezelő rendszere dinamikusan betölti a Sojern konténert a sajátja mellett. Ez automatikusan történik — nincs szükség manuális lépésekre a Wink csapat részéről ingatlanonként.
- **A Sojern konténered aszinkron módon töltődik be**, ami azt jelenti, hogy nem befolyásolja az oldal betöltési sebességét a vendégeid számára.
- **A Wink saját nyomkövetése és a Sojern pixel párhuzamosan futnak**, ugyanabból a megosztott eseményadatból olvasva. Minden foglalási esemény, amit a Wink követ, egyszerre elérhető a Sojern konténered számára is.
- **Amikor az ingatlanod nincs megtekintve** — például, ha a vendég egy másik hotelt böngész a Wink-en — a Sojern konténer nem töltődik be. Ez biztosítja, hogy a Sojern csak az ingatlanodra vonatkozó releváns adatokat kapja meg.
...
Ezek az események automatikusan aktiválódnak, ahogy a vendég halad a foglalási folyamatban. Állítsd be a GTM triggerek típusát **Egyedi Esemény** triggerként, az alábbi eseménynévvel.

| Lépés | Esemény | Mikor Aktiválódik |
|-------|---------|-------------------|
| 1 | `view_item_list` | Szálláshely lista vagy rács betöltése |
...
Ezek a paraméterek Wink-specifikus foglalási kontextust hordoznak. A GA4 nem jeleníti meg őket automatikusan a jelentésekben — minden egyes paramétert regisztrálnod kell **elemhez kötött egyedi dimenzióként** a GA4 tulajdonodban, mielőtt megjelennek a jelentésekben vagy elemzésekben. Lásd a [Custom Dimensions in GA4](#custom-dimensions-in-ga4) részt a beállítási útmutatóért.
...
A GA4 figyelmen kívül hagyja az egyedi elem paramétereket a jelentésekben, amíg kifejezetten nem regisztrálod őket elemhez kötött egyedi dimenzióként. Csak azokat a paramétereket kell regisztrálnod, amelyeket használni szeretnél a jelentésekben — nem szükséges mind a 20-at regisztrálni.
...
4. **Mentés és ismétlés**
   ...
   Kattints a **Mentés** gombra, majd ismételd meg minden olyan paraméter esetén, amelyet követni szeretnél.
...
A GA4 standard tulajdonok esetén legfeljebb 50 elemhez kötött egyedi dimenziót engedélyez, a 360-as tulajdonok ennél többet is.
</Aside>

Használd az alábbi táblázatot referenciaként az egyedi dimenziók létrehozásához. Az **Esemény paraméter** értéknek pontosan egyeznie kell — a GA4 kis- és nagybetű érzékeny.
