...
- ***Embed*** Shows you how to embed this link as an [Ad Banner](/developers/web-components#ad-banner) into your website. 
...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developers/web-components#wink-content-loader) Web Component and tell it to fetch an ad banner for your code.
