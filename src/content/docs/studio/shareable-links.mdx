...
If you wish to embed your link as an ad banner into your site, the code above shows you how that is done.
...
- Learn more about our collection of [Web Components](/developer/web-component).
