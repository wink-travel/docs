...
- ***Copy*** Copies the link to your clipboard so you can easily share it anywhere you want (*including [WinkLinks](/winklinks/what-is-a-link-manager)*).
...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developer/web-components#wink-content-loader) Web Component and tell it to fetch an ad banner for your code.
...
Developers who want to manage shareable links can head over to [API > Affiliate > Inventory](https://docs.wink.travel/affiliate/inventory).
