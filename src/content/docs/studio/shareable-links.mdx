...
- ***Use with WordPress*** Shows you how to use our [WordPress plugin](/developer/wordpress) to embed this link into your website.
...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developer/web-component#wink-content-loader) Web Component and tell it to fetch an ad banner for your code.
