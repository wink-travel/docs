...
- **Embed** Shows you how to embed this card as a [Card](/developers/web-components/#content-loader) into your website. 
...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developers/web-components/#content-loader) Web Component and tell it to fetch a guest room card for your code.
