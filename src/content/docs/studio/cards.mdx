---
title: Cards
description: This article steps you through how to create supplier and inventory cards from search results and then promote them on your site.
sidebar:
  order: 7
---
...
- **Embed** Shows you how to embed this card as a [Card](/developers/integrations/web-components/#content-loader) into your website.
...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developers/integrations/web-components/#content-loader) Web Component and tell it to fetch a guest room card for your code.
