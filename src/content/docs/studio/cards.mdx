...
- Lines 6 through 9 shows you how to use the [wink-content-loader](/developer/web-components#wink-content-loader) Web Component and tell it to fetch a guest room card for your code.
...
Developers who want to manage cards can head over to [API > Affiliate > Inventory](https://docs.wink.travel/affiliate/inventory).
