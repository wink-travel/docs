...
2. Click the `Gallery` link to see all photos and videos for this inventory.
3. Click `Best deal` link, if available, to see the best priced room.
4. Click `Hotel details` link, if available, to see property information. 
...
The rest of this article walks you through how to create, customize and expose cards to your users.
...
<CloudinaryImage 
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*A card entry*</figcaption>
</figure>
...
<CloudinaryImage 
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Card actions*</figcaption>
</figure>

Above shows you an image with all the available actions for your card:

- ***Update*** Updates your card configuration.
- ***Add to WinkLinks*** Adds the card to your WinkLinks account as a [Card](/developer/web-components#card).
- ***Embed*** Shows you how to embed this card as a [Card](/developer/web-components#card) into your website. 
- ***Use with WordPress*** Shows you how to use our [WordPress plugin](/developer/wordpress) to embed this card as a [Card](/developer/web-components#card).
...
If you wish to embed your link as a card into your site, the code above shows you how that is done.
