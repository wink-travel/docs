...
- Click on a map marker to see inventory details in the form of a [Card](/studio.card).
...
- ***Embed*** Shows you how to embed this map as a [Map](/developer/web-components#map) into your website. 
- ***Use with WordPress*** Shows you how to use our [WordPress plugin](/developer/wordpress) to embed this map into your website.
...
Developers who want to manage maps can head over to [API > Affiliate > Inventory](https://docs.wink.travel/affiliate/inventory).
