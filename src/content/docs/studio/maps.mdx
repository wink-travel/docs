---
title: Maps
description: This article steps your through how to create maps from lists and search results and then promote them on your site.
sidebar:
  order: 6
---
...
1. Zoom, pan and drag the map to see available inventory.
2. Click on a map marker to see inventory details in the form of a [Card](/studio.card).
...
<CloudinaryImage 
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*A map entry*</figcaption>
</figure>
...
<CloudinaryImage 
      ...
      quality="best"
      alt="Actions"
      src="academy/map-actions" 
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Map actions*</figcaption>
</figure>
