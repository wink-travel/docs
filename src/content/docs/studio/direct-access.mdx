---
title: Direct Access
description: This article shows you how to ask a supplier for a direct relationship.
sidebar:
  order: 10
---

When you first get started as an affiliate on Wink, you find some stuff you want to sell on the platform and share it on social media, your blog etc. 
At some point, you feel that you've become quite proficient with our tools and your selling game is solid. Now what else is there to do on Wink that could level you up even further?

The answer is: Go Direct!

This article shows you how to ask a supplier for a direct relationship that could be beneficial to both of you.
...
4. Supplier responds
    - The supplier accepts your request and a direct sales channel between them and you is created that can be configured in many different ways. 
    - The supplier rejects your request and you will have access to the same inventory as before. You can send another request, at the earliest, two months after the rejection.
