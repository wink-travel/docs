...
- ***Make a link*** Create a link you can easily share in emails, on social media or messaging apps.
- ***Make a map*** Create a map you can use with WinkLinks, WordPress, embed it and more.
- ***Make a card*** Create a card you can use with WinkLinks, WordPress, embed it and more.
...
When you click on `Add to...`, a menu opens up that displays your existing curated lists and a way to create a new list. You can:
...
Continue on to the next section to learn what to do once you find what you were looking for.
