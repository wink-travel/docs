...
פרמטרים אלה נושאים הקשר הזמנה ספציפי ל-Wink. GA4 לא מציג אותם אוטומטית בדוחות — יש לרשום כל אחד מהם כמידה מותאמת אישית ברמת פריט בנכס GA4 שלך לפני שיופיע בדוחות או בחקירות. ראה [מידות מותאמות אישית ב-GA4](#custom-dimensions-in-ga4) למטה להוראות הגדרה.
...
### מידות מותאמות אישית ב-GA4

GA4 מתעלם מפרמטרים מותאמים אישית ברמת פריט בדוחות עד שתירשם אותם במפורש כמידות מותאמות אישית ברמת פריט. יש לרשום רק את הפרמטרים שאתה מתכוון להשתמש בהם בדוחות — אין צורך לרשום את כל 18.
...
2. **צור מידה מותאמת אישית חדשה**

   לחץ על **Create custom dimensions**.

3. **מלא את פרטי המידה**

   - **שם המידה** — התווית הקריאה לבן אדם שמופיעה בדוחות GA4 (ראה טבלה למטה)
   - **Scope** — בחר **Item**
...
<Aside type="note">
מידות מותאמות אישית עשויות להופיע בדוחות GA4 עד 24 שעות לאחר הרישום. נתונים היסטוריים שנאספו לפני הרישום אינם מתווספים בדיעבד.

GA4 מאפשר עד 50 מידות מותאמות אישית ברמת פריט לנכס סטנדרטי (נכסי 360 מאפשרים יותר).
</Aside>

השתמש בטבלה הבאה כהפניה בעת יצירת מידות מותאמות אישית. ערך **Event parameter** חייב להתאים במדויק — GA4 רגיש לאותיות גדולות וקטנות.
...
האירועים הבאים זמינים ב-dataLayer של Wink אך אינם חלק ממשפך ההזמנה הסטנדרטי. הם עשויים להיות מופעלים על ידי אינטראקציות אחרות בפלטפורמה.
...
לא מצורף מטען `ecommerce` לאירוע זה.
