...
<Steps>
1. [הרשמו](/he/getting-started/sign-up) לחשבון המשתמש שלכם ב-Wink.
...
3. [צרו אפליקציה](/he/account/applications) וקשרו אותה לחשבון השותף שיצרתם בשלב 2. לאינטגרציות API מסוג שרת-לשרת, בחרו ב-**MACHINE_2_MACHINE** כסוג הלקוח.
