...
- הצגת מלאי הזמין להזמנה בפורמט, שפה ומטבע הרצויים, כגון:
    ...
    - דף נחיתה של מלון בכתובת https://book.wink.travel עם מלאי עבור אותו מלון.
...
מנוע ההזמנות הוא אוסף של פונקציות שניתן להשתמש בהן שוב, שאנו מציגים דרך https://book.wink.travel; אתר אינטרנט שניתן להתאמה אישית גבוהה עבור מלונות ושותפים למכירת מוצריהם למטיילים.
