...
* הצגת מלאי הניתן להזמנה בפורמט, בשפה ובמטבע הרצויים, כגון:
  ...
  * א [מַפָּה](/studio/maps) על שלך [מַפָּה](/studio/maps) חשבון.
...
למשתלבים, שרוצים עוד יותר חופש, יש גישה לכל אותן תכונות דרך שלנו [תוסף וורדפרס](/developers/wordpress/), [תוסף וורדפרס](/developers/wordpress/) ו[ממשקי API](/developers/apis).
