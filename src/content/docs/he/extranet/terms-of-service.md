...
**Winkfluence**, חברה שהוקמה על פי חוקי סינגפור ומשרד רשום בכתובת \#03-01 Wilkie Edge, 8 Wilkie Road, Singapore 228095 עם מספר רישום מע"מ 201437335D ("Wink"), ו-
...
**"Payment Facilitator"** חברת בת בבעלות מלאה של Winkfluence ("TripPay"), המנהלת את שירותי התשלום, אוספת תשלומים מהאורחים ("Pay-in"), על ידי חיוב אמצעי התשלום המשויך לרכישתם, כגון כרטיס אשראי, כרטיס חיוב, העברה בנקאית, מטבעות קריפטו או PayPal וכו', ומפזרת את הסכום המגיע ("מחיר נקי") לספק האירוח.
