...
**"Payment Facilitator"** חברת בת בבעלות מלאה של Winkfluence, המנהלת את שירותי התשלום, אוספת תשלומים מאורחים ("Pay-in"), על ידי חיוב שיטת התשלום המשויכת לרכישתם, כגון כרטיס אשראי, כרטיס חיוב, העברה בנקאית, מטבעות קריפטו או PayPal וכו'... ומפזרת את הכספים המגיעים ("עמלת נטו") לחשבון הבנק המקומי של השותף.  
