...
<Aside type="tip">
Eeldatakse, et teil on juba GTM konteineri ID (vormingus `GTM-XXXXXXX`). Kui teie konteiner pärineb partnerilt nagu Sojern, küsige oma kontohaldurilt spetsiaalselt **GTM konteineri ID** — see erineb pikslist või sildi ID-st. Uus Sojernis? Alustamiseks külastage [sojern.com/contact](https://www.sojern.com/contact).
</Aside>
...
2. **Sisestage see Wink portaali**
   ...
   Logige sisse [app.wink.travel](https://app.wink.travel), valige oma konto ja avage kohandamise seaded. Jaotises **Analytics & integrations** kleepige oma GTM konteineri ID välja **GTM Container ID** ja salvestage. Teie integratsioon on nüüd aktiivne.
...
Wink lähtestab ecommerce objekti enne iga sündmuse pushi:
...
Ärge lootke, et ecommerce omadused püsivad sündmuste vahel. Lugege neid alati käivitamise ajal samas sündmuses.
</Aside>
