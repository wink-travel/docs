...
- [Makse veebikomponent](/et/integrations/web-components/#payment).
- [Makse API](/et/api). *Lugege jaotist `Loo tasumisele kuuluvad lepingud`*
...
2. Laske reisijal valida soovitud inventar ja valmistuge makseks.
...
Me ei selgita siin iga andmepunkti, kuna need on juba API dokumentatsioonis kaetud.
...
- Read: **8 - 9** on TripPay konto, mis broneeringut vahendab. See võib olla:
    ...
    - Kui haldate sidusvõrku, võib see olla teie sidusettevõte.
- Kasutage `traceId`, et grupeerida mitut broneeringut mitme tarnija vahel. Nii saate tühistada grupibroneeringu.
...
- Iga kirje `contractItemList` all sisaldab:
    - **Külaliskasutaja** See on kasutaja, kes saabub kohale.
    - **Nimi inglise keeles** Inventari nimi inglise keeles.
    - **Kirjeldus inglise keeles** Pikem kirjeldus inventarist inglise keeles.
    - **Hind** Üksuse hind.
    - **Reisiplaan** Millal see üksus tuleks broneerida.
    - **Hinnatüüp** Kuidas hind arvutati.
    - **Inventari tüüp** Mis tüüpi inventar see on.
    - **Tasumisele kuuluv** Millal reisijalt tasu võetakse. *Praegu toetame ainult kohest makset.*
