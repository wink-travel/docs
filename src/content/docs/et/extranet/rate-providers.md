...
Hinnapakkuja määramiseks klõpsake põhimenüüst `Distribution > Channel manager`.

Valige rippmenüüst oma hinnapakkuja ja klõpsake nuppu `Save`. See võimaldab hinnapakkujal saata meile hindu ning me teavitame neid, kui Winkis toimub broneering mõne teie kinnisvara kohta.
...
- Nad paluvad teil täita vormi ***PRS***.
  ...
  - ...ja soovitud valuuta.
- Täitke vorm ja saatke see tagasi SynXisele.

## Tarnijad

Allpool on nimekiri tarnijatest, keda me toetame:

Saadaval tüübid:

- Kanalihaldur (CM)
- Kinnisvara haldussüsteem (PMS)
- Keskne broneerimissüsteem (CRS)

*Kui tarnijal on esindaja, tähendab see, et me saame hindu tarnijalt esindaja kaudu kaudselt.*

| Tarnija | Tüüp | Esindaja | Alates | Viimati muudetud | Kommentaar
| -- | -- | -- | -- | -- | -- |
