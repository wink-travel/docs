...
:::note
Testimine peaks alati toimuma meie [testkeskkonnas](/et/getting-started/environments). Seal on palju vähem andmeid, kuid võid testida nii palju kui soovid, ilma tootmiskeskkonda koormamata.
...
<Steps>
1. [Registreeri](/et/my-account/register) oma kasutajakonto Winkis.
2. [Loo sidusettevõtte konto](/et/my-account/create-account). Seda vajad oma rakenduse sidumiseks. Vaata lisateavet [mis on Studio](/et/studio/what-is-studio).
3. [Loo rakendus](/et/my-account/applications) ja seo see 2. sammus loodud sidusettevõtte kontoga. Serveri-serveri API integratsioonide puhul vali klienditüübiks **MACHINE_2_MACHINE**.
...
Mine meie [API-de](/et/developers/apis) sektsiooni ja vali API, millega soovid töötada.
...
:::tip[Pro näpunäide]
Mugavuse huvides soovitame integreerijatel kasutada meie määratud `OAuth2` lõpp-punkte. Need lõpp-punktid ootavad API kutsujaid ja teavad juba, millise kontoga oled, nii et sa ei pea URL-ides `companyIdentifier`-it määrama.
:::
...
:::tip[Pro näpunäide]
Soovitame muuta serveri domeen, kliendi ID ja kliendi salajase võtme keskkonnamuutujateks. Nii saad lihtsalt vahetada test- ja tootmiskeskkondade vahel ning taaskasutada kõiki loodud toiminguid.
:::
