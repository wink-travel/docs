...
Kui oled valmis tootmiskeskkonda minema, sertifitseerime sinu konto ja sinu rakenduse ning saad käivitada tootmiskeskkonnas.
:::

Järgi neid samme:

<Steps>
1. [Registreeri](/et/user/register) oma kasutajakonto Winkis
2. Loo [reisibüroo konto](/et/travel-agent/what-is-agent) või [affiliate konto](/et/studio/what-is-studio).
3. [Loo rakendus](/et/developer/applications), kus seod selle kontoga, mille lõid sammus 2.
...
Mine meie [API-de](/et/developer/apis) sektsiooni ja vali API, millega soovid töötada.
...
:::tip[Pro näpunäide]
Lihtsuse huvides soovitame integreerijatel kasutada lõpp-punkte, mida me nimetame `OAuth2`. Need lõpp-punktid ootavad API-kõne tegijaid ja teavad juba, millise kontoga oled, nii et sa ei pea URL-ides `companyIdentifier`-it määrama.
:::
...
:::tip[Pro näpunäide]
Soovitame muuta serveri domeen, client ID ja client secret keskkonnamuutujateks. Nii saad lihtsalt vahetada test- ja tootmiskeskkondade vahel ning taaskasutada kõiki loodud toiminguid.
:::
