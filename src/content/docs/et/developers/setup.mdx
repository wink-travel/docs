...
<Steps>
1. [Registreeri](/et/getting-started/sign-up) oma kasutajakonto Winkis.
...
3. [Loo rakendus](/et/account/applications) ja seo see 2. sammus loodud sidusettevõtte kontoga. Serveri-serveri API integratsioonide puhul vali klienditüübiks **MACHINE_2_MACHINE**.
