...
description: Wink haldab JavaScripti veebikomponentide teeki, mida saate oma saidile manustada.
sidebar:
  order: 6
---
...
Selle laheda tehnoloogia abil saate Wink reisiinventari hõlpsasti manustada. See artikkel juhendab teid meie veebikomponentide kogu kasutamisel.
...
Näidiseid leiate [kaartide](/et/studio/cards), [võrgustike](/et/studio/grids) ja [kaartide](/et/studio/maps) kohta.
...
Otsing on reisiplaani valija ikooninupp. Kui sellele klõpsata, avaneb täisreisiplaani valija modaalaknas.
...
:::note
Selleks, et õppida, kuidas genereerida broneerimislepingu `id`, lugege juhendit: [Integrating with TripPay](/et/guides/integrating-with-trip-pay).
:::
...
Kui teil kuvatakse veateade, kui manustate mõnda meie veebikomponenti, kas WinkLinksis või oma veebisaidil, võib olla mitu võimalikku põhjust:

### Saadavus

Inventar ei pruugi enam saadaval olla. Minge [Wink Studio](/et/studio/cards) ja kontrollige, kas "kaardi" olek on saadaval.
Kui see pole saadaval, kuvatakse see punasena. Sellisel juhul võite oodata, kuni tarnija teeb selle uuesti kättesaadavaks või eemaldada selle oma nimekirjast.
...
Inventar võis olla eemaldatud. Minge [Wink Studio](/et/studio/cards) ja kontrollige, kas "kaardi" olek on saadaval.
Kui see pole saadaval, kuvatakse see punasena. Sellisel juhul võite oodata, kuni tarnija teeb selle uuesti kättesaadavaks või eemaldada selle oma nimekirjast.
...
See on mõeldud ainult veebiarendajatele. Kui eemaldasite kogemata [Rakenduse](/et/developer/applications), muutes kliendi ID enam kättesaamatuks, looge uus rakendus ja kasutage uut kliendi ID-d meie veebikomponentide manustamiseks.
