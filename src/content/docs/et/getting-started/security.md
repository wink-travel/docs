...
Ulatuses olevad domeenid:  
\*.wink.travel  
\*.trippay.io

## Testimise sagedus ja ajakava

Meie sissetungimise testid viiakse läbi kord aastas ning lisatestid ajastatakse vajadusel pärast rakenduse või infrastruktuuri olulisi uuendusi. See regulaarne testimistsükkel tagab, et hoiame sammu muutuvate ohtudega ja säilitame turvalise keskkonna.
...
Oleme võtnud järgmised sammud tuvastatud haavatavuste lahendamiseks:
...
Sissetungimise testimine on osa meie laiemast strateegiast pidevaks turvalisuse parandamiseks. Iga testi leiud juhivad meie turvapoliitikaid, mõjutavad arenduspraktikaid ja suunavad täiustusi meie turvarhitektuuris.
...
## Aruande juurdepääs ja uuendused

Seda dokumenti uuendatakse pidevalt, kui väljastatakse uusi sissetungimise testimise aruandeid. Täieliku aruande saamiseks palun võtke meiega ühendust alloleva e-posti aadressi kaudu. Tulevased uuendused sisaldavad uusi tuvastatud haavatavusi, parandusmeetmeid ja meie testimismetoodikate kohandusi.
