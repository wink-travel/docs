...
See on mõeldud ainult veebiarendajatele. Kui eemaldasite kogemata [Rakenduse](/et/account/applications), muutes kliendi ID enam kättesaamatuks, looge palun uus rakendus ja kasutage uut kliendi ID-d meie veebikomponentide manustamiseks.
