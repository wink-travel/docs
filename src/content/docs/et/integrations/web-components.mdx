...
See on mõeldud ainult veebiarendajatele. Kui eemaldasite kogemata [Rakenduse](/et/my-account/applications), muutes kliendi ID enam kättesaamatuks, looge uus rakendus ja kasutage uut kliendi ID-d meie veebikomponentide manustamiseks.
