...
Näidiseid leiate [kaartide](/et/portal/studio/cards), [võrgustike](/et/portal/studio/grids) ja [kaartide](/et/portal/studio/maps) kohta.
...
:::note
Selleks, et õppida, kuidas genereerida broneerimislepingu `id`, lugege juhendit: [Integrating with TripPay](/et/guides/developers/integrating-with-trip-pay).
:::
...
Kui see pole saadaval, kuvatakse see punasena. Sellisel juhul võite oodata, ehk teeb tarnija selle uuesti kättesaadavaks või eemaldada selle oma nimekirjast.
...
See on mõeldud ainult veebiarendajatele. Kui eemaldasite kogemata [Rakenduse](/et/portal/settings/applications), muutes kliendi ID enam kättesaamatuks, looge uus rakendus ja kasutage uut kliendi ID-d meie veebikomponentide manustamiseks.
