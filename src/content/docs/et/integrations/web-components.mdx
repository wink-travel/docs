...
Näiteid leiate [kaartide](/et/portal/studio/cards), [võrgustike](/et/portal/studio/grids) ja [kaartide](/et/portal/studio/maps) kohta.
...
:::note
Selleks, et õppida, kuidas broneerimislepingu `id` genereerida, lugege juhendit: [Integrating with TripPay](/et/guides/developers/integrating-with-trip-pay).
:::
...
Inventar ei pruugi enam saadaval olla. Minge [Wink Studio](/et/portal/studio/cards) ja kontrollige, kas "kaardi" olek on saadaval.
...
Inventar võis olla eemaldatud. Minge [Wink Studio](/et/portal/studio/cards) ja kontrollige, kas "kaardi" olek on saadaval.
Kui see pole saadaval, kuvatakse see punasena. Sellisel juhul võite oodata, kuni tarnija selle uuesti saadavaks teeb, või eemaldada selle oma nimekirjast.
...
See on mõeldud ainult veebiarendajatele. Kui eemaldasite kogemata [Rakenduse](/et/portal/settings/applications), muutes kliendi ID enam kättesaamatuks, looge palun uus rakendus ja kasutage uut kliendi ID-d meie veebikomponentide manustamiseks.
