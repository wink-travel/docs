...
Inclou el nostre Javascript a la part inferior del teu document. (*Recomanem just a sobre de la etiqueta final &lt;/body&gt;*).
...
Canviar l’itinerari, en qualsevol dels nostres components d’itinerari, activa l’esdeveniment d’actualització d’itinerari a qualsevol inventari que tinguis actualment mostrant a la pàgina.
...
Això és només per a desenvolupadors web. Si has eliminat accidentalment la [Aplicació](/ca/developer/applications) ; fent que l’ID de client ja no estigui disponible, crea una nova aplicació i utilitza el nou ID de client per incrustar els nostres Components web.
