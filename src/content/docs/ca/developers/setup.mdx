...
<Steps>
1. [Registra’t](/ca/getting-started/sign-up) el teu compte d’usuari a Wink.
...
3. [Crea una Aplicació](/ca/account/applications) i associa-la amb el compte d’afiliat que vas crear al Pas 2. Per a integracions API servidor a servidor, tria **MACHINE_2_MACHINE** com a tipus de client.
