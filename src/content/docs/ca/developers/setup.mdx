...
2. [Crea un compte d’afiliat](/ca/portal/create-account). Necessitaràs aquest per vincular-hi la teva Aplicació. Consulta [què és Studio](/ca/portal/studio/what-is-studio) per a més context.
