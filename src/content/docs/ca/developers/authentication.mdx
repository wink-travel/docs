...
- `Wink-Version` = `2.0` Última versió - *Consulteu la nostra documentació API per a altres versions disponibles.*
...
Agafeu un 'Client ID' i una 'Secret Key' d'una de les vostres aplicacions i navegueu a qualsevol de les nostres [APIs](/ca/developers/apis).
:::
