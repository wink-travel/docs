...
llista d’àmbits separats per espais al paràmetre `scope`, i el token només pot accedir a les àrees
...
**Pagament** i **Comptabilitat** gestionen moviment de diners, per això tenen un risc elevat.
:::
...
Agafeu un 'Client ID' i una 'Secret Key' d’una de les vostres aplicacions i navegueu per qualsevol de les nostres [APIs](/ca/api/overview/).
:::
