...
3. El teu sistema fa el seguiment de les seves pròpies analítiques i utilitza aquest esdeveniment per actualitzar la seva base de dades de sèries temporals.
</Steps>
...
:::caution
Cal que creïs un compte afiliat a Wink o un compte a TripPay abans de crear un webhook, ja que vincularàs el webhook a un compte específic.
:::
