...
Les polítiques de cancel·lació determinen com es gestionen els fons del reservador en cas que el client no pugui assistir. Les polítiques de cancel·lació es presenten en dues variants diferents:
...
Per crear una política de cancel·lació, fes clic al botó `Create a new cancellation policy`.

## No reemborsable

Per crear una política de cancel·lació no reemborsable, posa l'interruptor a 🛑 off quan et preguntin si la política és reemborsable.
...
Per crear una política de cancel·lació reemborsable, posa l'interruptor a ✅ on quan et preguntin si la política és reemborsable.
