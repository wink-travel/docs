...
description: Aquest article conté els nostres termes del servei per a agents de viatges a la plataforma Wink.
sidebar:
  order: 4
---

:::note
Última actualització 2024-10-30
:::

:::caution[Avís]
Els termes del servei següents s'apliquen als agents de viatges que desitgin adquirir i distribuir fons pel seu compte.  
Això només es pot fer a través de la nostra API i només pels agents de viatges que hagin indicat que volen fer-ho durant el procés de registre.

Tots els agents de viatges encara poden reservar a través del nostre portal per a agents de viatges utilitzant la passarel·la de pagament de Wink amb la seva pròpia targeta de crèdit o la del viatger. Per tant, tots els agents de viatges també han d'acceptar els termes del servei on la passarel·la de pagament de Wink és el comerciant registrat.

Aquests termes estan disponibles a [Affiliate Portal > Terms of Service](/ca/portal/studio/terms-of-service).
:::
...
1. **Winkfluence**, una empresa constituïda sota les lleis de Singapur i amb domicili social a \#03-01 Wilkie Edge 8 Wilkie Road Singapore 228095 amb número de registre d'IVA 201437335D (d'ara endavant "Wink") i  
     
2. **L'AGENT DE VIATGES** les dades del qual consten al Formulari de registre d'agent de viatges o s'han enviat en línia (l'"Agent de viatges").
...
(v) L'Agent de viatges i Wink desitgen que l'Agent de viatges posi el Servei (directa o indirectament) a disposició dels seus clients i visitants dels llocs web i aplicacions de l'Agent de viatges i en la forma i sota els termes i condicions (d'ara endavant els "Termes") establerts en aquest Acord.

**PER TANT, LES PARTS ACORDEN EL SEGÜENT:**

**1\. Definicions**

1. A més dels termes definits en altres parts d'aquest Acord, s'apliquen les definicions següents a tot l'Acord tret que s'indiqui el contrari:
...
* **“Força major”** significa qualsevol esdeveniment fora del control raonable d'una part, incloent però no limitat a desastres naturals, actes de guerra, terrorisme, disturbis civils, pandèmies i accions governamentals, que impedeixen que una part compleixi les seves obligacions sota aquest Acord.  
    
* **“Hoste”** significa un individu o grup que fa una reserva a través de l'Agent de viatges per a serveis d'allotjament.  
    
* **"Comerciant registrat"** es refereix a l'entitat legalment autoritzada i responsable de processar els pagaments dels Hostes, incloent la gestió de transaccions de pagament, reemborsaments, devolucions i assegurant el compliment de les regulacions de pagament. El Comerciant registrat és l'entitat el nom de la qual apareix a l'estat de compte de la targeta de crèdit de l'Hoste per càrrecs relacionats amb la Reserva.
...
* **"Facilitador de pagament"** és una filial de propietat total de Winkfluence que gestiona els Serveis de Pagament, recaptant pagaments dels hostes carregant el mètode de pagament associat a la seva compra, com targeta de crèdit, targeta de dèbit, transferència bancària, criptomonedes o PayPal, etc.  
...
3.5 **Facturació de Wink:** Wink emetrà una factura mensual a l'Agent de viatges per la comissió de reserva del 1,5% acumulada durant el mes. L'Agent de viatges és responsable de liquidar aquesta factura dins dels terminis de pagament especificats.
...
* Wink no serà responsable dels pagaments als Proveïdors d'allotjament. L'Agent de viatges té la responsabilitat exclusiva de totes les transaccions financeres amb els Proveïdors d'allotjament.  
...
5.1 **Llicències:** Cada Part concedeix a l'altra una llicència limitada, no exclusiva, lliure de royalties i mundial per utilitzar la seva propietat intel·lectual exclusivament per complir les obligacions d'aquest Acord.
...
* En cas de disputa sobre qualsevol factura, l'Agent de viatges notificarà a Wink dins dels 10 dies següents a la data de la factura, proporcionant raons detallades per la disputa. Ambdues parts negociaran de bona fe per resoldre la disputa ràpidament. La part no disputada de la factura es pagarà en la data de venciment.

**7\. Responsabilitats de l'Agent de viatges**

7.1 **Compliment de lleis i regulacions:**

* L'Agent de viatges complirà totes les lleis, regulacions i estàndards aplicables locals, nacionals i internacionals en la seva activitat, incloent però no limitat a la protecció del consumidor, protecció de dades i prevenció del blanqueig de capitals.  
...
* L'Agent de viatges promourà activament els serveis oferts a través de la Plataforma d'acord amb les directrius proporcionades pel Proveïdor de Serveis. Això inclou activitats de màrqueting, manteniment de materials promocionals actualitzats i assegurar que tot el contingut promocional sigui precís i compleixi amb els estàndards publicitaris aplicables.

7.4 **Gestió de reserves:**

* L'Agent de viatges gestionarà totes les reserves fetes a través de la Plataforma, incloent el processament de reserves, cancel·lacions i modificacions. L'Agent de viatges serà responsable de comunicar-se amb els Hostes i Proveïdors d'allotjament per assegurar que totes les reserves es processin i confirmin correctament.

7.5 **Recaptació i remesa de pagaments:**
...
7.6 **Gestió de queixes i disputes dels Hostes:**

* L'Agent de viatges serà el punt de contacte principal per als Hostes respecte a qualsevol queixa, disputa o problema relacionat amb els serveis proporcionats a través de la Plataforma. L'Agent de viatges farà esforços raonables per resoldre aquestes queixes i disputes ràpidament i de manera que mantingui una relació positiva amb els Hostes i Proveïdors d'allotjament.
...
8.2 **Comissió de reserva de Wink:** Wink emetrà una factura mensual per la comissió de reserva del 1,5%. L'Agent de viatges és responsable de liquidar aquesta factura dins dels terminis de pagament especificats per Wink.
...
10.1 **Durada:** Aquest Acord començarà en la data d'execució i continuarà fins que qualsevol de les parts el rescindeixi.

10.2 **Terminació:** Qualsevol de les parts pot rescindir aquest Acord a la seva discreció.

10.3 **Post-terminació:** En finalitzar, l'Agent de viatges haurà de liquidar tots els pagaments pendents i cessar l'ús de qualsevol propietat intel·lectual o contingut relacionat amb Wink.

**11\. Legislació aplicable i resolució de conflictes**

11.1 **Legislació aplicable:** Aquest Acord es regirà i interpretarà d'acord amb les lleis de Singapur, sense tenir en compte els seus principis de conflicte de lleis.
...
* Obligacions de l'Agent de viatges: L'Agent de viatges no serà responsable de cap obligació envers el vostre negoci que sigui impossible de complir a causa de l'esdeveniment de força major. No obstant això, l'Agent de viatges haurà de continuar complint totes les altres obligacions no afectades directament per l'esdeveniment.

12.4 **Durada i terminació:** Si l'esdeveniment de força major dura més de seixanta (60) dies, qualsevol de les parts pot rescindir aquest Acord mitjançant notificació escrita a l'altra part. En cas de terminació, cap de les parts tindrà responsabilitat envers l'altra excepte per les obligacions acumulades abans de l'esdeveniment de força major.
...
13.1 Ambdues parts mantindran la confidencialitat de tota la informació propietària i no la revelaran a cap tercer sense consentiment previ per escrit.

**14\. Diversos**

14.1 **Acord complet:** Aquest Acord constitueix l'acord complet entre les parts i substitueix tots els acords o enteses anteriors.
