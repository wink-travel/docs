...
- [Payment Web Component](/ca/integrations/web-components/#payment).
- [Payment API](/ca/api). *Llegeix la secció sobre `Create payable contracts`*
...
### Sol·licitud
Aquí tens un exemple de sol·licitud JSON que inclou tot el que necessites per crear el teu primer contracte pagable.
...
- 1,5% s’ha assignat a la plataforma que va facilitar la reserva. *p. ex. Wink*
- 9,85% s’ha assignat a l’afiliat com a comissió. *p. ex. Kim Kardashian*
- 88,65% s’ha assignat al proveïdor per la reserva de l’habitació. *p. ex. Hilton*
...
Pel que fa a la integració, això és tot el que necessites fer. Tot el treball pesat el fa TripPay a partir d’aquí.
