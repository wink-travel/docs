---
title: Integració d'Analytics amb GTM
description: Com connectar qualsevol contenidor de Google Tag Manager (com un contenidor Sojern) a Wink perquè pugui fer el seguiment del procés de reserva dels teus clients i potenciar les teves campanyes de retargeting i publicitat.
sidebar:
  label: Integració d'Analytics amb GTM
---
...
<Aside type="tip">
Això pressuposa que ja tens un ID de Contenidor GTM (format `GTM-XXXXXXX`). Si el teu contenidor prové d'un soci com Sojern, demana al teu gestor de compte l'**ID de Contenidor GTM** específicament — és diferent d'un ID de píxel o etiqueta. Nou a Sojern? Visita [sojern.com/contact](https://www.sojern.com/contact) per començar.
</Aside>
...
<Aside type="note">
No cal que col·loquis cap codi de píxel al teu propi lloc web per a aquesta integració. Wink carrega automàticament el teu contenidor GTM a totes les pàgines on la teva propietat està activa.

Això funciona per a **qualsevol** ID de Contenidor GTM — Sojern és només un exemple habitual.
</Aside>
...
Aquests paràmetres porten context específic de reserva de Wink. GA4 no els mostra automàticament als informes — has de registrar cadascun com a **dimensió personalitzada a nivell d'article** a la teva propietat GA4 abans que apareguin a exploracions o informes estàndard. Consulta [Dimensions personalitzades a GA4](#custom-dimensions-in-ga4) més avall per a les instruccions.
