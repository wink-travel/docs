...
<Steps>
1. **Crea contingut** en el teu idioma principal — manualment o utilitzant [registre assistit per IA](/ca/guides/hoteliers/ai-assisted-registration).
...
1. **Registra la teva propietat** utilitzant [registre assistit per IA](/ca/guides/hoteliers/ai-assisted-registration) — L'IA genera contingut en el teu idioma principal.
2. **La traducció s'activa automàticament** — Wink crea tasques de traducció per a tots els idiomes habilitats.
3. **Revisa les traduccions clau** — Mentre la traducció automàtica gestiona la major part, revisa les traduccions importants (com el text de benvinguda) per assegurar-ne l'exactitud.
...
- [Registre assistit per IA](/ca/guides/hoteliers/ai-assisted-registration) — Registra una propietat amb IA i traducció automàtica.
