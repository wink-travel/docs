...
- Staging és el nostre entorn de certificació i proves.

Si ets un integrador, un hotel o una agència de viatges que vol preparar-se per a la certificació o provar la plataforma Wink, crea un compte al nostre entorn staging per començar.

:::note
L'entorn staging està disponible sota demanda. Això vol dir que s'apaga si no hi ha ús i es torna a encendre quan n'hi ha. Si l'estàs despertant, si us plau, tingues paciència. Triga aproximadament un minut a iniciar tots els servidors després de connectar-te per primera vegada amb un dels nostres servidors o aplicacions.
:::
