...
- **Visualització inicial** Controla com el teu públic interactua primer amb el teu lloc i veu el teu contingut. Tens tres opcions disponibles:
    ...
    - Disseny `basat en llista`. La majoria d’altres gestors d’enllaços mostren una llista simple amb una URL i contingut mínim. Tria aquesta manera de mostrar el teu contingut si en tens molt i vols que es mostri tan ràpidament com sigui possible.
...
- **Personalització** Tria quina personalització vols utilitzar per a la teva pàgina de WinkLinks. Això afecta els colors del tema així com l’itinerari quan es mostren targetes d’inventari de Wink, mapes o graelles.
...
- Llegeix més sobre [Personalitzacions](/ca/studio/customization).
