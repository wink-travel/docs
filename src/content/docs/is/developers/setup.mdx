...
<Steps>
  1. Notaðu [Leitarforritaskil](https://developer.wink.travel/lookup) til að sækja áfangastaði eða hótel.
...
<Steps>
  ...
  2. Smelltu á `Download OpenAPI spec` frá toppnum á [Leitarforritaskil](https://developer.wink.travel/lookup) síðu.
