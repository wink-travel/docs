...
description: Kynnir Wink og þjónustuna og hvert á að fara næst.
sidebar:
  order: 0
---
...
Hver gátt getur haft mismunandi persónuverndarstillingar. Farðu í viðeigandi kafla hér að neðan og leitaðu að undirkaflanum Persónuvernd. Ef slíkur undirkafli er ekki til, lestu okkar [algenga persónuvernd viðskiptavina](/is/booking-engine/privacy).
...
WinkLinks lyftir sölu þinni á netinu á næsta stig og gefur IG bio tenglinum þínum ferskt útlit.
