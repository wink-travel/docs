...
description: Þessi skjöl fjalla um framboð fjármuna og hvernig Wink styður umboðsaðilalíkanið fyrir ferðaskrifstofur.
sidebar:
  order: 5
---
...
:::caution[Athugið]
Greiðsluskilmálar hér að neðan gilda fyrir ferðaskrifstofur sem vilja afla og úthluta fjármunum sjálfar.  
...
Allar ferðaskrifstofur geta enn bókað í gegnum ferðaskrifstofuvettvanginn okkar með greiðslugátt Wink með eigin eða kreditkorti ferðalangsins. Því þurfa allar ferðaskrifstofur einnig að samþykkja greiðsluskilmála þar sem greiðslugátt Wink er kaupmaður skráður.
