...
- **Pakkaðar kynningartilboð** Bættu við þeim pakkaða kynningartilboðum sem þú vilt að þessi sölurás hafi.
- **Virkjað** Kveiktu eða slökktu á rofanum til að virkja eða óvirkja sölurásina alveg.
- **Svartlistað** Að merkja sölurás sem svartlistaða gerir það ómögulegt að bóka í gegnum þessa sölurás.

Þegar þú ert ánægður með stillingarnar, smelltu á `Save` hnappinn til að halda áfram.

:::tip
Með því að svartlista sölurás gerir þú það ómögulegt fyrir sölurásina að fá neinar verðskrár frá þér; jafnvel ekki Wink Network-verðskrár þínar.
:::
...
Í þessum hluta getur þú séð beiðnir sem bíða samþykkis frá samstarfsaðilum efst á síðunni og lista yfir samstarfsaðila til að tengjast neðst.
...
Í samstarfsaðilagrindinni getur þú leitað að samstarfsaðilum eftir nafni, tegund og staðsetningu. Þegar þú sérð einhvern sem þér líkar, smelltu á hann og þú ferð á `affiliate details` síðuna.
...
Þegar þú hefur vistað nýju sölurásina, verður þú fluttur aftur á listann þinn yfir sölurásir.

## API

Forritarar sem vilja stjórna `Network` geta farið á [Developers > APIs > Distribution](/is/api/overview/).
