...
:::tip
CalDAV er staðlað dagatals samskiptaprotókoll sem flest dagatalsforrit styðja, þar á meðal Google Calendar, Apple Calendar og Outlook. Bættu einfaldlega slóðinni við sem nýju dagatalsáskrift í uppáhaldsforritinu þínu.
:::
...
3 dögum eftir að gestur hefur útritun, fær gesturinn tölvupóst frá okkur þar sem óskað er eftir að hann skrifi umsögn um gististaðinn þinn.
...
Forritarar sem vilja stjórna `Booking` geta farið á [Developers > API > Property Booking](/is/api/overview/).
