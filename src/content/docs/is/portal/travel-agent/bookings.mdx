...
<Steps>
1. Rásarstjórinn þinn, CRS eða PMS fær tilkynningu.
...
Til að endursenda staðfestingar tölvupóst til ferðalangsins, smelltu á `Actions > Resend confirmation email`.
...
*Þessi hnappur fylgir reglum afpöntunarstefnu þinnar og verður því ekki alltaf tiltækur.*
