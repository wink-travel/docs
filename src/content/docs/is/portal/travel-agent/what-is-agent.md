---
title: Hvað er Agent?
description: Lærðu hvernig Wink styður skráða ferðaskipuleggjendur.
sidebar:
  order: 0
---
...
Forritarar sem vilja stjórna `Travel Agent` geta farið á [Developers > API > Travel Agent](/is/api).
