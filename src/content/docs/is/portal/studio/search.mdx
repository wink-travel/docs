...
1. Veldu tengda aðganginn sem þú vilt vinna með úr [lista yfir aðganga](https://studio.wink.travel/company/list)
...
Ef þú ert að leita að ákveðnum birgja en finnur hann ekki, verður þér sýnt form til að fylla út sem leyfir þér að finna það sem þú ert að leita að á Google Places. Ef það er til á Google Places, getur þú búið til `lead` á Wink.
