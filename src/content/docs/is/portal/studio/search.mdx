...
- **Búið til tengil** [Búðu til tengil](/is/portal/studio/shareable-links) sem þú getur auðveldlega deilt í tölvupósti, á samfélagsmiðlum eða í skilaboðaöppum.
- **Búið til kort** [Búðu til kort](/is/portal/studio/maps) sem þú getur notað með WinkLinks, WordPress, fellt inn og fleira.
- **Búið til spjald** [Búðu til spjald](/is/portal/studio/cards) sem þú getur notað með WinkLinks, WordPress, fellt inn og fleira.
...
- Umbreyting leitarniðurstaðna í [Spjöld](/is/portal/studio/cards).
