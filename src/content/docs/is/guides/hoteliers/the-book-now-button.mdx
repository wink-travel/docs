...
Fyrir einföldustu samþættingu mælum við með að nota [Deilanlegan Tengil](/is/portal/studio/shareable-links).
...
13. Til að sækja `Client-ID` þitt, farðu á [Applications](/is/portal/settings/applications).  
14. Til að sækja `Configuration-ID` þitt, farðu á [Customization](/is/portal/settings/branding)  
14. Þú ert ✅.  
</Steps>
