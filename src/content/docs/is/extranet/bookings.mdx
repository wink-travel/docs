...
<Steps>
1. Rásastjórinn þinn, CRS eða PMS fær tilkynningu.
...
Smelltu á `Yes` hnappinn til að halda áfram eða 'No' ef þú breyttir um skoðun.
...
Þegar þú hefur lokið þessu skrefi og bætt CalDAV slóðinni við dagatalsforritið þitt, mun dagatalið byrja að sýna bókanir frá Wink.
...
3 dögum eftir að gestur hefur skráð sig út fær gesturinn tölvupóst frá okkur þar sem óskað er eftir að hann meti gististaðinn þinn.
