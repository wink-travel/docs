---
title: Greiningar
description: Þessi grein sýnir þér hvernig á að stjórna greiningum þínum á Wink Travel Platform.
sidebar:
  order: 14
---
...
Þekking er lífsblóð Wink. Hún segir þér hvernig allir og allt eru að standa sig á Wink, niður í klukkustund. Áður en Wink kom fram á sjónarsviðið gerðu hótel samninga við þriðja aðila og greiddu þeim mikið fé til að fá aðgang að því sem tekjustjórnunarteymið kallar `the comp set`; sem þýðir: `Hvernig stendur eign mín sig miðað við aðra eign?`.
...
3. Smelltu á `Analytics` hlekkinn.
...
Þegar þú vilt byrja að búa til þín eigin myndrit, farðu á myndritin þín eins og lýst er að ofan og smelltu á `Create chart` hnappinn.

Hér að neðan eru einföld skref til að búa til greiningarmyndrit, fylgt eftir af ítarlegri leiðbeiningum.

<Steps>
1. **Tímaraðir** Veldu tímaraðir fyrir myndritið þitt. *Dæmi: Daglegt*.
...
3. **Birta gjaldmiðil** Ef þú ert að vinna með upphæðir í myndritinu, veldu hvaða gjaldmiðla þú vilt sjá þær í. *Dæmi: USD*.
...
11. **Nafn myndrits** Gefðu myndritinu lýsandi nafn. *Dæmi: Travelbug bókanir á klukkustundargrunni*
12. Smelltu á `Save` hnappinn.
</Steps>
...
:::note
Gagnapunktarnir ættu að vera 'samverkandi' þannig að þeir passi saman á sama línuritinu. Til dæmis myndir þú ekki hafa 'Síðuskoðanir' og 'Heildar hreinar tekjur' á sama myndriti.
:::
...
<Steps>
1. Smelltu á `Actions` hlekkinn sem er undir hverju myndriti.
2. Smelltu á `Remove` hnappinn.
</Steps>
...
Forritarar sem vilja stjórna greiningarmyndritum sínum geta farið á [Developers > API > Analytics](/is/api/overview/).

## Frekari lestur

- Kynntu þér leiðbeininguna okkar um [Insight for Dummies](/is/guides/general/insight-for-dummies).
