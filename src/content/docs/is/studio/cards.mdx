...
- **Innbyggja** Sýnir þér hvernig á að innbyggja þetta kort sem [Card](/is/developers/integrations/web-components/#content-loader) inn á vefsíðuna þína.
- **Nota með WordPress** Sýnir þér hvernig á að nota [WordPress viðbótina okkar](/is/developers/integrations/wordpress) til að innbyggja þetta kort inn á vefsíðuna þína.
...
- Línur 6 til 9 sýna hvernig á að nota [wink-content-loader](/is/developers/integrations/web-components/#content-loader) vefhlutann og segja honum að sækja gestaherbergiskort fyrir kóðann þinn.
- Lína 11 sýnir hvernig á að innbyggja Javascript-ið okkar inn á síðuna þína.
- Lína 13 sýnir hvernig á að innbyggja [wink-app-loader](/is/developers/integrations/web-components/#application-loader) vefhlutann og segja honum að sækja stillingar þínar á síðustigi.
