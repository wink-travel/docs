...
2. **Tegund eftirfylgni** Veldu hvort þú viljir fylgjast með föstu tímabili eða samfellt. *Dæmi: `Continuous`*.
    - Samfellt: Veldu tímeiningar. *Dæmi: 7 dagar*
...
5. **Fylgjast með sölurás** Fylgstu með sölurás eftir heimsálfu, landi eða borg. *Valfrjálst*
...
:::note
Gagnapunktarnir ættu að vera 'samverkandi' þannig að þeir passi saman á myndrit. Til dæmis myndir þú ekki hafa 'Skoðanir á síðu' og 'Heildar nettótekjur' á sama myndriti.
:::
...
- Skoðaðu leiðbeiningar okkar um [Insight for Dummies](/is/guides/insight-for-dummies).
