...
Birgðir kunna að vera ekki lengur í boði. Farðu á [Wink Studio](/is/portal/studio/cards) og athugaðu hvort stöðu "spjaldsins" sé í boði.
...
Birgðir kunna að hafa verið fjarlægðar. Farðu á [Wink Studio](/is/portal/studio/cards) og athugaðu hvort stöðu "spjaldsins" sé í boði.
Ef það er ekki, mun það birtast sem rautt. Í því tilfelli geturðu beðið og kannski gerir birgirinn það aftur aðgengilegt eða fjarlægt það af listanum þínum.
...
Þetta er aðeins fyrir vefþróunaraðila. Ef þú hefur óvart fjarlægt [Forritið](/is/portal/settings/applications) ; sem gerir client ID ekki lengur aðgengilegt, vinsamlegast búðu til nýtt forrit og notaðu nýja client ID til að fella inn vefþætti okkar.
