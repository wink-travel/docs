...
Our social share feature is all about making it easy to produce, share and consume travel deals on social media or anywhere else online. The most widely used method of sharing anything online is `the link`. Our link comes with dynamic link previews that show price overlaid on a beautiful picture of your choosing. This feature expedites how travelers discover and book, and increases the conversion path from social feed to booking​​.
...
Wink leverages AI to accelerate every aspect of content creation. Generate compelling descriptions for properties, rooms, restaurants, spas, activities, and more — in seconds, not days. Choose from 12 tones of voice to match your brand, and let AI suggest amenities and demographics during property registration. What used to take weeks is now done in under an hour.
...
All Wink portals support dark mode. You can toggle between light and dark themes using the theme switcher in the navigation bar. Dark mode reduces eye strain in low-light environments and respects your system's display preferences.

## Session management

All authenticated portals include automatic session management. If your session expires due to inactivity or token expiration, you'll be redirected to a session-expired page with a clear option to log in again. This ensures you never lose track of where you were — simply re-authenticate to pick up where you left off.
