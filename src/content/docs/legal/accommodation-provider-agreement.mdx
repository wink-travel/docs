...
<BreadcrumbJsonLd items={[{ name: "Home", url: "https://wink.travel/" }, { name: "Legal", url: "https://wink.travel/legal/" }, { name: "Accommodation Provider Agreement" }]} />
...
<nav aria-label="Breadcrumb" class="mx-auto w-full max-w-3xl px-4 pt-6 text-sm text-muted-foreground">
  ...
  <span class="px-1.5">/</span>
  <span class="text-foreground">Accommodation Provider Agreement</span>
</nav>
...
<header class="mx-auto w-full max-w-3xl px-4 pt-8 pb-8">
  ...
  <h1 class="font-heading mt-3 text-4xl font-semibold tracking-tight text-balance @lg:text-5xl">Accommodation Provider Agreement</h1>
  <p class="mt-3 text-lg text-muted-foreground text-pretty">Terms and conditions for hotels listing supply on the Wink platform</p>
