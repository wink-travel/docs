...
<BreadcrumbJsonLd items={[{ name: "Home", url: "https://wink.travel/" }, { name: "Legal", url: "https://wink.travel/legal/" }, { name: "Demand Partner Agreement" }]} />
...
<nav aria-label="Breadcrumb" class="mx-auto w-full max-w-3xl px-4 pt-6 text-sm text-muted-foreground">
  ...
  <span class="px-1.5">/</span>
  <span class="text-foreground">Demand Partner Agreement</span>
</nav>
...
<header class="mx-auto w-full max-w-3xl px-4 pt-8 pb-8">
  ...
  <h1 class="font-heading mt-3 text-4xl font-semibold tracking-tight text-balance @lg:text-5xl">Demand Partner Agreement</h1>
  <p class="mt-3 text-lg text-muted-foreground text-pretty">For affiliates, creators, API partners and AI agent operators</p>
...
<section class="mx-auto w-full max-w-3xl px-4">
  <div class="rounded-2xl border-l-4 border-primary bg-primary/[0.04] p-6">
    ...
    <p class="mt-3 text-pretty text-foreground/90">You promote hotel supply to your audience or through your product. When someone books, you earn commission set by the hotel — 10% by default. Attribution runs six months from the first click. You never hold guest money and never contract with the guest: the hotel does, and TripPay collects on the hotel’s behalf. This summary does not govern; the terms below do.</p>
  </div>
</section>
