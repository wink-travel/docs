---
title: Analytics
description: This article shows you how to manage your Wink Travel Platform analytics.
sidebar:
  order: 14
---
...
Below are the simple steps to create an analytics chart followed by more detailed instructions below.
...
10. **Group data** Instead of filtering on properties or sales channels, you can also group to aggregate on data points. *E.g. Group on Sales Channels*
11. **Chart name** Give your chart a descriptive name. *E.g. Travelbug bookings on the Hourly*
12. Click `Save` button.
</Steps>

## How it works

Charts are processed with 4 steps. These steps are described below.

### Time series type

By choosing a fixed date range or a continuous time slice, you start to focus on the WHEN you want to see data from.

### Tracking / Filtering

By choosing a property, sales channel etc, you start to focus on WHO you want to see data from. You are effectively filtering out all the stuff you don't want to see.

### Data points

By selecting data points, you start to focus on WHAT you want to see data for.

:::note
The data points should be 'synergistical' in a way that they fit on a graph together. For example, you wouldn't include 'Page Views' and 'Total Net Revenue' on the same chart.
:::

### Grouping <Badge text="New" variant="note" />

Grouping is a powerful way to aggregate and focus in on data.

:::tip
For example, if you are a property and you want to track how many bookings each of your sales channels made, you would filter on your property (above), select to track 'Bookings' (above) and you would group on 'Sales channel' in the Grouping section.
:::
...
<CloudinaryImage
    ...
    />
    <figcaption>*Chart with sales channel grouping*</figcaption>
</figure>

Once you save, you are redirected back to your charts where you can see your new chart in action.
...
Developers who want to manage their analytics charts can head over to [Developers > API > Analytics](/api/overview/).

## Further reading

- Check out our guide on [Insight for Dummies](/guides/general/insight-for-dummies).
