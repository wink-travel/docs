...
If you want to change your password, or you have forgotten your password, follow these steps:

## Update password

<Steps>
1. Go to [app.wink.travel](https://app.wink.travel).
1. Log in by clicking on `Sign-in / Register` in the top-right corner.
2. Click on your profile icon, in the top-right corner and a menu will appear.
3. Click the `Change password` link.
4. Follow the instructions to change your password.
5. Click `Change password` to continue.
</Steps>
