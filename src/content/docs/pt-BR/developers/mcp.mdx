...
- Navegar por especificações OpenAPI ao vivo e documentação de operações (`wink://api/...`)
- Realizar buscas semânticas / por palavra-chave leves sobre docs e APIs ao vivo
...
Se seu cliente suportar apenas SSE, use:
...
| `docs_search` | Encontrar docs conceituais / guias | `authentication`, `webhooks`, `wordPress` |
