...
<CloudinaryImage
      ...
      resize="scale"
      quality="best"
      alt="Modal de busca Lookup"
      src="academy/lookup-results"
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Modal de busca Lookup com resultados*</figcaption>
</figure>
...
Isso é apenas para desenvolvedores web. Se você removeu acidentalmente a [Aplicação](/pt-BR/developer/applications), fazendo com que o client ID não esteja mais disponível, crie uma nova aplicação e use o novo client ID para incorporar nossos Componentes Web.
