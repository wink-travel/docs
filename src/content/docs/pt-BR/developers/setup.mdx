...
<Steps>
1. [Registre-se](/pt-BR/account/register) com sua conta de usuário no Wink.
2. [Crie uma conta afiliada](/pt-BR/portal/create-account). Você precisará dela para vincular sua Aplicação. Veja [o que é Studio](/pt-BR/portal/studio/what-is-studio) para mais contexto.
3. [Crie uma Aplicação](/pt-BR/portal/settings/applications) e associe-a à conta afiliada que você criou no Passo 2. Para integrações API servidor a servidor, escolha **MACHINE_2_MACHINE** como tipo de cliente.
