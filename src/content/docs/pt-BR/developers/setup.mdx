...
3. [Crie uma Aplicação](/pt-BR/portal/settings/applications) e associe-a à conta de afiliado criada no Passo 2. Para integrações API servidor a servidor, escolha **MACHINE_2_MACHINE** como tipo de cliente.
