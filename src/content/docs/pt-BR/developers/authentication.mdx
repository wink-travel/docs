...
- `Wink-Version` = `2.0` Última - *Consulte nossa documentação da API para outras versões disponíveis.*
...
- **Solicite o mínimo.** Peça apenas os escopos que sua integração realmente usa — um token emitido
  com acesso mais amplo do que o necessário tem um raio de impacto maior se vazado.
...
Pegue um 'Client ID' e 'Secret Key' de um dos seus apps e navegue por qualquer uma de nossas [APIs](/pt-BR/api/overview/).
:::
