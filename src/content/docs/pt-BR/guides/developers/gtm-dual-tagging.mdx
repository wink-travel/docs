...
2. **Insira no Portal Wink**
   ...
   Faça login em [app.wink.travel](https://app.wink.travel), selecione sua conta e vá para a aba **Customizações**. Cole seu ID do Contêiner GTM do Sojern no campo Sojern e salve. Sua integração estará ativa.
