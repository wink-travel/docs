...
<Steps>
1. **Você cria o conteúdo** no seu idioma principal — manualmente ou usando o [registro assistido por IA](/pt-BR/guides/hoteliers/ai-assisted-registration).
...
3. **O conteúdo traduzido é armazenado** junto com o conteúdo original. Cada tradução está vinculada ao original, para que atualizações no conteúdo fonte possam acionar nova tradução.
...
1. **Registre sua propriedade** usando o [registro assistido por IA](/pt-BR/guides/hoteliers/ai-assisted-registration) — a IA gera conteúdo no seu idioma principal.
...
Esse pipeline significa que uma única sessão de geração por IA pode produzir anúncios refinados em mais de 40 idiomas.
...
- [Localização](/pt-BR/getting-started/localization) — Suporte a idiomas e localidades na plataforma.
- [Registro Assistido por IA](/pt-BR/guides/hoteliers/ai-assisted-registration) — Registre uma propriedade com IA e tradução automática.
