---
title: O que é Agent?
description: Saiba como o Wink apoia agentes de viagem registrados.
sidebar:
  order: 0
---
...
Desenvolvedores que desejam gerenciar `Travel Agent` podem acessar [Developers > API > Travel Agent](/pt-BR/api).
