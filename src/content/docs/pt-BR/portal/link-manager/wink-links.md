...
:::note
Ative `Intelligent` para 🟢 em suas [Configurações](/pt-BR/portal/link-manager/settings) para usar este recurso.
:::
...
- [Links compartilháveis](/pt-BR/portal/studio/shareable-links) - Escolha exibir como:
    - [Banner de anúncio](/pt-BR/integrations/web-components/#content-loader).
    - Link normal com atualizações de preços em tempo real.
- [Cards](/pt-BR/portal/studio/cards) - Cards reserváveis com preços e disponibilidade em tempo real.
- [Grids](/pt-BR/portal/studio/grids) - Grade com cards reserváveis.
- [Maps](/pt-BR/portal/studio/maps) - Mapa com marcadores que abrem cards reserváveis.
