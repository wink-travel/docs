...
Most of the time, there is no need to share either of these applications directly. We have created a variety of ways for you to share travel inventory, which you can discover in [Wink Studio](/portal/studio/what-is-studio) or through [WinkLinks](/portal/link-manager/wink-links).
...
<Steps>
1. Log into either [Wink Extranet](/portal/extranet/what-is-extranet) or [Wink Studio](/portal/studio/what-is-studio).
2. Click on your profile icon in the top-right corner and click on [Applications](/portal/settings/applications).
...
<Steps>
1. Log into [Wink Extranet](/portal/extranet/what-is-extranet).
2. Select the property you want to work with.
3. From the main navigation bar, click `Account > Branding`
...
<Steps>
1. Log into [Wink Studio](/portal/studio/what-is-studio).
2. Select the account you want to work with.
3. From the main navigation bar, click `Tools > Customization`
...
If you are a property management company, you want to link to the Wink IBE homepage. The homepage will show your designated theme along with the [properties you represent](/portal/settings/agency-representation).
