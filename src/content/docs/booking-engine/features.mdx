...
Most of the time, there is no need to share either of these applications directly. We have created a variety of ways for you to share travel inventory, which you can discover in [Wink Studio](/studio/what-is-studio) or through [WinkLinks](/link-manager/wink-links).
