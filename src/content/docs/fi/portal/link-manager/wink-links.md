...
:::note
Ota `Älykäs` käyttöön 🟢 kohdassa [Asetukset](/fi/portal/link-manager/settings) käyttääksesi tätä ominaisuutta.
:::
...
- [Jaa-linkkejä](/fi/portal/studio/shareable-links) - Valitse näyttötapa:
    - [Mainosbanneri](/fi/integrations/web-components/#content-loader).
    - Tavallinen linkki reaaliaikaisilla hintapäivityksillä.
- [Kortteja](/fi/portal/studio/cards) - Varattavat kortit reaaliaikaisilla hinnoilla ja saatavuudella.
- [Ruudukkoja](/fi/portal/studio/grids) - Ruudukko varattavilla korteilla.
- [Karttoja](/fi/portal/studio/maps) - Kartta, jossa on merkkejä, jotka avautuvat varattaviin kortteihin.
