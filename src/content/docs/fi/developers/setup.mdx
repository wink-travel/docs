...
<Steps>
1. [Rekisteröidy](/fi/account/register) käyttäjätilillesi Winkissä.
...
3. [Luo sovellus](/fi/portal/settings/applications) ja liitä se affiliate-tiliin, jonka loit vaiheessa 2. Palvelin-palvelin API-integraatioissa valitse **MACHINE_2_MACHINE** asiakastyypiksi.
...
Siirry [API-rajapintoihimme](/fi/api) ja valitse haluamasi API.
