...
Sovellus antaa sinulle `Client ID` ja `Secret Key`, joita tarvitset luodaksesi autentikoidun OAuth2-istunnon, jota voit käyttää kommunikoidessasi Wink- ja TripPay-rajapintojen kanssa.
...
Hanki 'Client ID' ja 'Secret Key' jostakin sovelluksestasi ja siirry mihin tahansa [APIs](/fi/developers/apis)-sivuillemme.
:::
