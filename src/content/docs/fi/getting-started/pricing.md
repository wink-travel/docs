...
| Partner API | 10,000 | $0.0001 | Yksi hotellipäivä |
...
Julkaisut hinnoitellaan niiden sisällön mukaan, koska se on meille kustannus niiden tekemisestä. Staattinen kuva on halpa; video ei ole; kaikki tekoälyn tuottama media maksaa huomattavasti enemmän kuin itse toimittamasi valokuva.
...
- **Tekoälyperäisyys määrää tason.** Sinun toimittamasi media — omat valokuvasi ja videosi tai mikä tahansa Wink-sisältökirjastostasi — veloitetaan normaalihinnalla. Meidän tuottama media veloitetaan tekoälyhinnalla.
...
- Partner API:ssa **hotellipäivä** tarkoittaa yhtä hotellia yhden yön majoituksella — *ei* yhtä API-kutsua. Haku, joka palauttaa 20 hotellia kolmen yön majoituksella, on 60 hotellipäivää yhdestä pyynnöstä. Hakemisto- ja automaattisen täydennyksen päätepisteet ovat ilmaisia eivätkä niitä mitata.
...
Kun käytön mittaus on päällä, käyttöä mitataan mutta **ei koskaan rajoiteta** — et kohtaa kulutusrajaa rahankäytössä.
...
| Keskeytetty | Laskua ei ole maksettu loppuun asti. Laskutettavat toiminnot estetään, kunnes maksu on suoritettu; ilmaiset ominaisuudet toimivat normaalisti. |
