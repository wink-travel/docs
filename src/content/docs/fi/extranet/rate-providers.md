...
- He pyytävät sinua täyttämään lomakkeen ***PRS***.
  - Sinua pyydetään antamaan Wink-käyttäjätunnuksesi.
  - ...sekä haluamasi valuutta.
- Täytä lomake ja lähetä se takaisin SynXisille.

## Toimittajat

Alla on lista toimittajista, joita tuemme:
...
| Fastbooking | CM |  | 2016 | 2016 | Nyt d-edge |
