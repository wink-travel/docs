...
Tämä koskee vain web-kehittäjiä. Jos olet vahingossa poistanut [Sovelluksen](/fi/account/applications), jolloin client ID ei ole enää käytettävissä, luo uusi sovellus ja käytä uutta client ID:tä upottaessasi Web-komponenttejamme.
