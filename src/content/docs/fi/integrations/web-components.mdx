...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Lookup-modaali hakutuloksilla*</figcaption>
</figure>

### Matkaohjelma

Matkaohjelmapainike näyttää nykyisen matkaohjelman painikkeessa. Klikatessasi sitä koko matkaohjelman valitsin avautuu modaalina.
...
Haku on pelkkä kuvakepainike matkaohjelman valitsimesta. Klikatessasi sitä koko matkaohjelman valitsin avautuu modaalina.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tilipainike (avoinna) web-komponentti*</figcaption>
</figure>
...
Maksukomponentti ilmoittaa TripPay:lle, että matkustaja haluaa ostaa jotain, sekä näiden tuotteiden säännöt ja hinnat.
...
Varasto ei välttämättä ole enää saatavilla. Mene [Wink Studioon](/fi/portal/studio/cards) ja tarkista, onko "kortin" tila saatavilla.
...
Varasto on voitu poistaa. Mene [Wink Studioon](/fi/portal/studio/cards) ja tarkista, onko "kortin" tila saatavilla.
Jos ei ole, se näkyy punaisena. Tällöin voit odottaa, että toimittaja tekee sen taas saatavaksi, tai poistaa sen listaltasi.
...
Tämä koskee vain web-kehittäjiä. Jos olet vahingossa poistanut [Sovelluksen](/fi/portal/settings/applications), jolloin client ID ei ole enää käytettävissä, luo uusi sovellus ja käytä uutta client ID:tä upottaessasi Web-komponenttejamme.
