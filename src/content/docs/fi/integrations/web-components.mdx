...
*Attribuutti `sort` on käytettävissä vain, kun layout on `RANKED` eikä halua käyttää olemassa olevaa rankattua ruudukkoa. Näissä tapauksissa jätä `id` tyhjäksi.*
...
Esimerkkejä löytyy [korteista](/fi/portal/studio/cards), [ruudukoista](/fi/portal/studio/grids) ja [kartoista](/fi/portal/studio/maps).

### Hakutoiminto

Lookup toimii erinomaisesti yhdessä rankatun ruudukon kanssa. Se antaa käyttäjillesi mahdollisuuden hakea hotelleja ja kohteita, ja ruudukko päivittyy hakutulosten mukaan.
...
Maksukomponentti ilmoittaa TripPay:lle, että matkustaja haluaa ostaa jotain, sekä kyseisten tuotteiden säännöt ja hinnat.
...
:::note
Oppiaksesi, miten varauksen sopimuksen `id` luodaan, lue opas: [Integrating with TripPay](/fi/guides/developers/integrating-with-trip-pay).
:::
...
Varasto ei välttämättä ole enää saatavilla. Mene [Studioon](/fi/portal/studio/cards) ja tarkista, onko "kortin" tila saatavilla.
Jos ei ole, se näkyy punaisena. Tällöin voit odottaa, että toimittaja tekee sen taas saataville tai poistaa sen listaltasi.

:::note
`Saatavuus` ei tarkoita varaston päivittäistä varattavuutta. Se tarkoittaa, että varasto on kokonaan poissa käytöstä sinulta ja/tai kaikilta.
:::

### Poistettu

Varasto on voitu poistaa. Mene [Studioon](/fi/portal/studio/cards) ja tarkista, onko "kortin" tila saatavilla.
Jos ei ole, se näkyy punaisena. Tällöin voit odottaa, että toimittaja tekee sen taas saataville tai poistaa sen listaltasi.
...
Tämä koskee vain web-kehittäjiä. Jos olet vahingossa poistanut [Sovelluksen](/fi/account/applications), jolloin asiakas-ID ei ole enää käytettävissä, luo uusi sovellus ja käytä uutta asiakas-ID:tä upottaessasi web-komponenttejamme.
