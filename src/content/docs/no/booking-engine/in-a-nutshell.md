...
* Vise bestillbar beholdning i ønsket format, språk og valuta, for eksempel:
  ...
  * En [kart](/studio/maps) på din [kart](/studio/maps) konto.
...
Integratorer som ønsker enda mer frihet har tilgang til alle de samme funksjonene via vår [WordPress-plugin](/developers/wordpress/), [WordPress-plugin](/developers/wordpress/) og[API-er](/developers/apis).
