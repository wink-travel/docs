...
<Steps>
1. [Registrer](/no/getting-started/sign-up) brukerkontoen din på Wink.
...
3. [Opprett en applikasjon](/no/account/applications) og knytt den til affiliate-kontoen du opprettet i steg 2. For server-til-server API-integrasjoner, velg **MACHINE_2_MACHINE** som klienttype.
