...
<Steps>
  1. Bruk [Oppslags-API](https://developer.wink.travel/lookup) for å hente destinasjoner eller hoteller.
...
<Steps>
  ...
  2. Klikk på `Download OpenAPI spec` fra toppen av [Oppslags-API](https://developer.wink.travel/lookup) side.
