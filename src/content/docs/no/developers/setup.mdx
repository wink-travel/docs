...
<Steps>
1. [Registrer](/no/my-account/register) brukerkontoen din på Wink.
2. [Opprett en affiliate-konto](/no/my-account/create-account). Du trenger denne for å knytte applikasjonen din til. Se [hva er Studio](/no/studio/what-is-studio) for mer kontekst.
3. [Opprett en applikasjon](/no/my-account/applications) og knytt den til affiliate-kontoen du opprettet i steg 2. For server-til-server API-integrasjoner, velg **MACHINE_2_MACHINE** som klienttype.
...
Gå til vår [API-er](/no/developers/apis) seksjon og velg API-et du vil jobbe med.
...
4. Hvis du importerte den som en ny samling kalt `Wink API`, klikk på de horisontale ellipsene (3 prikker) ved siden av samlingsnavnet og klikk `Edit`.
