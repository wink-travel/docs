...
Gå til vår [API-seksjon](/no/api/overview/) og velg API-et du vil jobbe med.
...
11. Sett feltet `Client ID` til Client ID-en som applikasjonen din genererte.
12. Sett feltet `Client Secret` til Client Secret som applikasjonen din genererte.
