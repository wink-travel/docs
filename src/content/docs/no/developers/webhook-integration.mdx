...
:::tip
Start med å abonnere på alle hendelser under utvikling. Når du forstår nyttelastene, kan du begrense til kun de hendelsene systemet ditt trenger.
:::

## Beste praksis

- **Bruk HTTPS** — Wink sender nyttelaster kun til HTTPS-endepunkter.
- **Svar raskt** — Returner en `200 OK` så snart du mottar nyttelasten. Gjør tung prosessering asynkront.
...
- [Applications](/no/portal/settings/applications) — Administrer API-legitimasjonen din.
