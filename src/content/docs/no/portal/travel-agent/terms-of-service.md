...
description: Denne artikkelen inneholder våre vilkår for bruk for reisebyråer på Wink-plattformen.
sidebar:
  order: 4
---
...
Disse vilkårene er tilgjengelige under [Affiliate Portal > Terms of Service](/no/portal/studio/terms-of-service).
:::
...
(i) Wink driver et nettbasert system (heretter kalt "Systemet") hvor deltakende overnattingssteder (samlet kalt "Overnattingsleverandører") kan gjøre sitt inventar tilgjengelig for reservasjon, og hvor Reisebyrået kan foreta reservasjoner hos slike Overnattingsleverandører på vegne av sine gjester (heretter kalt "Tjenesten");
...
* **“Tjenesteleverandør”** betyr Wink, **TRAVELIKO SINGAPORE PTE. LTD** registrert i Singapore.  
    
* **“Reisebyrå”** betyr den enheten som inngår denne avtalen med Tjenesteleverandøren for å promotere og selge reisebestillinger gjennom Tjenesteleverandørens plattform.

**2\. Ikke-eksklusivitet**

2.1 Reisebyrået skal operere som en ikke-eksklusiv distributør av Wink.

2.2 Tjenesten skal gjøres tilgjengelig av Wink for Reisebyrået som angitt i registreringsskjemaet for Reisebyrå og på nettsiden(e) angitt i registreringsskjemaet.

**3\. Inndrivelse og distribusjon av betalinger**

3.1 **Inndrivelse av betalinger:** Reisebyrået skal innkreve betaling fra gjesten ved bookingtidspunktet.

3.2 **Fradrag av gebyrer:** Reisebyrået skal trekke følgende fra bookingverdien:
...
* Wink er ikke ansvarlig for betalinger til Overnattingsleverandørene. Reisebyrået har fullt ansvar for alle økonomiske transaksjoner med Overnattingsleverandørene.  
* Wink vil gi tilgang til Systemet og sikre at Tjenesten er tilgjengelig for Reisebyrået.

**5\. Immaterielle rettigheter**

5.1 **Lisenser:** Hver part gir den andre en begrenset, ikke-eksklusiv, royaltyfri, verdensomspennende lisens til å bruke sin immaterielle eiendom utelukkende for å oppfylle forpliktelsene under denne avtalen.

5.2 **Begrensninger:** Reisebyrået skal ikke underlisensiere, overføre eller avsløre noen immaterielle rettigheter eller innhold levert av Wink.
...
* Reisebyrået skal foreta betalinger via bankoverføring, kredittkort eller PayPal, og eventuelle gebyrer knyttet til valgt betalingsmetode skal bæres av Reisebyrået.

6.6 **Betalingsdisputter:**

* Ved uenighet om en faktura skal Reisebyrået varsle Wink innen 10 dager fra fakturadato med detaljerte grunner for uenigheten. Begge parter skal forhandle i god tro for å løse tvisten raskt. Den uomtvistede delen av fakturaen skal betales innen forfallsdato.

**7\. Reisebyråets ansvar**

7.1 **Overholdelse av lover og regler:**

* Reisebyrået skal overholde alle gjeldende lokale, nasjonale og internasjonale lover, forskrifter og bransjestandarder i sin virksomhet, inkludert men ikke begrenset til forbrukerbeskyttelse, databeskyttelse og hvitvaskingsregler.  
  

7.2 **Korrekt fremstilling av tjenester:**

* Reisebyrået skal korrekt fremstille tjenestene og overnattingsstedene som tilbys gjennom Plattformen. Reisebyrået er ansvarlig for at all informasjon gitt til gjestene, inkludert beskrivelser, priser og tilgjengelighet, er korrekt og oppdatert.
...
* Reisebyrået skal administrere alle bookinger gjort gjennom Plattformen, inkludert behandling av reservasjoner, avbestillinger og endringer. Reisebyrået er ansvarlig for kommunikasjon med gjester og Overnattingsleverandører for å sikre at alle bookinger behandles og bekreftes korrekt.
...
* Reisebyrået skal være hovedkontaktpunkt for gjester vedrørende klager, tvister eller problemer knyttet til tjenestene levert gjennom Plattformen. Reisebyrået skal gjøre rimelige anstrengelser for å løse slike klager og tvister raskt og på en måte som opprettholder et godt forhold til både gjester og Overnattingsleverandører.
...
* Reisebyrået skal opprettholde konfidensialiteten til all proprietær informasjon og forretningshemmeligheter til Tjenesteleverandøren, inkludert men ikke begrenset til kundedata, prisinformasjon og forretningsstrategier. Reisebyrået skal ikke avsløre slik informasjon til tredjepart uten skriftlig forhåndssamtykke fra Tjenesteleverandøren.
...
* Reisebyrået skal holde Tjenesteleverandøren skadesløs for alle krav, skader, forpliktelser og utgifter som oppstår som følge av Reisebyråets brudd på denne avtalen, inkludert men ikke begrenset til manglende overholdelse av lover, feilaktig fremstilling av tjenester eller manglende oppfyllelse av forpliktelser overfor gjester eller Overnattingsleverandører.
...
9.1 **Ansvarsbegrensning:** Ingen av partene skal holdes ansvarlig for indirekte, tilfeldige, følgeskader, spesielle eller straffende skader som oppstår fra denne avtalen.
...
10.3 **Etter oppsigelse:** Ved oppsigelse skal Reisebyrået gjøre opp alle utestående betalinger og slutte å bruke immateriell eiendom eller innhold relatert til Wink.
...
* Suspensjon av tjenester: Dersom en Force Majeure-hendelse påvirker din virksomhets evne til å levere tjenester til Reisebyrået, skal disse tjenestene suspenderes i hendelsens varighet uten straff. Reisebyråets betalingsforpliktelser knyttet til de berørte tjenestene skal også suspenderes i denne perioden.  
* Reisebyråets forpliktelser: Reisebyrået skal ikke holdes ansvarlig for forpliktelser som er umulige å oppfylle på grunn av Force Majeure-hendelsen. Reisebyrået må imidlertid fortsatt oppfylle alle andre forpliktelser som ikke direkte påvirkes av hendelsen.

12.4 **Varighet og oppsigelse:** Dersom Force Majeure-hendelsen varer i mer enn seksti (60) dager, kan en av partene si opp denne avtalen med skriftlig varsel til den andre parten. Ved slik oppsigelse skal ingen av partene ha ansvar overfor den andre, bortsett fra forpliktelser som har påløpt før Force Majeure-hendelsen.

12.5 **Gjenopptakelse av forpliktelser:** Når Force Majeure-hendelsen opphører, skal begge parter snarest mulig gjenoppta sine forpliktelser under denne avtalen i den grad det er rimelig praktisk.
