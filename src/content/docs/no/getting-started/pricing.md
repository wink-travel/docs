...
- **Den gratis kvoten dekker kun standard bildeinnlegg.** Du får ett av disse per konto per måned. Videoinnlegg og AI-generert media faktureres fra første innlegg — det finnes ingen gratis kvote på disse nivåene, så en eiendom som legger ut video må regne med en kostnad i sin første måned.
...
Når det er aktivert, måles bruken din, men **aldri begrenses** — du vil ikke nå en grense for hvor mye du kan bruke hos oss.
