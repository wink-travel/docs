...
For å sette din pristilbyder, klikk på `Distribution > Channel manager` i hovednavigasjonsmenyen.

Velg din pristilbyder fra nedtrekkslisten og klikk på `Save`-knappen. Dette vil tillate pristilbyderen å sende oss priser, og vi vil varsle dem når det skjer en booking på Wink for en av dine eiendommer.
...
- De vil be deg fylle ut skjemaet ***PRS***.
  - Du vil bli bedt om å fylle inn dine Wink-brukeropplysninger.
  - ...og ønsket valuta.
- Fullfør skjemaet og send det tilbake til SynXis.
