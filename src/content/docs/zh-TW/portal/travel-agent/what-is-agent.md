---
title: 什麼是 Agent？
description: 了解 Wink 如何支援註冊的旅行社。
sidebar:
  order: 0
---

我們為註冊旅行社提供的解決方案是 [Wink Agent](https://agent.wink.travel)。這是一個自助式入口網站，代理人可以用來代表客戶搜尋和預訂，並從每筆訂單中賺取佣金。
...
請前往 [搜尋](/zh-TW/portal/studio/search) 了解如何搜尋和預訂飯店。
