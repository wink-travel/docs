...
:::note
在你的 [設定](/zh-TW/portal/link-manager/settings) 中將 `Intelligent` 設為 🟢 即可使用此功能。
:::
...
- [可分享連結](/zh-TW/portal/studio/shareable-links) - 可選擇顯示為：
    - [廣告橫幅](/zh-TW/integrations/web-components/#content-loader)。
    - 帶有即時價格更新的普通連結。
- [卡片](/zh-TW/portal/studio/cards) - 可訂房的卡片，帶有即時價格與可用性。
- [網格](/zh-TW/portal/studio/grids) - 含可訂房卡片的網格。
- [地圖](/zh-TW/portal/studio/maps) - 含標記並可開啟可訂房卡片的地圖。
