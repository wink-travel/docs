...
有些飯店希望網站功能更完整，整合更深入。此範例將說明如何將 [Card](/zh-TW/portal/studio/cards) 嵌入網站。
...
13. 若要取得您的 `Client-ID`，請前往 [應用程式](/zh-TW/portal/settings/applications)。
14. 若要取得您的 `Configuration-ID`，請前往 [自訂](/zh-TW/portal/settings/branding)。
14. 您已完成 ✅。
</Steps>
