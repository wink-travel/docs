...
Fiyat sağlayıcınızı ayarlamak için ana navigasyon çubuğundan `Distribution > Channel manager` seçeneğine tıklayın.

Açılır listeden fiyat sağlayıcınızı seçin ve `Save` butonuna tıklayın. Bu, fiyat sağlayıcısının bize fiyat göndermesine olanak tanır ve Wink üzerinde mülklerinizden biri için bir rezervasyon gerçekleştiğinde onları bilgilendiririz.
...
Aşağıda desteklediğimiz sağlayıcıların listesi bulunmaktadır:
