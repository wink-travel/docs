...
Bu koşullar [Affiliate Portal > Payment Terms](/tr/portal/studio/payment-terms) altında mevcuttur.
:::
...
Ana Sözleşmede tanımlanan terimler ve tanımlar, aksi belirtilmedikçe bu Ödeme Koşullarında da geçerlidir.
...
4.1 **Seyahat Acentesi Sorumlulukları:**

* Misafirlerden ödemelerin zamanında tahsil edilmesini sağlamak, Bölüm 2.1’de belirtilen koşullara uymak.  
* Ayrı Sözleşmeye göre Net Ödemeyi Konaklama Sağlayıcılarına göndermeden önce uygun Rezervasyon Ücreti ve Komisyonu kesmek.  
* Bölüm 3.1’de belirtilen koşullar içinde Wink’in Rezervasyon Ücreti faturalarını zamanında ödemek.  
* Rezervasyon veya ödemelerle ilgili anlaşmazlıkları aktif olarak yönetmek ve çözmek, sorunların etkin çözümü için Wink ile iletişimi sürdürmek.

4.2 **Wink Sorumlulukları:**

* Bölüm 3.1’de detaylandırıldığı gibi Rezervasyon Ücretleri için doğru ve zamanında aylık faturalar düzenlemek.  
* Seyahat Acentesine rezervasyonları işlemek ve ödemeleri yönetmek için Wink platformuna sürekli erişim sağlamak.  
* Ödeme ile ilgili anlaşmazlıkların çözümünde gerekli işlem verilerini ve desteği sağlayarak Seyahat Acentesine yardımcı olmak.

**5\. Döviz Kuru Dönüşümü**

Herhangi bir döviz kuru dönüşümü gerekiyorsa, ödeme işleme hizmeti tarafından sağlanan kur üzerinden yapılacaktır. Döviz dönüşümü ile ilgili tüm masraflar Seyahat Acentesine aittir.
