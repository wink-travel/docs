...
description: Bu makale, TripPay ile nasıl entegre olunacağını ve TripPay'in ödemeyi sizin için nasıl yöneteceğini tam bir örnekle anlatmaktadır.
sidebar:
  order: 4
---
...
- [Ödeme Web Bileşeni](/tr/integrations/web-components/#payment).
- [Ödeme API](/tr/developers/apis/#payment-api). *`Ödenecek sözleşmeler oluşturma` bölümünü okuyun*
...
- %1,5 rezervasyonu kolaylaştıran platforma ayrılmıştır. *örneğin Wink*
- %9,85 bağlı kuruluşa komisyon olarak ayrılmıştır. *örneğin Kim Kardashian*
- %88,65 oda rezervasyonu için tedarikçiye ayrılmıştır. *örneğin Hilton*

TripPay ödenecek sözleşmeyle yanıt verdiğinde, kendi yararlanıcısını %4,0 olarak eklediğini göreceksiniz.
:::
