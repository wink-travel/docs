...
- Ang [Extranet](/tl/portal/extranet/what-is-extranet) ay tumutok sa mga supplier na nagma-manage ng imbentaryo.
- Ang [Studio](/tl/portal/studio/what-is-studio) ay tumutok sa mga affiliate na nagma-manage ng nilalaman.
- Ang `Booking Engine` ay tumutok sa paggawa ng nilalaman, na nilikha sa `Studio`, na nakabase sa imbentaryong nilikha sa `Extranet` at ginagawa itong maibook.
...
Ang booking engine ang puso ng aming platform.

Kabilang sa mga responsibilidad nito ang:

- Pamamahala ng mga pera at pagpapanatiling napapanahon ng mga palitan ng pera.
- Pagbibigay ng paraan sa mga tagapagbigay ng rate upang ipadala sa amin ang data ng rate.
- Pamamahala ng lookup data. *hal. mga rehiyon, bansa, destinasyon, mga ari-arian, atbp.*
- Pamamahala ng mga wika.
- Pagbuo ng analytics batay sa mga interaksyon ng user, mga kaganapan, at mga tawag sa API.
- Pagseserbisyo ng maibook na imbentaryo sa nais na format, wika, at pera, tulad ng:
...
- Pagbibigay sa mga biyahero ng paraan upang:
    ...
    - Pamahalaan ang kanilang [mga booking at review](/tl/booking-engine/bookings).
...
Ang booking engine ay isang koleksyon ng mga reusable na functionality na inilalantad namin sa pamamagitan ng https://book.wink.travel; isang lubos na nako-customize na website para sa mga hotel at affiliate upang ibenta ang kanilang mga produkto sa mga biyahero.
