---
title: Ano ang Agent?
description: Alamin kung paano sinusuportahan ng Wink ang mga rehistradong travel agent.
sidebar:
  order: 0
---
...
Pumunta sa [Search](/tl/portal/studio/search) upang matutunan kung paano maghanap at mag-book ng mga hotel.

Kung hindi, magpatuloy sa susunod na seksyon.

## API

Ang mga developer na nais pamahalaan ang `Travel Agent` ay maaaring pumunta sa [Developers > API > Travel Agent](/tl/api).
