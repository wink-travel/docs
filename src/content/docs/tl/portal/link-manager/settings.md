---
title: Mga Setting
description: Sa artikulong ito, ipapakita namin kung paano mo mai-customize ang iyong WinkLinks page gamit ang mga tampok na makukuha mo sa ilalim ng mga setting.
sidebar:
  order: 4
---

Para pamahalaan ang iyong mga setting sa WinkLinks, pumunta sa `WinkLinks` sa pangunahing nav bar at i-click ang tab na `Design`.

Narito ang mga paraan kung paano mo mai-configure ang pag-uugali ng iyong WinkLinks gamit ang `Design`:
...
- **Customization** I-personalize ang itsura at pakiramdam ng iyong WinkLinks page. Maaari mong i-customize ang iyong color palette ayon sa gusto mo upang perpektong tumugma sa iyong brand. Ang setting na ito ay nakakaapekto rin sa kung paano ipinapakita ang Wink inventory cards, maps, at grids.  
...
- Basahin pa tungkol sa [Customizations](/tl/portal/settings/branding).
