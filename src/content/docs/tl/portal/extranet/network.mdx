...
Kapag na-save mo na ang bagong sales channel, ibabalik ka sa iyong listahan ng mga sales channel.

## API

Ang mga developer na nais pamahalaan ang kanilang `Network` ay maaaring pumunta sa [Developers > APIs > Distribution](/tl/api/overview/).
