...
6. **Agreement** Tanggapin ang aming [terms of service](/tl/portal/extranet/terms-of-service) at [payment terms](/tl/portal/extranet/payment-terms) upang magpatuloy.
...
Maaaring [imbitahan ka](/tl/portal/studio/search#empty-results) ng ibang mga miyembro upang sumali sa Wink. Makakatanggap ka ng email invite mula sa amin na may `lead` request na maaari mong i-claim at gamitin upang tapusin ang paggawa ng ari-arian.
...
Ang pag-click sa alinman sa mga kahon ay magdadala sa iyo sa [Wink Studio](/tl/portal/studio/what-is-studio).
...
Upang matuto nang higit pa tungkol sa mga opsyon na magagamit sa iyo, pumunta sa [Customization](/tl/portal/settings/branding).
...
Ang mga developer na nais pamahalaan ang `Property information` ay maaaring pumunta sa [Developers > API > Property](/tl/api/#property-api).
