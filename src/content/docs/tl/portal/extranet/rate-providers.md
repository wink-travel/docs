...
- Hahayaan ka nilang kumpletuhin ang form na ***PRS***.
  - Hihilingin sa iyo na punan ang iyong Wink user credentials.
  - ...at ang iyong nais na pera.
- Kumpletuhin ang form at isumite ito pabalik sa SynXis.

## Mga Vendor

Nasa ibaba ang listahan ng mga vendor na sinusuportahan namin:
...
*Kung ang vendor ay may proxy, ibig sabihin ay hindi direkta naming natatanggap ang rate mula sa vendor kundi sa pamamagitan ng proxy.*

| Vendor | Uri | Proxy | Simula | Huling binago | Komento
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Ngayon ay d-edge |
