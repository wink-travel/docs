...
Ang mga kuwarto ng bisita, o mga uri ng kuwarto gaya ng sinasabi sa `the biz`, ay nagbibigay-daan sa iyo upang ipakita at ibenta ang iyong mga kuwarto, sa loob at labas ng lugar. Upang gumawa ng kuwarto ng bisita, i-click ang button na `Create a new guest room`.
...
- **Bathroom count** Bilang ng mga banyo para sa ganitong uri ng kuwarto. *hal. 1*
- **Living room count** Bilang ng mga living room para sa ganitong uri ng kuwarto. *hal. 1*
- **Max rollaways** Bilang ng mga rollaway na sinusuportahan ng ganitong uri ng kuwarto. *hal. 1*
- **Max cribs** Bilang ng mga crib na sinusuportahan ng ganitong uri ng kuwarto. *hal. 1*
...
Ang seksyong ito ay nalalapat lamang kung nagpapatakbo ka ng dormitoryo, hostel, o iba pang shared room service.
...
:::note
Walang katapusang posibleng layout ng mga kwarto. Sinubukan naming gawing kasing-customizable nito upang umangkop sa iyong property.
:::
...
:::tip
Maraming bagay ang maaaring isama bilang ancillary sa isang kuwarto ng bisita:
...
- **Featured** Tukuyin kung dapat mas prominenteng ipakita ang kuwarto ng bisita kung may pagkakataon.
...
Kung ipagpapatuloy natin ang halimbawa ng pagrenta ng paddle board kada oras ngunit nais nating kailanganin ang bisita na mag-book ng hindi bababa sa 2 board nang sabay, gagawin natin:
...
Ang mga developer na nais pamahalaan ang `Guest Rooms` ay maaaring pumunta sa [Developers > APIs > Facilities](/tl/api/overview/).
