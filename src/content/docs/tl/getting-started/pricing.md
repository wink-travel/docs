...
Ito ay walang bayad, magpakailanman, walang alok at walang pagsukat:

- Ang **booking engine** — sa iyong sariling site, sa iyong WinkLinks page, o saanman mo ito i-embed.
...
:::note[Processing fee]
Naniningil ang Wink ng 1.5% processing fee / booking. Ito ay para sa pagpapanatili ng platform at ito ang dahilan kung bakit libre ang lahat ng nakalista sa itaas.
:::

:::note[Payment fee]
Naniningil ang TripPay ng 4.0% payment fee / booking. Ito ay para sa pagkuha ng bayad mula sa manlalakbay.
:::
...
Kung nais mong suportahan namin ang ibang paraan ng pag-withdraw, magpadala ng e-mail sa amin.
:::
...
Ang mga post ay pinapresyo base sa laman nito, dahil iyon ang gastos sa amin para gawin ito. Ang isang still image ay mura; ang video ay hindi; anumang ginagawa namin gamit ang AI ay mas mahal kaysa sa larawang ikaw mismo ang nagbigay.

- **Ang libreng alok ay para lamang sa mga standard na image post.** Makakakuha ka ng isa bawat account bawat buwan. Ang mga video post at AI-generated media ay sinisingil mula sa unang post pa lang — walang libreng alok sa mga ito, kaya ang isang property na nagpo-post ng video ay dapat asahan ang singil sa unang buwan pa lang.
...
- **Ang pag-publish sa WinkLinks ay palaging libre**, generated man o hindi.
- Sinisingil ka **kapag na-publish**, hindi sa bawat pagtatangka. Ang pag-regenerate ng draft hanggang sa maging kontento ka ay hindi magdadagdag sa iyong bill — magbabayad ka lang isang beses para sa post na talagang naipadala mo. Hindi unlimited ang pagtatangka: bawat post ay may humigit-kumulang 10 regenerations para sa mga larawan at 3 para sa video, na sumasalamin sa gastos namin sa paggawa nito. Makikita mo kung ilan pa ang natitira habang nagtatrabaho ka.
- Sa Partner API, ang isang **hotel-day** ay isang hotel na pinapresyo para sa isang gabi ng pananatili — *hindi* isang API call. Ang paghahanap na nagbabalik ng 20 hotel para sa 3-gabing pananatili ay 60 hotel-days mula sa isang request. Ang lookup at autocomplete endpoints ay libre at hindi sinusukat.

### Paano ito i-on

Ang pay-as-you-go ay naka-off bilang default. Lahat ay nakakakuha ng libreng alok nang hindi kailangang gumawa ng anuman.

Para lumampas sa alok, ang **may-ari** ng account ang nag-e-enable ng pay-as-you-go at pipili kung alin sa kanilang mga account ang susukatin. Ang paggamit mula sa lahat ng enabled na account ay pinagsasama sa isang **isang buwanang invoice**, na maaari mong bayaran nang awtomatiko gamit ang card o makatanggap bilang invoice para bayaran mo mismo.

Kapag na-enable, sinusukat ang iyong paggamit ngunit **hindi kailanman nililimitahan** — hindi ka maaabot sa rate limit para gumastos sa amin.

:::note[Kung hindi mo ito i-enable]
Walang masisira at walang sisingilin. Titigil ka lang sa libreng alok para sa buwan na iyon: ang mga generated post ay hindi ipo-publish at ang mga Partner API call ay magbabalik ng `429` hanggang sa mag-reset ang alok.
:::
...
| Past due | Nabigo ang isang bayad at sinusubukang muli. Patuloy na gumagana ang iyong mga tampok sa panahong ito. |
...
Sa wakas, habang patuloy kaming lumalaki sa laki at bilang ng mga booking, nais naming maibahagi sa iyo ang ilan sa mga epekto ng platform. Ang mas maraming booking ay nagdadala ng mga oportunidad para sa volume discounts mula sa aming payment gateway na magpapahintulot sa amin na babaan ang aming processing fee para sa lahat.
