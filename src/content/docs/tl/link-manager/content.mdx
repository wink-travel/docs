...
<CloudinaryImage
      ...
      resize="scale"
      quality="best"
      alt="Pagpasok sa WinkLinks"
      src="academy/winklinks-entry"
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Halimbawang pagpasok sa WinkLinks*</figcaption>
</figure>
...
Ang mga gumagamit, na tumitingin sa iyong pahina ng WinkLinks, ay maaaring pumili kung paano nila nais gamitin ang iyong nilalaman (listahan o grid) at maaaring pumili ng isa o higit pang mga tag upang higit pang i-filter ang iyong nilalaman.

## API

Ang mga developer na nais pamahalaan ang `WinkLinks` ay maaaring pumunta sa [Developers > API > WinkLinks](/developers/apis/#winklinks-api).
