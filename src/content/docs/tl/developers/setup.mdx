...
<Steps>
1. [Magrehistro](/tl/my-account/register) ng iyong user account sa Wink.
2. [Gumawa ng affiliate account](/tl/my-account/create-account). Kakailanganin mo ito upang i-bind ang iyong Application. Tingnan ang [ano ang Studio](/tl/studio/what-is-studio) para sa karagdagang konteksto.
3. [Gumawa ng Application](/tl/my-account/applications) at iugnay ito sa affiliate account na ginawa mo sa Hakbang 2. Para sa server-to-server API integrations, piliin ang **MACHINE_2_MACHINE** bilang client type.
...
Pumunta sa aming [APIs](/tl/developers/apis) na seksyon at piliin ang API na gusto mong gamitin.
...
:::tip[Pro Tip]
Para sa mas madaling paggamit, inirerekomenda naming gamitin ng mga integrator ang mga endpoint na tinukoy namin bilang `OAuth2`. Alam ng mga endpoint na ito na inaasahan ang mga API caller at alam na kung anong account ka kaya hindi mo na kailangang tukuyin ang `companyIdentifier` sa iyong mga URL.
:::
