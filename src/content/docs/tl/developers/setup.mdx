...
<Steps>
1. [Magrehistro](/tl/getting-started/sign-up) ng iyong user account sa Wink.
...
3. [Gumawa ng Application](/tl/account/applications) at iugnay ito sa affiliate account na ginawa mo sa Hakbang 2. Para sa server-to-server API integrations, piliin ang **MACHINE_2_MACHINE** bilang client type.
