...
<Steps>
  1. Gamitin ang [Lookup API](https://developer.wink.travel/lookup) upang makuha ang mga destinasyon o hotel.
...
<Steps>
  ...
  2. Mag-click sa `Download OpenAPI spec` mula sa tuktok ng [Lookup API](https://developer.wink.travel/lookup) pahina.
