...
description: Ipinapakita ng gabay na ito sa mga developer kung paano mag-set up ng webhooks upang makatanggap ng real-time na mga notification para sa mga booking, bayad, at iba pang mga kaganapan.
sidebar:
  order: 3
---
...
:::tip
Magsimula sa pagsubscribe sa lahat ng kaganapan habang nasa development. Kapag naunawaan mo na ang mga payload, paliitin ito sa mga kaganapan lamang na kailangan ng iyong sistema.
:::
...
- [Webhooks](/tl/portal/settings/webhooks) — Buong sanggunian para sa pamamahala ng webhook.
- [Applications](/tl/portal/settings/applications) — Pamahalaan ang iyong mga API credentials.
- [Developers > APIs](/tl/api) — Buong dokumentasyon ng API.
