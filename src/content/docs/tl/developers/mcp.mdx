...
4. Ipasok ang Wink Inventory server URL:
   ```
...
6. **Mag-sign in sa Wink** at aprubahan ang mga permiso. Parehong lalabas ang mga server bilang aktibo sa MCP Servers panel.
</Steps>
...
Kapag inaprubahan mo ang consent screen makikita mo ang detalyadong listahan ng hinihingi ng agent. Gumagamit ang mga MCP client ng parehong bokabularyo ng permiso tulad ng sa buong platform — tingnan ang buong
