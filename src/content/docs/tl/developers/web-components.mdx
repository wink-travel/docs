...
Makikita ang mga halimbawa para sa [cards](/tl/studio/cards), [grids](/tl/studio/grids) at [maps](/tl/studio/maps).
...
:::note
Para matutunan kung paano gumawa ng booking contract `id`, basahin ang gabay: [Integrating with TripPay](/tl/guides/integrating-with-trip-pay).
:::
...
Maaaring hindi na available ang inventory. Pumunta sa [Wink Studio](/tl/studio/cards) at tingnan kung ang status ng "card" ay available.
...
Maaaring naalis ang inventory. Pumunta sa [Wink Studio](/tl/studio/cards) at tingnan kung ang status ng "card" ay available.
Kung hindi, ito ay lalabas na pula. Sa ganitong kaso, maaari kang maghintay at baka gawing available muli ito ng supplier o alisin ito sa iyong listahan.
...
Para lamang ito sa mga web developer. Kung aksidenteng naalis mo ang [Application](/tl/my-account/applications) ; kaya hindi na available ang client ID, mangyaring gumawa ng bagong application at gamitin ang bagong client ID para i-embed ang aming Web Components.
