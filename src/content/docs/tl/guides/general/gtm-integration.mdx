---
title: Pagsasama ng GTM Analytics
description: Paano ikonekta ang anumang Google Tag Manager container (tulad ng Sojern container) sa Wink upang masubaybayan ang booking journey ng iyong mga bisita at mapagana ang iyong mga kampanya sa retargeting at advertising.
sidebar:
  label: Pagsasama ng GTM Analytics
---

import { Aside, Steps } from '@astrojs/starlight/components';

Maaari mong ikonekta ang **anumang** Google Tag Manager (GTM) container sa Wink sa pamamagitan ng paglalagay ng **GTM Container ID** nito sa Wink portal. Kapag nakakonekta na, awtomatikong naglo-load ang iyong container para sa iyong property at binabasa ang mga booking event ng Wink nang direkta — sumasaklaw sa buong guest journey mula sa paghahanap hanggang sa kumpletong booking. Isang karaniwang gamit ay ang **Sojern** container para sa retargeting at advertising, ngunit gumagana ang anumang GTM container sa parehong paraan.

<Aside type="tip">
Ipinapalagay nito na mayroon ka nang GTM Container ID (format na `GTM-XXXXXXX`). Kung ang iyong container ay mula sa isang partner tulad ng Sojern, hilingin sa iyong account manager ang **GTM Container ID** nang partikular — iba ito sa pixel o tag ID. Bago ka sa Sojern? Bisitahin ang [sojern.com/contact](https://www.sojern.com/contact) upang makapagsimula.
</Aside>
...
2. **Ilagay Ito sa Wink Portal**
   ...
   Mag-log in sa [app.wink.travel](https://app.wink.travel), piliin ang iyong account, at buksan ang iyong mga setting sa pag-customize. Sa seksyong **Analytics & integrations**, i-paste ang iyong GTM Container ID sa field na **GTM Container ID** at i-save. Live na ang iyong integration.

3. **Kumpirmahin sa Iyong Provider**
...
<Aside type="note">
Hindi mo kailangang maglagay ng anumang pixel code sa iyong sariling website para sa integration na ito. Awtomatikong niloload ng Wink ang iyong GTM container sa lahat ng pahina kung saan aktibo ang iyong property.

Gumagana ito para sa **anumang** GTM Container ID — ang Sojern ay isang karaniwang halimbawa lamang.
</Aside>
...
Para sa transparency, narito ang mga kinokonpigura ng Wink upang gumana ang integration na ito:

- **May field na GTM Container ID** sa seksyong **Analytics & integrations** ng iyong mga setting sa pag-customize. Kapag inilagay mo ang iyong Container ID, sine-validate ng Wink ang format (`GTM-XXXXXXX`) at iniimbak ito nang ligtas para sa iyong property.
...
- **Ang sariling tracking ng Wink at ang iyong container ay tumatakbo nang sabay**, binabasa mula sa parehong shared `dataLayer`. Ang bawat booking event na sinusubaybayan ng Wink ay sabay na available sa iyong container.
- **Kapag hindi tinitingnan ang iyong property** — halimbawa, kapag nagba-browse ang bisita sa ibang hotel sa Wink — hindi niloload ang iyong container, kaya tumatanggap lamang ito ng data na may kaugnayan sa iyong property.
- **Ang kumpletong booking (`purchase`) ay nagfa-fire sa browser sa thank-you page.** Ang GTM Container ID ay isang black box — hindi maaaring hulaan ng Wink kung ano ang mga tag sa loob nito — kaya hindi kailanman tumatawag ang Wink sa Google para sa iyo mula sa mga server nito. Sa halip, anumang GA4 o conversion tag na nasa iyong container ay tumatanggap ng `purchase` client-side, katulad ng bawat ibang booking event. Dahil nire-redirect ng payment provider ang browser ng bisita palayo at pabalik, nire-reconnect ng Wink ang analytics session na na-interrupt ng redirect **bago** mag-fire ng `purchase`, kaya naia-attribute ang benta sa orihinal na pagbisita ng bisita sa halip na bilang bagong session.

---

## Sanggunian ng DataLayer

Pinapadala ng Wink ang mga GA4-compatible na event sa `dataLayer` sa buong guest journey. Binabasa ng iyong GTM container ang parehong shared `dataLayer`, kaya anumang trigger o variable na iyong kinonpigura ay may access sa lahat ng properties na inilalarawan sa ibaba.
...
Nagfa-fire kapag nakansela ang booking.
...
Hindi pinapansin ng GA4 ang custom item parameters sa mga report hangga't hindi mo ito inirehistro bilang item-scoped custom dimensions. Kailangan mo lamang irehistro ang mga parameter na balak mong gamitin sa mga report — hindi mo kailangang irehistro lahat ng 20.
...
Pinapayagan ng GA4 ang hanggang 50 item-scoped custom dimensions bawat property sa standard properties (mas marami sa 360 properties).
</Aside>
...
Ang mga sumusunod na event ay available sa Wink dataLayer ngunit hindi bahagi ng standard booking funnel. Maaaring ma-fire ang mga ito ng iba pang interaksyon sa platform.
...
Walang kasamang `ecommerce` payload ang event na ito.
