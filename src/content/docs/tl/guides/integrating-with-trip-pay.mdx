...
<Steps>
  ...
  3. Lumikha ng a `payable contract` gamit ang TripPay na naglalaman ng mga item na i-book.
...
:::tandaan
Pumunta sa Payment API upang matuto nang higit pa tungkol sa mga kinakailangan para gumawa ng kontratang babayaran.
:::

### Kahilingan

Narito ang isang sample na kahilingan ng JSON na kasama ang lahat ng kailangan mong gawin para sa iyong unang babayarang kontrata.
...
I-save ang `id` sa linya 3. Gagamitin mo ito upang mag-inject sa bahagi ng web ng TripPay.
