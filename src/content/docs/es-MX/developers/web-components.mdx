...
Esto es solo para desarrolladores web. Si eliminaste accidentalmente la [Aplicación](/es-MX/developer/applications), haciendo que el client ID ya no esté disponible, por favor crea una nueva aplicación y usa el nuevo client ID para incrustar nuestros Componentes Web.
