...
Puedes encontrar ejemplos para [tarjetas](/studio/cards), [rejillas](/studio/grids) y [mapas](/studio/maps).
...
Esto es solo para desarrolladores web. Si eliminaste accidentalmente la [Aplicación](/developer/applications) ; haciendo que el ID de cliente ya no esté disponible, por favor crea una nueva aplicación y usa el nuevo ID de cliente para incrustar nuestros Componentes Web.
