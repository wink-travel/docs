...
:::note
Tu primera aplicación ya está creada cuando [creas una nueva cuenta](/es-MX/my-account/create-account). Usamos esta aplicación para algunos escenarios de reserva.
...
Necesitarás actualizar tu aplicación si alguna de tus URIs de redirección cambia o si quieres agregar o eliminar una URI.
