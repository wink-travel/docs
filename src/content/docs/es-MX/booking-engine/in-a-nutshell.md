...
Los integradores, que quieren aún más libertad, tienen acceso a todas las mismas funciones mediante nuestro [plugin de WordPress](/es-MX/integrations/wordpress/), [Web Components](/es-MX/integrations/web-components) y [APIs](/es-MX/developers/apis).
