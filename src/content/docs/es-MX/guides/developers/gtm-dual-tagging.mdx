...
<Aside type="note">
Las dimensiones personalizadas pueden tardar hasta 24 horas en aparecer en los reportes GA4 después de registrarlas. Los datos históricos recolectados antes del registro no se completan retroactivamente.
