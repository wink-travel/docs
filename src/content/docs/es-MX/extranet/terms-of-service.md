...
**"Propiedad Intelectual"** significa todos y cada uno de los derechos de propiedad intelectual de cualquier naturaleza (ya sea o no registrados, registrables o de otro tipo), incluyendo patentes, modelos de utilidad, marcas, diseños registrados y nombres de dominio, aplicaciones para cualquiera de los anteriores, nombres comerciales, buena voluntad, derechos de autor y derechos afines, derechos de diseño, derechos en bases de datos, derechos morales, know-how y cualquier otro derecho de propiedad intelectual que subsista en software, programas, sitios web, documentos, información, técnicas, métodos comerciales, dibujos, logotipos, manuales, listas y procedimientos, métodos y literatura publicitaria, incluyendo el "look and feel" de cualquier sitio web.

**“Transacción Materializada(s)"** significa la Reserva realizada por un Huésped con un Proveedor de Alojamiento, y cuya reserva ha resultado en la prestación real del alojamiento, confirmada a Wink por el Proveedor de Alojamiento. Las Transacciones Materializadas siempre se ajustarán por modificaciones (por ejemplo, estancias acortadas), contracargos, fraude con tarjeta de crédito, deudas incobrables o de otro tipo. Para evitar dudas, cancelaciones, no presentaciones, etc., nunca se considerarán Transacciones Materializadas.
...
**“Facilitador de Pagos”** una subsidiaria propiedad total de Traveliko Singapore Pte. Ltd. (“TripPay”), que administra los Servicios de Pago, recolectando pagos de huéspedes (“Pay-in”), cobrando el método de pago asociado a su compra, como tarjeta de crédito, débito, transferencia bancaria, criptomonedas o PayPal, etc., y desembolsando los fondos adeudados (“Tarifa Neta”) al Proveedor de Alojamiento.
...
9.2 Si el Proveedor de Alojamiento comete un error que resulta en una tarifa incorrecta cargada y se realiza una Reserva a esa tarifa incorrecta, el Proveedor de Alojamiento deberá respetar la reserva a la tarifa incorrecta.
...
10.3 Las Partes acuerdan que si un Proveedor de Alojamiento no cumple con esta cláusula y la Reserva se determina posteriormente como Potencialmente Fraudulenta, Wink no será responsable.
...
13.1 Modificación. Salvo que la ley aplicable disponga lo contrario, Wink puede modificar estos Términos en cualquier momento. Si hacemos cambios materiales a estos Términos, publicaremos los Términos revisados en la Plataforma Wink y actualizaremos la fecha de “Última actualización” en la parte superior de estos Términos. Si te afectan las modificaciones, también te notificaremos al menos treinta (30) días antes de que entren en vigor. Si no rescindes tu acuerdo antes de la fecha en que los Términos revisados entren en vigor, tu uso continuado de los Servicios constituirá aceptación de los cambios.
...
* Por Wink, en cualquier momento y sin causa, con un aviso previo por escrito de treinta (30) días naturales a la otra Parte;  
...
* El Proveedor de Alojamiento inicia insolvencia, bancarrota, administración judicial, liquidación, administración o procedimientos similares (ya sea iniciados por el Proveedor o sus acreedores), que no sean desestimados o resueltos a favor del Proveedor dentro de sesenta (60) días;  
...
15.2 El Proveedor de Alojamiento acuerda cooperar plenamente con Wink en el manejo de todas las reclamaciones o quejas de Huéspedes y proporcionar una respuesta detallada a cualquier consulta de Wink sobre estos asuntos a más tardar siete (7) días naturales después de recibirla o dentro del plazo acordado en el acuerdo de nivel de servicio.

15.3 Si Wink debe compensar a un Huésped debido a un incidente, reclamación o queja causada por un acto u omisión del Proveedor de Alojamiento, este acuerda indemnizar y reembolsar a Wink prontamente y en su totalidad, conforme a la Sección 33 de los Términos Generales ("Indemnización") según corresponda.
...
21.2 Si Wink no desea continuar el Acuerdo con la nueva entidad por cualquier motivo, las Partes podrán acordar terminar este Acuerdo inmediatamente y sin perjuicio de Reservas existentes y otros derechos adquiridos antes de dicha terminación.
...
22.5 El Proveedor de Alojamiento proporcionará a Wink actualizaciones sobre el progreso de cualquier reclamo de DPI y, si no cumple o Wink no está satisfecho, Wink asumirá el control inmediato del reclamo a costo del Proveedor. Wink podrá compensar cualquier costo y compensación pagada contra cualquier monto adeudado por el Proveedor.
...
23.2 El Proveedor de Alojamiento consultará con Wink sobre el contenido de cualquier comunicación o material que proponga emitir y deberá proporcionar copia de cualquier comunicación o material finalmente emitido.

**24. Precedencia**

24.1 Este Acuerdo se crea para permitir acuerdos comerciales individuales que Wink celebrará con cada Proveedor de Alojamiento. En caso de discrepancia, los términos de este Acuerdo aplicarán a los Proveedores de Alojamiento sujeto a lo siguiente:
...
Si alguna disposición de este Acuerdo es declarada ilegal, inválida o inaplicable por una autoridad competente, dicha disposición será modificada o eliminada en la medida necesaria para hacerla válida y el resto del Acuerdo permanecerá en vigor y vinculante.

**29. Relación entre las Partes**

Las Partes actúan como contratistas independientes. Ninguna Parte actuará como agente o socio de la otra ni tendrá autoridad para obligar a la otra.

**30. Cesión**

30.1 Ninguna Parte podrá ceder o transferir derechos u obligaciones sin consentimiento previo por escrito, salvo que Wink pueda ceder a una empresa afiliada sin consentimiento del Proveedor.
...
Wink no será responsable por retrasos o incumplimientos causados por eventos fuera de su control razonable, incluyendo desastres naturales, guerra, terrorismo, pandemias, huelgas, escasez, etc.
...
36.2 Si alguna disposición es inválida o no vinculante, las demás disposiciones seguirán vigentes y se reemplazará la disposición inválida por una válida con efecto similar.

**37. Ejecución**

El Acuerdo entra en vigor solo tras confirmación escrita de aceptación y aprobación del Proveedor por Wink. Al registrarse y suscribirse al programa Wink como Proveedor, el Proveedor acepta y reconoce los términos, incluyendo modificaciones.
...
Todos los avisos bajo este Acuerdo serán en inglés, por escrito, y entregados en persona, correo registrado prepagado o mensajería internacional reconocida (ej. FedEx, UPS, DHL) a la oficina registrada o por correo electrónico a la persona de contacto.

Se considerará recibido un aviso (i) entregado en mano con firma de acuse, (ii) por correo registrado con prueba de entrega, (iii) por mensajería con fecha registrada de entrega, o (iv) por correo electrónico con acuse de recibo.
