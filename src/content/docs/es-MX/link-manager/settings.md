---
title: Configuración
description: En este artículo, te explicamos cómo puedes personalizar tu página de WinkLinks usando las funciones disponibles en configuración.
sidebar:
  order: 4
---
...
- **Personalización** Elige qué personalización quieres usar para tu página de WinkLinks. Esto afecta los colores de tu tema así como tu itinerario al mostrar tarjetas de inventario Wink, mapas o cuadrículas.
...
- Lee más sobre [Personalizaciones](/es-MX/studio/customization).
