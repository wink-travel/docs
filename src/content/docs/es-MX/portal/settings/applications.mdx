...
- **SPA** (Aplicación de Página Única) — Para aplicaciones frontend basadas en navegador que usan el flujo de código de autorización OAuth2 con PKCE. Este es el tipo más común para aplicaciones web.
...
6. **URIs de redirección post-cierre de sesión** *(Opcional)* URLs a donde los usuarios pueden ser redirigidos después de cerrar sesión. Esto asegura que los usuarios lleguen a una página conocida tras terminar su sesión.
