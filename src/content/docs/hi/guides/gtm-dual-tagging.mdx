...
यदि आप Sojern के माध्यम से विज्ञापन अभियान चला रहे हैं, तो आप अपने Sojern खाते को Wink से कनेक्ट कर सकते हैं, अपने Sojern GTM कंटेनर आईडी को Wink पोर्टल में दर्ज करके। कनेक्ट होने के बाद, Sojern का ट्रैकिंग पिक्सेल स्वचालित रूप से आपके संपत्ति के लिए सक्रिय हो जाता है — खोज से लेकर पूरी बुकिंग तक की पूरी मेहमान यात्रा को कवर करता है।
...
2. **इसे Wink पोर्टल में दर्ज करें**
   ...
   [my.wink.travel](https://my.wink.travel) में लॉग इन करें, अपना खाता चुनें, और **Customizations** टैब पर जाएं। अपने Sojern GTM कंटेनर आईडी को Sojern फ़ील्ड में पेस्ट करें और सहेजें। आपकी एकीकरण अब सक्रिय है।
...
GA4 रिपोर्टों में कस्टम आइटम पैरामीटर को तब तक नजरअंदाज करता है जब तक आप उन्हें स्पष्ट रूप से आइटम-स्कोप्ड कस्टम डाइमेंशन्स के रूप में पंजीकृत न करें। आपको केवल उन पैरामीटरों को पंजीकृत करना है जिन्हें आप रिपोर्टों में उपयोग करना चाहते हैं — आपको सभी 18 को पंजीकृत करने की आवश्यकता नहीं है।
...
3. **डाइमेंशन विवरण भरें**
   ...
   - **Scope** — **Item** चुनें
   - **Event parameter** — dataLayer में जैसा दिखता है वैसा ही पैरामीटर नाम (नीचे तालिका देखें)
...
यह एक कस्टम Wink इवेंट है — मानक GA4 इवेंट सेट का हिस्सा नहीं। यह हर पृष्ठ नेविगेशन पर पुश होता है और डिवाइस और सेशन संदर्भ ले जाता है। इसमें कोई `ecommerce` ऑब्जेक्ट शामिल नहीं होता।
...
| गुण | विवरण |
|----------|-------------|
| `device` | पता लगाया गया डिवाइस प्रकार — `Desktop`, `Android`, `iPhone`, `iPad`, या समान |
| `deviceAgent` | कच्चा उपयोगकर्ता एजेंट स्ट्रिंग |
| `os` | पता लगाया गया ऑपरेटिंग सिस्टम — `Windows`, `MacOS`, `Linux`, `UNIX` |
