...
2. **इसे Wink पोर्टल में दर्ज करें**
   ...
   [app.wink.travel](https://app.wink.travel) में लॉग इन करें, अपना खाता चुनें, और **Customizations** टैब पर जाएं। Sojern फ़ील्ड में अपना Sojern GTM कंटेनर आईडी पेस्ट करें और सहेजें। आपकी एकीकरण अब सक्रिय है।
