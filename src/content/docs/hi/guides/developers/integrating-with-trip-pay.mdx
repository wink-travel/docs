...
- [Payment Web Component](/hi/integrations/web-components/#payment).
- [Payment API](/hi/api). *`Create payable contracts` अनुभाग पढ़ें*
...
:::note
payable contract बनाने की आवश्यकताओं के बारे में अधिक जानने के लिए Payment API पर जाएं।
:::

### अनुरोध
यहाँ एक JSON नमूना अनुरोध है जिसमें आपके पहले payable contract के लिए आवश्यक सभी चीजें शामिल हैं।
...
- `traceId` का उपयोग कई आपूर्तिकर्ताओं के बीच कई बुकिंग समूहित करने के लिए करें। इस तरह आप समूह बुकिंग रद्द कर सकते हैं।
...
- `contractItemList` के प्रत्येक प्रविष्टि में शामिल हैं:
...
- 1.5% उस प्लेटफ़ॉर्म को आवंटित किया गया जिसने बुकिंग को सुविधाजनक बनाया। *जैसे Wink*
...
जब TripPay एक payable contract के साथ प्रतिक्रिया करता है, तो आप देखेंगे कि उसने अपने स्वयं के लाभार्थी को 4.0% पर जोड़ा है।
:::
...
जहाँ तक एकीकरण की बात है, बस इतना ही करना है। यहाँ से सभी भारी काम TripPay द्वारा किया जाएगा।
