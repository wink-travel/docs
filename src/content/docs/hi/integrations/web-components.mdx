...
[Web Components](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) एक मानक है जो आपको बिना कोडिंग जाने अपनी वेबसाइट में पूरी जावास्क्रिप्ट सुविधाओं को एकीकृत करने देता है।
इस शानदार तकनीक की बदौलत, यह आपको Wink ट्रैवल इन्वेंटरी को बहुत कम झंझट के साथ एम्बेड करने देता है। यह लेख आपको हमारे वेब कॉम्पोनेंट्स के संग्रह के माध्यम से ले जाता है और दिखाता है कि उन्हें कैसे उपयोग करें।
...
अपने दस्तावेज़ के नीचे हमारे जावास्क्रिप्ट को शामिल करें। (*हम अंत के ठीक ऊपर &lt;/body&gt; टैग की सलाह देते हैं*)।
...
आपकी साइट अब तैयार है और हमारे वेब कॉम्पोनेंट्स को दिखाने में सक्षम है।
...
*एट्रिब्यूट `sort` केवल तब उपलब्ध है जब layout `RANKED` हो और आप मौजूदा रैंक्ड ग्रिड का उपयोग नहीं करना चाहते। इन मामलों में, `id` खाली छोड़ दें।*
...
जब उपयोगकर्ता प्रमाणीकरण किया होता है, तो यह उपयोगकर्ता की प्रोफ़ाइल आइकन दिखाता है।
...
:::note
बुकिंग कॉन्ट्रैक्ट `id` कैसे जनरेट करें, यह जानने के लिए गाइड पढ़ें: [TripPay के साथ एकीकरण](/hi/guides/developers/integrating-with-trip-pay)।
:::
...
यदि नहीं है, तो यह लाल दिखेगा। ऐसी स्थिति में, आप प्रतीक्षा कर सकते हैं और शायद सप्लायर इसे फिर से उपलब्ध कराए या इसे अपनी सूची से हटा दें।
