...
<Steps>
1. Wink पर अपना उपयोगकर्ता खाता [Register](/hi/user/register) करें
2. एक [travel agent account](/hi/travel-agent/what-is-agent) या एक [affiliate account](/hi/studio/what-is-studio) बनाएं।
3. [Create an Application](/hi/developer/applications) करें जहाँ आप इसे चरण 2 में बनाए गए खाते से जोड़ते हैं।
...
हमारे [APIs](/hi/developer/apis) सेक्शन पर जाएं और उस API को चुनें जिसके साथ आप काम करना चाहते हैं।
...
:::tip[Pro Tip]
यह अनुशंसित है कि सर्वर डोमेन, client ID और client secret को पर्यावरण चर (environment variables) में बदल दिया जाए। इस तरह आप आसानी से staging और production वातावरण के बीच स्विच कर सकते हैं और आपने जो सभी ऑपरेशंस बनाए हैं उन्हें पुनः उपयोग कर सकते हैं।
:::
