...
एक एप्लिकेशन आपको एक `Client ID` और `Secret Key` प्रदान करता है जिसकी आपको एक प्रमाणीकृत OAuth2 सत्र बनाने के लिए आवश्यकता होती है, जिसे आप Wink और TripPay APIs के साथ संवाद करने के लिए उपयोग कर सकते हैं।
...
| **Accounting** | `accounting.read` `accounting.write` `accounting.remove` | लेखांकन, निकासी खाता, मिलान | मध्यम–उच्च |
...
**Payment** और **Accounting** पैसे के लेन-देन की सुरक्षा करते हैं, इसलिए इनमें जोखिम अधिक होता है।
:::
...
अपने किसी ऐप से 'Client ID' और 'Secret Key' प्राप्त करें और हमारे किसी भी [APIs](/hi/api/overview/) पर जाएँ।
:::
