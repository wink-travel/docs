...
ด้วยเทคโนโลยีเจ๋งๆ นี้ มันช่วยให้คุณฝังสินค้าคงคลังการเดินทางของ Wink ได้อย่างง่ายดาย บทความนี้จะแนะนำคุณผ่านคอลเลกชันของคอมโพเนนต์เว็บของเราและแสดงวิธีใช้งาน
...
ตัวอย่างสามารถดูได้สำหรับ [การ์ด](/th/portal/studio/cards), [กริด](/th/portal/studio/grids) และ [แผนที่](/th/portal/studio/maps)
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บปุ่มบัญชี (เมื่อยืนยันตัวตนแล้ว)*</figcaption>
</figure>
