...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บแผนการเดินทาง*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บการค้นหา*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บแบบฟอร์มแผนการเดินทาง*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บปุ่มบัญชีผู้ใช้*</figcaption>
</figure>

การคลิกที่ปุ่ม เมื่อผู้ใช้ยังไม่ได้ยืนยันตัวตน จะนำผู้ใช้ไปยังหน้าการยืนยันตัวตน
เมื่อผู้ใช้ยืนยันตัวตนแล้ว จะมีการแสดงไอคอนโปรไฟล์ของผู้ใช้
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บปุ่มบัญชีผู้ใช้ (ยืนยันตัวตนแล้ว)*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*คอมโพเนนต์เว็บปุ่มบัญชีผู้ใช้ (เปิด)*</figcaption>
</figure>
...
:::note
เพื่อเรียนรู้วิธีสร้าง `id` ของสัญญาการจอง โปรดอ่านคำแนะนำ: [การผสานรวมกับ TripPay](/th/guides/developers/integrating-with-trip-pay)
:::
...
สินค้าคงคลังอาจไม่พร้อมใช้งานอีกต่อไป ไปที่ [Wink Studio](/th/portal/studio/cards) และตรวจสอบสถานะของ "การ์ด" ว่าพร้อมใช้งานหรือไม่
...
:::note
`ความพร้อมใช้งาน` ไม่ได้หมายถึงความพร้อมใช้งานรายวันของสินค้าคงคลังสำหรับการจอง แต่หมายความว่าสินค้าคงคลังนั้นไม่พร้อมใช้งานสำหรับคุณและ/หรือใครก็ตามโดยสมบูรณ์
:::

### ถูกลบ

สินค้าคงคลังอาจถูกลบไปแล้ว ไปที่ [Wink Studio](/th/portal/studio/cards) และตรวจสอบสถานะของ "การ์ด" ว่าพร้อมใช้งานหรือไม่
ถ้าไม่พร้อมใช้งาน จะปรากฏเป็นสีแดง ในกรณีนั้น คุณสามารถรอและอาจซัพพลายเออร์จะทำให้พร้อมใช้งานอีกครั้ง หรือเอาออกจากรายการของคุณ
...
ส่วนนี้สำหรับนักพัฒนาเว็บเท่านั้น หากคุณเผลอลบ [Application](/th/portal/settings/applications) ทำให้ client ID ไม่พร้อมใช้งานอีกต่อไป โปรดสร้างแอปพลิเคชันใหม่และใช้ client ID ใหม่เพื่อฝังคอมโพเนนต์เว็บของเรา
