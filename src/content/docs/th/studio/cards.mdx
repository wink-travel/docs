...
- **Embed** แสดงวิธีฝังการ์ดนี้เป็น [Card](/th/developers/integrations/web-components/#content-loader) ลงในเว็บไซต์ของคุณ
- **Use with WordPress** แสดงวิธีใช้ [WordPress plugin](/th/developers/integrations/wordpress) ของเราเพื่อฝังการ์ดนี้ลงในเว็บไซต์ของคุณ
...
- บรรทัดที่ 6 ถึง 9 แสดงวิธีใช้ [wink-content-loader](/th/developers/integrations/web-components/#content-loader) Web Component และบอกให้ดึงการ์ดห้องพักแขกสำหรับโค้ดของคุณ
