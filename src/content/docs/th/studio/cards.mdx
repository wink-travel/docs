...
- **Embed** แสดงวิธีฝังการ์ดนี้เป็น [Card](/th/integrations/web-components/#content-loader) ลงในเว็บไซต์ของคุณ
- **Use with WordPress** แสดงวิธีใช้ [WordPress plugin](/th/integrations/wordpress) ของเราเพื่อฝังการ์ดนี้ลงในเว็บไซต์ของคุณ
