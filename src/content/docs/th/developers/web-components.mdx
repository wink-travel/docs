...
ตัวอย่างสามารถพบได้สำหรับ [การ์ด](/studio/cards), [กริด](/studio/grids) และ [แผนที่](/studio/maps)
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*โมดัลการค้นหาพร้อมผลลัพธ์*</figcaption>
</figure>
...
:::note
เพื่อเรียนรู้วิธีสร้าง `id` ของสัญญาการจอง โปรดอ่านคำแนะนำ: [การรวมกับ TripPay](/guides/integrating-with-trip-pay)
:::
...
สินค้าคงคลังอาจไม่พร้อมใช้งานอีกต่อไป ไปที่ [Wink Studio](/studio/cards) และตรวจสอบสถานะของ "การ์ด" ว่าพร้อมใช้งานหรือไม่
...
:::note
`ความพร้อมใช้งาน` ไม่ได้หมายถึงความพร้อมใช้งานรายวันของสินค้าคงคลังสำหรับการจอง แต่หมายถึงว่าสินค้าคงคลังนั้นไม่พร้อมใช้งานสำหรับคุณและ/หรือใครก็ตามโดยสมบูรณ์
:::

### ถูกลบ

สินค้าคงคลังอาจถูกลบไปแล้ว ไปที่ [Wink Studio](/studio/cards) และตรวจสอบสถานะของ "การ์ด" ว่าพร้อมใช้งานหรือไม่
ถ้าไม่พร้อมใช้งาน จะปรากฏเป็นสีแดง ในกรณีนั้น คุณสามารถรอและอาจซัพพลายเออร์จะทำให้พร้อมใช้งานอีกครั้ง หรือเอาออกจากรายการของคุณ
...
สำหรับนักพัฒนาเว็บเท่านั้น หากคุณเผลอลบ [แอปพลิเคชัน](/developer/applications) ทำให้ client ID ไม่พร้อมใช้งานอีกต่อไป โปรดสร้างแอปพลิเคชันใหม่และใช้ client ID ใหม่เพื่อฝังคอมโพเนนต์เว็บของเรา
