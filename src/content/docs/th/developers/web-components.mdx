...
ตัวอย่างสามารถดูได้ที่ [การ์ด](/th/studio/cards), [กริด](/th/studio/grids) และ [แผนที่](/th/studio/maps)
...
:::note
เพื่อเรียนรู้วิธีสร้าง `id` ของสัญญาการจอง โปรดอ่านคำแนะนำ: [การผสานรวมกับ TripPay](/th/guides/integrating-with-trip-pay)
:::
...
ส่วนนี้สำหรับนักพัฒนาเว็บเท่านั้น หากคุณเผลอลบ [Application](/th/my-account/applications) ทำให้ client ID ไม่พร้อมใช้งานอีกต่อไป โปรดสร้างแอปพลิเคชันใหม่และใช้ client ID ใหม่เพื่อฝังคอมโพเนนต์เว็บของเรา
