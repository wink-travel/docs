...
:::note
คอลัมน์ **ความเสี่ยง** แสดงความไว: `read` อยู่ในระดับต่ำสุด และ `write`/`remove` อยู่ในระดับสูงสุด **การชำระเงิน** และ **บัญชี** ควบคุมการเคลื่อนย้ายเงิน จึงมีความเสี่ยงสูงขึ้น
:::

สิ่งที่ควรจำ:

- **ขอเฉพาะสิ่งที่จำเป็นที่สุด** ขอเฉพาะ scopes ที่การผสานรวมของคุณใช้งานจริง — โทเค็นที่ออกด้วยสิทธิ์กว้างกว่าที่จำเป็นจะมีผลกระทบมากขึ้นหากรั่วไหล
...
รับ 'Client ID' และ 'Secret Key' จากแอปของคุณ แล้วไปที่ [APIs](/th/api/overview/) ของเราได้เลย
:::
