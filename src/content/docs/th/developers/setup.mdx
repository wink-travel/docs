...
<Steps>
  1. ใช้ [ค้นหา API](https://developer.wink.travel/lookup) เพื่อดึงข้อมูลจุดหมายปลายทางหรือโรงแรม
...
<Steps>
  ...
  2. คลิ๊กที่นี่ `Download OpenAPI spec` จากด้านบนของ [ค้นหา API](https://developer.wink.travel/lookup) หน้าหนังสือ.
