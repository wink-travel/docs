...
<Steps>
1. [ลงทะเบียน](/th/my-account/register) บัญชีผู้ใช้ของคุณบน Wink
2. [สร้างบัญชีพันธมิตร](/th/my-account/create-account) คุณจะต้องใช้บัญชีนี้เพื่อผูกกับแอปพลิเคชันของคุณ ดู [Studio คืออะไร](/th/studio/what-is-studio) เพื่อข้อมูลเพิ่มเติม
3. [สร้างแอปพลิเคชัน](/th/my-account/applications) และเชื่อมโยงกับบัญชีพันธมิตรที่คุณสร้างในขั้นตอนที่ 2 สำหรับการเชื่อมต่อ API แบบ server-to-server ให้เลือก **MACHINE_2_MACHINE** เป็นประเภทไคลเอนต์
...
ไปที่ส่วน [APIs](/th/developers/apis) ของเราและเลือก API ที่คุณต้องการใช้งาน
...
:::tip[เคล็ดลับมือโปร]
แนะนำให้ตั้งค่าชื่อโดเมนเซิร์ฟเวอร์, Client ID และ Client Secret เป็นตัวแปรสภาพแวดล้อม เพื่อให้คุณสามารถสลับระหว่างสภาพแวดล้อม staging และ production ได้ง่าย และนำการดำเนินการทั้งหมดที่คุณสร้างไว้กลับมาใช้ใหม่
:::
