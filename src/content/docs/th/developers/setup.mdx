---
title: การตั้งค่า
description: บทความนี้แสดงวิธีการตั้งค่าอย่างรวดเร็วในฐานะนักพัฒนาและเริ่มทดสอบ API ของเราใน Wink
sidebar:
  order: 1
---
...
:::note
การทดสอบควรทำใน [สภาพแวดล้อม staging](/th/getting-started/environments) เสมอ ที่นั่นจะมีข้อมูลน้อยกว่าแต่คุณสามารถทดสอบได้อย่างเต็มที่โดยไม่ส่งผลกระทบต่อสภาพแวดล้อม production

เมื่อคุณพร้อมใช้งานจริง เราจะรับรองบัญชีและแอปพลิเคชันของคุณ และคุณสามารถเปิดใช้งานในสภาพแวดล้อม production ได้
:::

ทำตามขั้นตอนเหล่านี้:

<Steps>
1. [ลงทะเบียน](/th/getting-started/sign-up) บัญชีผู้ใช้ของคุณบน Wink
2. [สร้างบัญชีพันธมิตร](/th/portal/create-account) คุณจะต้องใช้บัญชีนี้เพื่อผูกกับแอปพลิเคชันของคุณ ดู [Studio คืออะไร](/th/portal/studio/what-is-studio) เพื่อบริบทเพิ่มเติม
3. [สร้างแอปพลิเคชัน](/th/account/applications) และเชื่อมโยงกับบัญชีพันธมิตรที่คุณสร้างในขั้นตอนที่ 2 สำหรับการเชื่อมต่อ API แบบ server-to-server ให้เลือก **MACHINE_2_MACHINE** เป็นประเภทไคลเอนต์
...
บรรทัดที่เน้นด้านบนแสดง ID เฉพาะของ Cloudinary คือ `partners/radisson_blu_logo` นั่นคือสิ่งที่คุณต้องใช้เพื่อดึงภาพในรูปแบบ คุณภาพ และขนาดที่คุณต้องการ

## การทดสอบ

ไปที่ส่วน [APIs](/th/api/overview/) ของเราและเลือก API ที่คุณต้องการใช้งาน
...
:::tip[เคล็ดลับมือโปร]
เพื่อความสะดวก เราแนะนำให้นักพัฒนาระบบใช้ endpoints ที่เรากำหนดเป็น `OAuth2` endpoints เหล่านี้จะรู้ว่าผู้เรียก API คือใครและรู้ว่าคุณอยู่ในบัญชีใด ดังนั้นคุณไม่ต้องระบุ `companyIdentifier` ใน URL ของคุณ
:::
...
4. หากคุณนำเข้าเป็นคอลเลกชันใหม่ชื่อ `Wink API` ให้คลิกที่จุดสามจุดแนวนอนข้างชื่อคอลเลกชันแล้วคลิก `Edit`
...
13. ตั้งค่า `Scope` เป็นสโคปที่การเชื่อมต่อของคุณต้องการโดยเว้นวรรค เช่น `inventory.read inventory.write inventory.remove` ดู [รายการสโคป](/th/developers/authentication#scopes) สำหรับรายการทั้งหมด
14. ตั้งค่า `Client Authentication` เป็น `Send as Basic Auth header`
15. คลิกปุ่ม `Get New Access Token` เพื่อดึงโทเค็นและบันทึกไว้
...
:::tip[เคล็ดลับมือโปร]
แนะนำให้ตั้งค่าชื่อโดเมนเซิร์ฟเวอร์, Client ID และ Client Secret เป็นตัวแปรสภาพแวดล้อม เพื่อให้คุณสามารถสลับระหว่างสภาพแวดล้อม staging และ production ได้อย่างง่ายดาย และใช้ซ้ำการดำเนินการทั้งหมดที่คุณสร้างไว้
:::
