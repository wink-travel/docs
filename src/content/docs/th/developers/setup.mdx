...
:::note
การทดสอบควรทำใน [สภาพแวดล้อมสเตจจิ้ง](/th/getting-started/environments) เสมอ ที่นั่นจะมีข้อมูลน้อยกว่าแต่คุณสามารถทดสอบได้อย่างเต็มที่โดยไม่ส่งผลกระทบต่อสภาพแวดล้อมการผลิต
...
<Steps>
1. [ลงทะเบียน](/th/user/register) บัญชีผู้ใช้ของคุณบน Wink
2. สร้าง [บัญชีตัวแทนท่องเที่ยว](/th/travel-agent/what-is-agent) หรือ [บัญชีพันธมิตร](/th/studio/what-is-studio)
3. [สร้างแอปพลิเคชัน](/th/developer/applications) โดยเชื่อมโยงกับบัญชีที่คุณสร้างในขั้นตอนที่ 2
4. เมื่อคุณสร้าง `Application` แล้ว ให้บันทึก client-id และ client secret ไว้ในที่ปลอดภัย
</Steps>

## CDN

ที่ Wink เราใช้ Cloudinary สำหรับภาพและวิดีโอทั้งหมดของเรา เมื่อคุณเข้าถึงสินค้าคงคลังการท่องเที่ยว คุณจะสามารถใช้ฟีเจอร์ขั้นสูงทั้งหมดของ Cloudinary ได้อย่างเต็มที่
...
สำหรับสินค้าคงคลังการท่องเที่ยวทุกประเภทที่เรารองรับ จะมีอาร์เรย์ JSON ซ้อนชื่อ `multimedias` JSON สำหรับรายการมัลติมีเดียมีลักษณะดังนี้:
...
บรรทัดที่เน้นด้านบนแสดง ID เฉพาะของ Cloudinary คือ `partners/radisson_blu_logo` นั่นคือข้อมูลทั้งหมดที่คุณต้องใช้เพื่อดึงภาพในรูปแบบ คุณภาพ และขนาดที่คุณต้องการ

## การทดสอบ

ไปที่ส่วน [APIs](/th/developer/apis) ของเราและเลือก API ที่คุณต้องการใช้งาน
...
4. หากข้อมูลรับรองถูกต้อง คุณจะเห็นว่า API key ของคุณถูกนำไปใช้แล้ว
...
13. ตั้งค่า `Scope` เป็น `inventory.read inventory.write inventory.remove` ซึ่งเป็นสโคปทั้งหมดที่คุณต้องใช้สำหรับ Wink
...
:::tip[เคล็ดลับมือโปร]
แนะนำให้ตั้งค่าชื่อโดเมนเซิร์ฟเวอร์, Client ID และ Client Secret เป็นตัวแปรสภาพแวดล้อม เพื่อให้คุณสามารถสลับระหว่างสภาพแวดล้อมสเตจจิ้งและการผลิตได้อย่างง่ายดาย และใช้ซ้ำการดำเนินการทั้งหมดที่คุณสร้างไว้
:::
