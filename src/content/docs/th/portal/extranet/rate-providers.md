...
ในการตั้งค่าผู้ให้บริการอัตราค่าห้องของคุณ ให้คลิกที่ `Distribution > Channel manager` จากแถบนำทางหลัก

เลือกผู้ให้บริการอัตราค่าห้องของคุณจากรายการแบบเลื่อนลงแล้วคลิกปุ่ม `Save` ซึ่งจะช่วยให้ผู้ให้บริการอัตราค่าห้องส่งอัตราค่าห้องมาให้เรา และเราจะแจ้งเตือนพวกเขาเมื่อมีการจองเกิดขึ้นบน Wink สำหรับหนึ่งในที่พักของคุณ


### SynXis

หากที่พักของคุณใช้ channel manager ของ SynXis จะมีขั้นตอนเพิ่มเติมอีกหนึ่งขั้นตอนก่อนที่คุณจะพร้อมเชื่อมต่อกับ Wink

- กรุณาติดต่อผู้แทนบัญชี SynXis หรือฝ่ายดูแลลูกค้า (SHSCustomerCare@sabre.com)
- แจ้งให้พวกเขาทราบว่าคุณต้องการเชื่อมต่อกับ Wink ผ่าน Channel Connect Express (***CCX***)
- พวกเขาจะให้คุณกรอกแบบฟอร์ม ***PRS***
  - คุณจะถูกขอให้กรอกข้อมูลผู้ใช้ Wink ของคุณ
  - ...และสกุลเงินที่คุณต้องการ
- กรอกแบบฟอร์มให้ครบถ้วนและส่งกลับไปยัง SynXis

## ผู้ขาย

ด้านล่างนี้คือรายชื่อผู้ขายที่เราสนับสนุน:
...
*หากผู้ขายมี proxy หมายความว่าเรารับอัตราค่าห้องจากผู้ขายผ่าน proxy โดยทางอ้อม*
