...
description: เอกสารนี้ครอบคลุมถึงการมีเงินพร้อมใช้และวิธีที่ Wink จ่ายเงินให้กับพันธมิตรของตน
sidebar:
  order: 17
---
...
เงื่อนไขการให้บริการชำระเงินเหล่านี้ (“**เงื่อนไขการชำระเงิน**”) เป็นข้อตกลงทางกฎหมายที่ผูกพันระหว่างผู้ให้บริการที่พักและ TripPay (ซึ่งต่อไปนี้จะเรียกว่า **“ผู้ดำเนินการชำระเงิน”**) ซึ่งเป็นบริษัทย่อยที่เป็นเจ้าของโดยสมบูรณ์ของ Winkfluence ที่ควบคุมบริการชำระเงิน (ซึ่งกำหนดไว้ด้านล่าง) ที่ดำเนินการผ่านหรือเชื่อมโยงกับแพลตฟอร์ม Wink (ซึ่งต่อไปนี้จะเรียกว่า **“Wink”**) เมื่อเงื่อนไขการชำระเงินนี้กล่าวถึง “**ผู้ดำเนินการชำระเงิน**,” “**เรา**,” “**พวกเรา**,” หรือ “**ของเรา**” หมายถึงบริษัท TripPay ที่คุณทำสัญญาด้วยสำหรับบริการชำระเงิน
...
เพื่อใช้บริการชำระเงิน คุณต้องมีอายุอย่างน้อย 18 ปี มีบัญชี Wink ที่อยู่ในสถานะดีตามเงื่อนไขของผู้ดำเนินการชำระเงิน และรักษาข้อมูลการชำระเงินและข้อมูลส่วนตัวของคุณให้ถูกต้องและครบถ้วน
...
บริการชำระเงินจะถูกจัดให้โดยหน่วยงานที่ทำสัญญาขึ้นอยู่กับประเทศที่ที่พักตั้งอยู่ดังนี้:
...
2.6 **ข้อจำกัดการจ่ายเงินออก** ผู้ดำเนินการชำระเงินอาจระงับ ชะลอ หรือยกเลิกการจ่ายเงินออกใด ๆ ชั่วคราวเพื่อป้องกันกิจกรรมที่ผิดกฎหมายหรือการฉ้อโกง เพื่อการประเมินความเสี่ยง ความปลอดภัย หรือการสืบสวน หรือหากเราไม่สามารถยืนยันตัวตนของคุณได้ นอกจากนี้ ผู้ดำเนินการชำระเงินอาจระงับ ชะลอ หรือเลื่อนการเริ่มต้นหรือดำเนินการจ่ายเงินออกใด ๆ ที่คุณควรได้รับภายใต้เงื่อนไขนี้เนื่องจากการยกเลิกหรือแก้ไขการจองจำนวนมากที่เกิดจากเหตุสุดวิสัย (ตามที่กำหนดด้านล่าง)

2.7 **ข้อจำกัดการจ่ายเงินออก** เพื่อเหตุผลด้านการปฏิบัติตามกฎหมายหรือการดำเนินงาน ผู้ดำเนินการชำระเงินอาจจำกัดจำนวนเงินที่จ่ายออก หากคุณควรได้รับจำนวนเงินเกินขีดจำกัดนั้น ผู้ดำเนินการชำระเงินอาจจ่ายเงินออกเป็นชุด (อาจเป็นหลายวัน) เพื่อให้คุณได้รับจำนวนเงินเต็มจำนวน
...
2.9 **การจัดการเงิน** ผู้ดำเนินการชำระเงินอาจรวบรวมจำนวนเงินที่เก็บจากแขกและลงทุนตามที่กฎหมายที่ใช้บังคับอนุญาต ผู้ดำเนินการชำระเงินจะเก็บดอกเบี้ยที่ได้รับจากการลงทุนเหล่านั้น

2.10 **ความถูกต้องของพันธมิตร** ผู้ให้บริการที่พักมีหน้าที่รับผิดชอบในการตรวจสอบความถูกต้องของข้อมูลบัญชีธนาคารที่เก็บไว้ในโปรไฟล์ของผู้ดำเนินการชำระเงิน หากหมายเลขบัญชีธนาคารถูกป้อนผิด จะมีค่าธรรมเนียมการดำเนินการเพิ่มเติมที่เรียกเก็บโดยธนาคาร ผู้ดำเนินการชำระเงินจะหักค่าธรรมเนียมนี้จากการจ่ายค่าคอมมิชชั่นครั้งถัดไป ในกรณีที่บัญชีธนาคารที่ผู้ให้บริการที่พักให้ไว้ถูกปิด ถูกระงับ หรือไม่สามารถรับ/สะท้อนการชำระเงินได้ด้วยเหตุผลที่ไม่เกี่ยวข้องกับผู้ดำเนินการชำระเงิน ภาระผูกพันในการชำระเงินของผู้ดำเนินการชำระเงินภายใต้ข้อตกลงนี้จะถือว่าสิ้นสุดตราบเท่าที่บันทึกของผู้ดำเนินการชำระเงินแสดงว่าการชำระเงินได้ดำเนินการแล้ว
...
* ภาษี ตามที่ใช้บังคับและระบุไว้ในเงื่อนไข  
* ค่าบริการหรือค่าธรรมเนียมการยกเลิกที่กำหนดตามเงื่อนไข (เช่น หากคุณในฐานะผู้ให้บริการที่พักยกเลิกการจองที่ยืนยันแล้ว)  
* จำนวนเงินที่จ่ายให้คุณในฐานะผู้ให้บริการที่พักแล้วแม้แขกจะยกเลิกการจองที่ยืนยันแล้ว หรือ Wink ตัดสินใจว่าสมควรยกเลิกการจองตามเงื่อนไข นโยบายการคืนเงินแขก หรือ นโยบายการยกเลิกที่ใช้บังคับ คุณตกลงว่าในกรณีที่คุณได้รับเงินแล้ว ผู้ดำเนินการชำระเงินมีสิทธิ์เรียกคืนจำนวนเงินคืนแขกดังกล่าวจากคุณ รวมถึงการหักจำนวนเงินคืนดังกล่าวจากการจ่ายเงินออกในอนาคตที่คุณควรได้รับ
...
3.1 **ข้อผิดพลาด** ผู้ดำเนินการชำระเงินจะดำเนินการแก้ไขข้อผิดพลาดในการประมวลผลการชำระเงินที่เราทราบ ขั้นตอนเหล่านี้อาจรวมถึงการเครดิตหรือเดบิต (ตามความเหมาะสม) บัญชีผู้ดำเนินการชำระเงินของคุณ เพื่อให้คุณได้รับหรือจ่ายจำนวนเงินที่ถูกต้อง อาจดำเนินการโดยผู้ดำเนินการชำระเงินหรือบุคคลที่สาม เช่น สถาบันการเงินของคุณ เรายังอาจดำเนินการเรียกคืนเงินที่ส่งให้คุณโดยผิดพลาด (รวมถึงแต่ไม่จำกัดเฉพาะกรณีจ่ายเงินซ้ำเนื่องจากข้อผิดพลาดในการประมวลผล) โดยการลด หักลบ และ/หรือเดบิตจำนวนเงินดังกล่าวจากการจ่ายเงินออกในอนาคตที่คุณควรได้รับ หากคุณได้รับเงินโดยผิดพลาด คุณตกลงที่จะคืนเงินดังกล่าวให้ผู้ดำเนินการชำระเงินทันที

3.2 **การคืนเงิน** การคืนเงินหรือเครดิตใด ๆ ที่ต้องจ่ายให้กับแขกตามเงื่อนไขและนโยบายการคืนเงินแขกจะถูกเริ่มต้นและจ่ายโดยผู้ดำเนินการชำระเงินตามเงื่อนไขการชำระเงินนี้
...
ผู้ดำเนินการชำระเงินจะไม่รับผิดชอบต่อความล่าช้าหรือความล้มเหลวในการปฏิบัติตามภาระผูกพันใด ๆ ภายใต้เงื่อนไขการชำระเงินนี้ที่เกิดจากสาเหตุที่อยู่นอกเหนือการควบคุมที่สมเหตุสมผลของ Wink หรือผู้ดำเนินการชำระเงิน รวมถึงแต่ไม่จำกัดเพียง เหตุการณ์ธรรมชาติ สงคราม การก่อการร้าย จลาจล การปิดล้อม การกระทำของเจ้าหน้าที่พลเรือนหรือทหาร ไฟไหม้ น้ำท่วม อุบัติเหตุ โรคระบาด การประท้วง หรือการขาดแคลนสิ่งอำนวยความสะดวกการขนส่ง น้ำมันเชื้อเพลิง พลังงาน แรงงาน หรือวัสดุ (“เหตุสุดวิสัย”)
...
7.2 แม้ว่าผู้ดำเนินการชำระเงินจะได้รับแต่งตั้งเป็นตัวแทนเก็บเงินจำกัดของผู้ให้บริการที่พักตามข้อ 6 ผู้ดำเนินการชำระเงินปฏิเสธความรับผิดทั้งหมดสำหรับการกระทำหรือการละเลยของผู้ให้บริการที่พักหรือบุคคลที่สามอื่น ๆ ผู้ดำเนินการชำระเงินไม่มีหน้าที่หรือภาระผูกพันใด ๆ ในฐานะตัวแทนของผู้ให้บริการที่พักแต่ละราย นอกจากที่ระบุไว้อย่างชัดเจนในเงื่อนไขการชำระเงินนี้ และหน้าที่หรือภาระผูกพันเพิ่มเติมใด ๆ ที่อาจบังคับใช้ตามกฎหมายจะถูกยกเว้นอย่างชัดเจนในขอบเขตสูงสุดที่กฎหมายอนุญาต

7.3 หากเราเลือกที่จะทำการตรวจสอบตัวตนของผู้ให้บริการที่พักใด ๆ ในขอบเขตที่กฎหมายอนุญาต เราปฏิเสธการรับประกันใด ๆ ทั้งโดยชัดแจ้งหรือโดยนัย ว่าการตรวจสอบดังกล่าวจะระบุพฤติกรรมผิดกฎหมายก่อนหน้าของผู้ให้บริการที่พัก หรือรับประกันว่าผู้ให้บริการที่พักจะไม่กระทำผิดในอนาคต

7.4 ข้อปฏิเสธข้างต้นใช้ในขอบเขตสูงสุดที่กฎหมายอนุญาต คุณอาจมีสิทธิหรือการรับประกันตามกฎหมายอื่น ๆ ที่ไม่สามารถยกเว้นได้ตามกฎหมาย อย่างไรก็ตาม ระยะเวลาของการรับประกันตามกฎหมายจะถูกจำกัดในขอบเขตสูงสุด (ถ้ามี) ที่กฎหมายอนุญาต
...
10.6 **ผลของการยกเลิก** หากคุณยกเลิกบัญชี Wink ของคุณในฐานะผู้ให้บริการที่พัก หรือผู้ดำเนินการชำระเงินดำเนินมาตรการใด ๆ ข้างต้น ผู้ดำเนินการชำระเงินอาจคืนเงินเต็มจำนวนให้กับแขกที่มีการจองยืนยัน และคุณจะไม่มีสิทธิ์ได้รับค่าชดเชยใด ๆ สำหรับการจองที่รอดำเนินการหรือยืนยันที่ถูกยกเลิก
...
11.3 หากคุณทำสัญญากับผู้ดำเนินการชำระเงินในสโลวาเกีย เงื่อนไขการชำระเงินนี้จะถูกตีความตามกฎหมายของสหภาพยุโรป หากคุณเป็นผู้บริโภค คดีความที่คุณสามารถฟ้องร้องกับเราอันเกิดจากหรือเกี่ยวข้องกับเงื่อนไขการชำระเงินนี้สามารถฟ้องได้เฉพาะในศาลที่ตั้งอยู่ในเมืองบราติสลาวาหรือศาลที่มีเขตอำนาจในที่พำนักของคุณ หากคุณเป็นธุรกิจ คุณตกลงที่จะอยู่ภายใต้เขตอำนาจศาลเฉพาะของศาลที่ตั้งอยู่ในเมืองบราติสลาวา ประเทศสโลวาเกีย
