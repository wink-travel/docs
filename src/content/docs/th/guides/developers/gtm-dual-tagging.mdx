...
2. **ป้อนในพอร์ทัล Wink**
   ...
   เข้าสู่ระบบที่ [app.wink.travel](https://app.wink.travel) เลือกบัญชีของคุณ และไปที่แท็บ **Customizations** วาง Sojern GTM Container ID ของคุณในช่อง Sojern แล้วบันทึก การผสานรวมของคุณจะเริ่มทำงานทันที
...
- **มีช่อง GTM Container ID ของ Sojern** ในแท็บ Customizations ของพอร์ทัล Wink ของคุณ เมื่อคุณป้อน Container ID Wink จะตรวจสอบรูปแบบและจัดเก็บอย่างปลอดภัยกับที่พักของคุณ
- **ในทุกหน้าที่ที่ที่พักของคุณเปิดใช้งาน** บน Wink GTM Container ID ของ Sojern จะถูกแทรกลงในหน้าและระบบจัดการแท็กของ Wink จะโหลดคอนเทนเนอร์ Sojern ของคุณแบบไดนามิกพร้อมกับของตัวเอง ซึ่งเกิดขึ้นโดยอัตโนมัติ — ไม่มีขั้นตอนด้วยมือจากทีม Wink ต่อที่พัก
- **คอนเทนเนอร์ Sojern ของคุณจะโหลดแบบอะซิงโครนัส** หมายความว่าจะไม่ส่งผลกระทบต่อประสิทธิภาพการโหลดหน้าสำหรับแขกของคุณ
- **การติดตามของ Wink และพิกเซล Sojern ของคุณทำงานพร้อมกัน** โดยอ่านจากข้อมูลเหตุการณ์ที่ใช้ร่วมกันเดียวกัน เหตุการณ์การจองทุกครั้งที่ Wink ติดตามจะพร้อมใช้งานในคอนเทนเนอร์ Sojern ของคุณพร้อมกัน
...
แต่ละเหตุการณ์จะเป็นไปตามโครงสร้าง GA4 Enhanced Ecommerce มาตรฐาน: สตริง `event` ระดับบนสุดและอ็อบเจ็กต์ `ecommerce` ก่อนการส่งแต่ละครั้ง Wink จะล้างข้อมูล ecommerce ก่อนหน้าเพื่อป้องกันข้อมูลเก่ารั่วไหลไปยังทริกเกอร์ใหม่
...
| `quantity` | number | — | จำนวน (ค่าเริ่มต้น `1`) |

#### พารามิเตอร์เฉพาะรายการแบบกำหนดเอง

พารามิเตอร์เหล่านี้บรรจุบริบทการจองเฉพาะของ Wink GA4 จะไม่แสดงโดยอัตโนมัติในรายงาน — คุณต้องลงทะเบียนแต่ละพารามิเตอร์เป็น **มิติแบบกำหนดเองที่มีขอบเขตรายการ** ในทรัพย์สิน GA4 ของคุณก่อนจึงจะปรากฏในรายงานหรือการสำรวจ ดู [มิติแบบกำหนดเองใน GA4](#custom-dimensions-in-ga4) ด้านล่างสำหรับคำแนะนำการตั้งค่า
...
GA4 จะไม่สนใจพารามิเตอร์รายการแบบกำหนดเองในรายงานจนกว่าคุณจะลงทะเบียนเป็นมิติแบบกำหนดเองที่มีขอบเขตรายการ คุณต้องลงทะเบียนเฉพาะพารามิเตอร์ที่ต้องการใช้ในรายงาน — ไม่จำเป็นต้องลงทะเบียนทั้งหมด 20 รายการ
...
| คุณสมบัติ | คำอธิบาย |
|----------|-------------|
| `device` | ประเภทอุปกรณ์ที่ตรวจจับได้ — `Desktop`, `Android`, `iPhone`, `iPad` หรือคล้ายกัน |
