---
title: การรวมระบบกับ TripPay
description: บทความนี้มีตัวอย่างเต็มรูปแบบของวิธีการรวมระบบกับ TripPay และให้ TripPay จัดการการชำระเงินให้คุณ
sidebar:
  order: 4
---
...
บทความนี้มีตัวอย่างตั้งแต่ต้นจนจบของวิธีการรวมระบบกับ TripPay

แนะนำให้คุณได้อ่านแล้ว:

- [Payment > Mapping](/th/payment/mapping).
- [Payment > Integration](/th/payment/integration).
- [Payment Web Component](/th/integrations/web-components/#payment).
- [Payment API](/th/api). *อ่านส่วนที่เกี่ยวกับ `Create payable contracts`*

นี่คือขั้นตอนในการใช้ TripPay เพื่อชำระเงินสำหรับการจองให้สำเร็จ:
...
เราสมมติว่าคุณได้ทำ `ขั้นตอนที่ 1` และ `ขั้นตอนที่ 2` เสร็จแล้ว และพร้อมที่จะให้ TripPay รับทราบเกี่ยวกับการจอง
...
- บรรทัด: **2 - 7** คือผู้ใช้ที่รับผิดชอบการจอง มีสองประเภทของผู้จอง:
    - ผู้เดินทาง
    - ตัวแทนท่องเที่ยว
- บรรทัด: **8 - 9** คือบัญชี TripPay ที่อำนวยความสะดวกในการจอง อาจเป็น:
    - บัญชี integrator ของ TripPay ของคุณ
...
- `redirectUrl` แจ้ง TripPay ว่าจะเปลี่ยนเส้นทางไปยังหน้าใดหลังจากชำระเงินเสร็จสิ้น
...
- สินค้าคงคลังที่คุณต้องการจองจากซัพพลายเออร์นั้น ซึ่งระบุไว้ในอาร์เรย์ซ้อน `contractItemList`
- ทุกรายการใน `contractItemList` ประกอบด้วย:
    ...
    - **ชำระเงิน** เมื่อใดที่ผู้เดินทางควรถูกเรียกเก็บเงิน *ปัจจุบันรองรับเฉพาะตัวเลือกชำระเงินทันทีเท่านั้น*
    - **นโยบาย** รวมกฎนโยบายการยกเลิก
    - **รายการอัตรารายวัน** หากรายการที่จองเป็นห้องพัก คุณสามารถระบุว่าห้องนั้นมีค่าใช้จ่ายเท่าไรในแต่ละคืนที่แขกพัก
    - **ผู้รับผลประโยชน์** รวมบัญชี TripPay ที่ควรได้รับส่วนแบ่งราคา *รองรับจำนวนเงินแบบคงที่/เปอร์เซ็นต์*
...
สำหรับการรวมระบบ นั่นคือทั้งหมดที่คุณต้องทำ งานหนักทั้งหมดจะถูกจัดการโดย TripPay ตั้งแต่ตรงนี้เป็นต้นไป
