...
Winkfluence, pôsobiaca pod názvom Wink (ďalej len „Spoločnosť“), by vás chcela informovať, kto kontaktuje Spoločnosť, že je nevyhnutné zhromažďovať, spracovávať a používať vaše osobné údaje pre služby Spoločnosti v súlade s týmito Zásadami ochrany osobných údajov. Kontaktovaním a zverejnením vašich osobných údajov Spoločnosti za účelom komunikácie, koordinácie a/alebo poskytovania služieb Spoločnosti vám sa považuje, že súhlasíte a prijímate záväzok dodržiavať tieto Zásady ochrany osobných údajov.

Osobné údaje, ktoré sa spracúvajú, môže Spoločnosť získať z rôznych kanálov nasledovne:

(1) Priamo od vás prostredníctvom komunikácie Spoločnosti s vami;
...
(3) Iné osobné údaje, ktoré môžete poskytnúť Spoločnosti počas komunikácie, ako informácie o predmetoch dopytu, záujmové informácie alebo akékoľvek iné osobne identifikovateľné informácie, ktoré priamo poskytnete Spoločnosti prostredníctvom rôznych komunikačných kanálov.

(4) V prípade komunikácie prostredníctvom webovej stránky môžu byť zahrnuté vaše technické informácie, ako IP adresa, cookies, vrátane informácií o vašom správaní pri prehliadaní.

Účel spracovania a používania osobných údajov, Spoločnosť je nevyhnutné zhromažďovať, spracovávať a používať osobné údaje uchádzača o zamestnanie na nasledujúce účely:

(1) Na riadenie komunikácie, ktorú ste so Spoločnosťou viedli, ako odpovedanie na otázky, poskytovanie relevantných informácií podľa požiadaviek, riešenie sťažností alebo reagovanie na vaše pripomienky priamo prostredníctvom rôznych komunikačných kanálov, vrátane kontinuálnej koordinácie, vykonávania zmluvy o službách a/alebo plnenia práv a povinností, na ktorých sa Spoločnosť a vy môžete dohodnúť;
...
Doba uchovávania osobných údajov, aby Spoločnosť mohla plniť účely opísané vyššie, je nevyhnutné zhromažďovať, spracovávať a uchovávať vaše osobné údaje podľa nasledujúcich období:

(1) Pri spracovaní osobných údajov za účelom poskytovania služieb, vykonávania zmluvy a/alebo plnenia práv a povinností podľa zmluvy, je Spoločnosť povinná spracovávať vaše osobné údaje tak dlho, ako má povinnosť vám poskytovať služby;

(2) Pri spracovaní osobných údajov za účelom plnenia povinností podľa platných zákonov je Spoločnosť povinná spracovávať vaše osobné údaje počas obdobia určeného platnými zákonmi;

(3) Pri spracovaní osobných údajov za účelom budovania a zlepšovania obchodných vzťahov a/alebo zlepšovania služieb si Spoločnosť vyhradzuje právo uchovávať tieto osobné údaje v rozsahu, v akom to môže byť obchodne nevyhnutné. Spoločnosť zaručuje, že uchovávanie osobných údajov nebude neprimerane ovplyvňovať práva dotknutej osoby;

(4) Pri spracovaní osobných údajov za účelom ochrany a presadzovania oprávnených práv Spoločnosti je Spoločnosť povinná uchovávať takéto osobné údaje podľa lehoty stanovenej platnými zákonmi; a
