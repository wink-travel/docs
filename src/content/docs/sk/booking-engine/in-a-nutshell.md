...
* Zobrazovanie rezervovateľného inventára v požadovanom formáte, jazyku a mene, ako napríklad:
  ...
  * A [mapa](/studio/maps) na tvojom [mapa](/studio/maps) účet.
...
Integrátori, ktorí chcú ešte väčšiu slobodu, majú prístup ku všetkým rovnakým funkciám prostredníctvom nášho [Doplnok WordPressu](/developers/wordpress/), [Doplnok WordPressu](/developers/wordpress/) a[API](/developers/apis).
