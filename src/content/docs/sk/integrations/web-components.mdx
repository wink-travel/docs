...
Vďaka tejto skvelej technológii môžete jednoducho vložiť Wink cestovný inventár s minimálnou námahou. Tento článok vás prevedie našou kolekciou webových komponentov a ukáže vám, ako ich používať.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Itinerary form webový komponent*</figcaption>
</figure>
...
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní inventár, alebo ho odstrániť zo svojho zoznamu.
...
Toto je určené iba pre webových vývojárov. Ak ste omylom odstránili [Aplikáciu](/sk/portal/settings/applications), čím sa klientské ID stalo nedostupným, vytvorte novú aplikáciu a použite nové klientské ID na vloženie našich webových komponentov.
