...
description: Wink udržiava knižnicu JavaScript webových komponentov, ktoré môžete vložiť do svojej stránky.
sidebar:
  order: 1
---
...
[Webové komponenty](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) sú štandard, ktorý vám umožňuje integrovať celé JavaScript funkcie do vašej webovej stránky bez znalosti programovania.
Vďaka tejto skvelej technológii môžete jednoducho vložiť Wink cestovný inventár. Tento článok vás prevedie našou kolekciou webových komponentov a ukáže vám, ako ich používať.
...
Ukážky nájdete pre [karty](/sk/portal/studio/cards), [mriežky](/sk/portal/studio/grids) a [mapy](/sk/portal/studio/maps).
...
<CloudinaryImage
    ...
    />
    <figcaption>*Lookup webový komponent*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Itinerary webový komponent*</figcaption>
</figure>
...
Search je tlačidlo iba s ikonou pre výber itinerára. Po kliknutí sa zobrazí plný výber itinerára ako modálne okno.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Search webový komponent*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Formulár itinerára webový komponent*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu webový komponent*</figcaption>
</figure>

Kliknutím na tlačidlo, keď používateľ nie je autentifikovaný, bude presmerovaný na autentifikáciu.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu (autentifikované) webový komponent*</figcaption>
</figure>

Kliknutím na tlačidlo sa otvorí používateľský rozbaľovací zoznam.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu (otvorené) webový komponent*</figcaption>
</figure>
...
:::note
Ak sa chcete naučiť, ako vygenerovať `id` rezervačnej zmluvy, prečítajte si návod: [Integrácia s TripPay](/sk/guides/developers/integrating-with-trip-pay).
:::

Widget pripraví zmluvu na vykonanie a zobrazí používateľovi podrobnosti o platbe *(Obrázok 1)* na dokončenie rezervácie.
...
Inventár už nemusí byť dostupný. Prejdite do [Studio](/sk/portal/studio/cards) a skontrolujte, či je stav "karty" dostupný.
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní inventár, alebo ho odstrániť zo zoznamu.

:::note
`Dostupnosť` neznamená dennú dostupnosť inventára na rezerváciu. Znamená to, že inventár je úplne nedostupný pre vás a/alebo kohokoľvek iného.
:::

### Odstránené

Inventár mohol byť odstránený. Prejdite do [Studio](/sk/portal/studio/cards) a skontrolujte, či je stav "karty" dostupný.
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní inventár, alebo ho odstrániť zo zoznamu.
...
Toto je určené iba pre webových vývojárov. Ak ste omylom odstránili [Aplikáciu](/sk/account/applications), čím sa klientské ID stalo nedostupným, vytvorte novú aplikáciu a použite nové klientské ID na vloženie našich webových komponentov.
