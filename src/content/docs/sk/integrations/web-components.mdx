...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Account button (otvorený) web komponent*</figcaption>
</figure>
...
:::note
Ak sa chcete naučiť, ako vygenerovať `id` rezervačnej zmluvy, prečítajte si návod: [Integrating with TripPay](/sk/guides/developers/integrating-with-trip-pay).
:::
...
Inventár už nemusí byť dostupný. Prejdite do [Wink Studio](/sk/portal/studio/cards) a skontrolujte, či je stav "karty" dostupný.
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní položku, alebo ju odstrániť zo svojho zoznamu.
...
Inventár mohol byť odstránený. Prejdite do [Wink Studio](/sk/portal/studio/cards) a skontrolujte, či je stav "karty" dostupný.
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní položku, alebo ju odstrániť zo svojho zoznamu.

### Prispôsobenie

Možno ste omylom odstránili prispôsobenie, ktoré ste definovali pre svoj inventár. Uistite sa, že prispôsobenie je stále dostupné, a ak niektoré chýba, nastavte nové.

### Aplikácia

Toto je určené iba pre webových vývojárov. Ak ste omylom odstránili [Aplikáciu](/sk/portal/settings/applications), čím sa klientské ID stalo nedostupným, vytvorte novú aplikáciu a použite nové klientské ID na vloženie našich Web komponentov.
