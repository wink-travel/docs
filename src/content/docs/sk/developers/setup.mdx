...
2. [Vytvorte si partnerský účet](/sk/portal/create-account). Tento účet budete potrebovať na prepojenie vašej aplikácie. Viac informácií nájdete v [čo je Studio](/sk/portal/studio/what-is-studio).
3. [Vytvorte aplikáciu](/sk/portal/settings/applications) a priraďte ju k partnerskému účtu, ktorý ste vytvorili v kroku 2. Pre serverové API integrácie vyberte ako typ klienta **MACHINE_2_MACHINE**.
