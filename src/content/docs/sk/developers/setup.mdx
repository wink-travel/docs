...
Keď budete pripravení spustiť produkciu, overíme váš účet a vašu aplikáciu a môžete spustiť prevádzku v produkčnom prostredí.
:::

Postupujte podľa týchto krokov:

<Steps>
1. [Zaregistrujte sa](/sk/user/register) ako používateľ na Wink
2. Vytvorte si [účet cestovnej kancelárie](/sk/travel-agent/what-is-agent) alebo [affiliate účet](/sk/studio/what-is-studio).
3. [Vytvorte aplikáciu](/sk/developer/applications), ktorú priradíte k účtu vytvorenému v kroku 2.
...
Prejdite do sekcie našich [API](/sk/developer/apis) a vyberte API, s ktorým chcete pracovať.
...
2. V ľavom menu kliknite na `Authentication`.
