...
:::note
Ak sa chcete naučiť, ako vygenerovať `id` rezervačnej zmluvy, prečítajte si návod: [Integrating with TripPay](/sk/guides/integrating-with-trip-pay).
:::
...
Toto je určené iba pre webových vývojárov. Ak ste omylom odstránili [Aplikáciu](/sk/my-account/applications), čím sa klientské ID stalo nedostupným, vytvorte novú aplikáciu a použite nové klientské ID na vloženie našich Web komponentov.
