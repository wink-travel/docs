...
[Web komponenty](https://developer.mozilla.org/en-US/docs/Web/API/Web_components) sú štandard, ktorý vám umožňuje integrovať celé JavaScript funkcie do vašej webovej stránky bez znalosti programovania.
Vďaka tejto skvelej technológii môžete jednoducho vložiť Wink cestovný inventár s minimálnou námahou. Tento článok vás prevedie našou kolekciou web komponentov a ukáže vám, ako ich používať.
...
Ukážky nájdete pre [karty](/studio/cards), [mriežky](/studio/grids) a [mapy](/studio/maps).
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu web komponent*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu (autentifikované) web komponent*</figcaption>
</figure>
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Tlačidlo účtu (otvorené) web komponent*</figcaption>
</figure>
...
:::note
Ak sa chcete naučiť, ako vygenerovať `id` rezervačnej zmluvy, prečítajte si návod: [Integrácia s TripPay](/guides/integrating-with-trip-pay).
:::
...
Inventár už nemusí byť dostupný. Prejdite do [Wink Studio](/studio/cards) a skontrolujte, či je stav "karty" dostupný.
...
Inventár mohol byť odstránený. Prejdite do [Wink Studio](/studio/cards) a skontrolujte, či je stav "karty" dostupný.
Ak nie je, zobrazí sa červená farba. V takom prípade môžete počkať, možno dodávateľ opäť sprístupní inventár, alebo ho odstrániť zo svojho zoznamu.
...
Toto je určené iba pre webových vývojárov. Ak ste omylom odstránili [Aplikáciu](/developer/applications), čím sa klientské ID stalo nedostupným, vytvorte novú aplikáciu a použite nové klientské ID na vloženie našich web komponentov.
