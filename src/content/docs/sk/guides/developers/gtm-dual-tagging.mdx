...
<Aside type="note">
Vlastné dimenzie sa môžu začať zobrazovať v GA4 reportoch až do 24 hodín po registrácii. Historické dáta zozbierané pred registráciou sa nevyplnia spätne.
