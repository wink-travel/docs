...
description: Jednostavno dostupna i ažurirana pravila privatnosti za sve naše korisnike putnike.
sidebar:
  order: 5
---
...
(2) Neizravno, putem preporuke treće strane kojoj možete dati suglasnost za otkrivanje vaših osobnih podataka Društvu; ili

(3) Automatski prikupljene putem sustava kada pristupate web stranici Društva i/ili koristite usluge.
...
(3) Ostali osobni podaci koje možete pružiti Društvu tijekom komunikacije, poput informacija o upitima, informacijama od interesa ili bilo kojih drugih osobno prepoznatljivih podataka koje izravno pružite Društvu putem različitih komunikacijskih kanala.
...
(4) U svrhu zaštite i obrane pravnih prava Društva u slučaju spora između vas i Društva; te
...
Razdoblje čuvanja osobnih podataka, kako bi se ispunile gore navedene svrhe, Društvu je potrebno prikupljati, sastavljati i obrađivati vaše osobne podatke prema sljedećim razdobljima:

(1) Za obradu osobnih podataka u svrhu pružanja usluga, izvršenja ugovora i/ili ostvarivanja prava i obveza prema ugovoru, Društvu je potrebno obrađivati vaše osobne podatke dok god Društvo ima obvezu pružati vam usluge;
...
(3) Za obradu osobnih podataka u svrhu izgradnje i poboljšanja poslovnih odnosa i/ili poboljšanja usluge, Društvo zadržava pravo zadržati te osobne podatke u mjeri u kojoj Društvo ima poslovnu potrebu. Društvo jamči da zadržavanje osobnih podataka neće nerazumno utjecati na prava ispitanika podataka;
...
Prava ispitanika podataka, Društvo poštuje vaša prava kao ispitanika podataka prema važećim zakonima. Možete kontaktirati Društvo kako biste ostvarili prava koja su (1) pravo na povlačenje suglasnosti, (2) pravo na pristup, (3) pravo na zahtjev za kopijom osobnih podataka, (4) pravo na ispravak osobnih podataka, (5) pravo na prigovor na bilo koju obradu osobnih podataka, (6) pravo na zahtjev za prenosivost podataka u slučaju da Društvo pohranjuje osobne podatke u formatu koji je čitljiv ili uobičajeno korišten od strane automatiziranih alata ili opreme, uključujući pravo na prijenos takvih osobnih podataka drugim voditeljima obrade, (7) pravo na zahtjev za brisanjem ili anonimizacijom osobnih podataka ako nema potrebe za njihovom obradom, (8) pravo na zahtjev za obustavom korištenja osobnih podataka, te (9) pravo na podnošenje pritužbe.

Kontakt informacije Društva
