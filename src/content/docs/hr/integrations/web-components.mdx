...
Zahvaljujući ovoj sjajnoj tehnologiji, možete jednostavno ugrađivati Wink putnički inventar s vrlo malo komplikacija. Ovaj članak vas vodi kroz našu kolekciju web komponenti i pokazuje kako ih koristiti.

## Ugradite Wink

Postoje tri stvari koje morate uključiti na svaku stranicu na kojoj želite prikazati neku od naših web komponenti.
...
<CloudinaryImage
      ...
      errorImage="noimage_opaque_nyrtl0.png"
    />
    <figcaption>*Account button (otvoreni) web komponenta*</figcaption>
</figure>

## Ugradite TripPay

Postoje dvije stvari koje morate uključiti na svaku stranicu na kojoj želite koristiti TripPay web komponentu za plaćanje.
...
Ovo je namijenjeno samo web developerima. Ako ste slučajno uklonili [Aplikaciju](/hr/portal/settings/applications) ; zbog čega client ID više nije dostupan, molimo kreirajte novu aplikaciju i koristite novi client ID za ugrađivanje naših Web Komponenti.
