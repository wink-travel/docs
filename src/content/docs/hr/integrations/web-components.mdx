...
Zahvaljujući ovoj sjajnoj tehnologiji, možete vrlo jednostavno ugrađivati Wink putnički inventar. Ovaj članak vas vodi kroz našu kolekciju web komponenti i pokazuje kako ih koristiti.

## Ugradite Wink

Postoje tri stvari koje morate uključiti u bilo koju stranicu na kojoj želite prikazati neku od naših web komponenti.
...
Ako dobijete poruku o pogrešci prilikom ugrađivanja neke od naših web komponenti, bilo na WinkLinks ili na vašoj vlastitoj web stranici, postoji nekoliko stvari koje bi mogle biti uzrok problema:

### Dostupnost

Inventar možda više nije dostupan. Idite na [Studio](/hr/portal/studio/cards) i provjerite je li status "kartice" dostupan.
...
Inventar je možda uklonjen. Idite na [Studio](/hr/portal/studio/cards) i provjerite je li status "kartice" dostupan.
Ako nije, prikazat će se crveno. U tom slučaju možete pričekati i možda će dobavljač ponovno učiniti dostupnim ili ga ukloniti s vaše liste.
...
Ovo je namijenjeno samo web programerima. Ako ste slučajno uklonili [Aplikaciju](/hr/account/applications) ; čime client ID više nije dostupan, molimo kreirajte novu aplikaciju i koristite novi client ID za ugrađivanje naših Web komponenti.
