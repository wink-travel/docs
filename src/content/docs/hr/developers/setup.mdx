...
:::note
Testiranje bi uvijek trebalo obavljati u našem [staging okruženju](/hr/getting-started/environments). Tamo je puno manje podataka, ali slobodni ste testirati koliko god želite bez utjecaja na produkcijsko okruženje.
...
<Steps>
1. [Registrirajte](/hr/my-account/register) svoj korisnički račun na Wink.
2. [Kreirajte affiliate račun](/hr/my-account/create-account). Trebat će vam za povezivanje vaše Aplikacije. Pogledajte [što je Studio](/hr/studio/what-is-studio) za više konteksta.
3. [Kreirajte Aplikaciju](/hr/my-account/applications) i povežite je s affiliate računom koji ste kreirali u Koraku 2. Za server-to-server API integracije, odaberite **MACHINE_2_MACHINE** kao tip klijenta.
...
Uputite se u naš odjeljak [API-jevi](/hr/developers/apis) i odaberite API s kojim želite raditi.
...
:::tip[Pro savjet]
Radi lakše upotrebe, preporučujemo integratorima da koriste endpointove koje označavamo kao `OAuth2`. Ti endpointi znaju očekivati API pozive i već znaju na kojem ste računu, pa ne morate specificirati `companyIdentifier` u URL-ovima.
:::
