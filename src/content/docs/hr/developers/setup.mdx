---
title: Postavljanje
description: Ovaj članak pokazuje kako se brzo postaviti kao programer i početi testirati naše API-je na Wink-u.
sidebar:
  order: 1
---
...
:::note
Testiranje bi uvijek trebalo obavljati u našem [staging okruženju](/getting-started/environments). Tamo ima puno manje podataka, ali slobodni ste testirati koliko god želite bez utjecaja na produkcijsko okruženje.
...
<Steps>
1. [Registrirajte se](/user/register) kao korisnik na Wink-u
2. Kreirajte [račun turističkog agenta](/travel-agent/what-is-agent) ili [affiliate račun](/studio/what-is-studio).
3. [Kreirajte aplikaciju](/developer/applications) i povežite je s računom koji ste kreirali u Koraku 2.
...
Idite na našu sekciju [API-je](/developer/apis) i odaberite API s kojim želite raditi.
...
:::tip[Pro savjet]
Radi lakše upotrebe, preporučujemo integratorima da koriste krajnje točke koje označavamo kao `OAuth2`. Te krajnje točke prepoznaju API pozivatelje i već znaju na kojem ste računu, pa ne morate navoditi `companyIdentifier` u URL-ovima.
:::
