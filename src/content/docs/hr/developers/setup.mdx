...
<Steps>
1. [Registrirajte](/hr/account/register) svoj korisnički račun na Wink.
2. [Kreirajte affiliate račun](/hr/portal/create-account). Trebat će vam za povezivanje vaše Aplikacije. Pogledajte [što je Studio](/hr/portal/studio/what-is-studio) za više konteksta.
3. [Kreirajte Aplikaciju](/hr/portal/settings/applications) i povežite je s affiliate računom koji ste kreirali u Koraku 2. Za server-to-server API integracije, odaberite **MACHINE_2_MACHINE** kao tip klijenta.
...
Idite na našu [API-je](/hr/api) sekciju i odaberite API s kojim želite raditi.
...
:::tip[Pro savjet]
Radi lakše upotrebe, preporučujemo integratorima da koriste endpoint-e koje označavamo kao `OAuth2`. Ti endpoint-i znaju očekivati API pozive i već znaju na kojem ste računu pa ne morate specificirati `companyIdentifier` u URL-ovima.
:::
