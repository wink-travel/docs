...
<Steps>
  1. Koristite [API za pretraživanje](https://developer.wink.travel/lookup) za pronalaženje odredišta ili hotela.
...
<Steps>
  ...
  2. Kliknite na `Download OpenAPI spec` s vrha [API za pretraživanje](https://developer.wink.travel/lookup) stranica.
