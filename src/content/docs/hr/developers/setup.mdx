...
<Steps>
1. [Registrirajte](/hr/getting-started/sign-up) svoj korisnički račun na Wink.
...
3. [Kreirajte Aplikaciju](/hr/account/applications) i povežite je s affiliate računom koji ste kreirali u Koraku 2. Za server-to-server API integracije, odaberite **MACHINE_2_MACHINE** kao tip klijenta.
