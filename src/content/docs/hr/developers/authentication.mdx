...
| **Inventory** | `inventory.read` `inventory.write` `inventory.remove` | Nekretnine, tipovi soba, planovi cijena, cijene, dodaci, dostupnost, aktivnosti, atrakcije | Nizak–Srednji |
...
| **Analytics** | `analytics.read` `analytics.write` `analytics.remove` | Izvještaji i analitika — prihodi, ljestvice | Nizak–Srednji |
| **Integrations** | `integrations.read` `integrations.write` `integrations.remove` | Channel manageri, vanjski sustavi rezervacija, Google Hotel, krajnje točke za obavijesti, sinkronizacija rezervacija | Nizak–Srednji |
...
Uzmite 'Client ID' i 'Secret Key' iz jedne od vaših aplikacija i posjetite bilo koji od naših [API-ja](/hr/api/overview/).
:::
