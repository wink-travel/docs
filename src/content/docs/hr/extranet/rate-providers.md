...
Za postavljanje vašeg pružatelja cijena, kliknite na `Distribution > Channel manager` u glavnoj navigacijskoj traci.

Odaberite svog pružatelja cijena s padajućeg popisa i kliknite gumb `Save`. To će omogućiti pružatelju cijena da nam šalje cijene, a mi ćemo ih obavijestiti kada se na Wink dogodi rezervacija za jednu od vaših nekretnina.
...
- Oni će vam dati obrazac ***PRS*** za ispunjavanje.
  - Bit ćete zamoljeni da unesete svoje Wink korisničke vjerodajnice.
  - ...i željenu valutu.
- Ispunite obrazac i pošaljite ga natrag SynXisu.

## Dobavljači

Ispod je popis dobavljača koje podržavamo:
