...
3. Vaš sustav prati vlastiti skup analitika i koristi ovaj događaj za ažuriranje svoje vremenske baze podataka.
</Steps>
...
:::caution
Prije nego što kreirate webhook, morate imati affiliate račun na Wink-u ili račun na TripPay jer ćete povezati svoj webhook s određenim računom.
:::
...
2. ***Ime*** Dajte svom webhooku ime. *npr. Wink Stalker*
3. ***Omogući*** Ostavite kako jest da bude omogućen.
4. **Naziv entiteta** Povežite svoj webhook s jednim od postojećih računa. *npr. Cool Account*
...
<Steps>
1. Kliknite na poveznicu `Actions` za webhook koji želite ažurirati.
...
<Steps>
1. Kliknite na poveznicu `Actions` za webhook koji želite ukloniti.
