...
Pode encontrar exemplos para [cartões](/pt-PT/studio/cards), [grelhas](/pt-PT/studio/grids) e [mapas](/pt-PT/studio/maps).
...
:::note
Para aprender como gerar o `id` do contrato de reserva, leia o guia: [Integrar com TripPay](/pt-PT/guides/integrating-with-trip-pay).
:::
...
O inventário pode já não estar disponível. Vá a [Wink Studio](/pt-PT/studio/cards) e verifique se o estado do "cartão" está disponível.
...
O inventário pode ter sido removido. Vá a [Wink Studio](/pt-PT/studio/cards) e verifique se o estado do "cartão" está disponível.
Se não estiver, aparecerá em vermelho. Nesse caso, pode esperar e talvez o fornecedor o torne disponível novamente ou removê-lo da sua lista.
...
Isto é apenas para programadores web. Se acidentalmente removeu a [Aplicação](/pt-PT/my-account/applications), tornando o client ID indisponível, por favor crie uma nova aplicação e use o novo client ID para incorporar os nossos Componentes Web.
