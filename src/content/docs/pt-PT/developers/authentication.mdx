...
**Payment** e **Accounting** protegem o movimento de dinheiro, por isso têm risco elevado.
:::
...
Obtenha um 'Client ID' e 'Secret Key' de uma das suas apps e navegue para qualquer uma das nossas [APIs](/pt-PT/api/overview/).
:::
