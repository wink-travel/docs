...
Muito provavelmente, estará a trabalhar com uma biblioteca OAuth2 robusta para a sua linguagem, que fará todo o trabalho pesado por si.
Os nossos exemplos mostrarão a utilização mais básica a partir da linha de comandos usando `curl`.
