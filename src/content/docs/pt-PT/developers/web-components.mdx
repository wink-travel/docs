...
Isto é apenas para programadores web. Se acidentalmente removeu a [Aplicação](/pt-PT/developer/applications), tornando o client ID indisponível, por favor crie uma nova aplicação e use o novo client ID para incorporar os nossos Componentes Web.
