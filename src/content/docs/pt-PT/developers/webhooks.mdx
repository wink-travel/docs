...
Os Webhooks são uma forma de receber e reagir a eventos em tempo real do Wink e do TripPay relacionados com a sua conta.
...
<Steps>
  ...
  2. ***Nome*** Dê um nome ao seu webhook. *por exemplo Perseguidor Wink*
