...
O Wink suporta **mais de 64 tipos de eventos de webhook** em categorias que incluem gestão de conta, contratos de reserva, pagamentos, atualizações de gestores de canais e administração de entidades. Eventos comuns incluem:
