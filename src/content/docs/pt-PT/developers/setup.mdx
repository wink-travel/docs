...
2. [Crie uma conta de afiliado](/pt-PT/portal/create-account). Vai precisar disto para associar à sua Aplicação. Veja [o que é o Studio](/pt-PT/portal/studio/what-is-studio) para mais contexto.
3. [Crie uma Aplicação](/pt-PT/portal/settings/applications) e associe-a à conta de afiliado que criou no Passo 2. Para integrações API servidor-a-servidor, escolha **MACHINE_2_MACHINE** como tipo de cliente.
...
Dirija-se à nossa secção de [APIs](/pt-PT/api) e escolha a API com a qual quer trabalhar.
