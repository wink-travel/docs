...
3. [Crie uma Aplicação](/pt-PT/account/applications) e associe-a à conta afiliada que criou no Passo 2. Para integrações API servidor-a-servidor, escolha **MACHINE_2_MACHINE** como tipo de cliente.
