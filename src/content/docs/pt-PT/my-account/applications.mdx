...
:::caution
Precisa de criar uma conta afiliada no Wink ou uma conta no TripPay antes de criar uma app, pois irá ligar a sua aplicação a uma conta específica.
:::
...
- **MACHINE_2_MACHINE** — Para integrações servidor-a-servidor que se autenticam diretamente usando credenciais de cliente. Use este tipo quando o seu serviço backend precisar de chamar APIs do Wink sem um utilizador presente.
...
4. **Nome da entidade** Ligue a sua app a uma das suas contas existentes. *ex. Cool Account*
...
6. **URIs de redirecionamento pós-logout** *(Opcional)* URLs para onde os utilizadores podem ser redirecionados após efetuarem logout. Isto garante que os utilizadores aterram numa página conhecida após o fim da sessão.
