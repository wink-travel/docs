...
Selecione o seu fornecedor de tarifas na lista suspensa e clique no botão `Save`. Isto permitirá que o fornecedor de tarifas nos envie tarifas e nós os notificaremos quando ocorrer uma reserva na Wink para uma das suas propriedades.
...
- Eles irão pedir-lhe para preencher o formulário ***PRS***.
  - Será solicitado que preencha as suas credenciais de utilizador Wink.
  - ...e a sua moeda desejada.
