...
- **Incorporar** Mostra como incorporar este cartão como um [Card](/pt-PT/integrations/web-components/#content-loader) no seu site.
...
- As linhas 6 a 9 mostram como usar o [wink-content-loader](/pt-PT/integrations/web-components/#content-loader) Web Component e indicar que deve buscar um cartão de quarto para convidados para o seu código.
