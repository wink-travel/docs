...
Клик по кнопке выше открывает модальное окно для обновления маршрута.
...
Изменение маршрута в любом из наших компонентов маршрута вызывает событие обновления маршрута для любого инвентаря, который сейчас отображается на странице.
...
Если при встраивании одного из наших веб-компонентов, как на WinkLinks, так и на вашем собственном сайте, появляется сообщение об ошибке, возможно, произошли следующие проблемы:
...
Возможно, вы случайно удалили настройку, которую определили для вашего инвентаря. Убедитесь, что настройка всё ещё доступна, и задайте новую, если какая-то отсутствует.
