...
<Steps>
1. [Зарегистрируйте](/ru/account/register) свой пользовательский аккаунт на Wink.
...
3. [Создайте приложение](/ru/portal/settings/applications) и свяжите его с партнёрским аккаунтом, созданным на шаге 2. Для интеграций API сервер-сервер выберите тип клиента **MACHINE_2_MACHINE**.
...
Перейдите в раздел наших [API](/ru/api) и выберите API, с которым хотите работать.
