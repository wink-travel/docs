...
3. [Создайте приложение](/ru/account/applications) и свяжите его с аккаунтом партнёра, созданным на шаге 2. Для интеграций API сервер-сервер выберите тип клиента **MACHINE_2_MACHINE**.
