---
title: Поставщики тарифов
description: Здесь представлен актуальный список поставщиков тарифов, которые мы поддерживаем напрямую на Wink.
sidebar:
  order: 24
---

## Установить поставщика тарифов

Чтобы установить поставщика тарифов, нажмите `Distribution > Channel manager` в главном навигационном меню.

Выберите вашего поставщика тарифов из выпадающего списка и нажмите кнопку `Save`. Это позволит поставщику тарифов отправлять нам тарифы, и мы будем уведомлять их, когда на Wink будет совершено бронирование для одного из ваших объектов.


### SynXis

Если ваш объект использует channel manager SynXis, перед подключением к Wink требуется еще один шаг.

- Пожалуйста, свяжитесь с вашим представителем SynXis или службой поддержки клиентов (SHSCustomerCare@sabre.com).
- Сообщите им, что хотите подключиться к Wink через Channel Connect Express (***CCX***).
- Они попросят вас заполнить форму ***PRS***.
  - Вас попросят указать ваши учетные данные Wink.
  - ...и желаемую валюту.
- Заполните форму и отправьте ее обратно в SynXis.

## Поставщики

Ниже приведен список поддерживаемых поставщиков:
...
*Если у поставщика есть прокси, это означает, что мы получаем тарифы от поставщика косвенно через прокси.*

| Поставщик | Тип | Прокси | С | Последнее изменение | Комментарий
| -- | -- | -- | -- | -- | -- |
...
| Fastbooking | CM |  | 2016 | 2016 | Сейчас d-edge |
