---
title: Интеграция GTM Analytics
description: Как подключить любой контейнер Google Tag Manager (например, контейнер Sojern) к Wink для отслеживания пути бронирования гостей и поддержки ваших ретаргетинговых и рекламных кампаний.
sidebar:
  label: Интеграция GTM Analytics
---
...
<Aside type="tip">
Предполагается, что у вас уже есть GTM Container ID (формат `GTM-XXXXXXX`). Если ваш контейнер предоставлен партнёром, например Sojern, запросите у менеджера по работе с клиентами именно **GTM Container ID** — он отличается от пикселя или ID тега. Новичок в Sojern? Посетите [sojern.com/contact](https://www.sojern.com/contact), чтобы начать.
</Aside>
...
<Aside type="note">
Для этой интеграции не нужно размещать никакой пиксельный код на вашем сайте. Wink автоматически загружает ваш GTM контейнер на всех страницах, где активен ваш объект.

Это работает с **любым** GTM Container ID — Sojern приведён лишь как распространённый пример.
</Aside>
