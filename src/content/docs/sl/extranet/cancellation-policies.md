...
description: Ta članek prikazuje, kako upravljati politike odpovedi na Wink.
sidebar:
  order: 7
---

Za upravljanje svojih politik odpovedi kliknite na `Monetize > Cancellation policies` v glavni navigacijski vrstici.
...
- **Koliko se gostu zaračuna za odpoved po preteku roka?** Če gost preseže zgornji rok, lahko nastavite znesek, ki ga gost plača po tem roku. *npr. 70 % celotne cene*
...
- **Koliko naj se gostu zaračuna, če odpove po zgornjem roku?** Če ste natančneje določili rok, lahko nastavite znesek, ki ga gost plača po tem roku. *npr. 50 % celotne cene*
