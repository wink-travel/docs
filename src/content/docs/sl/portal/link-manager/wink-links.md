...
:::note
Vklopite `Intelligent` na 🟢 v svojih [Nastavitvah](/sl/portal/link-manager/settings), da uporabite to funkcijo.
:::
...
- [Deljivih povezav](/sl/portal/studio/shareable-links) - Izberite prikaz kot:
    - [Oglasni pas](/sl/integrations/web-components/#content-loader).
    - Navadna povezava z realnočasovnimi posodobitvami cen.
- [Kartic](/sl/portal/studio/cards) - Rezervabilne kartice z realnočasovno ceno in razpoložljivostjo.
- [Mrež](/sl/portal/studio/grids) - Mreža z rezervabilnimi karticami.
- [Zemljevidov](/sl/portal/studio/maps) - Zemljevid z oznakami, ki odpirajo rezervabilne kartice.
