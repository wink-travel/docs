...
<Steps>
1. [Registrirajte](/sl/user/register) svoj uporabniški račun na Wink
2. Ustvarite [račun potovalne agencije](/sl/travel-agent/what-is-agent) ali [partnerski račun](/sl/studio/what-is-studio).
3. [Ustvarite aplikacijo](/sl/developer/applications), ki jo povežete z računom, ki ste ga ustvarili v koraku 2.
...
Pojdite v našo sekcijo [API-ji](/sl/developer/apis) in izberite API, s katerim želite delati.
...
:::tip[Pro nasvet]
Za lažjo uporabo priporočamo, da integratorji uporabljajo končne točke, ki jih označimo kot `OAuth2`. Te končne točke vedo, da pričakujejo klice API-ja in že vedo, na katerem računu ste, zato vam ni treba navajati `companyIdentifier` v URL-jih.
:::
...
:::tip[Pro nasvet]
Priporočamo, da strežniško domeno, client ID in client secret nastavite kot okoljske spremenljivke. Tako lahko enostavno preklapljate med staging in produkcijskim okoljem ter ponovno uporabljate vse ustvarjene operacije.
:::
