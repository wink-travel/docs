...
<Steps>
  1. Uporabite [Iskalni API](https://developer.wink.travel/lookup) za pridobitev destinacij ali hotelov.
...
<Steps>
  ...
  2. Kliknite na `Download OpenAPI spec` z vrha [Iskalni API](https://developer.wink.travel/lookup) stran.
