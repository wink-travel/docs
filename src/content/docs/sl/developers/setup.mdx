...
<Steps>
1. [Registrirajte](/sl/my-account/register) svoj uporabniški račun na Wink.
2. [Ustvarite partnerski račun](/sl/my-account/create-account). Ta je potreben za povezavo vaše aplikacije. Za več informacij glejte [kaj je Studio](/sl/studio/what-is-studio).
3. [Ustvarite aplikacijo](/sl/my-account/applications) in jo povežite s partnerskim računom, ki ste ga ustvarili v koraku 2. Za API integracije strežnik-strežnik izberite **MACHINE_2_MACHINE** kot tip odjemalca.
...
Pojdite v našo sekcijo [API-ji](/sl/developers/apis) in izberite API, s katerim želite delati.
...
:::tip[Pro nasvet]
Za lažjo uporabo priporočamo, da integratorji uporabljajo končne točke, ki jih označimo kot `OAuth2`. Te končne točke že vedo, da pričakujejo klice API-ja in poznajo vaš račun, zato vam ni treba posebej navajati `companyIdentifier` v URL-jih.
:::
