...
- **Idempotentnost** — Vaš obdelovalec naj bo idempotenten. Wink lahko poskusi ponovno dostavo, če ne prejme odgovora `200`.
- **Preverite vir** — Pred obdelavo preverite, da so dohodni zahtevki res iz Wink.
...
- [Katalog webhook dogodkov](/sl/developers/webhook-events) — Popoln seznam vseh 64+ vrst dogodkov.
- [Webhooki](/sl/portal/settings/webhooks) — Celoten referenčni vodič za upravljanje webhookov.
- [Applications](/sl/portal/settings/applications) — Upravljanje vaših API poverilnic.
