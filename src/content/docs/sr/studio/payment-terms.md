...
**10.5 Жалба**Ако Посредник за плаћање предузме било коју од мера описаних у одељцима 10.3 и 10.4, можете се жалити на такву одлуку контактирањем [корисничка служба](mailto:support@wink.travel).
