...
| **Povraćaji novca** | `booking.contract.refund.partial`, `booking.contract.refund.full` |
| **Menadžer kanala** | `channel-manager.update.rate`, `channel-manager.update.availability` |
...
- [Webhooks](/sr/portal/settings/webhooks) — Potpuna referenca za upravljanje webhook-ovima.
- [Applications](/sr/portal/settings/applications) — Upravljajte svojim API akreditivima.
- [Developers > APIs](/sr/api) — Potpuna API dokumentacija.
