...
Naši primeri će pokazati najosnovniju upotrebu sa komandne linije koristeći `curl`.
...
Wink grupiše dozvole po funkcionalnim oblastima. Tražite samo opsege koje vaša integracija zahteva:
...
| **Analytics** | `analytics.read` `analytics.write` `analytics.remove` | Izveštaji i analitika — prihodi, rang liste | Nizak–Srednji |
...
Uzmete 'Client ID' i 'Secret Key' iz jedne od vaših aplikacija i posetite bilo koji od naših [API-ja](/sr/api/overview/).
:::
