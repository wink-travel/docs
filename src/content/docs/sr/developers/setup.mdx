...
<Steps>
  1. Користите [API за претрагу](https://developer.wink.travel/lookup) да бисте преузели дестинације или хотеле.
...
<Steps>
  ...
  2. Кликните на `Download OpenAPI spec` са врха [API за претрагу](https://developer.wink.travel/lookup) страница.
