...
<Steps>
1. [Registrujte se](/sr/user/register) kao korisnik na Wink-u
2. Kreirajte [nalog turističkog agenta](/sr/travel-agent/what-is-agent) ili [affiliate nalog](/sr/studio/what-is-studio).
3. [Kreirajte aplikaciju](/sr/developer/applications) i povežite je sa nalogom koji ste napravili u koraku 2.
...
Idite u našu sekciju [API-je](/sr/developer/apis) i izaberite API sa kojim želite da radite.
