...
<Steps>
  ...
  7. Поставите поље `Header prefix` до `Bearer`.
  ...
  13. Постави поље `Scope` до `inventory.read inventory.write inventory.remove`То су сви оптички нишани који ће вам бити потребни за Винк.
  14. Поставите поље `Client Authentication` до `Send as Basic Auth header`.
