---
title: Šta je Agent?
description: Saznajte kako Wink podržava registrovane turističke agente.
sidebar:
  order: 0
---
...
Programeri koji žele da upravljaju `Travel Agent` mogu otići na [Developers > API > Travel Agent](/sr/api).
