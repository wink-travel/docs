...
description: Ovaj dokument pokriva dostupnost sredstava i kako Wink podržava model agenata za turističke agente.
sidebar:
  order: 5
---

:::note
Poslednje ažuriranje 2024-10-30
:::

:::caution[Obaveštenje]
Uslovi plaćanja ispod važe za turističke agente koji žele da samostalno prikupljaju i raspoređuju sredstva.  
Ovo je moguće samo putem našeg API-ja i samo za turističke agente koji su tokom procesa registracije naznačili da žele da to rade.

Svi turistički agenti i dalje mogu da rezervišu putem našeg portala za turističke agente koristeći Wink-ov platni prolaz sa svojom ili kreditnom karticom putnika. Stoga, svi turistički agenti takođe moraju da se slože sa uslovima plaćanja gde je Wink-ov platni prolaz trgovac zapisan u evidenciji.

Ti uslovi su dostupni pod [Affiliate Portal > Payment Terms](/sr/portal/studio/payment-terms).
:::
...
1. **Winkfluence**, kompanija registrovana po zakonima Singapura sa sedištem na adresi \#03-01 Wilkie Edge 8 Wilkie Road Singapore 228095 i poreskim brojem 201437335D (u daljem tekstu "Wink") i  
...
Definicije i uslovi iz Glavnog ugovora primenjuju se na ove Uslove plaćanja osim ako ovde nije drugačije definisano.
...
2.2 **Odbitak naknada:** Turistički agent prvo odbija naknadu pružaoca usluge, a zatim svoju proviziju za podnaslov prema primeru ispod:
...
2.3 **Neto uplata pružaocima smeštaja:** Turistički agent je odgovoran za isplatu Neto uplate pružaocu smeštaja u skladu sa uslovima Posebnog ugovora između Turističkog agenta i Pružaoca smeštaja. Wink nije odgovoran za bilo kakve isplate pružaocu smeštaja.

**3\. Fakturisanje i plaćanje**

3.1 **Mesečno fakturisanje:** Wink će izdavati tačne i precizne mesečne fakture Turističkom agentu za naknade za rezervacije akumulirane tokom prethodnog meseca. Turistički agent je dužan da plati ovu fakturu u roku navedenom na fakturi.
...
3.3 **Kašnjenje u plaćanju:** U slučaju kašnjenja u plaćanju, Wink zadržava pravo da naplati kamatu na dospeli iznos po stopi od 5% mesečno ili maksimalnoj stopi dozvoljenoj zakonom, koja je niža. Takođe, ako Turistički agent kasni sa plaćanjem Pružaocu smeštaja prema uslovima Posebnog ugovora, Wink zadržava pravo da suspenduje pristup usluzi dok se ne reše sva dugovanja prema Wink-u i Pružaocu smeštaja. Međutim, ako postoje greške u fakturi koju je izdao Wink, Turistički agent je obavezan da plati samo tačan i ispravan deo fakture i neće biti podložan kamatama ili kaznama za neplaćeni netačni deo fakture.
...
* Aktivno upravljati i rešavati sporove vezane za rezervacije ili plaćanja, održavajući komunikaciju sa Wink-om radi efikasnog rešavanja problema.

4.2 **Odgovornosti Wink-a:**

* Izdavati tačne i pravovremene mesečne fakture za naknade za rezervacije kao što je navedeno u Sekciji 3.1.  
...
**7\. Izmena uslova**  
Wink zadržava pravo da u bilo kom trenutku izmeni ove Uslove plaćanja. Sve izmene biće saopštene Turističkom agentu najmanje 30 dana pre stupanja na snagu. Nastavak korišćenja Wink platforme nakon datuma stupanja na snagu predstavlja prihvatanje izmenjenih uslova.
