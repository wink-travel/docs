...
Da biste upravljali svojim WinkLinks podešavanjima, idite na `WinkLinks` u glavnoj navigacionoj traci i kliknite na karticu `Settings`.

Evo na koje načine možete konfigurisati ponašanje WinkLinks-a pomoću `Settings`:
...
- **Profile picture** Na vrhu svake WinkLinks stranice nalazi se profilna slika vašeg naloga zajedno sa opisom naloga. Profilnu sliku možete prikazati na dva načina:
    - `Circle` Preporučujemo korišćenje kružnog oblika ako je vaša slika vas ili bilo šta drugo što se uklapa u okrugli okvir.
