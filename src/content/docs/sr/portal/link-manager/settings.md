---
title: Podešavanja
description: U ovom članku objašnjavamo kako možete prilagoditi svoju WinkLinks stranicu koristeći funkcije dostupne u podešavanjima.
sidebar:
  order: 4
---

Da biste upravljali svojim WinkLinks podešavanjima, idite na `WinkLinks` u glavnom navigacionom meniju i kliknite na karticu `Design`.
...
- **Profile picture** Na vrhu svake WinkLinks stranice nalazi se profilna slika vašeg naloga zajedno sa opisom naloga. Profilnu sliku možete prikazati na dva načina:
    - `Circle` Preporučujemo kružni stil ako je vaša slika vas ili bilo šta drugo što odgovara u okruglom okviru.
...
- **Customization** Personalizujte izgled i doživljaj vaše WinkLinks stranice. Možete prilagoditi paletu boja do mile volje kako biste savršeno uskladili sa vašim brendom. Ovo podešavanje takođe utiče na prikaz Wink inventar kartica, mapa i mreža.  
...
- Pročitajte više o [Prilagođavanjima](/sr/portal/settings/branding).
