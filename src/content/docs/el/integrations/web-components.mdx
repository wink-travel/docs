...
Ο ιστότοπός σας είναι τώρα έτοιμος και ικανός να εμφανίσει τα web components μας.
...
*Το χαρακτηριστικό `sort` είναι διαθέσιμο μόνο όταν το layout είναι `RANKED` και δεν θέλετε να χρησιμοποιήσετε ένα υπάρχον ταξινομημένο πλέγμα. Για αυτές τις περιπτώσεις, αφήστε το `id` κενό.*
...
Το component πληρωμής σας επιτρέπει να ενημερώσετε το TripPay ότι ένας ταξιδιώτης θέλει να αγοράσει κάτι και τους κανόνες και τις τιμές για αυτά τα είδη.
