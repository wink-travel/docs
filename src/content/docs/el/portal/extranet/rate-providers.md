...
Για να ορίσετε τον πάροχο τιμών σας, κάντε κλικ στο `Distribution > Channel manager` από την κύρια γραμμή πλοήγησης.

Επιλέξτε τον πάροχο τιμών σας από τη λίστα επιλογών και κάντε κλικ στο κουμπί `Save`. Αυτό θα επιτρέψει στον πάροχο τιμών να μας στέλνει τιμές και θα τους ειδοποιούμε όταν γίνει κράτηση στο Wink για κάποιο από τα καταλύματά σας.


### SynXis

Εάν το κατάλυμά σας χρησιμοποιεί τον channel manager SynXis, απαιτείται ένα ακόμα βήμα πριν είστε έτοιμοι να συνδεθείτε με το Wink.
...
*Εάν ο πάροχος έχει proxy, σημαίνει ότι λαμβάνουμε έμμεσα τις τιμές από τον πάροχο μέσω του proxy.*
