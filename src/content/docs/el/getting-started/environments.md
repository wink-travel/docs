...
Αν είστε ενσωματωτής, ξενοδοχείο ή ταξιδιωτικό πρακτορείο που επιθυμεί να προετοιμαστεί για πιστοποίηση ή να δοκιμάσει την πλατφόρμα Wink, δημιουργήστε έναν λογαριασμό στο περιβάλλον staging για να ξεκινήσετε.
