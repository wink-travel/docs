---
title: Ρύθμιση
description: Αυτό το άρθρο σας δείχνει πώς να ρυθμιστείτε γρήγορα ως προγραμματιστής και να ξεκινήσετε να δοκιμάζετε τα API μας στο Wink.
sidebar:
  order: 1
---
...
:::note
Οι δοκιμές πρέπει πάντα να γίνονται στο [περιβάλλον staging](/getting-started/environments). Υπάρχουν πολύ λιγότερα δεδομένα εκεί, αλλά μπορείτε να δοκιμάσετε όσο θέλετε χωρίς να επηρεάσετε το περιβάλλον παραγωγής.

Μόλις είστε έτοιμοι να πάτε σε ζωντανή λειτουργία, θα πιστοποιήσουμε τον λογαριασμό και την εφαρμογή σας και μπορείτε να ξεκινήσετε στο περιβάλλον παραγωγής μας.
:::

Ακολουθήστε αυτά τα βήματα:

<Steps>
1. [Εγγραφείτε](/user/register) για τον λογαριασμό χρήστη σας στο Wink
2. Δημιουργήστε έναν [λογαριασμό ταξιδιωτικού πράκτορα](/travel-agent/what-is-agent) ή έναν [λογαριασμό συνεργάτη](/studio/what-is-studio).
3. [Δημιουργήστε μια Εφαρμογή](/developer/applications) όπου θα τη συσχετίσετε με τον λογαριασμό που δημιουργήσατε στο Βήμα 2.
...
Μεταβείτε στην ενότητα [APIs](/developer/apis) και επιλέξτε το API με το οποίο θέλετε να εργαστείτε.
...
:::tip[Συμβουλή]
Συνιστάται να κάνετε το domain του server, το client ID και το client secret μεταβλητές περιβάλλοντος. Με αυτόν τον τρόπο μπορείτε εύκολα να εναλλάσσετε μεταξύ των περιβαλλόντων staging και παραγωγής και να επαναχρησιμοποιείτε όλες τις λειτουργίες που έχετε δημιουργήσει.
:::
