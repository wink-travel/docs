...
Δείγματα μπορείτε να βρείτε για [κάρτες](/el/studio/cards), [πλέγματα](/el/studio/grids) και [χάρτες](/el/studio/maps).
...
Αυτό αφορά μόνο προγραμματιστές ιστού. Εάν καταλάθος αφαιρέσατε την [Εφαρμογή](/el/my-account/applications)· κάνοντας το client ID μη διαθέσιμο, παρακαλούμε δημιουργήστε μια νέα εφαρμογή και χρησιμοποιήστε το νέο client ID για να ενσωματώσετε τα Web Components μας.
