---
title: Ενσωμάτωση GTM Analytics
description: Πώς να συνδέσετε οποιοδήποτε container Google Tag Manager (όπως ένα container Sojern) με το Wink ώστε να παρακολουθεί το ταξίδι κράτησης των επισκεπτών σας και να ενισχύει τις καμπάνιες επαναστόχευσης και διαφήμισης.
sidebar:
  label: Ενσωμάτωση GTM Analytics
---
...
<Aside type="tip">
Αυτό προϋποθέτει ότι ήδη έχετε ένα GTM Container ID (μορφή `GTM-XXXXXXX`). Αν το container σας προέρχεται από συνεργάτη όπως η Sojern, ζητήστε από τον διαχειριστή του λογαριασμού σας το **GTM Container ID** συγκεκριμένα — είναι διαφορετικό από το pixel ή το tag ID. Νέοι στη Sojern; Επισκεφθείτε το [sojern.com/contact](https://www.sojern.com/contact) για να ξεκινήσετε.
</Aside>
...
<Aside type="note">
Δεν χρειάζεται να τοποθετήσετε κανένα pixel κώδικα στην ιστοσελίδα σας για αυτή την ενσωμάτωση. Το Wink φορτώνει το GTM container σας αυτόματα σε όλες τις σελίδες όπου το ακίνητό σας είναι ενεργό.

Αυτό λειτουργεί για **οποιοδήποτε** GTM Container ID — η Sojern είναι απλώς ένα κοινό παράδειγμα.
</Aside>
...
Το Wink επαναφέρει το αντικείμενο ecommerce πριν από κάθε push γεγονότος:

```js
dataLayer.push({ ecommerce: null });   // καθαρισμός προηγούμενου γεγονότος
dataLayer.push({ event: '...', ecommerce: { ... } });
```

Μην βασίζεστε στην επιμονή των ιδιοτήτων ecommerce μεταξύ γεγονότων. Διαβάζετέ τες πάντα κατά το χρόνο ενεργοποίησης μέσα στο ίδιο γεγονός.
</Aside>
