...
2. **Εισάγετέ το στην πύλη Wink**
   ...
   Συνδεθείτε στο [app.wink.travel](https://app.wink.travel), επιλέξτε τον λογαριασμό σας και ανοίξτε τις ρυθμίσεις προσαρμογής. Στην ενότητα **Analytics & integrations**, επικολλήστε το GTM Container ID στο πεδίο **GTM Container ID** και αποθηκεύστε. Η ενσωμάτωσή σας είναι πλέον ενεργή.
...
<Aside type="note">
Δεν χρειάζεται να τοποθετήσετε κανέναν κώδικα pixel στην ιστοσελίδα σας για αυτήν την ενσωμάτωση. Το Wink φορτώνει το GTM container σας αυτόματα σε όλες τις σελίδες όπου το ακίνητό σας είναι ενεργό.
...
```js
dataLayer.push({ ecommerce: null });   // καθαρίζει το προηγούμενο γεγονός
dataLayer.push({ event: '...', ecommerce: { ... } });
```

Μην βασίζεστε στην επιμονή των ιδιοτήτων ecommerce μεταξύ των γεγονότων. Διαβάζετέ τες πάντα κατά το χρόνο ενεργοποίησης μέσα στο ίδιο γεγονός.
</Aside>
